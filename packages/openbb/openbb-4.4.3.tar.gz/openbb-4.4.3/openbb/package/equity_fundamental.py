...
class ROUTER_equity_fundamental(Container):
    ...
    def filings(
        ...
        **kwargs
        ...
        limit : Optional[int]
            Number of results to return. (provider: fmp, intrinio, nasdaq)
        ...
        year : Optional[int]
            The calendar year to fetch. (provider: nasdaq)
        form_group : Literal['annual', 'quarterly', 'proxy', 'insider', '8k', 'registration', 'comment']
            The form group to fetch. (provider: nasdaq)
        ...
        period_ending : Optional[date]
            The period ending date of the filing. (provider: nasdaq)
        name : Optional[str]
        ...
        pdf_url : Optional[str]
            The URL to the PDF document. (provider: nasdaq)
        xls_url : Optional[str]
            The URL to the XLS document. (provider: nasdaq)
        xbr_url : Optional[str]
            The URL to the XBR document. (provider: nasdaq)
        doc_link : Optional[str]
            The URL to the DOC document. (provider: nasdaq)
