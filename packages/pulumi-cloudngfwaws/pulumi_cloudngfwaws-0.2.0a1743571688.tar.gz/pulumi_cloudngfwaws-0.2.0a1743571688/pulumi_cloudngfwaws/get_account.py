...
def get_account(account_id: Optional[str] = None,
    ...
    * `Global Rulestack` (for `scope="Global"`)
    ...
    :param str cft_url: The CFT URL.
    :param str external_id: The external ID of the account
    :param str onboarding_status: The Account onboarding status
    :param str origin: Origin of account onboarding
    :param str service_account_id: The account ID of cloud NGFW service
    :param str sns_topic_arn: The SNS topic ARN
    :param str trusted_account: The trusted account ID
    """
    __args__ = dict()
...
def get_account_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
                       cft_url: Optional[pulumi.Input[Optional[str]]] = None,
                       external_id: Optional[pulumi.Input[Optional[str]]] = None,
                       onboarding_status: Optional[pulumi.Input[Optional[str]]] = None,
                       origin: Optional[pulumi.Input[Optional[str]]] = None,
                       service_account_id: Optional[pulumi.Input[Optional[str]]] = None,
                       sns_topic_arn: Optional[pulumi.Input[Optional[str]]] = None,
                       trusted_account: Optional[pulumi.Input[Optional[str]]] = None,
