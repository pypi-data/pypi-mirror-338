...
class GetAccountsResult:
    ...
    @property
    @pulumi.getter
    def describe(self) -> Optional[bool]:
        """
...
def get_accounts(account_details: Optional[Sequence[Union['GetAccountsAccountDetailArgs', 'GetAccountsAccountDetailArgsDict']]] = None,
    ...
    * `Global Rulestack` (for `scope="Global"`)
    ...
    :param Sequence[str] account_ids: List of account ids.
    :param bool describe: Flag to include account details while listing accounts. Defaults to `false`.
    """
    __args__ = dict()
