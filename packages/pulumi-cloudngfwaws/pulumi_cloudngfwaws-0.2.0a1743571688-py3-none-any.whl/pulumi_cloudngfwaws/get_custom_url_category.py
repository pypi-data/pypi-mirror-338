...
class GetCustomUrlCategoryResult:
    ...
    def url_lists(self) -> Sequence[str]:
        """
...
def get_custom_url_category(config_type: Optional[str] = None,
...
def get_custom_url_category_output(config_type: Optional[pulumi.Input[Optional[str]]] = None,
