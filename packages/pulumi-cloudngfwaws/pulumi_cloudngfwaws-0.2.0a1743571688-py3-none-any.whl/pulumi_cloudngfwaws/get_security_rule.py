...
class GetSecurityRuleResult:
    ...
    def decryption_rule_type(self) -> str:
        """
    ...
    def prot_port_lists(self) -> Sequence[str]:
        """
        Protocol port list.
        """
    ...
    def rule_list(self) -> Optional[str]:
        """
...
def get_security_rule(config_type: Optional[str] = None,
    ...
    * `Global Rulestack` (for `scope="Global"`)
    ...
    :param str rule_list: The rulebase. Valid values are `PreRule`, `PostRule`, or `LocalRule`. Defaults to `PreRule`.
...
def get_security_rule_output(config_type: Optional[pulumi.Input[Optional[str]]] = None,
                             priority: Optional[pulumi.Input[int]] = None,
                             rule_list: Optional[pulumi.Input[Optional[str]]] = None,
