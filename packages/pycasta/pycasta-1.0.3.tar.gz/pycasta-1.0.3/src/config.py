...
#BOUNDED_DIR = "data/single"           # e.g., "data/edelb_short" (tested working)
BOUNDED_DIR = "data/bounded"         
UNBOUNDED_DIR = None 
#UNBOUNDED_DIR = "data/unbounded"       #or None 
...
ATOM_SPLITTING_MODE = "CAST"   # Options: "SIMPLE" for equal splitting, "CAST" for a CAST-like split
SIMPLE_SPLIT = False
...
def set_merge_threshold(value):
    ...
    print(f"[CONFIG] set_merge_threshold(): updated MERGE_THRESHOLD = {MERGE_THRESHOLD}")
