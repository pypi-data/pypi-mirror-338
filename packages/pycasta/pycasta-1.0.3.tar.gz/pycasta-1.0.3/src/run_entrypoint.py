...
from config import OUTPUT_DIR, VERSION_TAG, CORRESPONDENCE_FILE, UNBOUNDED_DIR, BOUNDED_DIR
...
def run_all_analysis():
    ...
    # Unbounded mode
        ...
        raise ValueError("Invalid configuration: check UNBOUNDED_DIR and CORRESPONDENCE_FILE settings.")
