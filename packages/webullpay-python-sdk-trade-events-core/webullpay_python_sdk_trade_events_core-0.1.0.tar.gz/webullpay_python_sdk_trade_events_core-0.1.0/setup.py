...
PACKAGE = "webullpaysdktradeeventscore"
DESCRIPTION = "The trade events core module of Webullpay Python SDK."
...
setup(name='webullpay-python-sdk-trade-events-core', **setup_args)
