...
from _driver import Transmitter
from _driver import MSPCodes
...
class MultirotorControl:
    ...
    def __init__(self, transmitter: Transmitter):
        ...
        self.logging = logging.getLogger("msp_driver")
        self.logging.setLevel(logging.INFO)
        self.formater = logging.Formatter("%(asctime)s - %(message)s")
        self.handler = logging.FileHandler(os.path.join("log", "msp_driver.log"))
