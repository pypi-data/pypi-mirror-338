...
class Dataset:
    ...
    def read_spark_table(self, db_name: str, table_name: str) -> DataFrame:
        """
        ...
        try:
            ...
            table_path = f"nessie.{db_name}.{table_name}"
    ...
    def write_spark_table(self, df: DataFrame, db_name: str, table_name: str) -> None:
        """
