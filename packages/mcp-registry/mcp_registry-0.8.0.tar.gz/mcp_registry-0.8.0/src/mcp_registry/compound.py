    ...
    def __init__(
        ...
        Args:
            ...
            server_names: Optional list of specific server names to include
                         ...
                         Note: This parameter is deprecated. Use registry.filter_servers() instead
                         for better efficiency and clearer code
...
async def run_registry_server(registry: ServerRegistry):
    ...
    # Create aggregator - no need for server_names filtering since registry is already filtered
    aggregator = MCPAggregator(registry)
