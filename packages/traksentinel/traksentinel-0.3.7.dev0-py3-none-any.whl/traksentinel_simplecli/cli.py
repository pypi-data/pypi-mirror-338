...
def cli():
    ascii_banner = pyfiglet.figlet_format("TrakSentinel")
    print(ascii_banner)
    print("🛡️  by PLAYTRAK Security Team\n")
    parser = argparse.ArgumentParser(description="TrakSentinel - OSV Vulnerability Scanner")
    ...
    print("+==============================================================================+")
    print("TrakSentinel - Vulnerability Report")
