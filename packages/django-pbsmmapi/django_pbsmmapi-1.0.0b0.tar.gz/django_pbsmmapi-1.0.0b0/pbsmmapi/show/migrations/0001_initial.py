            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text=(
                            "You can Set this to a future date/time to schedule"
                            " availability."
                        ),
                        null=True,
                        verbose_name="Live As Of",
                    ),
                ),
                (
                    "object_id",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=80,
                        null=True,
                        verbose_name="Canonical Image Type Override",
                    ),
                ),
                (
                    "funder_message",
                ...
                (
                    "episode_count",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Episode Count"
                    ),
                ),
                (
                    "display_episode_number",
                    models.BooleanField(
                        default=False, verbose_name="Display Episode Number"
                    ),
                ),
                (
                    "sort_episodes_descending",
                    models.BooleanField(
                        default=False, verbose_name="Sort Episodes Descending"
                    ),
                ),
                (
                    "ordinal_season",
                    models.BooleanField(default=True, verbose_name="Ordinal Season"),
                ),
                (
                    "language",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True, null=True, verbose_name="Content Rating Description"
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        choices=[(1, "Yes"), (0, "No")],
                        default=0,
                        verbose_name="Override Default Asset",
                    ),
                ),
                (
                    "show",
