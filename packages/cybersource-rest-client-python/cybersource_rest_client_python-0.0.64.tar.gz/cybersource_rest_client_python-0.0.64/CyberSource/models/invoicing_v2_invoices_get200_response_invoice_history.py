...
class InvoicingV2InvoicesGet200ResponseInvoiceHistory(object):
    ...
    def __init__(self, event=None, _date=None, transaction_details=None):
        """
    ...
    def _date(self):
        """
        Gets the _date of this InvoicingV2InvoicesGet200ResponseInvoiceHistory.
        The date and time when the invoice event was triggered in ISO 8601 format. Format: YYYY-MM-DDThh:mm:ssZ 

        :return: The _date of this InvoicingV2InvoicesGet200ResponseInvoiceHistory.
        :rtype: datetime
        """
        return self.__date
    ...
    def _date(self, _date):
        """
        Sets the _date of this InvoicingV2InvoicesGet200ResponseInvoiceHistory.
        The date and time when the invoice event was triggered in ISO 8601 format. Format: YYYY-MM-DDThh:mm:ssZ 

        :param _date: The _date of this InvoicingV2InvoicesGet200ResponseInvoiceHistory.
        :type: datetime
        """
