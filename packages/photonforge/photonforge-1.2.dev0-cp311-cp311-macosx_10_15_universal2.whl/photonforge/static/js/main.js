...
function updateRuler() {
    ...
    rulerContent.innerHTML = `
        ...
        <line x1="10" y1="15" x2="${(unitSize/scaleX) + 10}" y2="15" 
              stroke="#00643c" stroke-width="2px"/>
...
function createMeasurementLine(x1, y1, x2, y2, showMeasurement = false) {
    ...
    line.setAttribute('stroke', '#00643c');
    ...
    if (length > 0) {
        ...
        startTick.setAttribute('stroke', '#00643c');
        ...
        endTick.setAttribute('stroke', '#00643c');
