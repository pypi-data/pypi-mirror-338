...
class PlateSolve(BaseSettings):
    ...
    def solve(self, image_path, *, local_solve=False, index_dir: str = None, debug: bool = False) -> Solution:
        ...
        if local_solve:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                with tempfile.NamedTemporaryFile(mode='w+', delete=False) as temp_file:
                    ...
                    err_output = subprocess.STDOUT if debug else subprocess.DEVNULL
                    subprocess.Popen(args,
                                     stdout=subprocess.PIPE,
                                     stderr=err_output).stdout.read()
