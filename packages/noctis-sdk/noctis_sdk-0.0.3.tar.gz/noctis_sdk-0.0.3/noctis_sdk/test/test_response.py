...
class TestResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Response:
        ...
        if include_optional:
            return Response(
                relationships = [
                    noctis_sdk.models.triple_hash_map_string_entity_types_relationship_type_hash_map_string_entity_types.TripleHashMapStringEntityTypesRelationshipTypeHashMapStringEntityTypes(
                        left = {
                            'key' : 'MX_HOST'
                            }, 
                        right = {
