...
class TestVulpraEnrichData(unittest.TestCase):
    """VulpraEnrichData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VulpraEnrichData:
        """Test VulpraEnrichData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VulpraEnrichData`
        """
        model = VulpraEnrichData()
        if include_optional:
            return VulpraEnrichData(
                limit_exceeded = True,
                message = '',
                results_count = 56,
                results = [
