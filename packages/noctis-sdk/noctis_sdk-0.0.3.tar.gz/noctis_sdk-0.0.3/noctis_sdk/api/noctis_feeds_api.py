...
class NoctisFeedsApi:
    ...
    def list_feed_files(
        self,
        scope: Annotated[StrictStr, Field(description="The specific feed scope (directory path) to list files for.")],
        limit: Annotated[Optional[StrictInt], Field(description="Limit the number of files listed (latest first).")] = None,
        ...
        Retrieves a list of available feed files for a specified scope, including pre-signed download URLs.

        :param scope: The specific feed scope (directory path) to list files for. (required)
        :type scope: str
        :param limit: Limit the number of files listed (latest first).
        :type limit: int
        ...
        _param = self._list_feed_files_serialize(
            scope=scope,
            limit=limit,
    ...
    @validate_call
    def list_feed_files_with_http_info(
        self,
        scope: Annotated[StrictStr, Field(description="The specific feed scope (directory path) to list files for.")],
        limit: Annotated[Optional[StrictInt], Field(description="Limit the number of files listed (latest first).")] = None,
        app_partner: Annotated[Optional[StrictStr], Field(description="Your Product Name.")] = None,
    ...
    @validate_call
    def list_feed_files_without_preload_content(
        self,
        scope: Annotated[StrictStr, Field(description="The specific feed scope (directory path) to list files for.")],
        limit: Annotated[Optional[StrictInt], Field(description="Limit the number of files listed (latest first).")] = None,
        app_partner: Annotated[Optional[StrictStr], Field(description="Your Product Name.")] = None,
    ...
    def _list_feed_files_serialize(
        self,
        scope,
        limit,
        app_partner,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/noctis/v1/feeds/download',
