...
class Response(BaseModel):
    ...
    Response
    """ # noqa: E501
    relationships: Optional[List[TripleHashMapStringEntityTypesRelationshipTypeHashMapStringEntityTypes]] = None
    __properties: ClassVar[List[str]] = ["relationships"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "relationships": [TripleHashMapStringEntityTypesRelationshipTypeHashMapStringEntityTypes.from_dict(_item) for _item in obj["relationships"]] if obj.get("relationships") is not None else None
        })
        return _obj
