...
class WhoisLookupData(BaseModel):
    """
    Raw Whois data for a domain or IP.
    """ # noqa: E501
    registrant: Optional[StrictStr] = Field(default=None, description="Registrant name or Organization from the Whois record.")
    registration: Optional[RegistrationInfo] = Field(default=None, description="Domain registration details (if applicable).")
    ...
    record_source: Optional[StrictStr] = Field(default=None, description="Source of the Whois record (e.g., Registrar, Registry, RIR).", alias="recordSource")
    __properties: ClassVar[List[str]] = ["registrant", "registration", "nameServers", "whois", "recordSource"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WhoisLookupData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WhoisLookupData from a dict"""
        if obj is None:
            return None
