...
class NameServerInfoDTO(BaseModel):
    """
    Name Server (NS) record details.
    """ # noqa: E501
    host: Optional[GenericValueDTOString] = Field(default=None, description="Hostname of the name server.")
    domain: Optional[GenericValueDTOString] = Field(default=None, description="Domain part of the name server hostname.")
    ip: Optional[List[GenericValueDTOString]] = Field(default=None, description="IP addresses associated with the name server hostname.")
    __properties: ClassVar[List[str]] = ["host", "domain", "ip"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NameServerInfoDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NameServerInfoDTO from a dict"""
        if obj is None:
            return None
