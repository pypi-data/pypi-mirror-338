...
class compute2(v_class):
    ...
    def interface_ap_clk(self) -> tuple['compute2',str]:
        return (self,"ap_clk")


    def interface_ap_rst(self) -> tuple['compute2',str]:
        return (self,"ap_rst")


    def interface_ap_ctrl(self) -> tuple['compute2',str]:
        return (self,"ap_ctrl")


    def interface_port0_porta(self) -> tuple['compute2',str]:
        return (self,"port0_porta")


    def interface_port0_portb(self) -> tuple['compute2',str]:
        return (self,"port0_portb")


    def interface_port1_porta(self) -> tuple['compute2',str]:
        return (self,"port1_porta")


    def interface_port2_porta(self) -> tuple['compute2',str]:
