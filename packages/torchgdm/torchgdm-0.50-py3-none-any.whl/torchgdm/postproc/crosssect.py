...
def ecs(
    ...
    **kwargs,
    ...
    from torchgdm.tools.misc import test_illumination_field_is_plane_wave
    ...
    test_illumination_field_is_plane_wave(
        sim,
        illumination_index,
    ...
    ext_factor_m = (4 * torch.pi * k0 / (n_env_at_m**2 * I0_at_m)).real.unsqueeze(-1)
