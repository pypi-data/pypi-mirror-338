...
SAMPLE_RAW = "loki"
SAMPLE_DATA_EXPORT = "ALL_MONITORS"
...
class DataExportServiceTest(TestCase):
    ...
    def test_echo_data_exports(self, click_mock):
        self._request_wrapper_mock.make_request_v2.return_value = MonolithResponse(
            data=BoxList(
                [
                    {
                        "name": "ALL_MONITORS",
                        "title": "(Deprecated) All monitors",
                        "description": "(Deprecated) All monitors with aggregated properties, "
                        "excluding deleted monitors.",
                    },
                    {
                        "name": "MONITORS",
                        "title": "Monitors",
        ...
        click_mock.echo.assert_called_once_with(
            ...
            "(Deprecated) All monitors (ALL_MONITORS)  "
            "(Deprecated) All monitors with aggregated properties, excluding deleted monitors.\n"
            "Monitors (MONITORS)                       "
