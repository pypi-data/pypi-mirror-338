...
class PublicOrderBookRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["create_time", b"create_time", "delivery_area", b"delivery_area", "delivery_period", b"delivery_period", "price", b"price", "quantity", b"quantity", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["create_time", b"create_time", "delivery_area", b"delivery_area", "delivery_period", b"delivery_period", "execution_option", b"execution_option", "id", b"id", "price", b"price", "quantity", b"quantity", "side", b"side", "type", b"type", "update_time", b"update_time"]) -> None: ...
...
class PublicOrderBookFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["delivery_area", b"delivery_area", "delivery_period", b"delivery_period"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["delivery_area", b"delivery_area", "delivery_period", b"delivery_period"]) -> None: ...
...
class ReceivePublicOrderBookStreamResponse(google.protobuf.message.Message):
    ...
    PUBLIC_ORDER_BOOK_RECORD_FIELD_NUMBER: builtins.int
    @property
    def public_order_book_record(self) -> global___PublicOrderBookRecord: ...
    def __init__(
        self,
        *,
        public_order_book_record: global___PublicOrderBookRecord | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["public_order_book_record", b"public_order_book_record"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["public_order_book_record", b"public_order_book_record"]) -> None: ...
