    ...
    def download_orchestration_cluster_provision_binary(
        ...
        **Permission Required:** `kelvin.permission.cluster.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": bytes, "400": response.Error, "401": response.Error},
            True,
            _dry_run,
        )
        return result
    ...
    def apply_orchestration_clusters_edge_apps_version(
        ...
        **Permission Required:** `kelvin.permission.cluster.update`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": None, "400": response.Error, "401": response.Error, "404": response.Error, "406": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def update_orchestration_clusters_edge_apps_version_force(
        ...
        **Permission Required:** `kelvin.permission.cluster.update`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": None, "202": None, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def get_orchestration_clusters_provision(
        ...
        **Permission Required:** `kelvin.permission.cluster.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": str, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
        )
        return result
