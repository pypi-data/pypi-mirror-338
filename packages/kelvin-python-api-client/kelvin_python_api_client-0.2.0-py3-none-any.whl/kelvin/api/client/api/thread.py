    ...
    def create_thread(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": responses.ThreadCreate, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def list_threads(
        ...
        **Permission Required:** `kelvin.permission.threads.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.ThreadsList, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def delete_thread(cls, thread_id: str, _dry_run: bool = False, _client: Any = None) -> None:
        ...
        **Permission Required:** `kelvin.permission.threads.delete`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": None, "400": response.Error, "403": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def update_thread_follow(
        ...
        **Permission Required:** `kelvin.permission.threads.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.ThreadFollowUpdate, "404": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def get_thread(cls, thread_id: str, _dry_run: bool = False, _client: Any = None) -> responses.ThreadGet:
        ...
        **Permission Required:** `kelvin.permission.threads.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.ThreadGet, "404": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def create_thread_reply(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.ThreadReplyCreate, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def delete_thread_reply(cls, thread_id: str, reply_id: str, _dry_run: bool = False, _client: Any = None) -> str:
        ...
        **Permission Required:** `kelvin.permission.threads.delete`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": str, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def update_thread_reply(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.ThreadReplyUpdate, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def update_thread_seen(
        ...
        **Permission Required:** `kelvin.permission.threads.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.ThreadSeenUpdate, "404": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def update_thread(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.ThreadUpdate, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
            kwargs,
        )
