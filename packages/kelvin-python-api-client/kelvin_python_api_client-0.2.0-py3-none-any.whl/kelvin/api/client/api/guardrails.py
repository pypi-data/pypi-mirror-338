    ...
    def create_guardrail(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": responses.GuardrailCreate, "400": response.Error, "401": response.Error, "409": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_guardrail(cls, resource: str, _dry_run: bool = False, _client: Any = None) -> responses.GuardrailGet:
        ...
        **Permission Required:** `kelvin.permission.guardrails.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.GuardrailGet, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def update_guardrail(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.GuardrailUpdate, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
