    ...
    def get_instance_audit_log(
        ...
        **Permission Required:** `kelvin.permission.audit_log.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.InstanceAuditLogGet, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def get_instance_settings_kelvin_cluster(
        ...
        **Permission Required:** `kelvin.permission.instance.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.InstanceSettingsKelvinClusterGet, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def delete_instance_setting(cls, setting_name: str, _dry_run: bool = False, _client: Any = None) -> None:
        ...
        **Permission Required:** `kelvin.permission.instance.delete`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": None, "400": response.Error, "401": response.Error, "403": response.Error, "404": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def get_instance_settings(
        ...
        **Permission Required:** `kelvin.permission.instance.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.InstanceSettingsGet, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def get_instance_status(cls, _dry_run: bool = False, _client: Any = None) -> responses.InstanceStatusGet:
        ...
        **Permission Required:** `n/a`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"201": responses.InstanceStatusGet, "400": response.Error, "503": responses.InstanceStatusGet},
            False,
            _dry_run,
        )
        return result
