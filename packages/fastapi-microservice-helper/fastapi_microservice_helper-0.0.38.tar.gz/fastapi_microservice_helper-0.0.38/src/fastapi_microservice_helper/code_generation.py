...
class Generation:
  ...
  def generate_property(self, property: GenerationPropertyDetail):
    ...
    if property.default_value:
      value = f"'{property.default_value}'" if isinstance(property.default_value, str) else property.default_value
      fields.append(f'default={value}')
    ...
    if property.examples:
      value = f"'{property.examples}'" if isinstance(property.examples, str) else property.examples
      fields.append(f'examples={value}')
