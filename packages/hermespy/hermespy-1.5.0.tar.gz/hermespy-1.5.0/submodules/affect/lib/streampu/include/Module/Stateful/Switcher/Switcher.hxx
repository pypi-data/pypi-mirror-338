...
runtime::Task&
Switcher::operator[](const swi::tsk t)
{
    return Module::operator[]((size_t)t);
}

const runtime::Task&
Switcher::operator[](const swi::tsk t) const
{
    return Module::operator[]((size_t)t);
}

runtime::Socket&
Switcher::operator[](const std::string& tsk_sck)
{
    return Module::operator[](tsk_sck);
}

Switcher::Switcher(const size_t n_data_sockets,
  ...
  , no_copy_select(false)
{
    ...
    for (size_t s = 0; s < this->get_n_data_sockets(); s++)
        p1s_out_data.push_back(
          this->create_socket_out(p1, "out_data" + std::to_string(s), n_elmts_commute, datatype_commute));
    ...
    this->create_codelet(
      ...
      [p1s_in_data, p1s_in_ctrl, p1s_out_data](Module& m, runtime::Task& t, const size_t /*frame_id*/) -> int
      {
          ...
          if (!swi.is_no_copy_commute())
          {
              ...
              std::copy(
                data_socket_in, data_socket_in + swi.get_n_frames() * swi.get_n_bytes_commute(), data_socket_out);
          }
    ...
    for (size_t s = 0; s < this->get_n_data_sockets(); s++)
        p2s_in_data.push_back(
          this->create_socket_in(p2, "in_data" + std::to_string(s), n_elmts_select, datatype_select));
...
Switcher::Switcher(const size_t n_data_sockets, const size_t n_elmts, const std::type_index datatype)
  : Switcher(n_data_sockets, n_elmts, datatype, n_elmts, datatype)
{
}

void
Switcher::set_no_copy_commute(const bool no_copy_commute)
{
    this->no_copy_commute = no_copy_commute;
}

void
Switcher::set_no_copy_select(const bool no_copy_select)
{
    this->no_copy_select = no_copy_select;
}

bool
Switcher::is_no_copy_commute() const
{
    return this->no_copy_commute;
}

bool
Switcher::is_no_copy_select() const
{
    return this->no_copy_select;
}

size_t
Switcher::get_n_data_sockets() const
{
    return this->n_data_sockets;
}

size_t
Switcher::get_n_elmts_commute() const
{
    return this->n_elmts_commute;
}

size_t
Switcher::get_n_elmts_select() const
{
    return this->n_elmts_select;
}

size_t
Switcher::get_n_bytes_commute() const
{
    return this->n_bytes_commute;
}

size_t
Switcher::get_n_bytes_select() const
{
    return this->n_bytes_select;
}

std::type_index
Switcher::get_datatype_commute() const
{
    return this->datatype_commute;
}

std::type_index
Switcher::get_datatype_select() const
{
    return this->datatype_select;
}

size_t
Switcher::get_path() const
{
    return this->path;
}

void
Switcher::set_path(const size_t path)
{
