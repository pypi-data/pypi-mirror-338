...
template<typename B>
runtime::Task&
Source<B>::operator[](const src::tsk t)
{
...
template<typename B>
runtime::Socket&
Source<B>::operator[](const src::sck::generate s)
{
...
template<typename B>
runtime::Socket&
Source<B>::operator[](const std::string& tsk_sck)
{
    return Module::operator[](tsk_sck);
}

template<typename B>
Source<B>::Source(const int max_data_size)
  : Stateful()
  , max_data_size(max_data_size)
{
    ...
    this->create_codelet(p,
                         [ps_out_data, ps_out_count](Module& m, runtime::Task& t, const size_t frame_id) -> int
                         {
...
template<typename B>
int
Source<B>::get_max_data_size() const
{
...
template<class A>
void
Source<B>::generate(std::vector<B, A>& out_data, const int frame_id, const bool managed_memory)
{
...
template<typename B>
void
Source<B>::generate(B* out_data, const int frame_id, const bool managed_memory)
{
    (*this)[src::sck::generate::out_data].bind(out_data);
    (*this)[src::tsk::generate].exec(frame_id, managed_memory);
}
...
template<class A>
void
Source<B>::generate(std::vector<B, A>& out_data,
                    std::vector<uint32_t>& out_count,
                    const int frame_id,
...
template<typename B>
void
Source<B>::generate(B* out_data, uint32_t* out_count, const int frame_id, const bool managed_memory)
{
    (*this)[src::sck::generate::out_data].bind(out_data);
    (*this)[src::sck::generate::out_count].bind(out_count);
    (*this)[src::tsk::generate].exec(frame_id, managed_memory);
...
template<typename B>
void
Source<B>::_generate(B* out_data, uint32_t* out_count, const size_t frame_id)
{
