...
size_t
Controller_cyclic::get_n_paths() const
{
    return this->n_paths;
}

void
Controller_cyclic::set_n_paths(const size_t n_paths)
{
...
void
Controller_cyclic::set_path(const size_t path)
{
    this->path = path % this->n_paths;
}

void
Controller_cyclic::reset()
{
