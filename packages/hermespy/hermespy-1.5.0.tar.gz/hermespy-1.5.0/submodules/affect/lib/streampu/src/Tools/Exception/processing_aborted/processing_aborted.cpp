...
processing_aborted::processing_aborted() noexcept
  : exception(DEFAULT_MESSAGE)
{
}

processing_aborted::processing_aborted(std::string&& message) noexcept
  : exception(message.empty() ? DEFAULT_MESSAGE : message)
{
}

processing_aborted::processing_aborted(std::string&& filename,
                                       int&& line_num,
                                       std::string&& funcname,
