...
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::Decoder_LDPC_BP_flooding_inter(
  const int K,
  const int N,
  const int n_ite,
...
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::clone() const
{
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_reset(const size_t frame_id)
{
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_decode_siso(const R* Y_N1,
                                                                int8_t* CWD,
                                                                R* Y_N2,
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_decode_siho(const R* Y_N,
                                                                int8_t* CWD,
                                                                B* V_K,
                                                                const size_t frame_id)
{
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_decode_siho_cw(const R* Y_N,
                                                                   int8_t* CWD,
                                                                   B* V_N,
                                                                   const size_t frame_id)
{
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_decode(const mipp::Reg<R>* Y_N, const size_t cur_wave)
{
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_initialize_var_to_chk(
  const mipp::Reg<R>* Y_N,
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_decode_single_ite(const mipp::vector<mipp::Reg<R>>& msg_var_to_chk,
                                                                      mipp::vector<mipp::Reg<R>>& msg_chk_to_var)
{
    ...
    for (auto c = 0; c < n_chk_nodes; c++)
    {
        ...
        {
            auto val =
              saturate<R>(this->up_rule.compute_chk_node_out(v, msg_var_to_chk[transpose_ptr[v]]), this->sat_val);
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_compute_post(const mipp::Reg<R>* Y_N,
                                                                 const mipp::vector<mipp::Reg<R>>& msg_chk_to_var,
...
template<typename B, typename R, class Update_rule>
bool
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_check_syndrome_soft(const mipp::vector<mipp::Reg<R>>& var_nodes)
{
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::_check_syndrome_soft_status(
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_flooding_inter<B, R, Update_rule>::set_n_frames(const size_t n_frames)
{
