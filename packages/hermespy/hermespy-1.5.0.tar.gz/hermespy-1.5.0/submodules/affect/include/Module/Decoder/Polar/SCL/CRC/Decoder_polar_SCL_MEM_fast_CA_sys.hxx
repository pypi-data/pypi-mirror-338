...
Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>::Decoder_polar_SCL_MEM_fast_CA_sys(
  const int& K,
  const int& N,
  const int& L,
...
Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>::clone() const
{
...
template<typename B, typename R, class API_polar>
void
Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>::deep_copy(
  const Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>& m)
{
...
template<typename B, typename R, class API_polar>
bool
Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>::crc_check(mipp::vector<B>& s, const size_t frame_id)
{
...
template<typename B, typename R, class API_polar>
int
Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>::select_best_path(const size_t frame_id)
{
...
template<typename B, typename R, class API_polar>
void
Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>::init_buffers()
{
...
template<typename B, typename R, class API_polar>
void
Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>::_store(B* V_K) const
{
    if (fast_store)
