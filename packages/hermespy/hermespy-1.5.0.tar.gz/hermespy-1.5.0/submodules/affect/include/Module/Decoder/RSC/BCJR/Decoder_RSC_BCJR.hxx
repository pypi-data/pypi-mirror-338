...
Decoder_RSC_BCJR<B, R>::Decoder_RSC_BCJR(const int K,
...
template<typename B, typename R>
void
Decoder_RSC_BCJR<B, R>::set_n_frames_per_wave(const size_t n_frames_per_wave)
{
...
Decoder_RSC_BCJR<B, R>::clone() const
{
...
template<typename B, typename R>
int
Decoder_RSC_BCJR<B, R>::tail_length() const
{
    return 2 * n_ff;
}
...
template<typename B, typename R>
void
Decoder_RSC_BCJR<B, R>::_load(const R* Y_N)
{
...
template<typename B, typename R>
int
Decoder_RSC_BCJR<B, R>::_decode_siho(const R* Y_N, B* V_K, const size_t frame_id)
{
...
template<typename B, typename R>
void
Decoder_RSC_BCJR<B, R>::_store(B* V_K) const
{
