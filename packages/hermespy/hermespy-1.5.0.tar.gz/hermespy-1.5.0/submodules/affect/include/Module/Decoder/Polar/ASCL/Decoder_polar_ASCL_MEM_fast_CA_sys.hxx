...
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::Decoder_polar_ASCL_MEM_fast_CA_sys(
  const int& K,
  const int& N,
  const int& L_max,
...
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::clone() const
{
...
template<typename B, typename R, class API_polar>
void
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::deep_copy(
  const Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>& m)
{
...
template<typename B, typename R, class API_polar>
void
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::set_frozen_bits(const std::vector<bool>& frozen_bits)
{
...
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::get_frozen_bits() const
{
...
template<typename B, typename R, class API_polar>
void
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::_decode(const R* Y_N, B* V_K, const size_t frame_id)
{
    this->L = 1;
...
template<typename B, typename R, class API_polar>
int
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::_decode_siho(const R* Y_N, B* V_K, const size_t frame_id)
{
    ...
    if (this->L > 1) Decoder_polar_SCL_MEM_fast_CA_sys<B, R, API_polar>::_store(V_K);
...
template<typename B, typename R, class API_polar>
int
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::_decode_siho_cw(const R* Y_N, B* V_N, const size_t frame_id)
{
    //	auto t_decod = std::chrono::steady_clock::now();
...
template<typename B, typename R, class API_polar>
void
Decoder_polar_ASCL_MEM_fast_CA_sys<B, R, API_polar>::set_n_frames(const size_t n_frames)
{
