...
Decoder_polar_SCL_naive_CA<B, R, F, G>::Decoder_polar_SCL_naive_CA(const int& K,
                                                                   const int& N,
                                                                   const int& L,
...
Decoder_polar_SCL_naive_CA<B, R, F, G>::clone() const
{
...
template<typename B, typename R, tools::proto_f<R> F, tools::proto_g<B, R> G>
void
Decoder_polar_SCL_naive_CA<B, R, F, G>::deep_copy(const Decoder_polar_SCL_naive_CA<B, R, F, G>& m)
{
...
template<typename B, typename R, tools::proto_f<R> F, tools::proto_g<B, R> G>
void
Decoder_polar_SCL_naive_CA<B, R, F, G>::select_best_path(const size_t frame_id)
{
    std::vector<B> U_test;
