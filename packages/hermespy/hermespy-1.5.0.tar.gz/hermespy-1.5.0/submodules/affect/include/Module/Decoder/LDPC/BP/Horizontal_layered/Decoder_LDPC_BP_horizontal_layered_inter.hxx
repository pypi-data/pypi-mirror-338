...
template<typename R>
inline mipp::Reg<R>
saturate(const mipp::Reg<R> v, const R s)
{
    return v;
}
template<>
...
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::Decoder_LDPC_BP_horizontal_layered_inter(
  const int K,
  const int N,
  const int n_ite,
...
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::clone() const
{
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_reset(const size_t frame_id)
{
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_load(const R* Y_N, const size_t frame_id)
{
    const auto cur_wave = frame_id / this->get_n_frames_per_wave();
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_decode_siso(const R* Y_N1,
                                                                          int8_t* CWD,
                                                                          R* Y_N2,
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_decode_siho(const R* Y_N,
                                                                          int8_t* CWD,
                                                                          B* V_K,
                                                                          const size_t frame_id)
{
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_decode_siho_cw(const R* Y_N,
                                                                             int8_t* CWD,
                                                                             B* V_N,
                                                                             const size_t frame_id)
{
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_decode(const size_t frame_id)
{
    const auto cur_wave = frame_id / this->get_n_frames_per_wave();
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_decode_single_ite(mipp::vector<mipp::Reg<R>>& var_nodes,
...
template<typename B, typename R, class Update_rule>
bool
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_check_syndrome_soft(
...
template<typename B, typename R, class Update_rule>
int
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::_check_syndrome_soft_status(
  const mipp::vector<mipp::Reg<R>>& var_nodes)
{
    if (this->enable_syndrome)
    {
...
template<typename B, typename R, class Update_rule>
void
Decoder_LDPC_BP_horizontal_layered_inter<B, R, Update_rule>::set_n_frames(const size_t n_frames)
{
