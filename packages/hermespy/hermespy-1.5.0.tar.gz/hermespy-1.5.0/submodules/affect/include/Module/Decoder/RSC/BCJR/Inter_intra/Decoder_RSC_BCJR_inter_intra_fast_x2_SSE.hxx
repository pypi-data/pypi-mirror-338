...
Decoder_RSC_BCJR_inter_intra_fast_x2_SSE<B, R, MAX>::Decoder_RSC_BCJR_inter_intra_fast_x2_SSE(
  const int& K,
...
Decoder_RSC_BCJR_inter_intra_fast_x2_SSE<B, R, MAX>::clone() const
{
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_intra_fast_x2_SSE<B, R, MAX>::compute_gamma(const R* sys, const R* par)
{
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_intra_fast_x2_SSE<B, R, MAX>::compute_alpha()
{
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_intra_fast_x2_SSE<B, R, MAX>::compute_beta_ext(const R* sys, R* ext)
{
    constexpr auto n_frames = mipp::nElReg<R>() / 8;
