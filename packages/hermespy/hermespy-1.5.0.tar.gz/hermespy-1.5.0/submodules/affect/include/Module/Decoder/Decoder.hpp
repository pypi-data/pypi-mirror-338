...
enum class decode_hiho_cw : size_t
{
    Y_N,
    CWD,
    V_N,
...
enum class decode_siho_cw : size_t
{
    Y_N,
    CWD,
    V_N,
...
enum class decode_siso_alt : size_t
{
    sys,
    par,
    CWD,
