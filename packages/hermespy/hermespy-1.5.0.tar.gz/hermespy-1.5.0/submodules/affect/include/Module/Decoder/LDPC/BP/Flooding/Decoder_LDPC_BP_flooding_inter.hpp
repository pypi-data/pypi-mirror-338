...
class Decoder_LDPC_BP_flooding_inter
  ...
  , public Decoder_LDPC_BP
{
  ...
  public:
    Decoder_LDPC_BP_flooding_inter(const int K,
                                   const int N,
                                   const int n_ite,
  ...
  protected:
    ...
    void _initialize_var_to_chk(const mipp::Reg<R>* Y_N,
    ...
    void _compute_post(const mipp::Reg<R>* Y_N,
                       const mipp::vector<mipp::Reg<R>>& msg_chk_to_var,
