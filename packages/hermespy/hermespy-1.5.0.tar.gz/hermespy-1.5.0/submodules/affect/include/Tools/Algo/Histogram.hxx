...
template<typename R>
Histogram<R>::Histogram(unsigned precision)
  : precision(precision)
{
}
...
template<typename R>
void
Histogram<R>::add_values(const Histogram<R>& other)
{
    if (this->precision != other.precision)
    {
        std::stringstream message;
...
template<typename R>
void
Histogram<R>::add_values(const std::vector<R>& draw)
{
...
template<typename R>
void
Histogram<R>::add_value(const R& d)
{
    add_values(&d, 1);
}
...
template<typename R>
void
Histogram<R>::add_values(const R* draw, size_t size)
{
...
template<typename R>
void
Histogram<R>::add_value(const R& d, size_t weight)
{
...
template<typename R>
void
Histogram<R>::norm_sum_to_1(bool val)
{
    _norm_sum_to_1 = val;
}
...
template<typename R>
void
Histogram<R>::norm_minus_1(bool val)
{
    _norm_minus_1 = val;
}
...
template<typename R>
void
Histogram<R>::cumul_vals(bool val)
{
    _cumul_vals = val;
}
...
template<typename R>
void
Histogram<R>::cumul_borders(bool val)
{
    _cumul_borders = val;
}
...
template<typename R>
void
Histogram<R>::n_rung(unsigned val)
{
    _n_rung = val;
}
...
template<typename R>
void
Histogram<R>::data_separator(const std::string& val)
{
    _data_separator = val;
}
...
template<typename R>
bool
Histogram<R>::norm_sum_to_1() const
{
...
template<typename R>
bool
Histogram<R>::norm_minus_1() const
{
...
template<typename R>
bool
Histogram<R>::cumul_borders() const
{
...
template<typename R>
const std::string&
Histogram<R>::data_separator() const
{
...
template<typename R>
int
Histogram<R>::dump(std::ofstream& hist_file) const
{
...
template<typename R>
int
Histogram<R>::dump(std::ofstream& hist_file, R hist_min, R hist_max) const
{
    if (hist_min >= hist_max) return 1;
...
template<typename R>
int
Histogram<R>::calibrate_val(R val) const
{
...
template<typename R>
R
Histogram<R>::uncalibrate_val(int val) const
{
...
template<typename R>
R
Histogram<R>::get_hist_min() const
{
    if (hist.empty())
    {
        std::stringstream message;
...
template<typename R>
R
Histogram<R>::get_hist_max() const
{
    if (hist.empty())
    {
        std::stringstream message;
...
template<typename R>
size_t
Histogram<R>::get_n_values() const
{
    return n_values;
}
...
template<typename R>
int
Histogram<R>::dump_all_values(std::ofstream& hist_file, R hist_min, R hist_max) const
{
    R factor = 1;
    if (norm_sum_to_1())
    {
    ...
    for (auto it = hist.begin(); it != hist.end(); it++)
    {
        if ((it->first > cal_hist_min) && (cal_hist_max > it->first))
        {
            ...
            if (norm_sum_to_1() && norm_minus_1()) value = (R)1 - value;
...
template<typename R>
int
Histogram<R>::dump_intervals(std::ofstream& hist_file, R hist_min, R hist_max) const
{
    R factor = 1;
    if (norm_sum_to_1())
    {
