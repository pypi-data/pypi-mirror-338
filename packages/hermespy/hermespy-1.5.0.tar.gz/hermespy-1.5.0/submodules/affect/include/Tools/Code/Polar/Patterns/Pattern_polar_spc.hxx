...
namespace tools
{
Pattern_polar_spc ::Pattern_polar_spc(const int& N,
...
Pattern_polar_spc ::Pattern_polar_spc(const int min_level, const int max_level)
...
Pattern_polar_spc*
Pattern_polar_spc ::alloc(const int& N, const Binary_node<Pattern_polar_i>* node) const
{
    if (node == nullptr)
...
polar_node_t
Pattern_polar_spc ::type() const
{
    return polar_node_t::SPC;
}

std::string
Pattern_polar_spc ::name() const
{
    return "SPC";
}

std::string
Pattern_polar_spc ::short_name() const
{
    return "s";
}

std::string
Pattern_polar_spc ::fill_color() const
{
    return "#2F3F60";
}

std::string
Pattern_polar_spc ::font_color() const
{
    return "#FFFFFF";
}

std::string
Pattern_polar_spc ::f() const
{
    return "";
}

std::string
Pattern_polar_spc ::g() const
{
    return "";
}

std::string
Pattern_polar_spc ::h() const
{
    return "spc";
}

bool
Pattern_polar_spc ::recursive_check(const int reverse_graph_depth, const Binary_node<Pattern_polar_i>* node_curr)
{
...
int
Pattern_polar_spc ::_match(const int& reverse_graph_depth, const Binary_node<Pattern_polar_i>* node_curr) const
{
    return Pattern_polar_spc::recursive_check(reverse_graph_depth, node_curr) ? 49 : 0;
}

bool
Pattern_polar_spc ::is_terminal() const
{
    return true;
}
}
