...
template<typename T>
T
linear_interpolation(const T* x_data, const T* y_data, const unsigned l_data, const T x_val);
...
template<typename T>
void
linear_interpolation(const T* x_data,
                     const T* y_data,
                     const unsigned l_data,
                     const T* x_vals,
                     T* y_vals,
                     const unsigned l_vals);
...
template<typename T>
void
linear_interpolation(const std::vector<T>& x_data,
...
template<typename T>
T
nearest_interpolation(const T* x_data, const T* y_data, const unsigned l_data, const T x_val);
...
template<typename T>
void
nearest_interpolation(const T* x_data,
                      const T* y_data,
                      const unsigned l_data,
                      const T* x_vals,
                      T* y_vals,
...
template<typename T>
void
nearest_interpolation(const std::vector<T>& x_data,
                      const std::vector<T>& y_data,
                      const std::vector<T>& x_vals,
                      std::vector<T>& y_vals);
}
