 ...
 * Warning ! Never call modification methods (resize, erase, push_back and so on), on the second dimension of the
 * Full_matrix always pass through Full_matrix methods, else you may obtain runtime errors
 */
