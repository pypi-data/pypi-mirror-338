...
class Self_corrected : public Post_processing_SISO<B, R>
{
  private:
    ...
    std::vector<mipp::vector<R>>
      ext_nat; // extrinsic coming from the SISO working in the natural domain. Data in the interleaved order
    std::vector<mipp::vector<R>>
      ext_int; // extrinsic coming from the SISO working in the interleaved domain. Data in the natural order
