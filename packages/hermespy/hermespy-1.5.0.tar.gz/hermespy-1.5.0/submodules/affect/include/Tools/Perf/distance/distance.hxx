...
size_t
distance_seq(const B* in1, const B* in2, const unsigned size)
{
    size_t dist = 0;
...
template<typename B, class Fdiffcnt>
size_t
distance_seq(const B* in, const unsigned size)
{
    size_t dist = 0;
...
size_t
distance(const T* in1, const T* in2, const unsigned size)
{
...
template<typename T, class Fdiffcnt>
size_t
distance(const T* in, const unsigned size)
{
