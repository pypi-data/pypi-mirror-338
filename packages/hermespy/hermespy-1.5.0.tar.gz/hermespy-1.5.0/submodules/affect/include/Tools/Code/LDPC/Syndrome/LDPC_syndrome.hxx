...
template<typename B>
bool
LDPC_syndrome ::check_hard(const B* X_N, const Sparse_matrix& H)
{
    auto syndrome = false;
...
template<typename B>
bool
LDPC_syndrome ::check_hard(const std::vector<B>& X_N, const Sparse_matrix& H)
{
...
template<typename R>
bool
LDPC_syndrome ::check_soft(const R* Y_N, const Sparse_matrix& H)
{
    auto syndrome = false;
...
template<typename R>
bool
LDPC_syndrome ::check_soft(const std::vector<R>& Y_N, const Sparse_matrix& H)
{
