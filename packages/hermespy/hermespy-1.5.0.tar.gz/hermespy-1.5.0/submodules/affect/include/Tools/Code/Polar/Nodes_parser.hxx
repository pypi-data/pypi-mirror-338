...
void
Nodes_parser<R0, R0L, R1, REP, REPL, SPC, STD>::push_back_polar_pattern(
...
{
    if (polar_patterns_ptr != nullptr) polar_patterns_ptr->push_back(polar_pattern);
    if (polar_patterns_uptr != nullptr) polar_patterns_uptr->push_back(std::unique_ptr<Pattern_polar_i>(polar_pattern));

    if (polar_patterns_ptr == nullptr && polar_patterns_uptr == nullptr) delete polar_pattern;
}

template<class R0, class R0L, class R1, class REP, class REPL, class SPC, class STD>
void
Nodes_parser<R0, R0L, R1, REP, REPL, SPC, STD>::parse(
  const std::string& str_polar,
  int& idx_r0,
  int& idx_r1,
  std::vector<Pattern_polar_i*>* polar_patterns_ptr,
  std::vector<std::unique_ptr<Pattern_polar_i>>* polar_patterns_uptr)
        ...
        if (v_str1.size() >= 1)
        {
            if (v_str1[0] == "R0L")
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (plus)
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new R0L(min));
                        else
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new R0L(min, min));
                    }
                }
            }
            else if (v_str1[0] == "R0")
            {
                if (polar_patterns_uptr != nullptr)
                    idx_r0 = (int)polar_patterns_uptr->size();
                else if (polar_patterns_ptr != nullptr)
                    idx_r0 = (int)polar_patterns_ptr->size();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (plus)
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new R0(min));
                        else
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new R0(min, min));
                    }
                }
            }
            else if (v_str1[0] == "R1")
            {
                if (polar_patterns_uptr != nullptr)
                    idx_r1 = (int)polar_patterns_uptr->size();
                else if (polar_patterns_ptr != nullptr)
                    idx_r1 = (int)polar_patterns_ptr->size();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (plus)
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new R1(min));
                        else
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new R1(min, min));
                    }
                }
            }
            else if (v_str1[0] == "REPL")
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (plus)
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new REPL(min));
                        else
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new REPL(min, min));
                    }
                }
            }
            else if (v_str1[0] == "REP")
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (plus)
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new REP(min));
                        else
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new REP(min, min));
                    }
                }
            }
            else if (v_str1[0] == "SPC")
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (plus)
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new SPC(min));
                        else
                            push_back_polar_pattern(polar_patterns_ptr, polar_patterns_uptr, new SPC(min, min));
                    }
                }
            }
            else
...
template<class R0, class R0L, class R1, class REP, class REPL, class SPC, class STD>
std::vector<std::unique_ptr<Pattern_polar_i>>
Nodes_parser<R0, R0L, R1, REP, REPL, SPC, STD>::parse_uptr(const std::string& str_polar, int& idx_r0, int& idx_r1)
{
    std::vector<std::unique_ptr<Pattern_polar_i>> polar_patterns_uptr;
...
template<class R0, class R0L, class R1, class REP, class REPL, class SPC, class STD>
std::vector<Pattern_polar_i*>
Nodes_parser<R0, R0L, R1, REP, REPL, SPC, STD>::parse_ptr(const std::string& str_polar, int& idx_r0, int& idx_r1)
{
    std::vector<Pattern_polar_i*> polar_patterns_ptr;
