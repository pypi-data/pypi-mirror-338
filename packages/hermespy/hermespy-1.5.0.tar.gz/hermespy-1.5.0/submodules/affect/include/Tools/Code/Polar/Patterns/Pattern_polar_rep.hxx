...
namespace tools
{
Pattern_polar_rep ::Pattern_polar_rep(const int& N,
...
Pattern_polar_rep ::Pattern_polar_rep(const int min_level, const int max_level)
...
Pattern_polar_rep*
Pattern_polar_rep ::alloc(const int& N, const Binary_node<Pattern_polar_i>* node) const
{
    if (node == nullptr)
...
polar_node_t
Pattern_polar_rep ::type() const
{
    return polar_node_t::REP;
}

std::string
Pattern_polar_rep ::name() const
{
    return "Rep";
}

std::string
Pattern_polar_rep ::short_name() const
{
    return "re";
}

std::string
Pattern_polar_rep ::fill_color() const
{
    return "#8F463F";
}

std::string
Pattern_polar_rep ::font_color() const
{
    return "#FFFFFF";
}

std::string
Pattern_polar_rep ::f() const
{
    return "";
}

std::string
Pattern_polar_rep ::g() const
{
    return "";
}

std::string
Pattern_polar_rep ::h() const
{
    return "rep";
}

bool
Pattern_polar_rep ::recursive_check(const int reverse_graph_depth, const Binary_node<Pattern_polar_i>* node_curr)
{
...
int
Pattern_polar_rep ::_match(const int& reverse_graph_depth, const Binary_node<Pattern_polar_i>* node_curr) const
{
    return Pattern_polar_rep::recursive_check(reverse_graph_depth, node_curr) ? 50 : 0;
}

bool
Pattern_polar_rep ::is_terminal() const
{
    return true;
}
}
