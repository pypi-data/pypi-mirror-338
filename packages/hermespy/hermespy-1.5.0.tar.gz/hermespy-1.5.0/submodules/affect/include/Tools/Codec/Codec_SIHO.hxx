...
Codec_SIHO<B, Q>::Codec_SIHO(const int K, const int N_cw, const int N)
...
template<typename B, typename Q>
void
Codec_SIHO<B, Q>::deep_copy(const Codec_SIHO<B, Q>& t)
{
...
Codec_SIHO<B, Q>::get_decoder_siho()
{
...
template<typename B, typename Q>
void
Codec_SIHO<B, Q>::set_decoder_siho(module::Decoder_SIHO<B, Q>* dec)
{
...
template<typename B, typename Q>
void
Codec_SIHO<B, Q>::set_decoder_siho(std::shared_ptr<module::Decoder_SIHO<B, Q>> dec)
{
...
template<typename B, typename Q>
void
Codec_SIHO<B, Q>::set_n_frames(const size_t n_frames)
{
    Codec_HIHO<B, Q>::set_n_frames(n_frames);
    if (this->decoder_siho != nullptr) this->decoder_siho->set_n_frames(n_frames);
}
