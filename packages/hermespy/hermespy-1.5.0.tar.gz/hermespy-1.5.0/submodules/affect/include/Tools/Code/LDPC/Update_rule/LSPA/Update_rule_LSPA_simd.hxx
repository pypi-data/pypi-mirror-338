...
{
template<typename R>
Update_rule_LSPA_simd<R>::Update_rule_LSPA_simd(const unsigned max_chk_node_degree)
  : name("LSPA")
  , false_msk(false)
  , zero((R)0)
  , half((R)0.5)
  , two((R)2)
  , min(std::numeric_limits<R>::min())
...
template<typename R>
inline std::string
Update_rule_LSPA_simd<R>::get_name() const
{
    return this->name;
}
...
template<typename R>
inline void
Update_rule_LSPA_simd<R>::begin_decoding(const int n_ite)
{
    this->n_ite = n_ite;
}
...
template<typename R>
inline void
Update_rule_LSPA_simd<R>::begin_ite(const int ite)
{
    this->ite = ite;
}
...
template<typename R>
inline void
Update_rule_LSPA_simd<R>::begin_chk_node_in(const int chk_id, const int chk_degree)
{
...
template<typename R>
inline void
Update_rule_LSPA_simd<R>::compute_chk_node_in(const int var_id, const mipp::Reg<R> var_val)
{
...
template<typename R>
inline void
Update_rule_LSPA_simd<R>::end_chk_node_in()
{
}

template<typename R>
inline void
Update_rule_LSPA_simd<R>::begin_chk_node_out(const int chk_id, const int chk_degree)
{
}

template<typename R>
inline mipp::Reg<R>
Update_rule_LSPA_simd<R>::compute_chk_node_out(const int var_id, const mipp::Reg<R> var_val)
{
...
template<typename R>
inline void
Update_rule_LSPA_simd<R>::end_chk_node_out()
{
}

template<typename R>
inline void
Update_rule_LSPA_simd<R>::end_ite()
{
}

template<typename R>
inline void
Update_rule_LSPA_simd<R>::end_decoding()
{
}
}
}
