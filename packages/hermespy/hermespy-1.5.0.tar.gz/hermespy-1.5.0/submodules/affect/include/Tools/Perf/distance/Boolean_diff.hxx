...
template<typename R>
R
boolean_diff_unk_sign(const R in)
{
...
template<typename R>
R
boolean_diff_sign(const R in1, const R in2)
{
...
template<typename R>
R
boolean_diff_unk_sign(const R in1, const R in2)
{
    return (std::signbit(in1) ^ std::signbit(in2)) || aff3ct::tools::is_unknown_symbol<R>(in1) ||
...
template<typename R>
mipp::Reg<R>
boolean_diff_sign(const mipp::Reg<R>& in)
{
...
template<typename R>
mipp::Reg<R>
boolean_diff_unk_sign(const mipp::Reg<R>& in)
{
    const mipp::Reg<R> zeros = (R)0, ones = (R)1;
...
template<typename R>
mipp::Reg<R>
boolean_diff_sign(const mipp::Reg<R>& in1, const mipp::Reg<R>& in2)
{
    const mipp::Reg<R> zeros = (R)0, ones = (R)1;
...
template<typename R>
mipp::Reg<R>
boolean_diff_unk_sign(const mipp::Reg<R>& in1, const mipp::Reg<R>& in2)
{
    const mipp::Reg<R> zeros = (R)0, ones = (R)1;
    const auto m_in = (mipp::sign(in1) ^ mipp::sign(in2)) | aff3ct::tools::is_unknown_symbol<R>(in1) |
                      aff3ct::tools::is_unknown_symbol<R>(in2);
    return mipp::blend(ones, zeros, m_in);
}
...
mipp::Reg<B>
Boolean_diff<B, cus>::apply(const mipp::Reg<B>& in1, const mipp::Reg<B>& in2)
{
...
template<typename B, bool cus>
mipp::Reg<B>
Boolean_diff<B, cus>::apply(const mipp::Reg<B>& in)
{
    const mipp::Reg<B> zeros = (B)0, ones = (B)1;
...
template<typename B, bool cus>
B
Boolean_diff<B, cus>::apply(const B& in1, const B& in2)
{
...
template<typename B, bool cus>
B
Boolean_diff<B, cus>::apply(const B& in)
{
    return in ? (B)1 : (B)0;
}
...
struct Boolean_diff<B, true>
{
    ...
    static B apply(const B& in) { return in || is_unknown_symbol<B>(in) ? (B)1 : (B)0; }
};
...
struct Boolean_diff<double, false>
{
    ...
    static mipp::Reg<double> apply(const mipp::Reg<double>& in) { return boolean_diff_sign(in); }

    static double apply(const double& in1, const double& in2) { return boolean_diff_sign(in1, in2); }

    static double apply(const double& in) { return boolean_diff_sign(in); }
};
...
struct Boolean_diff<float, false>
{
    ...
    static mipp::Reg<float> apply(const mipp::Reg<float>& in) { return boolean_diff_sign(in); }

    static float apply(const float& in1, const float& in2) { return boolean_diff_sign(in1, in2); }

    static float apply(const float& in) { return boolean_diff_sign(in); }
};
...
struct Boolean_diff<double, true>
{
    ...
    static mipp::Reg<double> apply(const mipp::Reg<double>& in) { return boolean_diff_unk_sign(in); }

    static double apply(const double& in1, const double& in2) { return boolean_diff_unk_sign(in1, in2); }

    static double apply(const double& in) { return boolean_diff_unk_sign(in); }
};
...
struct Boolean_diff<float, true>
{
    ...
    static mipp::Reg<float> apply(const mipp::Reg<float>& in) { return boolean_diff_unk_sign(in); }

    static float apply(const float& in1, const float& in2) { return boolean_diff_unk_sign(in1, in2); }

    static float apply(const float& in) { return boolean_diff_unk_sign(in); }
};
