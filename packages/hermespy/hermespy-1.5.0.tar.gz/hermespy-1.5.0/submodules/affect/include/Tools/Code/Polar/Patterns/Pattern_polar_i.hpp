...
class Pattern_polar_i
{
  protected:
    ...
    inline Pattern_polar_i(const int& N,
                           const Binary_node<Pattern_polar_i>* node,
  ...
  public:
    ...
    virtual inline std::string apply_f(std::string start_indent = "",
                                       std::string str_off_l = "",
                                       std::string str_off_s = "") const;
    virtual inline std::string apply_g(std::string start_indent = "",
                                       std::string str_off_l = "",
                                       std::string str_off_s = "") const;
    virtual inline std::string apply_h(std::string start_indent = "",
                                       std::string str_off_l = "",
                                       std::string str_off_s = "") const;
