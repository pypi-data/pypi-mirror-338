...
Codec_polar_MK ::Codec_polar_MK(const std::string& prefix)
...
Codec_polar_MK ::get_names() const
{
...
std::vector<std::string>
Codec_polar_MK ::get_short_names() const
{
...
std::vector<std::string>
Codec_polar_MK ::get_prefixes() const
{
...
void
Codec_polar_MK ::get_description(cli::Argument_map_info& args) const
{
...
void
Codec_polar_MK ::store(const cli::Argument_map_value& vals)
{
...
void
Codec_polar_MK ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
...
tools::Codec_polar_MK<B, Q>*
Codec_polar_MK ::build(const module::CRC<B>* crc) const
{
    return new tools::Codec_polar_MK<B, Q>(
      *pc, *fbg, dynamic_cast<const Encoder_polar_MK&>(*enc), dynamic_cast<const Decoder_polar_MK&>(*dec), crc);
}

// ==================================================================================== explicit template instantiation
#include "Tools/types.h"
#ifdef AFF3CT_MULTI_PREC
template aff3ct::tools::Codec_polar_MK<B_8, Q_8>*
aff3ct::factory::Codec_polar_MK::build<B_8, Q_8>(const aff3ct::module::CRC<B_8>*) const;
template aff3ct::tools::Codec_polar_MK<B_16, Q_16>*
aff3ct::factory::Codec_polar_MK::build<B_16, Q_16>(const aff3ct::module::CRC<B_16>*) const;
template aff3ct::tools::Codec_polar_MK<B_32, Q_32>*
aff3ct::factory::Codec_polar_MK::build<B_32, Q_32>(const aff3ct::module::CRC<B_32>*) const;
template aff3ct::tools::Codec_polar_MK<B_64, Q_64>*
aff3ct::factory::Codec_polar_MK::build<B_64, Q_64>(const aff3ct::module::CRC<B_64>*) const;
#else
template aff3ct::tools::Codec_polar_MK<B, Q>*
aff3ct::factory::Codec_polar_MK::build<B, Q>(const aff3ct::module::CRC<B>*) const;
#endif
// ==================================================================================== explicit template instantiation
