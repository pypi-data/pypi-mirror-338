...
Codec_repetition ::Codec_repetition(const std::string& prefix)
...
void
Codec_repetition ::get_description(cli::Argument_map_info& args) const
{
...
void
Codec_repetition ::store(const cli::Argument_map_value& vals)
{
...
void
Codec_repetition ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
...
template aff3ct::tools::Codec_repetition<B_8, Q_8>*
aff3ct::factory::Codec_repetition::build<B_8, Q_8>(const aff3ct::module::CRC<B_8>*) const;
template aff3ct::tools::Codec_repetition<B_16, Q_16>*
aff3ct::factory::Codec_repetition::build<B_16, Q_16>(const aff3ct::module::CRC<B_16>*) const;
template aff3ct::tools::Codec_repetition<B_32, Q_32>*
aff3ct::factory::Codec_repetition::build<B_32, Q_32>(const aff3ct::module::CRC<B_32>*) const;
template aff3ct::tools::Codec_repetition<B_64, Q_64>*
aff3ct::factory::Codec_repetition::build<B_64, Q_64>(const aff3ct::module::CRC<B_64>*) const;
#else
template aff3ct::tools::Codec_repetition<B, Q>*
aff3ct::factory::Codec_repetition::build<B, Q>(const aff3ct::module::CRC<B>*) const;
#endif
// ==================================================================================== explicit template instantiation
