...
Frozenbits_generator_MK ::Frozenbits_generator_MK(const std::string& prefix)
...
void
Frozenbits_generator_MK ::get_description(cli::Argument_map_info& args) const
{
...
void
Frozenbits_generator_MK ::store(const cli::Argument_map_value& vals)
{
    auto p = this->get_prefix();
...
void
Frozenbits_generator_MK ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
    auto p = this->get_prefix();
...
Frozenbits_generator_MK ::build(const tools::Polar_code& pc) const
{
