...
Puncturer_turbo_DB ::Puncturer_turbo_DB(const std::string& prefix)
...
void
Puncturer_turbo_DB ::get_description(cli::Argument_map_info& args) const
{
...
void
Puncturer_turbo_DB ::store(const cli::Argument_map_value& vals)
{
...
void
Puncturer_turbo_DB ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
...
Puncturer_turbo_DB ::build() const
{
...
aff3ct::factory::Puncturer_turbo_DB::build<B_8, Q_8>() const;
template aff3ct::module::Puncturer<B_16, Q_16>*
aff3ct::factory::Puncturer_turbo_DB::build<B_16, Q_16>() const;
template aff3ct::module::Puncturer<B_32, Q_32>*
aff3ct::factory::Puncturer_turbo_DB::build<B_32, Q_32>() const;
template aff3ct::module::Puncturer<B_64, Q_64>*
aff3ct::factory::Puncturer_turbo_DB::build<B_64, Q_64>() const;
#else
template aff3ct::module::Puncturer<B, Q>*
aff3ct::factory::Puncturer_turbo_DB::build<B, Q>() const;
#endif
// ==================================================================================== explicit template instantiation
