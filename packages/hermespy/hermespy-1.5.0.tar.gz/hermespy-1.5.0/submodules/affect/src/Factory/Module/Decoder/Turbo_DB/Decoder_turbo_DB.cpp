...
Decoder_turbo_DB ::Decoder_turbo_DB(const std::string& prefix)
...
Decoder_turbo_DB ::get_names() const
{
...
std::vector<std::string>
Decoder_turbo_DB ::get_short_names() const
{
...
std::vector<std::string>
Decoder_turbo_DB ::get_prefixes() const
{
...
void
Decoder_turbo_DB ::get_description(cli::Argument_map_info& args) const
{
...
void
Decoder_turbo_DB ::store(const cli::Argument_map_value& vals)
{
    Decoder::store(vals);
    ...
    if (itl != nullptr)
    {
        ...
        if (this->sub->implem == "DVB-RCS1" && !vals.exist({ "itl-type" })) this->itl->core->type = "DVB-RCS1";

        if (this->sub->implem == "DVB-RCS2" && !vals.exist({ "itl-type" })) this->itl->core->type = "DVB-RCS2";
    }
...
void
Decoder_turbo_DB ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
                         ...
                         module::Encoder<B>* /*encoder*/) const
{
    ...
    {
        if (this->implem == "STD")
            return new module::Decoder_turbo_DB<B, Q>(this->K, this->N_cw, this->n_ite, siso_n, siso_i, itl);
    }
...
Decoder_turbo_DB ::build(module::Encoder<B>* encoder) const
{
...
template aff3ct::module::Decoder_turbo_DB<B_8, Q_8>*
aff3ct::factory::Decoder_turbo_DB::build<B_8, Q_8>(const aff3ct::module::Decoder_RSC_DB_BCJR<B_8, Q_8>&,
                                                   const aff3ct::module::Decoder_RSC_DB_BCJR<B_8, Q_8>&,
                                                   const aff3ct::module::Interleaver<Q_8>&,
                                                   module::Encoder<B_8>*) const;
template aff3ct::module::Decoder_turbo_DB<B_16, Q_16>*
aff3ct::factory::Decoder_turbo_DB::build<B_16, Q_16>(const aff3ct::module::Decoder_RSC_DB_BCJR<B_16, Q_16>&,
                                                     const aff3ct::module::Decoder_RSC_DB_BCJR<B_16, Q_16>&,
                                                     const aff3ct::module::Interleaver<Q_16>&,
                                                     module::Encoder<B_16>*) const;
template aff3ct::module::Decoder_turbo_DB<B_32, Q_32>*
aff3ct::factory::Decoder_turbo_DB::build<B_32, Q_32>(const aff3ct::module::Decoder_RSC_DB_BCJR<B_32, Q_32>&,
                                                     const aff3ct::module::Decoder_RSC_DB_BCJR<B_32, Q_32>&,
                                                     const aff3ct::module::Interleaver<Q_32>&,
                                                     module::Encoder<B_32>*) const;
template aff3ct::module::Decoder_turbo_DB<B_64, Q_64>*
aff3ct::factory::Decoder_turbo_DB::build<B_64, Q_64>(const aff3ct::module::Decoder_RSC_DB_BCJR<B_64, Q_64>&,
                                                     const aff3ct::module::Decoder_RSC_DB_BCJR<B_64, Q_64>&,
                                                     const aff3ct::module::Interleaver<Q_64>&,
                                                     module::Encoder<B_64>*) const;
#else
template aff3ct::module::Decoder_turbo_DB<B, Q>*
aff3ct::factory::Decoder_turbo_DB::build<B, Q>(const aff3ct::module::Decoder_RSC_DB_BCJR<B, Q>&,
                                               const aff3ct::module::Decoder_RSC_DB_BCJR<B, Q>&,
...
aff3ct::factory::Decoder_turbo_DB::build<B_8, Q_8>(module::Encoder<B_8>*) const;
template aff3ct::module::Decoder_SIHO<B_16, Q_16>*
aff3ct::factory::Decoder_turbo_DB::build<B_16, Q_16>(module::Encoder<B_16>*) const;
template aff3ct::module::Decoder_SIHO<B_32, Q_32>*
aff3ct::factory::Decoder_turbo_DB::build<B_32, Q_32>(module::Encoder<B_32>*) const;
template aff3ct::module::Decoder_SIHO<B_64, Q_64>*
aff3ct::factory::Decoder_turbo_DB::build<B_64, Q_64>(module::Encoder<B_64>*) const;
#else
template aff3ct::module::Decoder_SIHO<B, Q>*
aff3ct::factory::Decoder_turbo_DB::build<B, Q>(module::Encoder<B>*) const;
#endif
// ==================================================================================== explicit template instantiation
