...
Codec_turbo_DB ::Codec_turbo_DB(const std::string& prefix)
...
void
Codec_turbo_DB ::enable_puncturer()
{
    set_pct(new Puncturer_turbo_DB("pct"));
}

void
Codec_turbo_DB ::get_description(cli::Argument_map_info& args) const
{
...
void
Codec_turbo_DB ::store(const cli::Argument_map_value& vals)
{
    ...
    if (itl != nullptr)
    {
        ...
        if (dec_tur->sub->implem == "DVB-RCS1" && !vals.exist({ "itl-type" })) itl->core->type = "DVB-RCS1";

        if (dec_tur->sub->implem == "DVB-RCS2" && !vals.exist({ "itl-type" })) itl->core->type = "DVB-RCS2";
    }
}

void
Codec_turbo_DB ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
...
tools::Codec_turbo_DB<B, Q>*
Codec_turbo_DB ::build(const module::CRC<B>* crc) const
{
...
template aff3ct::tools::Codec_turbo_DB<B_8, Q_8>*
aff3ct::factory::Codec_turbo_DB::build<B_8, Q_8>(const aff3ct::module::CRC<B_8>*) const;
template aff3ct::tools::Codec_turbo_DB<B_16, Q_16>*
aff3ct::factory::Codec_turbo_DB::build<B_16, Q_16>(const aff3ct::module::CRC<B_16>*) const;
template aff3ct::tools::Codec_turbo_DB<B_32, Q_32>*
aff3ct::factory::Codec_turbo_DB::build<B_32, Q_32>(const aff3ct::module::CRC<B_32>*) const;
template aff3ct::tools::Codec_turbo_DB<B_64, Q_64>*
aff3ct::factory::Codec_turbo_DB::build<B_64, Q_64>(const aff3ct::module::CRC<B_64>*) const;
#else
template aff3ct::tools::Codec_turbo_DB<B, Q>*
aff3ct::factory::Codec_turbo_DB::build<B, Q>(const aff3ct::module::CRC<B>*) const;
#endif
// ==================================================================================== explicit template instantiation
