...
Codec_RS ::Codec_RS(const std::string& prefix)
...
void
Codec_RS ::get_description(cli::Argument_map_info& args) const
{
...
void
Codec_RS ::store(const cli::Argument_map_value& vals)
{
...
void
Codec_RS ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
...
template aff3ct::tools::Codec_RS<B_8, Q_8>*
aff3ct::factory::Codec_RS::build<B_8, Q_8>(const aff3ct::module::CRC<B_8>*) const;
template aff3ct::tools::Codec_RS<B_16, Q_16>*
aff3ct::factory::Codec_RS::build<B_16, Q_16>(const aff3ct::module::CRC<B_16>*) const;
template aff3ct::tools::Codec_RS<B_32, Q_32>*
aff3ct::factory::Codec_RS::build<B_32, Q_32>(const aff3ct::module::CRC<B_32>*) const;
template aff3ct::tools::Codec_RS<B_64, Q_64>*
aff3ct::factory::Codec_RS::build<B_64, Q_64>(const aff3ct::module::CRC<B_64>*) const;
#else
template aff3ct::tools::Codec_RS<B, Q>*
aff3ct::factory::Codec_RS::build<B, Q>(const aff3ct::module::CRC<B>*) const;
#endif
// ==================================================================================== explicit template instantiation
