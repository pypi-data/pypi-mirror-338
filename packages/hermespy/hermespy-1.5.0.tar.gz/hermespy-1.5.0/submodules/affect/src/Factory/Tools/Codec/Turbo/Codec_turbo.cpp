...
Codec_turbo ::Codec_turbo(const std::string& prefix)
...
void
Codec_turbo ::enable_puncturer()
{
    set_pct(new Puncturer_turbo("pct"));
}

void
Codec_turbo ::get_description(cli::Argument_map_info& args) const
{
...
void
Codec_turbo ::store(const cli::Argument_map_value& vals)
{
    ...
    if (itl != nullptr)
    {
        ...
        if (enc_tur->sub1->standard == "LTE" && !vals.exist({ "itl-type" })) itl->core->type = "LTE";

        if (enc_tur->sub1->standard == "CCSDS" && !vals.exist({ "itl-type" })) itl->core->type = "CCSDS";
    }
}

void
Codec_turbo ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
...
tools::Codec_turbo<B, Q>*
Codec_turbo ::build(const module::CRC<B>* crc) const
{
...
template aff3ct::tools::Codec_turbo<B_8, Q_8>*
aff3ct::factory::Codec_turbo::build<B_8, Q_8>(const aff3ct::module::CRC<B_8>*) const;
template aff3ct::tools::Codec_turbo<B_16, Q_16>*
aff3ct::factory::Codec_turbo::build<B_16, Q_16>(const aff3ct::module::CRC<B_16>*) const;
template aff3ct::tools::Codec_turbo<B_32, Q_32>*
aff3ct::factory::Codec_turbo::build<B_32, Q_32>(const aff3ct::module::CRC<B_32>*) const;
template aff3ct::tools::Codec_turbo<B_64, Q_64>*
aff3ct::factory::Codec_turbo::build<B_64, Q_64>(const aff3ct::module::CRC<B_64>*) const;
#else
template aff3ct::tools::Codec_turbo<B, Q>*
aff3ct::factory::Codec_turbo::build<B, Q>(const aff3ct::module::CRC<B>*) const;
#endif
// ==================================================================================== explicit template instantiation
