...
Factory ::Factory(const std::string& name, const std::string& short_name, const std::string& prefix)
  : name(name)
...
std::string
Factory ::get_name() const
{
    return this->name;
}

std::string
Factory ::get_short_name() const
{
    return this->short_name;
}

std::string
Factory ::get_prefix() const
{
    return this->prefix;
}

std::vector<std::string>
Factory ::get_names() const
{
...
cli::Argument_map_info
Factory ::get_description(const std::vector<Factory*>& factories)
{
...
void
Factory ::get_description(const std::vector<Factory*>& factories, cli::Argument_map_info& args)
{
...
void
Factory ::store(std::vector<Factory*>& factories, const cli::Argument_map_value& vals)
{
    for (auto* f : factories)
        f->store(vals);
}

cli::Argument_map_group
Factory ::create_groups(const std::vector<Factory*>& factories)
{
