...
Decoder_polar_MK ::Decoder_polar_MK(const std::string& prefix)
...
Decoder_polar_MK ::Decoder_polar_MK(const std::string& name, const std::string& prefix)
  : Decoder(name, prefix)
{
    this->type = "SC";
    this->implem = "NAIVE";
...
void
Decoder_polar_MK ::get_description(cli::Argument_map_info& args) const
{
...
void
Decoder_polar_MK ::store(const cli::Argument_map_value& vals)
{
    Decoder::store(vals);
...
void
Decoder_polar_MK ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
...
Decoder_polar_MK ::build(const tools::Polar_code& code,
