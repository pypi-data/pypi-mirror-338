...
template<typename R>
Channel_binary_erasure<R>::Channel_binary_erasure(const int N, const tools::Event_generator<R>& event_generator)
  : Channel<R>(N)
...
template<typename R>
Channel_binary_erasure<R>::Channel_binary_erasure(const int N,
...
Channel_binary_erasure<R>::clone() const
{
...
template<typename R>
void
Channel_binary_erasure<R>::set_seed(const int seed)
{
...
template<typename R>
void
Channel_binary_erasure<R>::_add_noise(const float* CP, const R* X_N, R* Y_N, const size_t frame_id)
{
