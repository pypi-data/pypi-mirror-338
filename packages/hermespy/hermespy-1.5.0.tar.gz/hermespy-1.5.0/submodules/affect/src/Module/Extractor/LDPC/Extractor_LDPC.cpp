...
Extractor_LDPC<B, Q>::Extractor_LDPC(const int K, const int N, const std::vector<uint32_t>& info_bits_pos)
  : Extractor<B, Q>(K, N, 0)
...
template<typename B, typename Q>
Extractor_LDPC<B, Q>*
Extractor_LDPC<B, Q>::clone() const
{
...
Extractor_LDPC<B, Q>::get_info_bits_pos()
{
