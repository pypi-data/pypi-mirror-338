...
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::Decoder_polar_MK_ASCL_naive_CA_sys(
  const int& K,
  const int& N,
  const int& L,
...
template<typename B, typename R>
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::Decoder_polar_MK_ASCL_naive_CA_sys(const int& K,
                                                                             const int& N,
                                                                             const int& L,
                                                                             const tools::Polar_code& code,
                                                                             const std::vector<bool>& frozen_bits,
...
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::clone() const
{
...
template<typename B, typename R>
void
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::deep_copy(const Decoder_polar_MK_ASCL_naive_CA_sys<B, R>& m)
{
...
template<typename B, typename R>
void
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::set_frozen_bits(const std::vector<bool>& fb)
{
...
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::get_frozen_bits() const
{
...
template<typename B, typename R>
int
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::_decode_siho(const R* Y_N, B* V_K, const size_t frame_id)
{
    ...
    if (!crc_decode_result) Decoder_polar_MK_SCL_naive_CA_sys<B, R>::_decode_siho(Y_N, V_K, frame_id);
...
template<typename B, typename R>
int
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::_decode_siho_cw(const R* Y_N, B* V_N, const size_t frame_id)
{
...
template<typename B, typename R>
void
Decoder_polar_MK_ASCL_naive_CA_sys<B, R>::set_n_frames(const size_t n_frames)
{
