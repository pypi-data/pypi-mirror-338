...
template<typename R>
Channel_Rayleigh_LLR<R>::Channel_Rayleigh_LLR(const int N,
                                              const bool complex,
...
Channel_Rayleigh_LLR<R>::clone() const
{
...
template<typename R>
void
Channel_Rayleigh_LLR<R>::deep_copy(const Channel_Rayleigh_LLR<R>& m)
{
...
template<typename R>
void
Channel_Rayleigh_LLR<R>::set_seed(const int seed)
{
...
template<typename R>
void
Channel_Rayleigh_LLR<R>::_add_noise_wg(const float* CP, const R* X_N, R* H_N, R* Y_N, const size_t frame_id)
{
...
template<typename R>
void
Channel_Rayleigh_LLR<R>::set_n_frames(const size_t n_frames)
{
