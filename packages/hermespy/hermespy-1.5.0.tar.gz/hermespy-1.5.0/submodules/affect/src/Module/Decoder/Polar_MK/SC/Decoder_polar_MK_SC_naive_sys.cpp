...
Decoder_polar_MK_SC_naive_sys<B, R>::Decoder_polar_MK_SC_naive_sys(
  const int& K,
  const int& N,
...
template<typename B, typename R>
Decoder_polar_MK_SC_naive_sys<B, R>::Decoder_polar_MK_SC_naive_sys(const int& K,
                                                                   const int& N,
                                                                   const tools::Polar_code& code,
                                                                   const std::vector<bool>& frozen_bits)
...
Decoder_polar_MK_SC_naive_sys<B, R>::clone() const
{
...
template<typename B, typename R>
void
Decoder_polar_MK_SC_naive_sys<B, R>::_store(B* V, bool coded) const
{
