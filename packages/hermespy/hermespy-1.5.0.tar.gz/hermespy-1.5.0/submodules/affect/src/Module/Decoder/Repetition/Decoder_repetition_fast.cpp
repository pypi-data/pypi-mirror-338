...
Decoder_repetition_fast<B, R>::Decoder_repetition_fast(const int& K, const int& N, const bool buffered_encoding)
...
Decoder_repetition_fast<B, R>::clone() const
{
...
template<typename B, typename R>
int
Decoder_repetition_fast<B, R>::_decode_siso_alt(const R* sys, const R* par, R* ext, const size_t /*frame_id*/)
{
