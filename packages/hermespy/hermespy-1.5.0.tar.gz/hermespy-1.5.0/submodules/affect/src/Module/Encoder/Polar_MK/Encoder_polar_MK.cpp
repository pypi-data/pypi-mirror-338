...
template<typename B>
Encoder_polar_MK<B>::Encoder_polar_MK(const int& K,
                                      const int& N,
...
template<typename B>
void
Encoder_polar_MK<B>::light_encode(B* X_N)
{
...
template<typename B>
void
Encoder_polar_MK<B>::convert(const B* U_K, B* U_N)
{
    if (U_K == U_N)
    {
...
template<typename B>
void
Encoder_polar_MK<B>::set_frozen_bits(const std::vector<bool>& frozen_bits)
{
...
Encoder_polar_MK<B>::get_frozen_bits() const
{
