...
Decoder_RSC_DB_BCJR<B, R>::Decoder_RSC_DB_BCJR(const int K,
...
Decoder_RSC_DB_BCJR<B, R>::clone() const
{
...
template<typename B, typename R>
void
Decoder_RSC_DB_BCJR<B, R>::_load(const R* Y_N)
{
    notify_new_frame();
...
template<typename B, typename R>
int
Decoder_RSC_DB_BCJR<B, R>::_decode_siho(const R* Y_N, B* V_K, const size_t frame_id)
{
...
template<typename B, typename R>
void
Decoder_RSC_DB_BCJR<B, R>::_store(B* V_K) const
{
...
template<typename B, typename R>
void
Decoder_RSC_DB_BCJR<B, R>::__init_alpha_beta()
{
...
template<typename B, typename R>
void
Decoder_RSC_DB_BCJR<B, R>::__save_alpha_beta()
{
    for (auto s = 0; s < n_states; s++)
    {
...
template<typename B, typename R>
void
Decoder_RSC_DB_BCJR<B, R>::notify_new_frame()
{
    for (auto s = 0; s < n_states; s++)
    {
        alpha_mp[s] = (R)0;
