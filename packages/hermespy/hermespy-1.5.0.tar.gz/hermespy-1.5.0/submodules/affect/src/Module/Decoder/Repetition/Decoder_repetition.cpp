...
Decoder_repetition<B, R>::Decoder_repetition(const int& K, const int& N, const bool buffered_encoding)
...
Decoder_repetition<B, R>::clone() const
{
...
template<typename B, typename R>
void
Decoder_repetition<B, R>::_load(const R* Y_N)
{
...
template<typename B, typename R>
int
Decoder_repetition<B, R>::_decode_siho(const R* Y_N, B* V_K, const size_t frame_id)
{
