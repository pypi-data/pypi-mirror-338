...
template<typename R>
Channel_AWGN_LLR<R>::Channel_AWGN_LLR(const int N,
...
template<typename R>
Channel_AWGN_LLR<R>*
Channel_AWGN_LLR<R>::clone() const
{
...
template<typename R>
void
Channel_AWGN_LLR<R>::deep_copy(const Channel_AWGN_LLR<R>& m)
{
...
template<typename R>
void
Channel_AWGN_LLR<R>::set_seed(const int seed)
{
...
template<typename R>
void
Channel_AWGN_LLR<R>::_add_noise(const float* CP, const R* X_N, R* Y_N, const size_t frame_id)
{
