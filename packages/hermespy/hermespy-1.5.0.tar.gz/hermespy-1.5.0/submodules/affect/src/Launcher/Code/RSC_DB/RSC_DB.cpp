...
RSC_DB<L, B, R, Q>::RSC_DB(const int argc, const char** argv, std::ostream& stream)
  : L(argc, argv, stream)
  , params_cdc(new factory::Codec_RSC_DB("cdc"))
{
...
template<class L, typename B, typename R, typename Q>
void
RSC_DB<L, B, R, Q>::get_description_args()
{
