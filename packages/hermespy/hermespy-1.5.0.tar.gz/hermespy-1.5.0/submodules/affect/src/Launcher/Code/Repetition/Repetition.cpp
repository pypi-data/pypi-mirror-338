...
Repetition<L, B, R, Q>::Repetition(const int argc, const char** argv, std::ostream& stream)
  : L(argc, argv, stream)
  , params_cdc(new factory::Codec_repetition("cdc"))
{
...
template<class L, typename B, typename R, typename Q>
void
Repetition<L, B, R, Q>::get_description_args()
{
