...
Polar_MK<L, B, R, Q>::Polar_MK(const int argc, const char** argv, std::ostream& stream)
  : L(argc, argv, stream)
  , params_cdc(new factory::Codec_polar_MK("cdc"))
{
...
template<class L, typename B, typename R, typename Q>
void
Polar_MK<L, B, R, Q>::get_description_args()
{
