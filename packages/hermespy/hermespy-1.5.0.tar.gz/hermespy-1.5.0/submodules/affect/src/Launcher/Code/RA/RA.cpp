...
RA<L, B, R, Q>::RA(const int argc, const char** argv, std::ostream& stream)
  : L(argc, argv, stream)
  , params_cdc(new factory::Codec_RA("cdc"))
{
...
template<class L, typename B, typename R, typename Q>
void
RA<L, B, R, Q>::get_description_args()
{
