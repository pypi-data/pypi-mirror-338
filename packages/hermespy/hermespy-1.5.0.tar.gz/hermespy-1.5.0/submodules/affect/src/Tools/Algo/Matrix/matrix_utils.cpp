...
Sparse_matrix
aff3ct::tools::bgemm(const Sparse_matrix& A, const Sparse_matrix& B)
{
...
Sparse_matrix
aff3ct::tools::operator*(const Sparse_matrix& A, const Sparse_matrix& B)
{
    return bgemm(A, B);
}

Sparse_matrix
aff3ct::tools::bgemmt(const Sparse_matrix& A, const Sparse_matrix& tB)
{
...
bool
aff3ct::tools::all_zeros(const Sparse_matrix& M)
{
