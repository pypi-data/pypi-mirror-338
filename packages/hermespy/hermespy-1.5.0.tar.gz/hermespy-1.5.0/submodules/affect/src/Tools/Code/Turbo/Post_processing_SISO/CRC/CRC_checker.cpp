...
CRC_checker<B, R>::CRC_checker(const module::CRC<B>& crc, const int start_crc_check_ite)
...
template<typename B, typename R>
void
CRC_checker<B, R>::deep_copy(const CRC_checker<B, R>& t)
{
...
template<typename B, typename R>
bool
CRC_checker<B, R>::siso_n(const int ite, const mipp::vector<R>& sys, mipp::vector<R>& ext, mipp::vector<B>& s)
{
...
template<typename B, typename R>
void
CRC_checker<B, R>::set_n_frames(const size_t n_frames)
{
