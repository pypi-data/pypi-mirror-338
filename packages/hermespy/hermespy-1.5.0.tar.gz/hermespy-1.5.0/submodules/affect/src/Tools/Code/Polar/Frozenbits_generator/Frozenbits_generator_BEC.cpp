...
Frozenbits_generator_BEC ::Frozenbits_generator_BEC(const int K,
                                                    const int N,
...
Frozenbits_generator_BEC ::clone() const
{
...
void
Frozenbits_generator_BEC ::evaluate()
{
    this->check_noise();
...
void
Frozenbits_generator_BEC ::check_noise()
{
