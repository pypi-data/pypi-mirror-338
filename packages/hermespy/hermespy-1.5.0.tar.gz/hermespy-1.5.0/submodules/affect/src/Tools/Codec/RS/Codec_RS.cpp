...
Codec_RS<B, Q>::Codec_RS(const factory::Encoder_RS& enc_params, const factory::Decoder_RS& dec_params)
...
template<typename B, typename Q>
const RS_polynomial_generator&
Codec_RS<B, Q>::get_GF_poly() const
{
    return *this->GF_poly;
}
