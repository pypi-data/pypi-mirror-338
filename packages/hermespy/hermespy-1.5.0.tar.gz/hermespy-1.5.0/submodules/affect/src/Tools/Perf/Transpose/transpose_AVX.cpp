...
//
void
aff3ct::tools::avx_trans_float(float* A, float* B, int n)
{
    int i = n / 8;
    while (i--)
    {
...
//
void
aff3ct::tools::avx_itrans_float(float* A, float* B, int n)
{
    int i = n / 8;
    while (i--)
    {
...
void
aff3ct::tools::uchar_transpose_avx(const __m256i* src, __m256i* dst, int n)
{
    if (n % 32)
    {
    ...
    while (loop--)
    {
        ...
        copy_p_input += constN;
        __m256i d = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i e = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i f = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i g = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i h = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i i = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i j = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i k = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i l = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i m = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i n = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i o = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
        __m256i p = LOAD_SIMD_FX(copy_p_input);
        copy_p_input += constN;
...
void
aff3ct::tools::uchar_itranspose_avx(const __m256i* src, __m256i* dst, int n)
{
    if (n % 32)
    {
        std::stringstream message;
