...
template<typename R>
User_pdf_noise_generator_GSL<R>::User_pdf_noise_generator_GSL(const tools::Distributions<R>& dists,
                                                              const int seed,
                                                              Interpolation_type inter_type)
  : User_pdf_noise_generator<R>(dists)
  , rng((void*)gsl_rng_alloc(gsl_rng_mt19937))
...
template<typename R>
User_pdf_noise_generator_GSL<R>::~User_pdf_noise_generator_GSL()
{
...
User_pdf_noise_generator_GSL<R>::clone() const
{
...
template<typename R>
void
User_pdf_noise_generator_GSL<R>::set_seed(const int seed)
{
...
template<typename R>
void
User_pdf_noise_generator_GSL<R>::generate(const R* signal, R* draw, const unsigned length, const R noise_power)
{
...
template<typename R>
void
User_pdf_noise_generator_GSL<R>::generate(R* draw, const unsigned length, const R noise_power)
{
