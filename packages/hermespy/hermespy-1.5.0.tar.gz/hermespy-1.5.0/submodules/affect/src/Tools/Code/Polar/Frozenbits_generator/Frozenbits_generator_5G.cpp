...
Frozenbits_generator_5G ::Frozenbits_generator_5G(const int K, const int N)
  : Frozenbits_generator_file(K, N, cli::modify_path<cli::Is_file>("conf/cde/awgn_polar_codes/5G/N_1024.pc"))
  , m((int)std::log2(N))
{
...
Frozenbits_generator_5G ::clone() const
{
...
void
Frozenbits_generator_5G ::evaluate()
{
