...
Codec_RSC_DB<B, Q>::Codec_RSC_DB(const factory::Encoder_RSC_DB& enc_params, const factory::Decoder_RSC_DB& dec_params)
...
template<typename B, typename Q>
bool
Codec_RSC_DB<B, Q>::is_buffered_encoding() const
{
...
Codec_RSC_DB<B, Q>::get_trellis() const
{
    return *this->trellis;
}
