...
Codec_turbo_product<B, Q>::Codec_turbo_product(const factory::Encoder_turbo_product& enc_params,
  ...
  , GF_poly(new BCH_polynomial_generator<B>(dec_params.sub->N_cw, dec_params.sub->t))
{
    ...
    {
        dec_cp.reset(new module::Decoder_chase_pyndiah_fast<B, Q>(dec_bch->get_K(),
                                                                  N_cw_p,
                                                                  *dec_bch,
                                                                  *enc_bch,
    ...
    {
        dec_cp.reset(new module::Decoder_chase_pyndiah<B, Q>(dec_bch->get_K(),
                                                             N_cw_p,
                                                             *dec_bch,
                                                             *enc_bch,
                                                             dec_params.n_least_reliable_positions,
...
Codec_turbo_product<B, Q>::clone() const
{
...
Codec_turbo_product<B, Q>::get_GF_poly() const
{
    return *this->GF_poly;
}
