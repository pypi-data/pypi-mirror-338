...
RS_polynomial_generator ::RS_polynomial_generator(const int& N, const int& t)
  : Galois<int>(N)
  , t(t)
  , d(2 * t + 1)
  , g(d, 0)
...
int
RS_polynomial_generator ::get_d() const
{
    return d;
}

int
RS_polynomial_generator ::get_t() const
{
    return t;
}

int
RS_polynomial_generator ::get_n_rdncy() const
{
    return (int)g.size() - 1;
}

const std::vector<int>&
RS_polynomial_generator ::get_g() const
{
    return g;
}
