...
Codec_polar_MK<B, Q>::Codec_polar_MK(const factory::Polar_code& pc_params,
...
template<typename B, typename Q>
Codec_polar_MK<B, Q>*
Codec_polar_MK<B, Q>::clone() const
{
...
template<typename B, typename Q>
void
Codec_polar_MK<B, Q>::deep_copy(const Codec_polar_MK<B, Q>& t)
{
...
template<typename B, typename Q>
void
Codec_polar_MK<B, Q>::set_frozen_bits(const std::vector<bool>& fb)
{
...
template<typename B, typename Q>
void
Codec_polar_MK<B, Q>::notify_noise_update()
{
...
template<typename B, typename Q>
void
Codec_polar_MK<B, Q>::check_noise()
{
...
Codec_polar_MK<B, Q>::get_frozen_bits() const
{
...
template<typename B, typename Q>
bool
Codec_polar_MK<B, Q>::is_adaptive_frozen_bits() const
{
...
template<typename B, typename Q>
const Polar_code&
Codec_polar_MK<B, Q>::get_code() const
{
    return *this->code;
}
...
Codec_polar_MK<B, Q>::get_frozen_bits_generator() const
{
