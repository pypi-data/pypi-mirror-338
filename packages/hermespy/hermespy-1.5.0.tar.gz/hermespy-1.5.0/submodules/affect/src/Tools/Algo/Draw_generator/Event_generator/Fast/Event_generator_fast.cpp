...
Event_generator_fast<R, E>::Event_generator_fast(const int seed)
  : Event_generator<R, E>()
{
    this->set_seed(seed);
}
...
Event_generator_fast<R, E>::clone() const
{
...
template<typename R, typename E>
void
Event_generator_fast<R, E>::set_seed(const int seed)
{
    mt19937.seed(seed);
...
template<typename R, typename E>
void
Event_generator_fast<R, E>::generate(E* draw, const unsigned length, const R event_probability)
{
...
template<>
void
Event_generator_fast<R_32, B_32>::generate(B_32* draw, const unsigned length, const R_32 event_probability)
{
...
template<>
void
Event_generator_fast<R_64, B_64>::generate(B_64* draw, const unsigned length, const R_64 event_probability)
{
