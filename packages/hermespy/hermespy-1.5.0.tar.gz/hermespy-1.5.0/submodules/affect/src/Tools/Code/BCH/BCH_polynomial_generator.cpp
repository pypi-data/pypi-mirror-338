...
template<typename I>
BCH_polynomial_generator<I>::BCH_polynomial_generator(const int& N, const int& t, const std::vector<I> p)
  : Galois<I>(N, p)
  , t(t)
  , d(2 * t + 1)
{
...
template<typename I>
int
BCH_polynomial_generator<I>::get_d() const
{
    return d;
}
...
template<typename I>
int
BCH_polynomial_generator<I>::get_t() const
{
    return t;
}
...
template<typename I>
int
BCH_polynomial_generator<I>::get_n_rdncy() const
{
    return (int)g.size() - 1;
}
...
template<typename I>
const std::vector<I>&
BCH_polynomial_generator<I>::get_g() const
{
    return g;
}
...
template<typename I>
void
BCH_polynomial_generator<I>::compute_polynomial()
{
    bool test;
