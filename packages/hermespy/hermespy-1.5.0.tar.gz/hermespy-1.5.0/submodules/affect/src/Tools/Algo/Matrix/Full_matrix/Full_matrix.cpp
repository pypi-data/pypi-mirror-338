...
template<typename T>
Full_matrix<T>::Full_matrix(const unsigned n_rows, const unsigned n_cols)
...
template<typename T>
bool
Full_matrix<T>::at(const size_t row_index, const size_t col_index) const
{
...
template<typename T>
void
Full_matrix<T>::add_connection(const size_t row_index, const size_t col_index)
{
...
template<typename T>
void
Full_matrix<T>::rm_connection(const size_t row_index, const size_t col_index)
{
    if (!at(row_index, col_index)) return;
...
template<typename T>
void
Full_matrix<T>::self_resize(const size_t n_rows, const size_t n_cols, Origin o)
{
...
template<typename T>
Full_matrix<T>
Full_matrix<T>::resize(const size_t n_rows, const size_t n_cols, Origin o) const
{
...
template<typename T>
void
Full_matrix<T>::parse_connections()
{
...
template<typename T>
Full_matrix<T>
Full_matrix<T>::turn(Way w) const
{
...
template<typename T>
void
Full_matrix<T>::sort_cols_per_density(Sort order)
{
    switch (order)
    {
        case Sort::ASCENDING:
...
template<typename T>
void
Full_matrix<T>::print(bool transpose, std::ostream& os) const
{
    if (transpose)
    {
        for (size_t c = 0; c < get_n_cols(); c++)
...
template<typename T>
Full_matrix<T>
Full_matrix<T>::identity(const size_t n_rows, const size_t n_cols)
{
...
template<typename T>
Full_matrix<T>
Full_matrix<T>::zero(const size_t n_rows, const size_t n_cols)
{
...
template<typename T>
void
Full_matrix<T>::erase_row(const size_t row_index, const size_t n_rows)
{
...
template<typename T>
void
Full_matrix<T>::erase_col(const size_t col_index, const size_t n_cols)
{
