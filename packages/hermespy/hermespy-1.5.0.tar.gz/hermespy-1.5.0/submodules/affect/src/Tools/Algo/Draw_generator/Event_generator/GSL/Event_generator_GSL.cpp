...
Event_generator_GSL<R, E>::Event_generator_GSL(const int seed)
  : Event_generator<R, E>()
...
template<typename R, typename E>
Event_generator_GSL<R, E>::~Event_generator_GSL()
{
...
Event_generator_GSL<R, E>::clone() const
{
...
template<typename R, typename E>
void
Event_generator_GSL<R, E>::set_seed(const int seed)
{
...
template<typename R, typename E>
void
Event_generator_GSL<R, E>::generate(E* draw, const unsigned length, const R event_probability)
{
