...
class ChannelSampleHook(Generic[CST]):
    ...
    def __call__(
        ...
        Args:
            ...
            sample: The channel sample to be processed.
            transmitter: The transmitter device the sample is associated with.
            receiver: The receiver device the sample is associated with.
        """
...
class ChannelSample(object):
    ...
    def _propagate(self, signal: SignalBlock, interpolation: InterpolationMode) -> SignalBlock:
        ...
        Abstract subroutine of :meth:`propagate<hermespy.channel.channel.ChannelSample.propagate>`.

        Args:

            signal: The signal block to be propagated.
...
class Channel(ABC, RandomNode, Serializable, Generic[CRT, CST]):
    ...
    def scenario(self) -> SimulationScenario | None:
        ...
        Handle to the :class:`Scenario<hermespy.simulation.scenario.SimulationScenario>` this channel is asigned to.
        :py:obj:`None` if the channel is not part of any specific :class:`Scenario<hermespy.simulation.scenario.SimulationScenario>`.

        The recommended way to set the scenario is:
    ...
    def remove_sample_hook(self, hook: ChannelSampleHook[CST]) -> None:
        ...
        Args:
            ...
            hook: Hook to be removed from the list of hooks.
        """
