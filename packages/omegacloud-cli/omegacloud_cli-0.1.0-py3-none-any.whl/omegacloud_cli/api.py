...
from omega_cli.common.enums import JobTypeEnum
from omega_cli.common.schemas import (
...
from omega_cli.controllers.filesync import (
    FilesSnapshotModel,
    FilesSyncModel,
    FileSyncManager,
)
from omega_cli.utils import load_config
...
async def disable_task_api(task_id: str, stop_job: bool = False, stop_agent: bool = False) -> bool:
    """Disable a task."""
