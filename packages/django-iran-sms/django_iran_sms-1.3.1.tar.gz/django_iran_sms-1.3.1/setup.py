...
setup(
    ...
    keywords="djangoiransms djangosms drfsms drfiransms chelseru lor lur bahman rashnu sobhan bahman bahman rashnu melipayamak parsianwebco sms جنگو پیامک ملی ایران کاوه نگار python kavenegar kave negar meli payamak",
)
