...
policy forwarding rule binding.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'policy-forwarding', 'interfaces', 'interface', 'state']
...
referenced by the corresponding interface.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="apply-forwarding-policy", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """apply_forwarding_policy must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="apply-forwarding-policy", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=False)""",
        })
  ...
  def _get_apply_vrf_selection_policy(self):
    """
    Getter method for apply_vrf_selection_policy, mapped from YANG variable /network_instances/network_instance/policy_forwarding/interfaces/interface/state/apply_vrf_selection_policy (leafref)

    YANG Description: Apply the specific VRF selection policy on the interface.
...
instance that is used for specific input criteria of packets.
  ...
  def _set_apply_vrf_selection_policy(self, v, load=False):
    """
    Setter method for apply_vrf_selection_policy, mapped from YANG variable /network_instances/network_instance/policy_forwarding/interfaces/interface/state/apply_vrf_selection_policy (leafref)
    If this variable is read-only (config: false) in the
...
instance that is used for specific input criteria of packets.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="apply-vrf-selection-policy", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  apply_vrf_selection_policy = __builtin__.property(_get_apply_vrf_selection_policy)
