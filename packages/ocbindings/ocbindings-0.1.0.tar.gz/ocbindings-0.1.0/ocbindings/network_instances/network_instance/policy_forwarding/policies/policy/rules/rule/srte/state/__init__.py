...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/policy-forwarding/policies/policy/rules/rule/srte/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state parameters associated with SR-TE policies.
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'policy-forwarding', 'policies', 'policy', 'rules', 'rule', 'srte', 'state']

  def _get_mpls_bsid(self):
    """
    Getter method for mpls_bsid, mapped from YANG variable /network_instances/network_instance/policy_forwarding/policies/policy/rules/rule/srte/state/mpls_bsid (oc-mplst:mpls-label)
...
must be popped from the label stack by the system.
  ...
  def _set_mpls_bsid(self, v, load=False):
    """
    Setter method for mpls_bsid, mapped from YANG variable /network_instances/network_instance/policy_forwarding/policies/policy/rules/rule/srte/state/mpls_bsid (oc-mplst:mpls-label)
...
must be popped from the label stack by the system.
  ...
  def _get_srte_endpoint(self):
    """
    Getter method for srte_endpoint, mapped from YANG variable /network_instances/network_instance/policy_forwarding/policies/policy/rules/rule/srte/state/srte_endpoint (oc-inet:ip-address)
...
acts as a wildcard in the policy resolution.
  ...
  def _set_srte_endpoint(self, v, load=False):
    """
    Setter method for srte_endpoint, mapped from YANG variable /network_instances/network_instance/policy_forwarding/policies/policy/rules/rule/srte/state/srte_endpoint (oc-inet:ip-address)
    If this variable is read-only (config: false) in the
...
acts as a wildcard in the policy resolution.
  ...
  def _get_srte_color(self):
    """
    Getter method for srte_color, mapped from YANG variable /network_instances/network_instance/policy_forwarding/policies/policy/rules/rule/srte/state/srte_color (uint32)
...
colour is a wildcard in the policy resolution.
  ...
  def _set_srte_color(self, v, load=False):
    """
    Setter method for srte_color, mapped from YANG variable /network_instances/network_instance/policy_forwarding/policies/policy/rules/rule/srte/state/srte_color (uint32)
    If this variable is read-only (config: false) in the
...
colour is a wildcard in the policy resolution.
  ...
  def _get_srte_preference(self):
    """
    Getter method for srte_preference, mapped from YANG variable /network_instances/network_instance/policy_forwarding/policies/policy/rules/rule/srte/state/srte_preference (uint32)
...
entries configured on the system.
  ...
  def _set_srte_preference(self, v, load=False):
    """
    Setter method for srte_preference, mapped from YANG variable /network_instances/network_instance/policy_forwarding/policies/policy/rules/rule/srte/state/srte_preference (uint32)
    If this variable is read-only (config: false) in the
...
entries configured on the system.
  ...
  mpls_bsid = __builtin__.property(_get_mpls_bsid)
  srte_endpoint = __builtin__.property(_get_srte_endpoint)
  srte_color = __builtin__.property(_get_srte_color)
  srte_preference = __builtin__.property(_get_srte_preference)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/policy-forwarding/policies/policy/rules/rule/srte/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
