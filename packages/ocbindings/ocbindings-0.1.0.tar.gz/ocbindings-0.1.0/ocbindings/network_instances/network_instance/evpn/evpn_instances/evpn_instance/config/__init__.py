...
the participation in an EVPN Intance.
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__evi = YANGDynClass(base=str, is_leaf=True, yang_name="evi", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=True)
  ...
  def _set_evi(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="evi", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """evi must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="evi", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=True)""",
        })
...
network-instance/config.
  ...
  def _get_local_vpws_service_id(self):
    """
    Getter method for local_vpws_service_id, mapped from YANG variable /network_instances/network_instance/evpn/evpn_instances/evpn_instance/config/local_vpws_service_id (uint32)
...
to the Attachment Circuit (AC).
  ...
  def _set_local_vpws_service_id(self, v, load=False):
    """
    Setter method for local_vpws_service_id, mapped from YANG variable /network_instances/network_instance/evpn/evpn_instances/evpn_instance/config/local_vpws_service_id (uint32)
    If this variable is read-only (config: false) in the
...
to the Attachment Circuit (AC).
  ...
  def _get_remote_vpws_service_id(self):
    """
    Getter method for remote_vpws_service_id, mapped from YANG variable /network_instances/network_instance/evpn/evpn_instances/evpn_instance/config/remote_vpws_service_id (uint32)
...
to the Attachment Circuit (AC).
  ...
  def _set_remote_vpws_service_id(self, v, load=False):
    """
    Setter method for remote_vpws_service_id, mapped from YANG variable /network_instances/network_instance/evpn/evpn_instances/evpn_instance/config/remote_vpws_service_id (uint32)
    If this variable is read-only (config: false) in the
...
to the Attachment Circuit (AC).
  ...
  local_vpws_service_id = __builtin__.property(_get_local_vpws_service_id, _set_local_vpws_service_id)
  remote_vpws_service_id = __builtin__.property(_get_remote_vpws_service_id, _set_remote_vpws_service_id)
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/evpn/evpn-instances/evpn-instance/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
