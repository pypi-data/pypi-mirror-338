...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/programming-errors/ip-routes/drop-routes/drop/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'programming-errors', 'ip-routes', 'drop-routes', 'drop', 'state']

  def _get_prefix(self):
    """
    Getter method for prefix, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/drop_routes/drop/state/prefix (oc-inet:ip-prefix)
  ...
  def _set_prefix(self, v, load=False):
    """
    Setter method for prefix, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/drop_routes/drop/state/prefix (oc-inet:ip-prefix)
  ...
  def _get_time(self):
    """
    Getter method for time, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/drop_routes/drop/state/time (oc-types:timeticks64)
...
the Unix epoch.
  ...
  def _set_time(self, v, load=False):
    """
    Setter method for time, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/drop_routes/drop/state/time (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
...
the Unix epoch.
  ...
  def _get_dest_component(self):
    """
    Getter method for dest_component, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/drop_routes/drop/state/dest_component (leafref)
  ...
  def _set_dest_component(self, v, load=False):
    """
    Setter method for dest_component, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/drop_routes/drop/state/dest_component (leafref)
    If this variable is read-only (config: false) in the
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/programming-errors/ip-routes/drop-routes/drop/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
