...
class counters(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/segment-routing/te-policies/te-policy/state/counters. Each member element of
...
switches between active protocols.
  """
  __slots__ = ('_path_helper', '_extmethods', '__in_pkts','__in_octets','__in_labeled_pkts','__in_labeled_octets','__out_pkts','__out_octets','__out_labeled_pkts','__out_labeled_octets',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__in_labeled_pkts = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="in-labeled-pkts", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-yang:counter64', is_config=False)
    self.__in_labeled_octets = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="in-labeled-octets", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-yang:counter64', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'segment-routing', 'te-policies', 'te-policy', 'state', 'counters']

  def _get_in_pkts(self):
    """
    Getter method for in_pkts, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/in_pkts (oc-yang:counter64)

    YANG Description: A cumulative counter of the incoming packets steered to
...
steered traffic.
  ...
  def _set_in_pkts(self, v, load=False):
    """
    Setter method for in_pkts, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/in_pkts (oc-yang:counter64)
...
steered traffic.
  ...
  def _get_in_octets(self):
    """
    Getter method for in_octets, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/in_octets (oc-yang:counter64)

    YANG Description: The cumulative counter of the total incoming bytes steered
...
steered traffic.
  ...
  def _set_in_octets(self, v, load=False):
    """
    Setter method for in_octets, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/in_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
steered traffic.
  ...
  def _get_in_labeled_pkts(self):
    """
    Getter method for in_labeled_pkts, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/in_labeled_pkts (oc-yang:counter64)
...
to this policy.
    """
    return self.__in_labeled_pkts
      
  def _set_in_labeled_pkts(self, v, load=False):
    """
    Setter method for in_labeled_pkts, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/in_labeled_pkts (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_in_labeled_pkts is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_in_labeled_pkts() directly.
...
to this policy.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="in-labeled-pkts", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-yang:counter64', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """in_labeled_pkts must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="in-labeled-pkts", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-yang:counter64', is_config=False)""",
        })

    self.__in_labeled_pkts = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_in_labeled_pkts(self):
    self.__in_labeled_pkts = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="in-labeled-pkts", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-yang:counter64', is_config=False)


  def _get_in_labeled_octets(self):
    """
    Getter method for in_labeled_octets, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/in_labeled_octets (oc-yang:counter64)
...
BSID associated to this policy.
    """
    return self.__in_labeled_octets
      
  def _set_in_labeled_octets(self, v, load=False):
    """
    Setter method for in_labeled_octets, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/in_labeled_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_in_labeled_octets is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_in_labeled_octets() directly.
...
BSID associated to this policy.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="in-labeled-octets", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-yang:counter64', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """in_labeled_octets must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="in-labeled-octets", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-yang:counter64', is_config=False)""",
        })

    self.__in_labeled_octets = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_in_labeled_octets(self):
    self.__in_labeled_octets = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="in-labeled-octets", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-yang:counter64', is_config=False)


  def _get_out_pkts(self):
    """
    Getter method for out_pkts, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/out_pkts (oc-yang:counter64)

    YANG Description: A cumulative counter of the outgoing packets after being
...
unlabeled steered traffic.
  ...
  def _set_out_pkts(self, v, load=False):
    """
    Setter method for out_pkts, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/out_pkts (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
unlabeled steered traffic.
  ...
  def _get_out_octets(self):
    """
    Getter method for out_octets, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/out_octets (oc-yang:counter64)

    YANG Description: The cumulative counter of the total outgoing bytes after
...
segments pushed to packets.
  ...
  def _set_out_octets(self, v, load=False):
    """
    Setter method for out_octets, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/out_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
segments pushed to packets.
  ...
  def _get_out_labeled_pkts(self):
    """
    Getter method for out_labeled_pkts, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/out_labeled_pkts (oc-yang:counter64)

    YANG Description: A cumulative counter of the outgoing labeled packets after
...
BSID associated to this policy.
  ...
  def _set_out_labeled_pkts(self, v, load=False):
    """
    Setter method for out_labeled_pkts, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/out_labeled_pkts (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
BSID associated to this policy.
  ...
  def _get_out_labeled_octets(self):
    """
    Getter method for out_labeled_octets, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/out_labeled_octets (oc-yang:counter64)

    YANG Description: A cumulative counter of the total bytes of outgoing labeled
...
include the segments pushed to packets.
  ...
  def _set_out_labeled_octets(self, v, load=False):
    """
    Setter method for out_labeled_octets, mapped from YANG variable /network_instances/network_instance/segment_routing/te_policies/te_policy/state/counters/out_labeled_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
include the segments pushed to packets.
  ...
  in_labeled_pkts = __builtin__.property(_get_in_labeled_pkts)
  in_labeled_octets = __builtin__.property(_get_in_labeled_octets)
  ...
  _pyangbind_elements = OrderedDict([('in_pkts', in_pkts), ('in_octets', in_octets), ('in_labeled_pkts', in_labeled_pkts), ('in_labeled_octets', in_labeled_octets), ('out_pkts', out_pkts), ('out_octets', out_octets), ('out_labeled_pkts', out_labeled_pkts), ('out_labeled_octets', out_labeled_octets), ])


class counters(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/segment-routing/te-policies/te-policy/state/counters. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
