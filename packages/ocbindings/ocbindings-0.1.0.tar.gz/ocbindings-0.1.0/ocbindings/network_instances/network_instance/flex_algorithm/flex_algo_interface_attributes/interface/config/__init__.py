...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/flex-algorithm/flex-algo-interface-attributes/interface/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Configuration parameters related to flex-algo interfaces:
  """
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__interface_id = YANGDynClass(base=str, is_leaf=True, yang_name="interface-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/flexalgo', defining_module='openconfig-flexalgo', yang_type='oc-if:interface-id', is_config=True)
    self.__te_metric = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="te-metric", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/flexalgo', defining_module='openconfig-flexalgo', yang_type='uint32', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'flex-algorithm', 'flex-algo-interface-attributes', 'interface', 'config']

  def _get_interface_id(self):
    """
    Getter method for interface_id, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/interface_id (oc-if:interface-id)
  ...
  def _set_interface_id(self, v, load=False):
    """
    Setter method for interface_id, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/interface_id (oc-if:interface-id)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="interface-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/flexalgo', defining_module='openconfig-flexalgo', yang_type='oc-if:interface-id', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """interface_id must be of a type compatible with oc-if:interface-id""",
          'defined-type': "oc-if:interface-id",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="interface-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/flexalgo', defining_module='openconfig-flexalgo', yang_type='oc-if:interface-id', is_config=True)""",
        })
  ...
  def _get_te_metric(self):
    """
    Getter method for te_metric, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/te_metric (uint32)
  ...
  def _set_te_metric(self, v, load=False):
    """
    Setter method for te_metric, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/te_metric (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_min_delay(self):
    """
    Getter method for min_delay, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/min_delay (uint32)
  ...
  def _set_min_delay(self, v, load=False):
    """
    Setter method for min_delay, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/min_delay (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_srlg_membership(self):
    """
    Getter method for srlg_membership, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/srlg_membership (leafref)
...
interface belongs to.
  ...
  def _set_srlg_membership(self, v, load=False):
    """
    Setter method for srlg_membership, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/srlg_membership (leafref)
    If this variable is read-only (config: false) in the
...
interface belongs to.
  ...
  def _get_admin_group(self):
    """
    Getter method for admin_group, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/admin_group (leafref)
  ...
  def _set_admin_group(self, v, load=False):
    """
    Setter method for admin_group, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_interface_attributes/interface/config/admin_group (leafref)
    If this variable is read-only (config: false) in the
  ...
  min_delay = __builtin__.property(_get_min_delay, _set_min_delay)
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/flex-algorithm/flex-algo-interface-attributes/interface/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
