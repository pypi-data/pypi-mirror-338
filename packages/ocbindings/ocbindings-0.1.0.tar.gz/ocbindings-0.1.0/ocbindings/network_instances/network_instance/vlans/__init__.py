...
class vlans(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/vlans. Each member element of
...
variables
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'vlans']

  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /network_instances/network_instance/vlans/vlan (list)
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /network_instances/network_instance/vlans/vlan (list)
...
class vlans(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/vlans. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
