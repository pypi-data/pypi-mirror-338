...
class next_hop(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/afts/next-hop-groups/next-hop-group/next-hops/next-hop. Each member element of
...
list.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'afts', 'next-hop-groups', 'next-hop-group', 'next-hops', 'next-hop']

  def _get_index(self):
    """
    Getter method for index, mapped from YANG variable /network_instances/network_instance/afts/next_hop_groups/next_hop_group/next_hops/next_hop/index (leafref)
...
the next-hop-group.
  ...
  def _set_index(self, v, load=False):
    """
    Setter method for index, mapped from YANG variable /network_instances/network_instance/afts/next_hop_groups/next_hop_group/next_hops/next_hop/index (leafref)
...
the next-hop-group.
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /network_instances/network_instance/afts/next_hop_groups/next_hop_group/next_hops/next_hop/state (container)
...
within the next-hop-group.
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /network_instances/network_instance/afts/next_hop_groups/next_hop_group/next_hops/next_hop/state (container)
    If this variable is read-only (config: false) in the
...
class next_hop(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/afts/next-hop-groups/next-hop-group/next-hops/next-hop. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
