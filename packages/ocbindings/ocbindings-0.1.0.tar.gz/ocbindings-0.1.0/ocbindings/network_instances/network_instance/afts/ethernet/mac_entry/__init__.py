...
of the Ethernet frame.
  """
  __slots__ = ('_path_helper', '_extmethods', '__mac_address','__state',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'afts', 'ethernet', 'mac-entry']
...
entry.
  ...
  _pyangbind_elements = OrderedDict([('mac_address', mac_address), ('state', state), ])
