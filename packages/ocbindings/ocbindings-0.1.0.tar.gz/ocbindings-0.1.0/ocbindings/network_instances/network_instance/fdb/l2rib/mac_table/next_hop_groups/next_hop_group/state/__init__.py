...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/fdb/l2rib/mac-table/next-hop-groups/next-hop-group/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'fdb', 'l2rib', 'mac-table', 'next-hop-groups', 'next-hop-group', 'state']

  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hop_groups/next_hop_group/state/id (uint64)
...
all L2RIB entries that reference it must also be updated.
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hop_groups/next_hop_group/state/id (uint64)
...
all L2RIB entries that reference it must also be updated.
  ...
  def _get_esi(self):
    """
    Getter method for esi, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hop_groups/next_hop_group/state/esi (oc-evpn-types:esi)
  ...
  def _set_esi(self, v, load=False):
    """
    Setter method for esi, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hop_groups/next_hop_group/state/esi (oc-evpn-types:esi)
    If this variable is read-only (config: false) in the
  ...
  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hop_groups/next_hop_group/state/type (enumeration)
  ...
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hop_groups/next_hop_group/state/type (enumeration)
    If this variable is read-only (config: false) in the
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/fdb/l2rib/mac-table/next-hop-groups/next-hop-group/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
