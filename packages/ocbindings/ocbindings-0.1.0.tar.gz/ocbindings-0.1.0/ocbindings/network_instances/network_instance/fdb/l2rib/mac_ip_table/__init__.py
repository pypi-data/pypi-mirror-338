...
into the MAC VRF of the L2RIB
  ...
  def _get_next_hop_groups(self):
    """
    Getter method for next_hop_groups, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_ip_table/next_hop_groups (container)
  ...
  def _set_next_hop_groups(self, v, load=False):
    """
    Setter method for next_hop_groups, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_ip_table/next_hop_groups (container)
    If this variable is read-only (config: false) in the
...
class mac_ip_table(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/fdb/l2rib/mac-ip-table. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
