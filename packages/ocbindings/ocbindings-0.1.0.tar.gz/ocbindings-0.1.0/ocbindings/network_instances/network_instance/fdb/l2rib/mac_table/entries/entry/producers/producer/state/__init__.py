...
class state(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__producer','__seq_number','__mobility_state','__esi','__sticky','__next_hop','__next_hop_group','__derived_from_mac_ip','__directly_received',)
...
learned with the same ESI should point to the same next-hop-group
  ...
  def _get_next_hop_group(self):
    """
    Getter method for next_hop_group, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/entries/entry/producers/producer/state/next_hop_group (leafref)
  ...
  def _set_next_hop_group(self, v, load=False):
    """
    Setter method for next_hop_group, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/entries/entry/producers/producer/state/next_hop_group (leafref)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = OrderedDict([('producer', producer), ('seq_number', seq_number), ('mobility_state', mobility_state), ('esi', esi), ('sticky', sticky), ('next_hop', next_hop), ('next_hop_group', next_hop_group), ('derived_from_mac_ip', derived_from_mac_ip), ('directly_received', directly_received), ])


class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/fdb/l2rib/mac-table/entries/entry/producers/producer/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
