...
class segment(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__state','__ipv4_segment','__unnumbered_hop',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv2', 'areas', 'area', 'lsdb', 'lsa-types', 'lsa-type', 'lsas', 'lsa', 'opaque-lsa', 'extended-prefix', 'tlvs', 'tlv', 'sid-label-binding', 'tlvs', 'tlv', 'ero-path', 'segments', 'segment']
...
ERO
  ...
  _pyangbind_elements = OrderedDict([('state', state), ('ipv4_segment', ipv4_segment), ('unnumbered_hop', unnumbered_hop), ])
