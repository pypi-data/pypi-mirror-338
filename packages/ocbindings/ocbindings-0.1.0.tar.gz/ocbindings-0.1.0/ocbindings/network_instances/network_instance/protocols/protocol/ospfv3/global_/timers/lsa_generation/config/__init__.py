...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/ospfv3/global/timers/lsa-generation/config. Each member element of
...
LSAs by the local system
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv3', 'global', 'timers', 'lsa-generation', 'config']

  def _get_initial_delay(self):
    """
    Getter method for initial_delay, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/timers/lsa_generation/config/initial_delay (uint32)
...
generation of that LSA.
  ...
  def _set_initial_delay(self, v, load=False):
    """
    Setter method for initial_delay, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/timers/lsa_generation/config/initial_delay (uint32)
...
generation of that LSA.
  ...
  def _get_maximum_delay(self):
    """
    Getter method for maximum_delay, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/timers/lsa_generation/config/maximum_delay (uint32)
...
increasing delay between generation of an LSA
  ...
  def _set_maximum_delay(self, v, load=False):
    """
    Setter method for maximum_delay, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/timers/lsa_generation/config/maximum_delay (uint32)
    If this variable is read-only (config: false) in the
...
increasing delay between generation of an LSA
  ...
  _pyangbind_elements = OrderedDict([('initial_delay', initial_delay), ('maximum_delay', maximum_delay), ])


class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/ospfv3/global/timers/lsa-generation/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
