...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/interfaces/interface/enable-bfd/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'interfaces', 'interface', 'enable-bfd', 'state']

  def _get_enabled(self):
    """
    Getter method for enabled, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/enable_bfd/state/enabled (boolean)
...
liveliness of the remote peer or next-hop.
  ...
  def _set_enabled(self, v, load=False):
    """
    Setter method for enabled, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/enable_bfd/state/enabled (boolean)
...
liveliness of the remote peer or next-hop.
  ...
  def _get_desired_minimum_tx_interval(self):
    """
    Getter method for desired_minimum_tx_interval, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/enable_bfd/state/desired_minimum_tx_interval (uint32)
...
The value 0 is reserved and cannot be used.
  ...
  def _set_desired_minimum_tx_interval(self, v, load=False):
    """
    Setter method for desired_minimum_tx_interval, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/enable_bfd/state/desired_minimum_tx_interval (uint32)
    If this variable is read-only (config: false) in the
...
The value 0 is reserved and cannot be used.
  ...
  def _get_required_minimum_receive(self):
    """
    Getter method for required_minimum_receive, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/enable_bfd/state/required_minimum_receive (uint32)
...
acceptable to the local system.
  ...
  def _set_required_minimum_receive(self, v, load=False):
    """
    Setter method for required_minimum_receive, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/enable_bfd/state/required_minimum_receive (uint32)
    If this variable is read-only (config: false) in the
...
acceptable to the local system.
  ...
  def _get_detection_multiplier(self):
    """
    Getter method for detection_multiplier, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/enable_bfd/state/detection_multiplier (uint8)
...
transmission interval by this value.
  ...
  def _set_detection_multiplier(self, v, load=False):
    """
    Setter method for detection_multiplier, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/enable_bfd/state/detection_multiplier (uint8)
    If this variable is read-only (config: false) in the
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/interfaces/interface/enable-bfd/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
