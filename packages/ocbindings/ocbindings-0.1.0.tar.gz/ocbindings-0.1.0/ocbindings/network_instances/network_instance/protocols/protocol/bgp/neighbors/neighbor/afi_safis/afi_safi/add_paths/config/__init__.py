...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/bgp/neighbors/neighbor/afi-safis/afi-safi/add-paths/config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'neighbors', 'neighbor', 'afi-safis', 'afi-safi', 'add-paths', 'config']

  def _get_receive(self):
    """
    Getter method for receive, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/add_paths/config/receive (boolean)
...
advertisements for an NLRI from the neighbor or group
  ...
  def _set_receive(self, v, load=False):
    """
    Setter method for receive, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/add_paths/config/receive (boolean)
...
advertisements for an NLRI from the neighbor or group
  ...
  def _get_send(self):
    """
    Getter method for send, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/add_paths/config/send (boolean)
...
advertisements for an NLRI from the neighbor or group
  ...
  def _set_send(self, v, load=False):
    """
    Setter method for send, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/add_paths/config/send (boolean)
    If this variable is read-only (config: false) in the
...
advertisements for an NLRI from the neighbor or group
  ...
  def _get_send_max(self):
    """
    Getter method for send_max, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/add_paths/config/send_max (uint8)
...
enabled.
  ...
  def _set_send_max(self, v, load=False):
    """
    Setter method for send_max, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/add_paths/config/send_max (uint8)
    If this variable is read-only (config: false) in the
...
enabled.
  ...
  def _get_eligible_prefix_policy(self):
    """
    Getter method for eligible_prefix_policy, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/add_paths/config/eligible_prefix_policy (leafref)
...
restrict the prefixes for which add-paths is enabled
  ...
  def _set_eligible_prefix_policy(self, v, load=False):
    """
    Setter method for eligible_prefix_policy, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/add_paths/config/eligible_prefix_policy (leafref)
    If this variable is read-only (config: false) in the
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/bgp/neighbors/neighbor/afi-safis/afi-safi/add-paths/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
