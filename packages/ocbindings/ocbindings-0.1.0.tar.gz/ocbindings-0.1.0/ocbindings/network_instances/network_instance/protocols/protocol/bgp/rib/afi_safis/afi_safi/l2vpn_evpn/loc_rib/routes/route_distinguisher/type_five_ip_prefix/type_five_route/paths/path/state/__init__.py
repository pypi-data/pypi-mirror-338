...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/bgp/rib/afi-safis/afi-safi/l2vpn-evpn/loc-rib/routes/route-distinguisher/type-five-ip-prefix/type-five-route/paths/path/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: BGP path attributes for this route
  """
  __slots__ = ('_path_helper', '_extmethods', '__esi','__gateway_ip_address','__peer_ip','__peer_path_id','__source_route_distinguisher','__source_address_family','__advertised_to_peer','__label','__label2','__bestpath','__multipath','__backup','__last_modified','__valid_route','__invalid_reason','__attr_index','__community_index','__ext_community_index',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__gateway_ip_address = YANGDynClass(base=[RestrictedClassType(base_type=str, restriction_dict={'pattern': '([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\\.([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])){3}/([0-9]|[12][0-9]|3[0-2])'}),RestrictedClassType(base_type=str, restriction_dict={'pattern': '(([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:))/(12[0-8]|1[0-1][0-9]|[1-9][0-9]|[0-9])'}),], is_leaf=True, yang_name="gateway-ip-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-inet:ip-prefix', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'rib', 'afi-safis', 'afi-safi', 'l2vpn-evpn', 'loc-rib', 'routes', 'route-distinguisher', 'type-five-ip-prefix', 'type-five-route', 'paths', 'path', 'state']

  def _get_esi(self):
    """
    Getter method for esi, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/esi (oc-evpn-types:esi)
...
segment for this route
  ...
  def _set_esi(self, v, load=False):
    """
    Setter method for esi, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/esi (oc-evpn-types:esi)
...
segment for this route
  ...
  def _get_gateway_ip_address(self):
    """
    Getter method for gateway_ip_address, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/gateway_ip_address (oc-inet:ip-prefix)

    YANG Description: The gateway-ip-address for the route
    """
    return self.__gateway_ip_address
      
  def _set_gateway_ip_address(self, v, load=False):
    """
    Setter method for gateway_ip_address, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/gateway_ip_address (oc-inet:ip-prefix)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_gateway_ip_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_gateway_ip_address() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """gateway_ip_address must be of a type compatible with oc-inet:ip-prefix""",
    ...
    self.__gateway_ip_address = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_gateway_ip_address(self):
    self.__gateway_ip_address = YANGDynClass(base=[RestrictedClassType(base_type=str, restriction_dict={'pattern': '([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\\.([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])){3}/([0-9]|[12][0-9]|3[0-2])'}),RestrictedClassType(base_type=str, restriction_dict={'pattern': '(([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:))/(12[0-8]|1[0-1][0-9]|[1-9][0-9]|[0-9])'}),], is_leaf=True, yang_name="gateway-ip-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-inet:ip-prefix', is_config=False)


  def _get_peer_ip(self):
    """
    Getter method for peer_ip, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/peer_ip (oc-inet:ip-address)
  ...
  def _set_peer_ip(self, v, load=False):
    """
    Setter method for peer_ip, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/peer_ip (oc-inet:ip-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_peer_path_id(self):
    """
    Getter method for peer_path_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/peer_path_id (uint32)
  ...
  def _set_peer_path_id(self, v, load=False):
    """
    Setter method for peer_path_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/peer_path_id (uint32)
    If this variable is read-only (config: false) in the
...
imported route
  ...
  def _get_source_address_family(self):
    """
    Getter method for source_address_family, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/source_address_family (identityref)
  ...
  def _set_source_address_family(self, v, load=False):
    """
    Setter method for source_address_family, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/source_address_family (identityref)
    If this variable is read-only (config: false) in the
  ...
  def _get_advertised_to_peer(self):
    """
    Getter method for advertised_to_peer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/advertised_to_peer (oc-inet:ip-address)
  ...
  def _set_advertised_to_peer(self, v, load=False):
    """
    Setter method for advertised_to_peer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/advertised_to_peer (oc-inet:ip-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_label(self):
    """
    Getter method for label, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/label (string)
  ...
  def _set_label(self, v, load=False):
    """
    Setter method for label, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/label (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_label2(self):
    """
    Getter method for label2, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/label2 (string)
  ...
  def _set_label2(self, v, load=False):
    """
    Setter method for label2, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/label2 (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_bestpath(self):
    """
    Getter method for bestpath, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/bestpath (boolean)
...
in the IP routing table and use for traffic forwarding
  ...
  def _set_bestpath(self, v, load=False):
    """
    Setter method for bestpath, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/bestpath (boolean)
    If this variable is read-only (config: false) in the
...
in the IP routing table and use for traffic forwarding
  ...
  def _get_multipath(self):
    """
    Getter method for multipath, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/multipath (boolean)
...
path is marked as multipath
  ...
  def _set_multipath(self, v, load=False):
    """
    Setter method for multipath, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/multipath (boolean)
    If this variable is read-only (config: false) in the
...
path is marked as multipath
  ...
  def _get_backup(self):
    """
    Getter method for backup, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/backup (boolean)
  ...
  def _set_backup(self, v, load=False):
    """
    Setter method for backup, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/backup (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_last_modified(self):
    """
    Getter method for last_modified, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/last_modified (oc-types:timeticks64)
...
the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
  ...
  def _set_last_modified(self, v, load=False):
    """
    Setter method for last_modified, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/last_modified (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
...
the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
  ...
  def _get_valid_route(self):
    """
    Getter method for valid_route, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/valid_route (boolean)
...
local router
  ...
  def _set_valid_route(self, v, load=False):
    """
    Setter method for valid_route, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/valid_route (boolean)
    If this variable is read-only (config: false) in the
...
local router
  ...
  def _get_invalid_reason(self):
    """
    Getter method for invalid_reason, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/invalid_reason (identityref)
...
reason.
  ...
  def _set_invalid_reason(self, v, load=False):
    """
    Setter method for invalid_reason, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/invalid_reason (identityref)
    If this variable is read-only (config: false) in the
...
reason.
  ...
  def _get_attr_index(self):
    """
    Getter method for attr_index, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/attr_index (leafref)
...
route
  ...
  def _set_attr_index(self, v, load=False):
    """
    Setter method for attr_index, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/attr_index (leafref)
    If this variable is read-only (config: false) in the
...
route
  ...
  def _get_community_index(self):
    """
    Getter method for community_index, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/community_index (leafref)
  ...
  def _set_community_index(self, v, load=False):
    """
    Setter method for community_index, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/community_index (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_ext_community_index(self):
    """
    Getter method for ext_community_index, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/ext_community_index (leafref)
...
route
  ...
  def _set_ext_community_index(self, v, load=False):
    """
    Setter method for ext_community_index, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/rib/afi_safis/afi_safi/l2vpn_evpn/loc_rib/routes/route_distinguisher/type_five_ip_prefix/type_five_route/paths/path/state/ext_community_index (leafref)
    If this variable is read-only (config: false) in the
...
route
  ...
  gateway_ip_address = __builtin__.property(_get_gateway_ip_address)
  ...
  _pyangbind_elements = OrderedDict([('esi', esi), ('gateway_ip_address', gateway_ip_address), ('peer_ip', peer_ip), ('peer_path_id', peer_path_id), ('source_route_distinguisher', source_route_distinguisher), ('source_address_family', source_address_family), ('advertised_to_peer', advertised_to_peer), ('label', label), ('label2', label2), ('bestpath', bestpath), ('multipath', multipath), ('backup', backup), ('last_modified', last_modified), ('valid_route', valid_route), ('invalid_reason', invalid_reason), ('attr_index', attr_index), ('community_index', community_index), ('ext_community_index', ext_community_index), ])


class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/bgp/rib/afi-safis/afi-safi/l2vpn-evpn/loc-rib/routes/route-distinguisher/type-five-ip-prefix/type-five-route/paths/path/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
