...
TLV
  """
  __slots__ = ('_path_helper', '_extmethods', '__type','__state','__segment_routing_algorithms','__segment_routing_capability',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'levels', 'level', 'link-state-database', 'lsp', 'tlvs', 'tlv', 'router-capabilities', 'capability', 'subtlvs', 'subtlv']
  ...
  _pyangbind_elements = OrderedDict([('type', type), ('state', state), ('segment_routing_algorithms', segment_routing_algorithms), ('segment_routing_capability', segment_routing_capability), ])
