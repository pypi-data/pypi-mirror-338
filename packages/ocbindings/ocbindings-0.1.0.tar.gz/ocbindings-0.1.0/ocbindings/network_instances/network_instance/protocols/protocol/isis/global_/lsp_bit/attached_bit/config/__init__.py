...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/global/lsp-bit/attached-bit/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: This container defines Attached Bit configuration.
  """
  __slots__ = ('_path_helper', '_extmethods', '__ignore_bit','__suppress_bit',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'global', 'lsp-bit', 'attached-bit', 'config']
...
with the attached bit set.
  ...
  def _set_ignore_bit(self, v, load=False):
    """
    Setter method for ignore_bit, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/lsp_bit/attached_bit/config/ignore_bit (boolean)
...
attached bit is not advertised in locally generated PDUs.
  ...
  def _set_suppress_bit(self, v, load=False):
    """
    Setter method for suppress_bit, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/lsp_bit/attached_bit/config/suppress_bit (boolean)
    If this variable is read-only (config: false) in the
...
attached bit is not advertised in locally generated PDUs.
  ...
  ignore_bit = __builtin__.property(_get_ignore_bit, _set_ignore_bit)
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/global/lsp-bit/attached-bit/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
