...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/bgp/global/route-selection-options/config. Each member element of
...
options
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'global', 'route-selection-options', 'config']

  def _get_always_compare_med(self):
    """
    Getter method for always_compare_med, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/always_compare_med (boolean)
...
received from the same AS.
  ...
  def _set_always_compare_med(self, v, load=False):
    """
    Setter method for always_compare_med, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/always_compare_med (boolean)
...
received from the same AS.
  ...
  def _get_ignore_as_path_length(self):
    """
    Getter method for ignore_as_path_length, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/ignore_as_path_length (boolean)
...
with shorter length.
  ...
  def _set_ignore_as_path_length(self, v, load=False):
    """
    Setter method for ignore_as_path_length, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/ignore_as_path_length (boolean)
    If this variable is read-only (config: false) in the
...
with shorter length.
  ...
  def _get_external_compare_router_id(self):
    """
    Getter method for external_compare_router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/external_compare_router_id (boolean)
...
the active path.
  ...
  def _set_external_compare_router_id(self, v, load=False):
    """
    Setter method for external_compare_router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/external_compare_router_id (boolean)
    If this variable is read-only (config: false) in the
...
the active path.
  ...
  def _get_advertise_inactive_routes(self):
    """
    Getter method for advertise_inactive_routes, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/advertise_inactive_routes (boolean)
...
default is to only advertise active routes.
  ...
  def _set_advertise_inactive_routes(self, v, load=False):
    """
    Setter method for advertise_inactive_routes, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/advertise_inactive_routes (boolean)
    If this variable is read-only (config: false) in the
...
default is to only advertise active routes.
  ...
  def _get_enable_aigp(self):
    """
    Getter method for enable_aigp, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/enable_aigp (boolean)
...
attribute in routing updates
  ...
  def _set_enable_aigp(self, v, load=False):
    """
    Setter method for enable_aigp, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/enable_aigp (boolean)
    If this variable is read-only (config: false) in the
...
attribute in routing updates
  ...
  def _get_ignore_next_hop_igp_metric(self):
    """
    Getter method for ignore_next_hop_igp_metric, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/ignore_next_hop_igp_metric (boolean)
...
which the metric to the next-hop is lowest
  ...
  def _set_ignore_next_hop_igp_metric(self, v, load=False):
    """
    Setter method for ignore_next_hop_igp_metric, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/route_selection_options/config/ignore_next_hop_igp_metric (boolean)
    If this variable is read-only (config: false) in the
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/bgp/global/route-selection-options/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
