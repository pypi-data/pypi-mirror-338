...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/ospfv3/areas/area/interfaces/interface/lsa-filter/state. Each member element of
...
LSAs on the specified interface
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv3', 'areas', 'area', 'interfaces', 'interface', 'lsa-filter', 'state']

  def _get_all(self):
    """
    Getter method for all, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/areas/area/interfaces/interface/lsa_filter/state/all (boolean)
...
formed on the interface.
  ...
  def _set_all(self, v, load=False):
    """
    Setter method for all, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/areas/area/interfaces/interface/lsa_filter/state/all (boolean)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/ospfv3/areas/area/interfaces/interface/lsa-filter/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
