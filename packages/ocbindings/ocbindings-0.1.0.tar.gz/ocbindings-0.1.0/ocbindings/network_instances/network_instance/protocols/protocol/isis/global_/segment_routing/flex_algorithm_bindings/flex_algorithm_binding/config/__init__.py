...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/global/segment-routing/flex-algorithm-bindings/flex-algorithm-binding/config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'global', 'segment-routing', 'flex-algorithm-bindings', 'flex-algorithm-binding', 'config']

  def _get_flex_algo_id(self):
    """
    Getter method for flex_algo_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/segment_routing/flex_algorithm_bindings/flex_algorithm_binding/config/flex_algo_id (uint8)
  ...
  def _set_flex_algo_id(self, v, load=False):
    """
    Setter method for flex_algo_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/segment_routing/flex_algorithm_bindings/flex_algorithm_binding/config/flex_algo_id (uint8)
  ...
  def _get_isis_level(self):
    """
    Getter method for isis_level, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/segment_routing/flex_algorithm_bindings/flex_algorithm_binding/config/isis_level (oc-isis-types:level-type)
  ...
  def _set_isis_level(self, v, load=False):
    """
    Setter method for isis_level, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/segment_routing/flex_algorithm_bindings/flex_algorithm_binding/config/isis_level (oc-isis-types:level-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_advertised(self):
    """
    Getter method for advertised, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/segment_routing/flex_algorithm_bindings/flex_algorithm_binding/config/advertised (boolean)
  ...
  def _set_advertised(self, v, load=False):
    """
    Setter method for advertised, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/segment_routing/flex_algorithm_bindings/flex_algorithm_binding/config/advertised (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_participate(self):
    """
    Getter method for participate, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/segment_routing/flex_algorithm_bindings/flex_algorithm_binding/config/participate (boolean)
  ...
  def _set_participate(self, v, load=False):
    """
    Setter method for participate, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/segment_routing/flex_algorithm_bindings/flex_algorithm_binding/config/participate (boolean)
    If this variable is read-only (config: false) in the
  ...
  isis_level = __builtin__.property(_get_isis_level, _set_isis_level)
  advertised = __builtin__.property(_get_advertised, _set_advertised)
  participate = __builtin__.property(_get_participate, _set_participate)
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/global/segment-routing/flex-algorithm-bindings/flex-algorithm-binding/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
