...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/bgp/peer-groups/peer-group/transport/config. Each member element of
...
session(s) used for the BGP neighbor or group
  """
  __slots__ = ('_path_helper', '_extmethods', '__tcp_mss','__mtu_discovery','__passive_mode','__local_address',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'peer-groups', 'peer-group', 'transport', 'config']

  def _get_tcp_mss(self):
    """
    Getter method for tcp_mss, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/transport/config/tcp_mss (uint16)
  ...
  def _set_tcp_mss(self, v, load=False):
    """
    Setter method for tcp_mss, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/transport/config/tcp_mss (uint16)
  ...
  def _get_mtu_discovery(self):
    """
    Getter method for mtu_discovery, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/transport/config/mtu_discovery (boolean)
...
or off (false)
  ...
  def _set_mtu_discovery(self, v, load=False):
    """
    Setter method for mtu_discovery, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/transport/config/mtu_discovery (boolean)
    If this variable is read-only (config: false) in the
...
or off (false)
  ...
  def _get_passive_mode(self):
    """
    Getter method for passive_mode, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/transport/config/passive_mode (boolean)
...
rather than initiating sessions from the local router.
  ...
  def _set_passive_mode(self, v, load=False):
    """
    Setter method for passive_mode, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/transport/config/passive_mode (boolean)
    If this variable is read-only (config: false) in the
...
rather than initiating sessions from the local router.
  ...
  def _get_local_address(self):
    """
    Getter method for local_address, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/transport/config/local_address (union)
...
to the name of an interface.
  ...
  def _set_local_address(self, v, load=False):
    """
    Setter method for local_address, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/peer_groups/peer_group/transport/config/local_address (union)
    If this variable is read-only (config: false) in the
...
to the name of an interface.
  ...
  _pyangbind_elements = OrderedDict([('tcp_mss', tcp_mss), ('mtu_discovery', mtu_discovery), ('passive_mode', passive_mode), ('local_address', local_address), ])


class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/bgp/peer-groups/peer-group/transport/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
