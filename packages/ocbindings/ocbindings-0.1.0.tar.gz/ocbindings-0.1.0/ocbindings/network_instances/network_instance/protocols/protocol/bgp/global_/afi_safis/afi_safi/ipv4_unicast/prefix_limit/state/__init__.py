...
AFI-SAFI
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'global', 'afi-safis', 'afi-safi', 'ipv4-unicast', 'prefix-limit', 'state']
...
down.
  ...
  def _get_warning_threshold_pct(self):
    """
    Getter method for warning_threshold_pct, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/afi_safis/afi_safi/ipv4_unicast/prefix_limit/state/warning_threshold_pct (oc-types:percentage)
...
max-prefixes
  ...
  def _set_warning_threshold_pct(self, v, load=False):
    """
    Setter method for warning_threshold_pct, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/afi_safis/afi_safi/ipv4_unicast/prefix_limit/state/warning_threshold_pct (oc-types:percentage)
    If this variable is read-only (config: false) in the
...
max-prefixes
  ...
  def _get_prefix_limit_exceeded(self):
    """
    Getter method for prefix_limit_exceeded, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/afi_safis/afi_safi/ipv4_unicast/prefix_limit/state/prefix_limit_exceeded (boolean)
...
the value must be reset to false
  ...
  def _set_prefix_limit_exceeded(self, v, load=False):
    """
    Setter method for prefix_limit_exceeded, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/afi_safis/afi_safi/ipv4_unicast/prefix_limit/state/prefix_limit_exceeded (boolean)
    If this variable is read-only (config: false) in the
