...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/pcep/path-computation-servers/path-computation-server/timers/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: This container defines state information for PCEP timers.
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'pcep', 'path-computation-servers', 'path-computation-server', 'timers', 'state']

  def _get_keepalive(self):
    """
    Getter method for keepalive, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pcep/path_computation_servers/path_computation_server/timers/state/keepalive (uint8)
  ...
  def _set_keepalive(self, v, load=False):
    """
    Setter method for keepalive, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pcep/path_computation_servers/path_computation_server/timers/state/keepalive (uint8)
  ...
  def _get_dead_timer(self):
    """
    Getter method for dead_timer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pcep/path_computation_servers/path_computation_server/timers/state/dead_timer (uint8)
  ...
  def _set_dead_timer(self, v, load=False):
    """
    Setter method for dead_timer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pcep/path_computation_servers/path_computation_server/timers/state/dead_timer (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_redelegation_timeout_interval(self):
    """
    Getter method for redelegation_timeout_interval, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pcep/path_computation_servers/path_computation_server/timers/state/redelegation_timeout_interval (uint16)
...
associated with the terminated PCEP session to an alternate PCE.
  ...
  def _set_redelegation_timeout_interval(self, v, load=False):
    """
    Setter method for redelegation_timeout_interval, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pcep/path_computation_servers/path_computation_server/timers/state/redelegation_timeout_interval (uint16)
    If this variable is read-only (config: false) in the
...
associated with the terminated PCEP session to an alternate PCE.
  ...
  def _get_state_timeout_interval(self):
    """
    Getter method for state_timeout_interval, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pcep/path_computation_servers/path_computation_server/timers/state/state_timeout_interval (uint16)
  ...
  def _set_state_timeout_interval(self, v, load=False):
    """
    Setter method for state_timeout_interval, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pcep/path_computation_servers/path_computation_server/timers/state/state_timeout_interval (uint16)
    If this variable is read-only (config: false) in the
  ...
  redelegation_timeout_interval = __builtin__.property(_get_redelegation_timeout_interval)
  state_timeout_interval = __builtin__.property(_get_state_timeout_interval)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/pcep/path-computation-servers/path-computation-server/timers/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
