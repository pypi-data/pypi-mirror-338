...
class state(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__afi_safi_name','__enabled','__send_community_type','__active','__prefixes',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'neighbors', 'neighbor', 'afi-safis', 'afi-safi', 'state']
...
enabled for the neighbor or group
  ...
  def _get_send_community_type(self):
    """
    Getter method for send_community_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/state/send_community_type (oc-bgp-types:community-type)
...
or group configuration
  ...
  def _set_send_community_type(self, v, load=False):
    """
    Setter method for send_community_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/state/send_community_type (oc-bgp-types:community-type)
    If this variable is read-only (config: false) in the
...
capability.
  ...
  _pyangbind_elements = OrderedDict([('afi_safi_name', afi_safi_name), ('enabled', enabled), ('send_community_type', send_community_type), ('active', active), ('prefixes', prefixes), ])
