...
class counters(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/pim/interfaces/interface/state/counters. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'pim', 'interfaces', 'interface', 'state', 'counters']

  def _get_hello_messages(self):
    """
    Getter method for hello_messages, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pim/interfaces/interface/state/counters/hello_messages (uint32)
  ...
  def _set_hello_messages(self, v, load=False):
    """
    Setter method for hello_messages, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pim/interfaces/interface/state/counters/hello_messages (uint32)
  ...
  def _get_join_prune_messages(self):
    """
    Getter method for join_prune_messages, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pim/interfaces/interface/state/counters/join_prune_messages (uint32)
  ...
  def _set_join_prune_messages(self, v, load=False):
    """
    Setter method for join_prune_messages, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pim/interfaces/interface/state/counters/join_prune_messages (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_bootstrap_messages(self):
    """
    Getter method for bootstrap_messages, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pim/interfaces/interface/state/counters/bootstrap_messages (uint32)
  ...
  def _set_bootstrap_messages(self, v, load=False):
    """
    Setter method for bootstrap_messages, mapped from YANG variable /network_instances/network_instance/protocols/protocol/pim/interfaces/interface/state/counters/bootstrap_messages (uint32)
    If this variable is read-only (config: false) in the
...
class counters(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/pim/interfaces/interface/state/counters. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
