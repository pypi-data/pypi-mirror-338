...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/interfaces/interface/graceful-restart/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: This container defines interface config parameters for ISIS
graceful-restart.
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'interfaces', 'interface', 'graceful-restart', 'config']

  def _get_interface_timer(self):
    """
    Getter method for interface_timer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/graceful_restart/config/interface_timer (uint16)
  ...
  def _set_interface_timer(self, v, load=False):
    """
    Setter method for interface_timer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/graceful_restart/config/interface_timer (uint16)
  ...
  def _get_interface_time_expirations(self):
    """
    Getter method for interface_time_expirations, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/graceful_restart/config/interface_time_expirations (int64)
...
Inermediate System
  ...
  def _set_interface_time_expirations(self, v, load=False):
    """
    Setter method for interface_time_expirations, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/graceful_restart/config/interface_time_expirations (int64)
    If this variable is read-only (config: false) in the
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/interfaces/interface/graceful-restart/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
