...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/bgp/neighbors/neighbor/ebgp-multihop/state. Each member element of
...
or group
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'neighbors', 'neighbor', 'ebgp-multihop', 'state']

  def _get_enabled(self):
    """
    Getter method for enabled, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/ebgp_multihop/state/enabled (boolean)
...
can be decremented between the BGP peers
  ...
  def _set_enabled(self, v, load=False):
    """
    Setter method for enabled, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/ebgp_multihop/state/enabled (boolean)
...
can be decremented between the BGP peers
  ...
  def _get_multihop_ttl(self):
    """
    Getter method for multihop_ttl, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/ebgp_multihop/state/multihop_ttl (uint8)
...
referenced group or neighbors and ebgp-multihop is enabled
  ...
  def _set_multihop_ttl(self, v, load=False):
    """
    Setter method for multihop_ttl, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/ebgp_multihop/state/multihop_ttl (uint8)
    If this variable is read-only (config: false) in the
...
referenced group or neighbors and ebgp-multihop is enabled
  ...
  multihop_ttl = __builtin__.property(_get_multihop_ttl)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/bgp/neighbors/neighbor/ebgp-multihop/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
