...
class state(PybindBase):
  ...
  def _get_extended_next_hop_encoding(self):
    """
    Getter method for extended_next_hop_encoding, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/ipv4_unicast/state/extended_next_hop_encoding (boolean)
...
this AFI-SAFI
  ...
  def _set_extended_next_hop_encoding(self, v, load=False):
    """
    Setter method for extended_next_hop_encoding, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/neighbors/neighbor/afi_safis/afi_safi/ipv4_unicast/state/extended_next_hop_encoding (boolean)
    If this variable is read-only (config: false) in the
