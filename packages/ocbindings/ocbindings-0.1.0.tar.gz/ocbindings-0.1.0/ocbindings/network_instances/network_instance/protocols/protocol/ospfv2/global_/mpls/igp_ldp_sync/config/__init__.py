...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/ospfv2/global/mpls/igp-ldp-sync/config. Each member element of
...
synchronization.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv2', 'global', 'mpls', 'igp-ldp-sync', 'config']
...
the neighbor(s) over the link are established.
  ...
  def _set_enabled(self, v, load=False):
    """
    Setter method for enabled, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv2/global/mpls/igp_ldp_sync/config/enabled (boolean)
...
it being considered synchronized by the IGP.
  ...
  def _set_post_session_up_delay(self, v, load=False):
    """
    Setter method for post_session_up_delay, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv2/global/mpls/igp_ldp_sync/config/post_session_up_delay (uint32)
    If this variable is read-only (config: false) in the
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/ospfv2/global/mpls/igp-ldp-sync/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
