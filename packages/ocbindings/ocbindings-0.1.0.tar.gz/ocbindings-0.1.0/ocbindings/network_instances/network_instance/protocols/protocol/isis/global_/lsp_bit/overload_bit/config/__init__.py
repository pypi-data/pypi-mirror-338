...
class config(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__set_bit','__set_bit_on_boot','__advertise_high_metric',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'global', 'lsp-bit', 'overload-bit', 'config']
