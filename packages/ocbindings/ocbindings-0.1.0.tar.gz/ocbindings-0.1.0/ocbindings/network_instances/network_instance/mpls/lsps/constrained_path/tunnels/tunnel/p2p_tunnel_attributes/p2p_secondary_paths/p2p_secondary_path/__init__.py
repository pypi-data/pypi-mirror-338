...
class p2p_secondary_path(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__name','__config','__state','__path_metric_bound_constraints','__admin_groups',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'lsps', 'constrained-path', 'tunnels', 'tunnel', 'p2p-tunnel-attributes', 'p2p-secondary-paths', 'p2p-secondary-path']
  ...
  def _get_path_metric_bound_constraints(self):
    """
    Getter method for path_metric_bound_constraints, mapped from YANG variable /network_instances/network_instance/mpls/lsps/constrained_path/tunnels/tunnel/p2p_tunnel_attributes/p2p_secondary_paths/p2p_secondary_path/path_metric_bound_constraints (container)
  ...
  def _set_path_metric_bound_constraints(self, v, load=False):
    """
    Setter method for path_metric_bound_constraints, mapped from YANG variable /network_instances/network_instance/mpls/lsps/constrained_path/tunnels/tunnel/p2p_tunnel_attributes/p2p_secondary_paths/p2p_secondary_path/path_metric_bound_constraints (container)
    If this variable is read-only (config: false) in the
...
link affinities
  ...
  _pyangbind_elements = OrderedDict([('name', name), ('config', config), ('state', state), ('path_metric_bound_constraints', path_metric_bound_constraints), ('admin_groups', admin_groups), ])
