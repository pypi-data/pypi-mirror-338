...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/mpls/te-global-attributes/bandwidth-measurement/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state parameters relating to bandwidth
measurement
  """
  __slots__ = ('_path_helper', '_extmethods', '__measure_sr_traffic','__collection_interval','__adjustment_interval','__bandwidth_multiplier','__effective_adjustment_interval',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__bandwidth_multiplier = YANGDynClass(base=RestrictedPrecisionDecimalType(precision=4), default=Decimal(1.0000), is_leaf=True, yang_name="bandwidth-multiplier", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/rsvp-sr-ext', defining_module='openconfig-rsvp-sr-ext', yang_type='decimal64', is_config=False)
    self.__effective_adjustment_interval = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="effective-adjustment-interval", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/rsvp-sr-ext', defining_module='openconfig-rsvp-sr-ext', yang_type='uint32', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'te-global-attributes', 'bandwidth-measurement', 'state']

  def _get_measure_sr_traffic(self):
    """
    Getter method for measure_sr_traffic, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/measure_sr_traffic (enumeration)
...
and optional flooding into IGP.
  ...
  def _set_measure_sr_traffic(self, v, load=False):
    """
    Setter method for measure_sr_traffic, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/measure_sr_traffic (enumeration)
...
and optional flooding into IGP.
  ...
  def _get_collection_interval(self):
    """
    Getter method for collection_interval, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/collection_interval (uint32)
...
performed
  ...
  def _set_collection_interval(self, v, load=False):
    """
    Setter method for collection_interval, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/collection_interval (uint32)
    If this variable is read-only (config: false) in the
...
performed
  ...
  def _get_adjustment_interval(self):
    """
    Getter method for adjustment_interval, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/adjustment_interval (uint32)
...
statistics.
  ...
  def _set_adjustment_interval(self, v, load=False):
    """
    Setter method for adjustment_interval, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/adjustment_interval (uint32)
    If this variable is read-only (config: false) in the
...
statistics.
  ...
  def _get_bandwidth_multiplier(self):
    """
    Getter method for bandwidth_multiplier, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/bandwidth_multiplier (decimal64)
...
sampled value is flooded.
  ...
  def _set_bandwidth_multiplier(self, v, load=False):
    """
    Setter method for bandwidth_multiplier, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/bandwidth_multiplier (decimal64)
    If this variable is read-only (config: false) in the
...
sampled value is flooded.
  ...
  def _get_effective_adjustment_interval(self):
    """
    Getter method for effective_adjustment_interval, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/effective_adjustment_interval (uint32)

    YANG Description: The effective adjustment interval that is being used by
...
same value as the adjustment-inerval leaf.
    """
    return self.__effective_adjustment_interval
      
  def _set_effective_adjustment_interval(self, v, load=False):
    """
    Setter method for effective_adjustment_interval, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/state/effective_adjustment_interval (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_effective_adjustment_interval is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_effective_adjustment_interval() directly.
...
same value as the adjustment-inerval leaf.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="effective-adjustment-interval", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/rsvp-sr-ext', defining_module='openconfig-rsvp-sr-ext', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """effective_adjustment_interval must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="effective-adjustment-interval", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/rsvp-sr-ext', defining_module='openconfig-rsvp-sr-ext', yang_type='uint32', is_config=False)""",
        })

    self.__effective_adjustment_interval = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_effective_adjustment_interval(self):
    self.__effective_adjustment_interval = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="effective-adjustment-interval", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/rsvp-sr-ext', defining_module='openconfig-rsvp-sr-ext', yang_type='uint32', is_config=False)

  measure_sr_traffic = __builtin__.property(_get_measure_sr_traffic)
  collection_interval = __builtin__.property(_get_collection_interval)
  adjustment_interval = __builtin__.property(_get_adjustment_interval)
  bandwidth_multiplier = __builtin__.property(_get_bandwidth_multiplier)
  effective_adjustment_interval = __builtin__.property(_get_effective_adjustment_interval)


  _pyangbind_elements = OrderedDict([('measure_sr_traffic', measure_sr_traffic), ('collection_interval', collection_interval), ('adjustment_interval', adjustment_interval), ('bandwidth_multiplier', bandwidth_multiplier), ('effective_adjustment_interval', effective_adjustment_interval), ])


class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/mpls/te-global-attributes/bandwidth-measurement/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
