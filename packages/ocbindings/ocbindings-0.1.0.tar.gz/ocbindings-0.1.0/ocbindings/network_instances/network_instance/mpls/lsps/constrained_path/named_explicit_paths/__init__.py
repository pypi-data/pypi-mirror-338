...
class named_explicit_paths(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'lsps', 'constrained-path', 'named-explicit-paths']
  ...
  _pyangbind_elements = OrderedDict([('named_explicit_path', named_explicit_path), ])
