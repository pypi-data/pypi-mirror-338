...
class encap_headers(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/static/next-hops/next-hop/encap-headers. Each member element of
...
header.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'static', 'next-hops', 'next-hop', 'encap-headers']

  def _get_encap_header(self):
    """
    Getter method for encap_header, mapped from YANG variable /network_instances/network_instance/static/next_hops/next_hop/encap_headers/encap_header (list)
...
index is a UDPv4 header.
  ...
  def _set_encap_header(self, v, load=False):
    """
    Setter method for encap_header, mapped from YANG variable /network_instances/network_instance/static/next_hops/next_hop/encap_headers/encap_header (list)
...
index is a UDPv4 header.
  ...
  encap_header = __builtin__.property(_get_encap_header, _set_encap_header)
...
class encap_headers(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/static/next-hops/next-hop/encap-headers. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
