...
class state(PybindBase):
  ...
  from YANG module openconfig-wifi-mac - based on the path /ssids/ssid/bssids/bssid/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['ssids', 'ssid', 'bssids', 'bssid', 'state']

  def _get_bssid(self):
    """
    Getter method for bssid, mapped from YANG variable /ssids/ssid/bssids/bssid/state/bssid (oc-yang:mac-address)
  ...
  def _set_bssid(self, v, load=False):
    """
    Setter method for bssid, mapped from YANG variable /ssids/ssid/bssids/bssid/state/bssid (oc-yang:mac-address)
  ...
  def _get_radio_id(self):
    """
    Getter method for radio_id, mapped from YANG variable /ssids/ssid/bssids/bssid/state/radio_id (uint8)
  ...
  def _set_radio_id(self, v, load=False):
    """
    Setter method for radio_id, mapped from YANG variable /ssids/ssid/bssids/bssid/state/radio_id (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_num_associated_clients(self):
    """
    Getter method for num_associated_clients, mapped from YANG variable /ssids/ssid/bssids/bssid/state/num_associated_clients (uint8)
  ...
  def _set_num_associated_clients(self, v, load=False):
    """
    Setter method for num_associated_clients, mapped from YANG variable /ssids/ssid/bssids/bssid/state/num_associated_clients (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_counters(self):
    """
    Getter method for counters, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters (container)
  ...
  def _set_counters(self, v, load=False):
    """
    Setter method for counters, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters (container)
    If this variable is read-only (config: false) in the
