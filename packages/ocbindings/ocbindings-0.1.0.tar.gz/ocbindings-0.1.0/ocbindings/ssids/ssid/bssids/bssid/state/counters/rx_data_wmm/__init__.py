...
class rx_data_wmm(PybindBase):
  ...
  from YANG module openconfig-wifi-mac - based on the path /ssids/ssid/bssids/bssid/state/counters/rx-data-wmm. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['ssids', 'ssid', 'bssids', 'bssid', 'state', 'counters', 'rx-data-wmm']

  def _get_vi(self):
    """
    Getter method for vi, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters/rx_data_wmm/vi (oc-yang:counter64)
  ...
  def _set_vi(self, v, load=False):
    """
    Setter method for vi, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters/rx_data_wmm/vi (oc-yang:counter64)
  ...
  def _get_vo(self):
    """
    Getter method for vo, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters/rx_data_wmm/vo (oc-yang:counter64)
  ...
  def _set_vo(self, v, load=False):
    """
    Setter method for vo, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters/rx_data_wmm/vo (oc-yang:counter64)
    If this variable is read-only (config: false) in the
  ...
  def _get_be(self):
    """
    Getter method for be, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters/rx_data_wmm/be (oc-yang:counter64)
  ...
  def _set_be(self, v, load=False):
    """
    Setter method for be, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters/rx_data_wmm/be (oc-yang:counter64)
    If this variable is read-only (config: false) in the
  ...
  def _get_bk(self):
    """
    Getter method for bk, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters/rx_data_wmm/bk (oc-yang:counter64)
  ...
  def _set_bk(self, v, load=False):
    """
    Setter method for bk, mapped from YANG variable /ssids/ssid/bssids/bssid/state/counters/rx_data_wmm/bk (oc-yang:counter64)
    If this variable is read-only (config: false) in the
