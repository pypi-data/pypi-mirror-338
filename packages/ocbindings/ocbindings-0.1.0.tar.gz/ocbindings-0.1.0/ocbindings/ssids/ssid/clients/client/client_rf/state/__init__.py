...
class state(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['ssids', 'ssid', 'clients', 'client', 'client-rf', 'state']
...
number.
  ...
  def _get_rx_phy_rate(self):
    """
    Getter method for rx_phy_rate, mapped from YANG variable /ssids/ssid/clients/client/client_rf/state/rx_phy_rate (uint16)
  ...
  def _set_rx_phy_rate(self, v, load=False):
    """
    Setter method for rx_phy_rate, mapped from YANG variable /ssids/ssid/clients/client/client_rf/state/rx_phy_rate (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_tx_phy_rate(self):
    """
    Getter method for tx_phy_rate, mapped from YANG variable /ssids/ssid/clients/client/client_rf/state/tx_phy_rate (uint16)
  ...
  def _set_tx_phy_rate(self, v, load=False):
    """
    Setter method for tx_phy_rate, mapped from YANG variable /ssids/ssid/clients/client/client_rf/state/tx_phy_rate (uint16)
    If this variable is read-only (config: false) in the
