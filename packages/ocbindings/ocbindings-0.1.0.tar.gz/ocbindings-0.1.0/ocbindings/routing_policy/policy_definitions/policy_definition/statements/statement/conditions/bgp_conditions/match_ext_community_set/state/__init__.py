...
class state(PybindBase):
  ...
  from YANG module openconfig-routing-policy - based on the path /routing-policy/policy-definitions/policy-definition/statements/statement/conditions/bgp-conditions/match-ext-community-set/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state data for match conditions on extended
community set
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['routing-policy', 'policy-definitions', 'policy-definition', 'statements', 'statement', 'conditions', 'bgp-conditions', 'match-ext-community-set', 'state']

  def _get_ext_community_set(self):
    """
    Getter method for ext_community_set, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/match_ext_community_set/state/ext_community_set (leafref)
  ...
  def _set_ext_community_set(self, v, load=False):
    """
    Setter method for ext_community_set, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/match_ext_community_set/state/ext_community_set (leafref)
  ...
  def _get_match_set_options(self):
    """
    Getter method for match_set_options, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/match_ext_community_set/state/match_set_options (oc-pol-types:match-set-options-type)
...
match operation
  ...
  def _set_match_set_options(self, v, load=False):
    """
    Setter method for match_set_options, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/match_ext_community_set/state/match_set_options (oc-pol-types:match-set-options-type)
    If this variable is read-only (config: false) in the
