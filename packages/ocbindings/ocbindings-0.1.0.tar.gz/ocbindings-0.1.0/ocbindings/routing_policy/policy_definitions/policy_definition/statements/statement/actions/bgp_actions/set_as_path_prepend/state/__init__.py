...
class state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__asn = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="asn", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='oc-inet:as-number', is_config=False)
    self.__use_last_as = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="use-last-as", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='boolean', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['routing-policy', 'policy-definitions', 'policy-definition', 'statements', 'statement', 'actions', 'bgp-actions', 'set-as-path-prepend', 'state']
...
implementation.
  ...
  def _get_asn(self):
    """
    Getter method for asn, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/actions/bgp_actions/set_as_path_prepend/state/asn (oc-inet:as-number)
...
the local AS number will be used for prepending.
  ...
  def _set_asn(self, v, load=False):
    """
    Setter method for asn, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/actions/bgp_actions/set_as_path_prepend/state/asn (oc-inet:as-number)
    If this variable is read-only (config: false) in the
...
the local AS number will be used for prepending.
  ...
  def _get_use_last_as(self):
    """
    Getter method for use_last_as, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/actions/bgp_actions/set_as_path_prepend/state/use_last_as (boolean)
...
used for prepending.
  ...
  def _set_use_last_as(self, v, load=False):
    """
    Setter method for use_last_as, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/actions/bgp_actions/set_as_path_prepend/state/use_last_as (boolean)
    If this variable is read-only (config: false) in the
...
used for prepending.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="use-last-as", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """use_last_as must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="use-last-as", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='boolean', is_config=False)""",
        })
  ...
  repeat_n = __builtin__.property(_get_repeat_n)
  asn = __builtin__.property(_get_asn)
  use_last_as = __builtin__.property(_get_use_last_as)
