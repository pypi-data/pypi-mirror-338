...
class config(PybindBase):
  ...
  from YANG module openconfig-routing-policy - based on the path /routing-policy/policy-definitions/policy-definition/statements/statement/conditions/isis-conditions/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Configuration parameters relating to IS-IS match
conditions
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['routing-policy', 'policy-definitions', 'policy-definition', 'statements', 'statement', 'conditions', 'isis-conditions', 'config']

  def _get_level_eq(self):
    """
    Getter method for level_eq, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/isis_conditions/config/level_eq (isis-types:level-number)
...
within it
  ...
  def _set_level_eq(self, v, load=False):
    """
    Setter method for level_eq, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/isis_conditions/config/level_eq (isis-types:level-number)
...
within it
  ...
  def _get_match_metric_type(self):
    """
    Getter method for match_metric_type, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/isis_conditions/config/match_metric_type (isis-types:metric-type)
  ...
  def _set_match_metric_type(self, v, load=False):
    """
    Setter method for match_metric_type, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/isis_conditions/config/match_metric_type (isis-types:metric-type)
    If this variable is read-only (config: false) in the
  ...
  level_eq = __builtin__.property(_get_level_eq, _set_level_eq)
  match_metric_type = __builtin__.property(_get_match_metric_type, _set_match_metric_type)
