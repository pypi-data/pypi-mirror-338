...
as the data will be within the optical-channel
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'optical-channel', 'state', 'laser-bias-current']
...
class laser_bias_current(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/optical-channel/state/laser-bias-current. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
