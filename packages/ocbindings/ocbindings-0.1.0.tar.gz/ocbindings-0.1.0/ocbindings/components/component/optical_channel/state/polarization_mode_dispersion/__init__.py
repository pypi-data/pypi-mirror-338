...
long = int
class polarization_mode_dispersion(PybindBase):
  """
...
instant value
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'optical-channel', 'state', 'polarization-mode-dispersion']
...
class polarization_mode_dispersion(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/optical-channel/state/polarization-mode-dispersion. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
