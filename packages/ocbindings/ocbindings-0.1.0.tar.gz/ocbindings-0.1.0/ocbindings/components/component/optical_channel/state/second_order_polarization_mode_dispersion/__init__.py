...
long = int
class second_order_polarization_mode_dispersion(PybindBase):
  """
...
is expected to just supply the instant value
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'optical-channel', 'state', 'second-order-polarization-mode-dispersion']
...
class second_order_polarization_mode_dispersion(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/optical-channel/state/second-order-polarization-mode-dispersion. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
