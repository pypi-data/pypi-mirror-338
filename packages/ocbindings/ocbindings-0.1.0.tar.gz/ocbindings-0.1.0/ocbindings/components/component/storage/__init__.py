...
class storage(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'storage']

  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /components/component/storage/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /components/component/storage/state (container)
