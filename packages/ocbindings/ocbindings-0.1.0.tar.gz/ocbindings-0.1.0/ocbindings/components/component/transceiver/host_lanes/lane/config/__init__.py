...
class config(PybindBase):
  ...
  from YANG module openconfig-platform - based on the path /components/component/transceiver/host-lanes/lane/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Configuration data for host lanes.
  """
  __slots__ = ('_path_helper', '_extmethods', '__lane_number',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'transceiver', 'host-lanes', 'lane', 'config']

  def _get_lane_number(self):
    """
    Getter method for lane_number, mapped from YANG variable /components/component/transceiver/host_lanes/lane/config/lane_number (uint8)
...
signal.  Lanes are numbered starting with 1.
  ...
  def _set_lane_number(self, v, load=False):
    """
    Setter method for lane_number, mapped from YANG variable /components/component/transceiver/host_lanes/lane/config/lane_number (uint8)
...
signal.  Lanes are numbered starting with 1.
  ...
  _pyangbind_elements = OrderedDict([('lane_number', lane_number), ])


class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/transceiver/host-lanes/lane/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
