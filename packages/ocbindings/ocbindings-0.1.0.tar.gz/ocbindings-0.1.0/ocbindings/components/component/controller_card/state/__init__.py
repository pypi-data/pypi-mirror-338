...
class state(PybindBase):
  ...
  from YANG module openconfig-platform - based on the path /components/component/controller-card/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'controller-card', 'state']

  def _get_power_admin_state(self):
    """
    Getter method for power_admin_state, mapped from YANG variable /components/component/controller_card/state/power_admin_state (oc-platform-types:component-power-type)
...
defined in the description of the component config container.
  ...
  def _set_power_admin_state(self, v, load=False):
    """
    Setter method for power_admin_state, mapped from YANG variable /components/component/controller_card/state/power_admin_state (oc-platform-types:component-power-type)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/controller-card/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
