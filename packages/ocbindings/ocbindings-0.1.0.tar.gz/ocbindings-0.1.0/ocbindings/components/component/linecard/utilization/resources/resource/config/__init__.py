...
class config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__name = YANGDynClass(base=str, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/platform/linecard', defining_module='openconfig-platform-linecard', yang_type='string', is_config=True)
    self.__used_threshold_upper = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': ['0..100']}), is_leaf=True, yang_name="used-threshold-upper", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/platform/linecard', defining_module='openconfig-platform-linecard', yang_type='oc-types:percentage', is_config=True)
  ...
  def _set_name(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/platform/linecard', defining_module='openconfig-platform-linecard', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/platform/linecard', defining_module='openconfig-platform-linecard', yang_type='string', is_config=True)""",
        })
  ...
  def _get_used_threshold_upper(self):
    """
    Getter method for used_threshold_upper, mapped from YANG variable /components/component/linecard/utilization/resources/resource/config/used_threshold_upper (oc-types:percentage)
...
when crossed will set utilization-threshold-exceeded to 'true'.
  ...
  def _set_used_threshold_upper(self, v, load=False):
    """
    Setter method for used_threshold_upper, mapped from YANG variable /components/component/linecard/utilization/resources/resource/config/used_threshold_upper (oc-types:percentage)
    If this variable is read-only (config: false) in the
...
when crossed will set utilization-threshold-exceeded to 'true'.
  ...
  def _get_used_threshold_upper_clear(self):
    """
    Getter method for used_threshold_upper_clear, mapped from YANG variable /components/component/linecard/utilization/resources/resource/config/used_threshold_upper_clear (oc-types:percentage)
...
crossed will set utilization-threshold-exceeded to 'false'.
  ...
  def _set_used_threshold_upper_clear(self, v, load=False):
    """
    Setter method for used_threshold_upper_clear, mapped from YANG variable /components/component/linecard/utilization/resources/resource/config/used_threshold_upper_clear (oc-types:percentage)
    If this variable is read-only (config: false) in the
