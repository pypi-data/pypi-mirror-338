...
class state(PybindBase):
  ...
  def _get_used_threshold_upper(self):
    """
    Getter method for used_threshold_upper, mapped from YANG variable /components/component/integrated_circuit/utilization/resources/resource/state/used_threshold_upper (oc-types:percentage)
...
when crossed will set utilization-threshold-exceeded to 'true'.
  ...
  def _set_used_threshold_upper(self, v, load=False):
    """
    Setter method for used_threshold_upper, mapped from YANG variable /components/component/integrated_circuit/utilization/resources/resource/state/used_threshold_upper (oc-types:percentage)
    If this variable is read-only (config: false) in the
...
when crossed will set utilization-threshold-exceeded to 'true'.
  ...
  def _get_used_threshold_upper_clear(self):
    """
    Getter method for used_threshold_upper_clear, mapped from YANG variable /components/component/integrated_circuit/utilization/resources/resource/state/used_threshold_upper_clear (oc-types:percentage)
...
crossed will set utilization-threshold-exceeded to 'false'.
  ...
  def _set_used_threshold_upper_clear(self, v, load=False):
    """
    Setter method for used_threshold_upper_clear, mapped from YANG variable /components/component/integrated_circuit/utilization/resources/resource/state/used_threshold_upper_clear (oc-types:percentage)
    If this variable is read-only (config: false) in the
...
(Jan 1, 1970 00:00:00 UTC).
  ...
  def _get_used_threshold_upper_exceeded(self):
    """
    Getter method for used_threshold_upper_exceeded, mapped from YANG variable /components/component/integrated_circuit/utilization/resources/resource/state/used_threshold_upper_exceeded (boolean)
...
used-threshold-upper-clear value for this resource.
  ...
  def _set_used_threshold_upper_exceeded(self, v, load=False):
    """
    Setter method for used_threshold_upper_exceeded, mapped from YANG variable /components/component/integrated_circuit/utilization/resources/resource/state/used_threshold_upper_exceeded (boolean)
    If this variable is read-only (config: false) in the
...
used-threshold-upper-clear value for this resource.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="used-threshold-upper-exceeded", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/platform', defining_module='openconfig-platform', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """used_threshold_upper_exceeded must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="used-threshold-upper-exceeded", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/platform', defining_module='openconfig-platform', yang_type='boolean', is_config=False)""",
        })
