...
class state(PybindBase):
  ...
  from YANG module openconfig-platform - based on the path /components/component/integrated-circuit/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'integrated-circuit', 'state']

  def _get_node_id(self):
    """
    Getter method for node_id, mapped from YANG variable /components/component/integrated_circuit/state/node_id (uint64)
...
/components/component list.
  ...
  def _set_node_id(self, v, load=False):
    """
    Setter method for node_id, mapped from YANG variable /components/component/integrated_circuit/state/node_id (uint64)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/integrated-circuit/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
