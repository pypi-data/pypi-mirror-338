...
depends on the interface's type.
  ...
  def _get_gratuitous_arp_accepted(self):
    """
    Getter method for gratuitous_arp_accepted, mapped from YANG variable /interfaces/interface/routed_vlan/ipv4/state/gratuitous_arp_accepted (boolean)
...
the ARP table will be updated.
  ...
  def _set_gratuitous_arp_accepted(self, v, load=False):
    """
    Setter method for gratuitous_arp_accepted, mapped from YANG variable /interfaces/interface/routed_vlan/ipv4/state/gratuitous_arp_accepted (boolean)
    If this variable is read-only (config: false) in the
