...
advertisements for IPv6.
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /interfaces/interface/routed_vlan/ipv6/router_advertisement/state/enable (boolean)
...
messages and will not respond to router solicitation messages.
  ...
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /interfaces/interface/routed_vlan/ipv6/router_advertisement/state/enable (boolean)
...
messages are not transmitted on this interface.
  ...
  def _get_mode(self):
    """
    Getter method for mode, mapped from YANG variable /interfaces/interface/routed_vlan/ipv6/router_advertisement/state/mode (enumeration)
...
to support IPv6 router advertisements.
  ...
  def _set_mode(self, v, load=False):
    """
    Setter method for mode, mapped from YANG variable /interfaces/interface/routed_vlan/ipv6/router_advertisement/state/mode (enumeration)
    If this variable is read-only (config: false) in the
