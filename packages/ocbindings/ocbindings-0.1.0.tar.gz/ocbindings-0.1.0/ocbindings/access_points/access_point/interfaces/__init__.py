...
class interfaces(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/interfaces. Each member element of
...
configuration and state data.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'interfaces']

  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /access_points/access_point/interfaces/interface (list)
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /access_points/access_point/interfaces/interface (list)
