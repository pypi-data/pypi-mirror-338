...
class config(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/interfaces/interface/tunnel/ipv4/addresses/address/config. Each member element of
...
address on the interface
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'interfaces', 'interface', 'tunnel', 'ipv4', 'addresses', 'address', 'config']

  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv4/addresses/address/config/ip (oc-inet:ipv4-address)
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv4/addresses/address/config/ip (oc-inet:ipv4-address)
  ...
  def _get_prefix_length(self):
    """
    Getter method for prefix_length, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv4/addresses/address/config/prefix_length (uint8)
  ...
  def _set_prefix_length(self, v, load=False):
    """
    Setter method for prefix_length, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv4/addresses/address/config/prefix_length (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv4/addresses/address/config/type (ipv4-address-type)
...
to SECONDARY.
  ...
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv4/addresses/address/config/type (ipv4-address-type)
    If this variable is read-only (config: false) in the
