...
advertisements for IPv6.
  ...
  def _get_prefixes(self):
    """
    Getter method for prefixes, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/router_advertisement/prefixes (container)
...
router advertisement message.
  ...
  def _set_prefixes(self, v, load=False):
    """
    Setter method for prefixes, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/router_advertisement/prefixes (container)
    If this variable is read-only (config: false) in the
