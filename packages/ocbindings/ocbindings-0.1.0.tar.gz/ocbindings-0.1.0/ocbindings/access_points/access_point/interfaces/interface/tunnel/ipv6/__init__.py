...
router advertisements.
  ...
  def _get_unnumbered(self):
    """
    Getter method for unnumbered, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/unnumbered (container)
...
address information
  ...
  def _set_unnumbered(self, v, load=False):
    """
    Setter method for unnumbered, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/unnumbered (container)
    If this variable is read-only (config: false) in the
