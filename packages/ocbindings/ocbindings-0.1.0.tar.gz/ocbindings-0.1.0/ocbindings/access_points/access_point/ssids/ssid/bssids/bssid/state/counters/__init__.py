...
within this BSS.
  ...
  def _get_rx_total_frames(self):
    """
    Getter method for rx_total_frames, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/rx_total_frames (oc-yang:counter64)
  ...
  def _set_rx_total_frames(self, v, load=False):
    """
    Setter method for rx_total_frames, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/rx_total_frames (oc-yang:counter64)
    If this variable is read-only (config: false) in the
  ...
  def _get_rx_total_data(self):
    """
    Getter method for rx_total_data, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/rx_total_data (oc-yang:counter64)
  ...
  def _set_rx_total_data(self, v, load=False):
    """
    Setter method for rx_total_data, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/rx_total_data (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
and require retransmission.
  ...
  def _get_rx_total_subframe(self):
    """
    Getter method for rx_total_subframe, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/rx_total_subframe (oc-yang:counter64)
  ...
  def _set_rx_total_subframe(self, v, load=False):
    """
    Setter method for rx_total_subframe, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/rx_total_subframe (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
802.11n MCS 20 = 802.11ac MCS 4.
  ...
  def _get_tx_total_frames(self):
    """
    Getter method for tx_total_frames, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/tx_total_frames (oc-yang:counter64)
  ...
  def _set_tx_total_frames(self, v, load=False):
    """
    Setter method for tx_total_frames, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/tx_total_frames (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
set.
  ...
  def _get_tx_total_data(self):
    """
    Getter method for tx_total_data, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/tx_total_data (oc-yang:counter64)
  ...
  def _set_tx_total_data(self, v, load=False):
    """
    Setter method for tx_total_data, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/tx_total_data (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
and require retransmission.
  ...
  def _get_tx_total_subframe(self):
    """
    Getter method for tx_total_subframe, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/tx_total_subframe (oc-yang:counter64)
  ...
  def _set_tx_total_subframe(self, v, load=False):
    """
    Setter method for tx_total_subframe, mapped from YANG variable /access_points/access_point/ssids/ssid/bssids/bssid/state/counters/tx_total_subframe (oc-yang:counter64)
    If this variable is read-only (config: false) in the
