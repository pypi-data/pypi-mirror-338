...
class selectors(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/system/logging/files/file/selectors. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'system', 'logging', 'files', 'file', 'selectors']

  def _get_selector(self):
    """
    Getter method for selector, mapped from YANG variable /access_points/access_point/system/logging/files/file/selectors/selector (list)
  ...
  def _set_selector(self, v, load=False):
    """
    Setter method for selector, mapped from YANG variable /access_points/access_point/system/logging/files/file/selectors/selector (list)
