...
class config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__tls_profile_id = YANGDynClass(base=str, is_leaf=True, yang_name="tls-profile-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=True)
  ...
  def _get_network_instance(self):
    """
    Getter method for network_instance, mapped from YANG variable /access_points/access_point/system/logging/remote_servers/remote_server/config/network_instance (oc-ni:network-instance-ref)
...
instance is specified, DEFAULT_INSTANCE is used.
  ...
  def _set_network_instance(self, v, load=False):
    """
    Setter method for network_instance, mapped from YANG variable /access_points/access_point/system/logging/remote_servers/remote_server/config/network_instance (oc-ni:network-instance-ref)
    If this variable is read-only (config: false) in the
...
the server.  The default for syslog is 514.
  ...
  def _get_transport_security(self):
    """
    Getter method for transport_security, mapped from YANG variable /access_points/access_point/system/logging/remote_servers/remote_server/config/transport_security (boolean)
  ...
  def _set_transport_security(self, v, load=False):
    """
    Setter method for transport_security, mapped from YANG variable /access_points/access_point/system/logging/remote_servers/remote_server/config/transport_security (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_tls_profile_id(self):
    """
    Getter method for tls_profile_id, mapped from YANG variable /access_points/access_point/system/logging/remote_servers/remote_server/config/tls_profile_id (string)
...
provided by the system.
  ...
  def _set_tls_profile_id(self, v, load=False):
    """
    Setter method for tls_profile_id, mapped from YANG variable /access_points/access_point/system/logging/remote_servers/remote_server/config/tls_profile_id (string)
    If this variable is read-only (config: false) in the
...
provided by the system.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="tls-profile-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """tls_profile_id must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="tls-profile-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=True)""",
        })
  ...
  tls_profile_id = __builtin__.property(_get_tls_profile_id, _set_tls_profile_id)
