...
class state(PybindBase):
  ...
  def _get_counters(self):
    """
    Getter method for counters, mapped from YANG variable /access_points/access_point/system/memory/state/counters (container)
  ...
  def _set_counters(self, v, load=False):
    """
    Setter method for counters, mapped from YANG variable /access_points/access_point/system/memory/state/counters (container)
...
system.
  ...
  def _get_used(self):
    """
    Getter method for used, mapped from YANG variable /access_points/access_point/system/memory/state/used (uint64)
  ...
  def _set_used(self, v, load=False):
    """
    Setter method for used, mapped from YANG variable /access_points/access_point/system/memory/state/used (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_free(self):
    """
    Getter method for free, mapped from YANG variable /access_points/access_point/system/memory/state/free (uint64)
  ...
  def _set_free(self, v, load=False):
    """
    Setter method for free, mapped from YANG variable /access_points/access_point/system/memory/state/free (uint64)
    If this variable is read-only (config: false) in the
