...
class config(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/utilization/resources/resource/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Configuration data for resource utilization.
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'utilization', 'resources', 'resource', 'config']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /system/utilization/resources/resource/config/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /system/utilization/resources/resource/config/name (string)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system-utilization', defining_module='openconfig-system-utilization', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system-utilization', defining_module='openconfig-system-utilization', yang_type='string', is_config=True)""",
        })
  ...
  def _get_used_threshold_upper(self):
    """
    Getter method for used_threshold_upper, mapped from YANG variable /system/utilization/resources/resource/config/used_threshold_upper (oc-types:percentage)
...
when crossed will set utilization-threshold-exceeded to 'true'.
  ...
  def _set_used_threshold_upper(self, v, load=False):
    """
    Setter method for used_threshold_upper, mapped from YANG variable /system/utilization/resources/resource/config/used_threshold_upper (oc-types:percentage)
    If this variable is read-only (config: false) in the
...
when crossed will set utilization-threshold-exceeded to 'true'.
  ...
  def _get_used_threshold_upper_clear(self):
    """
    Getter method for used_threshold_upper_clear, mapped from YANG variable /system/utilization/resources/resource/config/used_threshold_upper_clear (oc-types:percentage)
...
crossed will set utilization-threshold-exceeded to 'false'.
  ...
  def _set_used_threshold_upper_clear(self, v, load=False):
    """
    Setter method for used_threshold_upper_clear, mapped from YANG variable /system/utilization/resources/resource/config/used_threshold_upper_clear (oc-types:percentage)
    If this variable is read-only (config: false) in the
