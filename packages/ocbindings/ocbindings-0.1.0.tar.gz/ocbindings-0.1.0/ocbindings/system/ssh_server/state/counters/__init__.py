...
class counters(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/ssh-server/state/counters. Each member element of
...
accessing the target.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'ssh-server', 'state', 'counters']

  def _get_access_rejects(self):
    """
    Getter method for access_rejects, mapped from YANG variable /system/ssh_server/state/counters/access_rejects (oc-yang:counter64)

    YANG Description: The total number of times access to the target has been
denied.
    """
  ...
  def _set_access_rejects(self, v, load=False):
    """
    Setter method for access_rejects, mapped from YANG variable /system/ssh_server/state/counters/access_rejects (oc-yang:counter64)
...
denied.
  ...
  def _get_last_access_reject(self):
    """
    Getter method for last_access_reject, mapped from YANG variable /system/ssh_server/state/counters/last_access_reject (oc-types:timeticks64)

    YANG Description: A timestamp of the last time access to the target has been
denied.
    """
  ...
  def _set_last_access_reject(self, v, load=False):
    """
    Setter method for last_access_reject, mapped from YANG variable /system/ssh_server/state/counters/last_access_reject (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
...
denied.
  ...
  def _get_access_accepts(self):
    """
    Getter method for access_accepts, mapped from YANG variable /system/ssh_server/state/counters/access_accepts (oc-yang:counter64)
...
allowed.
  ...
  def _set_access_accepts(self, v, load=False):
    """
    Setter method for access_accepts, mapped from YANG variable /system/ssh_server/state/counters/access_accepts (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
allowed.
  ...
  def _get_last_access_accept(self):
    """
    Getter method for last_access_accept, mapped from YANG variable /system/ssh_server/state/counters/last_access_accept (oc-types:timeticks64)
...
allowed.
  ...
  def _set_last_access_accept(self, v, load=False):
    """
    Setter method for last_access_accept, mapped from YANG variable /system/ssh_server/state/counters/last_access_accept (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
