...
class state(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/logging/files/file/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'logging', 'files', 'file', 'state']

  def _get_filename_prefix(self):
    """
    Getter method for filename_prefix, mapped from YANG variable /system/logging/files/file/state/filename_prefix (string)
...
other identifier to the filename.
  ...
  def _set_filename_prefix(self, v, load=False):
    """
    Setter method for filename_prefix, mapped from YANG variable /system/logging/files/file/state/filename_prefix (string)
...
other identifier to the filename.
  ...
  def _get_path(self):
    """
    Getter method for path, mapped from YANG variable /system/logging/files/file/state/path (string)
...
and may include attributes such as a drive identifier.
  ...
  def _set_path(self, v, load=False):
    """
    Setter method for path, mapped from YANG variable /system/logging/files/file/state/path (string)
    If this variable is read-only (config: false) in the
...
and may include attributes such as a drive identifier.
  ...
  def _get_rotate(self):
    """
    Getter method for rotate, mapped from YANG variable /system/logging/files/file/state/rotate (uint32)
...
old versions are removed rather than rotated.
  ...
  def _set_rotate(self, v, load=False):
    """
    Setter method for rotate, mapped from YANG variable /system/logging/files/file/state/rotate (uint32)
    If this variable is read-only (config: false) in the
...
old versions are removed rather than rotated.
  ...
  def _get_max_size(self):
    """
    Getter method for max_size, mapped from YANG variable /system/logging/files/file/state/max_size (uint32)
...
If needed oldest logfile of same prefix shall be deleted to
  ...
  def _set_max_size(self, v, load=False):
    """
    Setter method for max_size, mapped from YANG variable /system/logging/files/file/state/max_size (uint32)
    If this variable is read-only (config: false) in the
...
If needed oldest logfile of same prefix shall be deleted to
  ...
  def _get_max_open_time(self):
    """
    Getter method for max_open_time, mapped from YANG variable /system/logging/files/file/state/max_open_time (uint32)
...
deleted to 
  ...
  def _set_max_open_time(self, v, load=False):
    """
    Setter method for max_open_time, mapped from YANG variable /system/logging/files/file/state/max_open_time (uint32)
    If this variable is read-only (config: false) in the
...
deleted to 
  ...
  def _get_open_logfile(self):
    """
    Getter method for open_logfile, mapped from YANG variable /system/logging/files/file/state/open_logfile (string)
...
and including suffix appended to filename-prefix by system
  ...
  def _set_open_logfile(self, v, load=False):
    """
    Setter method for open_logfile, mapped from YANG variable /system/logging/files/file/state/open_logfile (string)
    If this variable is read-only (config: false) in the
