...
class vty(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/logging/vty. Each member element of
...
logging (active sessions of ssh, telnet, etc )
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'logging', 'vty']

  def _get_selectors(self):
    """
    Getter method for selectors, mapped from YANG variable /system/logging/vty/selectors (container)
  ...
  def _set_selectors(self, v, load=False):
    """
    Setter method for selectors, mapped from YANG variable /system/logging/vty/selectors (container)
