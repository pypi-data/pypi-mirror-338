...
class ipv6(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/hashing/hashing-policies/hashing-policy/hash-field-modes/ipv6. Each member element of
...
compute the hash.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'hashing', 'hashing-policies', 'hashing-policy', 'hash-field-modes', 'ipv6']

  def _get_config(self):
    """
    Getter method for config, mapped from YANG variable /system/hashing/hashing_policies/hashing_policy/hash_field_modes/ipv6/config (container)
...
inputs level for IPv6.
  ...
  def _set_config(self, v, load=False):
    """
    Setter method for config, mapped from YANG variable /system/hashing/hashing_policies/hashing_policy/hash_field_modes/ipv6/config (container)
...
inputs level for IPv6.
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /system/hashing/hashing_policies/hashing_policy/hash_field_modes/ipv6/state (container)
...
inputs level for IPv6.
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /system/hashing/hashing_policies/hashing_policy/hash_field_modes/ipv6/state (container)
    If this variable is read-only (config: false) in the
