...
class state(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/control-plane-traffic/ingress/qos/classifier/terms/term/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state parameters relating to a term within
the applied control-plane classifier
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__id = YANGDynClass(base=str, is_leaf=True, yang_name="id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system-controlplane', defining_module='openconfig-system-controlplane', yang_type='leafref', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'control-plane-traffic', 'ingress', 'qos', 'classifier', 'terms', 'term', 'state']

  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /system/control_plane_traffic/ingress/qos/classifier/terms/term/state/id (leafref)

    YANG Description: Reference to a term identifier within the configured control-plane
classifier.
    """
    return self.__id
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /system/control_plane_traffic/ingress/qos/classifier/terms/term/state/id (leafref)
...
classifier.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system-controlplane', defining_module='openconfig-system-controlplane', yang_type='leafref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """id must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system-controlplane', defining_module='openconfig-system-controlplane', yang_type='leafref', is_config=False)""",
        })
  ...
  def _get_matched_packets(self):
    """
    Getter method for matched_packets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/classifier/terms/term/state/matched_packets (oc-yang:counter64)
...
match term on the interface.
  ...
  def _set_matched_packets(self, v, load=False):
    """
    Setter method for matched_packets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/classifier/terms/term/state/matched_packets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
match term on the interface.
  ...
  def _get_matched_octets(self):
    """
    Getter method for matched_octets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/classifier/terms/term/state/matched_octets (oc-yang:counter64)
...
classifier match term on the interface.
  ...
  def _set_matched_octets(self, v, load=False):
    """
    Setter method for matched_octets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/classifier/terms/term/state/matched_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
