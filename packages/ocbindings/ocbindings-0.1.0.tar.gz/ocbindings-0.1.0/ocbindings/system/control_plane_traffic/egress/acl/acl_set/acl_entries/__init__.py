...
class acl_entries(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/control-plane-traffic/egress/acl/acl-set/acl-entries. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'control-plane-traffic', 'egress', 'acl', 'acl-set', 'acl-entries']

  def _get_acl_entry(self):
    """
    Getter method for acl_entry, mapped from YANG variable /system/control_plane_traffic/egress/acl/acl_set/acl_entries/acl_entry (list)
  ...
  def _set_acl_entry(self, v, load=False):
    """
    Setter method for acl_entry, mapped from YANG variable /system/control_plane_traffic/egress/acl/acl_set/acl_entries/acl_entry (list)
