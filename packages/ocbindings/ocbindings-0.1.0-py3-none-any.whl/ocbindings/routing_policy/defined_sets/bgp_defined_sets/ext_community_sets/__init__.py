...
sets
  """
  __slots__ = ('_path_helper', '_extmethods', '__ext_community_set',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['routing-policy', 'defined-sets', 'bgp-defined-sets', 'ext-community-sets']
  ...
  _pyangbind_elements = OrderedDict([('ext_community_set', ext_community_set), ])
