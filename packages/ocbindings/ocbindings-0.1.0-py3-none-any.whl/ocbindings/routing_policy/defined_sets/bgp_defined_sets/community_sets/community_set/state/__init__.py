...
class state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__community_set_name = YANGDynClass(base=str, is_leaf=True, yang_name="community-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='string', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['routing-policy', 'defined-sets', 'bgp-defined-sets', 'community-sets', 'community-set', 'state']
...
reference the set in match conditions
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="community-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """community_set_name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="community-set-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/bgp-policy', defining_module='openconfig-bgp-policy', yang_type='string', is_config=False)""",
        })
...
`1000:1000` for a standard community
  ...
  def _get_match_set_options(self):
    """
    Getter method for match_set_options, mapped from YANG variable /routing_policy/defined_sets/bgp_defined_sets/community_sets/community_set/state/match_set_options (oc-pol-types:match-set-options-type)
...
match operation
  ...
  def _set_match_set_options(self, v, load=False):
    """
    Setter method for match_set_options, mapped from YANG variable /routing_policy/defined_sets/bgp_defined_sets/community_sets/community_set/state/match_set_options (oc-pol-types:match-set-options-type)
    If this variable is read-only (config: false) in the
...
match operation
  ...
  community_set_name = __builtin__.property(_get_community_set_name)
  community_member = __builtin__.property(_get_community_member)
