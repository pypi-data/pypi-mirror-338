...
class state(PybindBase):
  ...
  from YANG module openconfig-routing-policy - based on the path /routing-policy/policy-definitions/policy-definition/statements/statement/conditions/bgp-conditions/match-community-set/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state data for match conditions on community set
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['routing-policy', 'policy-definitions', 'policy-definition', 'statements', 'statement', 'conditions', 'bgp-conditions', 'match-community-set', 'state']

  def _get_community_set(self):
    """
    Getter method for community_set, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/match_community_set/state/community_set (leafref)
  ...
  def _set_community_set(self, v, load=False):
    """
    Setter method for community_set, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/match_community_set/state/community_set (leafref)
  ...
  def _get_match_set_options(self):
    """
    Getter method for match_set_options, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/match_community_set/state/match_set_options (oc-pol-types:match-set-options-type)
...
match operation
  ...
  def _set_match_set_options(self, v, load=False):
    """
    Setter method for match_set_options, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/bgp_conditions/match_community_set/state/match_set_options (oc-pol-types:match-set-options-type)
    If this variable is read-only (config: false) in the
