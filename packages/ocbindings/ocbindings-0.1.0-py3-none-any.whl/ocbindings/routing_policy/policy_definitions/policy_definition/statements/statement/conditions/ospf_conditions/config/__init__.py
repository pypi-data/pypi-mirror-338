...
class config(PybindBase):
  ...
  from YANG module openconfig-routing-policy - based on the path /routing-policy/policy-definitions/policy-definition/statements/statement/conditions/ospf-conditions/config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['routing-policy', 'policy-definitions', 'policy-definition', 'statements', 'statement', 'conditions', 'ospf-conditions', 'config']

  def _get_area_eq(self):
    """
    Getter method for area_eq, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/ospf_conditions/config/area_eq (oc-ospf-types:ospf-area-identifier)
  ...
  def _set_area_eq(self, v, load=False):
    """
    Setter method for area_eq, mapped from YANG variable /routing_policy/policy_definitions/policy_definition/statements/statement/conditions/ospf_conditions/config/area_eq (oc-ospf-types:ospf-area-identifier)
  ...
  area_eq = __builtin__.property(_get_area_eq, _set_area_eq)
