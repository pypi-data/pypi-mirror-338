...
class drop(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__state','__interface_block','__lookup_block','__queueing_block','__fabric_block','__host_interface_block',)
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/drop/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /components/component/integrated_circuit/pipeline_counters/drop/state (container)
...
external systems host or control subsystem
  ...
  _pyangbind_elements = OrderedDict([('state', state), ('interface_block', interface_block), ('lookup_block', lookup_block), ('queueing_block', queueing_block), ('fabric_block', fabric_block), ('host_interface_block', host_interface_block), ])
