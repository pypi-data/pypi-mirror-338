...
from . import config
from . import state
class controller_card(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform - based on the path /components/component/controller-card. Each member element of
...
with type=CONTROLLER_CARD
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'controller-card']

  def _get_config(self):
    """
    Getter method for config, mapped from YANG variable /components/component/controller_card/config (container)
  ...
  def _set_config(self, v, load=False):
    """
    Setter method for config, mapped from YANG variable /components/component/controller_card/config (container)
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /components/component/controller_card/state (container)

    YANG Description: Operational state data for controller card components
    """
    return self.__state
      
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /components/component/controller_card/state (container)
    If this variable is read-only (config: false) in the
...
class controller_card(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/controller-card. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
