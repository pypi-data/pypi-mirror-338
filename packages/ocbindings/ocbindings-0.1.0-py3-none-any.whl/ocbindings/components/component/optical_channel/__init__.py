...
from . import config
from . import state
class optical_channel(PybindBase):
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'optical-channel']
...
class optical_channel(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/optical-channel. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
