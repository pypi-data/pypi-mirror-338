...
optical-channel
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'optical-channel', 'state', 'output-power']
...
class output_power(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/optical-channel/state/output-power. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
