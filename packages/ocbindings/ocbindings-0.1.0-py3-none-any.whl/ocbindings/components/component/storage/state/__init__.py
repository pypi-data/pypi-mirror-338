...
class state(PybindBase):
  ...
  from YANG module openconfig-platform - based on the path /components/component/storage/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state data for storage components
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'storage', 'state']

  def _get_counters(self):
    """
    Getter method for counters, mapped from YANG variable /components/component/storage/state/counters (container)
  ...
  def _set_counters(self, v, load=False):
    """
    Setter method for counters, mapped from YANG variable /components/component/storage/state/counters (container)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/storage/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
