...
class config(PybindBase):
  ...
  from YANG module openconfig-platform - based on the path /components/component/port/optical-port/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational config data for optical ports
  """
  __slots__ = ('_path_helper', '_extmethods', '__admin_state',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'port', 'optical-port', 'config']

  def _get_admin_state(self):
    """
    Getter method for admin_state, mapped from YANG variable /components/component/port/optical_port/config/admin_state (oc-opt-types:admin-state-type)
  ...
  def _set_admin_state(self, v, load=False):
    """
    Setter method for admin_state, mapped from YANG variable /components/component/port/optical_port/config/admin_state (oc-opt-types:admin-state-type)
  ...
  _pyangbind_elements = OrderedDict([('admin_state', admin_state), ])


class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-platform-common - based on the path /components/component/port/optical-port/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
