...
class config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__name = YANGDynClass(base=str, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wavelength-router', defining_module='openconfig-wavelength-router', yang_type='string', is_config=True)
  ...
  def _set_name(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wavelength-router', defining_module='openconfig-wavelength-router', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wavelength-router', defining_module='openconfig-wavelength-router', yang_type='string', is_config=True)""",
        })
...
would specify the index of the super channel parent
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="super-channel-parent", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wavelength-router', defining_module='openconfig-wavelength-router', yang_type='leafref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
...
is configured
  ...
  def _get_media_channel_injection_offset(self):
    """
    Getter method for media_channel_injection_offset, mapped from YANG variable /wavelength_router/media_channels/channel/config/media_channel_injection_offset (decimal64)
...
configured
  ...
  def _set_media_channel_injection_offset(self, v, load=False):
    """
    Setter method for media_channel_injection_offset, mapped from YANG variable /wavelength_router/media_channels/channel/config/media_channel_injection_offset (decimal64)
    If this variable is read-only (config: false) in the
...
across a media channel is set
  ...
  def _get_attenuation_control_range(self):
    """
    Getter method for attenuation_control_range, mapped from YANG variable /wavelength_router/media_channels/channel/config/attenuation_control_range (identityref)
...
port spectrum power profile
  ...
  def _set_attenuation_control_range(self, v, load=False):
    """
    Setter method for attenuation_control_range, mapped from YANG variable /wavelength_router/media_channels/channel/config/attenuation_control_range (identityref)
    If this variable is read-only (config: false) in the
...
port spectrum power profile
  ...
  def _get_max_undershoot_compensation(self):
    """
    Getter method for max_undershoot_compensation, mapped from YANG variable /wavelength_router/media_channels/channel/config/max_undershoot_compensation (decimal64)
...
established for an individual media-channel
  ...
  def _set_max_undershoot_compensation(self, v, load=False):
    """
    Setter method for max_undershoot_compensation, mapped from YANG variable /wavelength_router/media_channels/channel/config/max_undershoot_compensation (decimal64)
    If this variable is read-only (config: false) in the
...
established for an individual media-channel
  ...
  def _get_max_overshoot_compensation(self):
    """
    Getter method for max_overshoot_compensation, mapped from YANG variable /wavelength_router/media_channels/channel/config/max_overshoot_compensation (decimal64)
...
established for an individual media-channel
  ...
  def _set_max_overshoot_compensation(self, v, load=False):
    """
    Setter method for max_overshoot_compensation, mapped from YANG variable /wavelength_router/media_channels/channel/config/max_overshoot_compensation (decimal64)
    If this variable is read-only (config: false) in the
