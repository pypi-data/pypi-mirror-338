...
class config(PybindBase):
  ...
  from YANG module openconfig-interfaces - based on the path /interfaces/interface/penalty-based-aied/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Configuration data for link damping settings.
  """
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['interfaces', 'interface', 'penalty-based-aied', 'config']

  def _get_max_suppress_time(self):
    """
    Getter method for max_suppress_time, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/max_suppress_time (uint32)
  ...
  def _set_max_suppress_time(self, v, load=False):
    """
    Setter method for max_suppress_time, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/max_suppress_time (uint32)
  ...
  def _get_decay_half_life(self):
    """
    Getter method for decay_half_life, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/decay_half_life (uint32)
  ...
  def _set_decay_half_life(self, v, load=False):
    """
    Setter method for decay_half_life, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/decay_half_life (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_suppress_threshold(self):
    """
    Getter method for suppress_threshold, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/suppress_threshold (uint32)
  ...
  def _set_suppress_threshold(self, v, load=False):
    """
    Setter method for suppress_threshold, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/suppress_threshold (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_reuse_threshold(self):
    """
    Getter method for reuse_threshold, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/reuse_threshold (uint32)
  ...
  def _set_reuse_threshold(self, v, load=False):
    """
    Setter method for reuse_threshold, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/reuse_threshold (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_flap_penalty(self):
    """
    Getter method for flap_penalty, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/flap_penalty (uint32)
  ...
  def _set_flap_penalty(self, v, load=False):
    """
    Setter method for flap_penalty, mapped from YANG variable /interfaces/interface/penalty_based_aied/config/flap_penalty (uint32)
    If this variable is read-only (config: false) in the
  ...
  flap_penalty = __builtin__.property(_get_flap_penalty, _set_flap_penalty)
