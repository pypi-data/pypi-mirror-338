...
for IPv6.
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /interfaces/interface/tunnel/ipv6/router_advertisement/config/enable (boolean)
...
messages and will not respond to router solicitation messages.
  ...
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /interfaces/interface/tunnel/ipv6/router_advertisement/config/enable (boolean)
...
messages and will not respond to router solicitation messages.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, default=YANGBool("true"), is_leaf=True, yang_name="enable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/tunnel', defining_module='openconfig-if-tunnel', yang_type='boolean', is_config=True)
...
messages are not transmitted on this interface.
  ...
  def _get_mode(self):
    """
    Getter method for mode, mapped from YANG variable /interfaces/interface/tunnel/ipv6/router_advertisement/config/mode (enumeration)
...
to support IPv6 router advertisements.
  ...
  def _set_mode(self, v, load=False):
    """
    Setter method for mode, mapped from YANG variable /interfaces/interface/tunnel/ipv6/router_advertisement/config/mode (enumeration)
    If this variable is read-only (config: false) in the
