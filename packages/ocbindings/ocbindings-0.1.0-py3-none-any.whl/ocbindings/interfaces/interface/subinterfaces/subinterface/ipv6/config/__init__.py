...
transmission with no follow-up retransmissions.
  ...
  def _get_learn_unsolicited(self):
    """
    Getter method for learn_unsolicited, mapped from YANG variable /interfaces/interface/subinterfaces/subinterface/ipv6/config/learn_unsolicited (enumeration)
...
advertisements for global or link local addresses or both.
  ...
  def _set_learn_unsolicited(self, v, load=False):
    """
    Setter method for learn_unsolicited, mapped from YANG variable /interfaces/interface/subinterfaces/subinterface/ipv6/config/learn_unsolicited (enumeration)
    If this variable is read-only (config: false) in the
