...
class connections(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/openflow/controllers/controller/connections. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__connection = YANGDynClass(base=YANGListType("aux_id",connection.connection, yang_name="connection", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='aux-id', extensions=None), is_container='list', yang_name="connection", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/openflow', defining_module='openconfig-openflow', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'openflow', 'controllers', 'controller', 'connections']

  def _get_connection(self):
    """
    Getter method for connection, mapped from YANG variable /system/openflow/controllers/controller/connections/connection (list)
...
connection, called auxiliary Openflow connections.
  ...
  def _set_connection(self, v, load=False):
    """
    Setter method for connection, mapped from YANG variable /system/openflow/controllers/controller/connections/connection (list)
