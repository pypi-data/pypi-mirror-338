...
long = int
class writes(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-system - based on the path /system/grpc-servers/grpc-server/gnmi-pathz-policy-counters/paths/path/state/writes. Each member element of
...
schema path.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'grpc-servers', 'grpc-server', 'gnmi-pathz-policy-counters', 'paths', 'path', 'state', 'writes']

  def _get_access_rejects(self):
    """
    Getter method for access_rejects, mapped from YANG variable /system/grpc_servers/grpc_server/gnmi_pathz_policy_counters/paths/path/state/writes/access_rejects (oc-yang:counter64)
...
to an OpenConfig path.
  ...
  def _set_access_rejects(self, v, load=False):
    """
    Setter method for access_rejects, mapped from YANG variable /system/grpc_servers/grpc_server/gnmi_pathz_policy_counters/paths/path/state/writes/access_rejects (oc-yang:counter64)
...
to an OpenConfig path.
  ...
  def _get_last_access_reject(self):
    """
    Getter method for last_access_reject, mapped from YANG variable /system/grpc_servers/grpc_server/gnmi_pathz_policy_counters/paths/path/state/writes/last_access_reject (oc-types:timeticks64)
...
an OpenConfig path
  ...
  def _set_last_access_reject(self, v, load=False):
    """
    Setter method for last_access_reject, mapped from YANG variable /system/grpc_servers/grpc_server/gnmi_pathz_policy_counters/paths/path/state/writes/last_access_reject (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
...
an OpenConfig path
  ...
  def _get_access_accepts(self):
    """
    Getter method for access_accepts, mapped from YANG variable /system/grpc_servers/grpc_server/gnmi_pathz_policy_counters/paths/path/state/writes/access_accepts (oc-yang:counter64)
...
to an OpenConfig path.
  ...
  def _set_access_accepts(self, v, load=False):
    """
    Setter method for access_accepts, mapped from YANG variable /system/grpc_servers/grpc_server/gnmi_pathz_policy_counters/paths/path/state/writes/access_accepts (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
to an OpenConfig path.
  ...
  def _get_last_access_accept(self):
    """
    Getter method for last_access_accept, mapped from YANG variable /system/grpc_servers/grpc_server/gnmi_pathz_policy_counters/paths/path/state/writes/last_access_accept (oc-types:timeticks64)
...
an OpenConfig path
  ...
  def _set_last_access_accept(self, v, load=False):
    """
    Setter method for last_access_accept, mapped from YANG variable /system/grpc_servers/grpc_server/gnmi_pathz_policy_counters/paths/path/state/writes/last_access_accept (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
