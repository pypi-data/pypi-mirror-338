...
class state(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/grpc-servers/grpc-server/acctz/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'grpc-servers', 'grpc-server', 'acctz', 'state']

  def _get_counters(self):
    """
    Getter method for counters, mapped from YANG variable /system/grpc_servers/grpc_server/acctz/state/counters (container)
...
module while servicing acctz clients.
  ...
  def _set_counters(self, v, load=False):
    """
    Setter method for counters, mapped from YANG variable /system/grpc_servers/grpc_server/acctz/state/counters (container)
