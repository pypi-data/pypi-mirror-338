...
class selectors(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/logging/vty/selectors. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'logging', 'vty', 'selectors']

  def _get_selector(self):
    """
    Getter method for selector, mapped from YANG variable /system/logging/vty/selectors/selector (list)
  ...
  def _set_selector(self, v, load=False):
    """
    Setter method for selector, mapped from YANG variable /system/logging/vty/selectors/selector (list)
