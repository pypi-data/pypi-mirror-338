...
class acl(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/control-plane-traffic/egress/acl. Each member element of
...
access control list applied to control-plane traffic.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'control-plane-traffic', 'egress', 'acl']

  def _get_acl_set(self):
    """
    Getter method for acl_set, mapped from YANG variable /system/control_plane_traffic/egress/acl/acl_set (list)
...
configured in the OpenConfig ACL model within the /acl hierarchy.
  ...
  def _set_acl_set(self, v, load=False):
    """
    Setter method for acl_set, mapped from YANG variable /system/control_plane_traffic/egress/acl/acl_set (list)
