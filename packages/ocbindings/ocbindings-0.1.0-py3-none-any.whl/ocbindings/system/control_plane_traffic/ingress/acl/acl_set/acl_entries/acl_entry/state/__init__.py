...
class state(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/control-plane-traffic/ingress/acl/acl-set/acl-entries/acl-entry/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'control-plane-traffic', 'ingress', 'acl', 'acl-set', 'acl-entries', 'acl-entry', 'state']

  def _get_sequence_id(self):
    """
    Getter method for sequence_id, mapped from YANG variable /system/control_plane_traffic/ingress/acl/acl_set/acl_entries/acl_entry/state/sequence_id (leafref)
...
interface
  ...
  def _set_sequence_id(self, v, load=False):
    """
    Setter method for sequence_id, mapped from YANG variable /system/control_plane_traffic/ingress/acl/acl_set/acl_entries/acl_entry/state/sequence_id (leafref)
...
interface
  ...
  def _get_matched_packets(self):
    """
    Getter method for matched_packets, mapped from YANG variable /system/control_plane_traffic/ingress/acl/acl_set/acl_entries/acl_entry/state/matched_packets (oc-yang:counter64)
...
the required aggregation if such a count is needed.
  ...
  def _set_matched_packets(self, v, load=False):
    """
    Setter method for matched_packets, mapped from YANG variable /system/control_plane_traffic/ingress/acl/acl_set/acl_entries/acl_entry/state/matched_packets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
the required aggregation if such a count is needed.
  ...
  def _get_matched_octets(self):
    """
    Getter method for matched_octets, mapped from YANG variable /system/control_plane_traffic/ingress/acl/acl_set/acl_entries/acl_entry/state/matched_octets (oc-yang:counter64)
...
the required aggregation if such a count is needed.
  ...
  def _set_matched_octets(self, v, load=False):
    """
    Setter method for matched_octets, mapped from YANG variable /system/control_plane_traffic/ingress/acl/acl_set/acl_entries/acl_entry/state/matched_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
