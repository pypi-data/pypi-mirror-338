...
class terms(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/control-plane-traffic/ingress/qos/classifier/terms. Each member element of
...
applied to control-plane traffic.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'control-plane-traffic', 'ingress', 'qos', 'classifier', 'terms']

  def _get_term(self):
    """
    Getter method for term, mapped from YANG variable /system/control_plane_traffic/ingress/qos/classifier/terms/term (list)
...
corresponding operational state parameters.
  ...
  def _set_term(self, v, load=False):
    """
    Setter method for term, mapped from YANG variable /system/control_plane_traffic/ingress/qos/classifier/terms/term (list)
...
corresponding operational state parameters.
  ...
  term = __builtin__.property(_get_term)
