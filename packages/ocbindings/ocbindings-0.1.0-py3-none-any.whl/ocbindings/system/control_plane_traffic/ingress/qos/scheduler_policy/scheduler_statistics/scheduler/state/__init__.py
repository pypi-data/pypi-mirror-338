...
class state(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/control-plane-traffic/ingress/qos/scheduler-policy/scheduler-statistics/scheduler/state. Each member element of
...
policy.
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__sequence = YANGDynClass(base=str, is_leaf=True, yang_name="sequence", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system-controlplane', defining_module='openconfig-system-controlplane', yang_type='leafref', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'control-plane-traffic', 'ingress', 'qos', 'scheduler-policy', 'scheduler-statistics', 'scheduler', 'state']

  def _get_sequence(self):
    """
    Getter method for sequence, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/sequence (leafref)

    YANG Description: Reference to a scheduler within the configured scheduler policy.
    """
    return self.__sequence
      
  def _set_sequence(self, v, load=False):
    """
    Setter method for sequence, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/sequence (leafref)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="sequence", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system-controlplane', defining_module='openconfig-system-controlplane', yang_type='leafref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """sequence must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="sequence", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system-controlplane', defining_module='openconfig-system-controlplane', yang_type='leafref', is_config=False)""",
        })
  ...
  def _get_conforming_pkts(self):
    """
    Getter method for conforming_pkts, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/conforming_pkts (oc-yang:counter64)
...
the scheduler.
  ...
  def _set_conforming_pkts(self, v, load=False):
    """
    Setter method for conforming_pkts, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/conforming_pkts (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
the scheduler.
  ...
  def _get_conforming_octets(self):
    """
    Getter method for conforming_octets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/conforming_octets (oc-yang:counter64)
...
conforming by the scheduler.
  ...
  def _set_conforming_octets(self, v, load=False):
    """
    Setter method for conforming_octets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/conforming_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
conforming by the scheduler.
  ...
  def _get_exceeding_pkts(self):
    """
    Getter method for exceeding_pkts, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/exceeding_pkts (oc-yang:counter64)
...
the scheduler.
  ...
  def _set_exceeding_pkts(self, v, load=False):
    """
    Setter method for exceeding_pkts, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/exceeding_pkts (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
the scheduler.
  ...
  def _get_exceeding_octets(self):
    """
    Getter method for exceeding_octets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/exceeding_octets (oc-yang:counter64)
...
exceeding by the scheduler.
  ...
  def _set_exceeding_octets(self, v, load=False):
    """
    Setter method for exceeding_octets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/exceeding_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
exceeding by the scheduler.
  ...
  def _get_violating_pkts(self):
    """
    Getter method for violating_pkts, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/violating_pkts (oc-yang:counter64)
...
the policer.
  ...
  def _set_violating_pkts(self, v, load=False):
    """
    Setter method for violating_pkts, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/violating_pkts (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
the policer.
  ...
  def _get_violating_octets(self):
    """
    Getter method for violating_octets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/violating_octets (oc-yang:counter64)
...
violating by the policer.
  ...
  def _set_violating_octets(self, v, load=False):
    """
    Setter method for violating_octets, mapped from YANG variable /system/control_plane_traffic/ingress/qos/scheduler_policy/scheduler_statistics/scheduler/state/violating_octets (oc-yang:counter64)
    If this variable is read-only (config: false) in the
