...
class utilization(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/utilization. Each member element of
  ...
  def _get_resources(self):
    """
    Getter method for resources, mapped from YANG variable /system/utilization/resources (container)
...
* /components/component/linecard/utilization/resources/resource.
  ...
  def _set_resources(self, v, load=False):
    """
    Setter method for resources, mapped from YANG variable /system/utilization/resources (container)
