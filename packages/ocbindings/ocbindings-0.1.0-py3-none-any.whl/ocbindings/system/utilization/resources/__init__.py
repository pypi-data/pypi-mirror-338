...
class resources(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/utilization/resources. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Enclosing container for the resources in the entire system. The system
...
* /components/component/linecard/utilization/resources/resource.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'utilization', 'resources']

  def _get_resource(self):
    """
    Getter method for resource, mapped from YANG variable /system/utilization/resources/resource (list)
...
resource name.
  ...
  def _set_resource(self, v, load=False):
    """
    Setter method for resource, mapped from YANG variable /system/utilization/resources/resource (list)
