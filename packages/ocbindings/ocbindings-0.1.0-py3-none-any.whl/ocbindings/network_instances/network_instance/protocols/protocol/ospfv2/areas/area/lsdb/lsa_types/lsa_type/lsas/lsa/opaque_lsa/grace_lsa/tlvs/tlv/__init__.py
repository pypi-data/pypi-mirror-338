...
graceful restart
  """
  __slots__ = ('_path_helper', '_extmethods', '__state','__unknown_tlv',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv2', 'areas', 'area', 'lsdb', 'lsa-types', 'lsa-type', 'lsas', 'lsa', 'opaque-lsa', 'grace-lsa', 'tlvs', 'tlv']
...
local system such that it cannot decode their value.
  ...
  _pyangbind_elements = OrderedDict([('state', state), ('unknown_tlv', unknown_tlv), ])
