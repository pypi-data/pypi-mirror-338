...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/ospfv2/global/mpls/state. Each member element of
...
OSPFv2
  """
  __slots__ = ('_path_helper', '_extmethods', '__traffic_engineering_extensions',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv2', 'global', 'mpls', 'state']

  def _get_traffic_engineering_extensions(self):
    """
    Getter method for traffic_engineering_extensions, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv2/global/mpls/state/traffic_engineering_extensions (boolean)
...
Opaque LSAs
  ...
  def _set_traffic_engineering_extensions(self, v, load=False):
    """
    Setter method for traffic_engineering_extensions, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv2/global/mpls/state/traffic_engineering_extensions (boolean)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/ospfv2/global/mpls/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
