...
class config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'global', 'graceful-restart', 'config']
...
default value is <= the hold-time value.
  ...
  def _get_stale_routes_time(self):
    """
    Getter method for stale_routes_time, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/graceful_restart/config/stale_routes_time (uint16)
...
Selection_Deferral_Timer in RFC4724
  ...
  def _set_stale_routes_time(self, v, load=False):
    """
    Setter method for stale_routes_time, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/graceful_restart/config/stale_routes_time (uint16)
    If this variable is read-only (config: false) in the
