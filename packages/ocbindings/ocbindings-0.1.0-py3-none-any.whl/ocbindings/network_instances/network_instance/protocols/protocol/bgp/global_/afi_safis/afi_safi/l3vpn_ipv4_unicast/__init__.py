...
class l3vpn_ipv4_unicast(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'bgp', 'global', 'afi-safis', 'afi-safi', 'l3vpn-ipv4-unicast']
...
accepted from a peer
  ...
  def _get_prefix_limit_received(self):
    """
    Getter method for prefix_limit_received, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/afi_safis/afi_safi/l3vpn_ipv4_unicast/prefix_limit_received (container)
...
received from a peer
  ...
  def _set_prefix_limit_received(self, v, load=False):
    """
    Setter method for prefix_limit_received, mapped from YANG variable /network_instances/network_instance/protocols/protocol/bgp/global/afi_safis/afi_safi/l3vpn_ipv4_unicast/prefix_limit_received (container)
    If this variable is read-only (config: false) in the
