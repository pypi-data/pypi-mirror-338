...
class undefined_tlvs(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__undefined_tlv',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'levels', 'level', 'link-state-database', 'lsp', 'undefined-tlvs']
...
not recognised by the system.
  ...
  _pyangbind_elements = OrderedDict([('undefined_tlv', undefined_tlv), ])
