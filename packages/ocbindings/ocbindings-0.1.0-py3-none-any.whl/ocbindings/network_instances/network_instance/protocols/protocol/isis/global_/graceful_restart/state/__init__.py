...
retaining forwarding information during a remote speaker's restart.
  ...
  def _get_non_planned_only(self):
    """
    Getter method for non_planned_only, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/graceful_restart/state/non_planned_only (boolean)
...
described in RFC 8706 are not used.
  ...
  def _set_non_planned_only(self, v, load=False):
    """
    Setter method for non_planned_only, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/graceful_restart/state/non_planned_only (boolean)
    If this variable is read-only (config: false) in the
...
described in RFC 8706 are not used.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="non-planned-only", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """non_planned_only must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="non-planned-only", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='boolean', is_config=False)""",
        })
  ...
  def _get_restart_time(self):
    """
    Getter method for restart_time, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/graceful_restart/state/restart_time (uint16)
  ...
  def _set_restart_time(self, v, load=False):
    """
    Setter method for restart_time, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/graceful_restart/state/restart_time (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface_timer(self):
    """
    Getter method for interface_timer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/graceful_restart/state/interface_timer (uint16)
  ...
  def _set_interface_timer(self, v, load=False):
    """
    Setter method for interface_timer, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/graceful_restart/state/interface_timer (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface_time_expirations(self):
    """
    Getter method for interface_time_expirations, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/graceful_restart/state/interface_time_expirations (int64)
...
Inermediate System
  ...
  def _set_interface_time_expirations(self, v, load=False):
    """
    Setter method for interface_time_expirations, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/global/graceful_restart/state/interface_time_expirations (int64)
    If this variable is read-only (config: false) in the
...
Inermediate System
  ...
  non_planned_only = __builtin__.property(_get_non_planned_only)
