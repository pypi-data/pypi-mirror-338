...
OSPFv2 extensions related to MPLS on the interface.
  """
  __slots__ = ('_path_helper', '_extmethods', '__config','__state','__igp_ldp_sync',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv2', 'areas', 'area', 'interfaces', 'interface', 'mpls']
...
MPLS for the interface
  ...
  _pyangbind_elements = OrderedDict([('config', config), ('state', state), ('igp_ldp_sync', igp_ldp_sync), ])
