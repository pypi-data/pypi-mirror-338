...
class config(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__level_number','__passive','__priority','__enabled',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'interfaces', 'interface', 'levels', 'level', 'config']
...
defined is enabled, when set to false it is explicitly disabled.
  ...
  _pyangbind_elements = OrderedDict([('level_number', level_number), ('passive', passive), ('priority', priority), ('enabled', enabled), ])
