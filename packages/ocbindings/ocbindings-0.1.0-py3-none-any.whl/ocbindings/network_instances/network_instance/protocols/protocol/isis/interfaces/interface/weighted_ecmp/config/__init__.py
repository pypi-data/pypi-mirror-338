...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/interfaces/interface/weighted-ecmp/config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'interfaces', 'interface', 'weighted-ecmp', 'config']

  def _get_load_balancing_weight(self):
    """
    Getter method for load_balancing_weight, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/weighted_ecmp/config/load_balancing_weight (union)
...
weighted ECMP is enabled and the interface is part of a multipath set.
  ...
  def _set_load_balancing_weight(self, v, load=False):
    """
    Setter method for load_balancing_weight, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/interfaces/interface/weighted_ecmp/config/load_balancing_weight (union)
...
weighted ECMP is enabled and the interface is part of a multipath set.
  ...
  load_balancing_weight = __builtin__.property(_get_load_balancing_weight, _set_load_balancing_weight)
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/interfaces/interface/weighted-ecmp/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
