...
information.
  """
  __slots__ = ('_path_helper', '_extmethods', '__global_','__levels','__interfaces',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis']
...
state information.
  ...
  _pyangbind_elements = OrderedDict([('global_', global_), ('levels', levels), ('interfaces', interfaces), ])
