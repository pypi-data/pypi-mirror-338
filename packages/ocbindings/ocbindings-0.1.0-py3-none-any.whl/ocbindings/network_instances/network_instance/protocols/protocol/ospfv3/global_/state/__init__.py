...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/ospfv3/global/state. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv3', 'global', 'state']

  def _get_router_id(self):
    """
    Getter method for router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/state/router_id (yang:dotted-quad)
...
be unique within the autonomous system
  ...
  def _set_router_id(self, v, load=False):
    """
    Setter method for router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/state/router_id (yang:dotted-quad)
...
be unique within the autonomous system
  ...
  def _get_log_adjacency_changes(self):
    """
    Getter method for log_adjacency_changes, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/state/log_adjacency_changes (boolean)
...
generated when the state of an OSPF neighbour changes.
  ...
  def _set_log_adjacency_changes(self, v, load=False):
    """
    Setter method for log_adjacency_changes, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/state/log_adjacency_changes (boolean)
    If this variable is read-only (config: false) in the
...
generated when the state of an OSPF neighbour changes.
  ...
  def _get_hide_transit_only_networks(self):
    """
    Getter method for hide_transit_only_networks, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/state/hide_transit_only_networks (boolean)
...
the behaviour discussed in RFC6860.
  ...
  def _set_hide_transit_only_networks(self, v, load=False):
    """
    Setter method for hide_transit_only_networks, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/state/hide_transit_only_networks (boolean)
    If this variable is read-only (config: false) in the
...
the behaviour discussed in RFC6860.
  ...
  def _get_abr_capability(self):
    """
    Getter method for abr_capability, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/state/abr_capability (identityref)
...
in multiple OSPF areas, one of which must be backbone.
  ...
  def _set_abr_capability(self, v, load=False):
    """
    Setter method for abr_capability, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv3/global/state/abr_capability (identityref)
    If this variable is read-only (config: false) in the
...
in multiple OSPF areas, one of which must be backbone.
  ...
  abr_capability = __builtin__.property(_get_abr_capability)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/ospfv3/global/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
