...
class state(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__remote_router_id','__priority','__dead_time','__designated_router','__backup_designated_router','__optional_capabilities','__last_established_time','__adjacency_state','__state_changes','__retransmission_queue_length',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'ospfv2', 'areas', 'area', 'virtual-links', 'virtual-link', 'state']
...
neighbor has been through
  ...
  def _get_retransmission_queue_length(self):
    """
    Getter method for retransmission_queue_length, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv2/areas/area/virtual_links/virtual_link/state/retransmission_queue_length (uint32)
...
retransmitted to the neighbor
  ...
  def _set_retransmission_queue_length(self, v, load=False):
    """
    Setter method for retransmission_queue_length, mapped from YANG variable /network_instances/network_instance/protocols/protocol/ospfv2/areas/area/virtual_links/virtual_link/state/retransmission_queue_length (uint32)
    If this variable is read-only (config: false) in the
