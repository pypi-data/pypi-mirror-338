...
long = int
from . import lsp
class link_state_database(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: This container defines ISIS LSDB.
  """
  __slots__ = ('_path_helper', '_extmethods', '__lsp',)

  _yang_name = 'link-state-database'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'protocols', 'protocol', 'isis', 'levels', 'level', 'link-state-database']
  ...
  def _set_lsp(self, v, load=False):
    """
    Setter method for lsp, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp (list)
  ...
  _pyangbind_elements = OrderedDict([('lsp', lsp), ])
...
class link_state_database(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
