...
class state(PybindBase):
  ...
  def _get_esi(self):
    """
    Getter method for esi, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hops/next_hop/state/esi (oc-evpn-types:esi)
  ...
  def _set_esi(self, v, load=False):
    """
    Setter method for esi, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hops/next_hop/state/esi (oc-evpn-types:esi)
    If this variable is read-only (config: false) in the
  ...
  def _get_resolved(self):
    """
    Getter method for resolved, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hops/next_hop/state/resolved (boolean)
...
withdraw procedures as defined in RFC 7432
  ...
  def _set_resolved(self, v, load=False):
    """
    Setter method for resolved, mapped from YANG variable /network_instances/network_instance/fdb/l2rib/mac_table/next_hops/next_hop/state/resolved (boolean)
    If this variable is read-only (config: false) in the
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/fdb/l2rib/mac-table/next-hops/next-hop/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
