...
class flex_algo_admin_groups(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/flex-algorithm/flex-algo-global-attributes/flex-algo-admin-groups. Each member element of
...
and state
  ...
  _yang_name = 'flex-algo-admin-groups'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'flex-algorithm', 'flex-algo-global-attributes', 'flex-algo-admin-groups']

  def _get_admin_group(self):
    """
    Getter method for admin_group, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_global_attributes/flex_algo_admin_groups/admin_group (list)
...
for mpls affinities/admin-groups
  ...
  def _set_admin_group(self, v, load=False):
    """
    Setter method for admin_group, mapped from YANG variable /network_instances/network_instance/flex_algorithm/flex_algo_global_attributes/flex_algo_admin_groups/admin_group (list)
...
class flex_algo_admin_groups(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/flex-algorithm/flex-algo-global-attributes/flex-algo-admin-groups. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
