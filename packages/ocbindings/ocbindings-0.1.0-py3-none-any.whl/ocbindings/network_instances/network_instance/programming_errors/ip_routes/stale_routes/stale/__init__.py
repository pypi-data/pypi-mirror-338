...
long = int
from . import state
class stale(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/programming-errors/ip-routes/stale-routes/stale. Each member element of
...
hardware is stale.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'programming-errors', 'ip-routes', 'stale-routes', 'stale']

  def _get_prefix(self):
    """
    Getter method for prefix, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/stale_routes/stale/prefix (leafref)

    YANG Description: Reference to the prefix that keys the stale list.
    """
    return self.__prefix
      
  def _set_prefix(self, v, load=False):
    """
    Setter method for prefix, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/stale_routes/stale/prefix (leafref)
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/stale_routes/stale/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /network_instances/network_instance/programming_errors/ip_routes/stale_routes/stale/state (container)
    If this variable is read-only (config: false) in the
...
class stale(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/programming-errors/ip-routes/stale-routes/stale. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
