...
class sid_counters(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__sid_counter',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'signaling-protocols', 'segment-routing', 'interfaces', 'interface', 'sid-counters']
  ...
  sid_counter = __builtin__.property(_get_sid_counter)
