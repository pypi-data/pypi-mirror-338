...
class counters(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'signaling-protocols', 'rsvp-te', 'global', 'state', 'counters']
  ...
  def _get_path_timeouts(self):
    ...
    YANG Description: The number of Path State Blocks (PSBs) that
...
have been timed out by the local system.
  ...
  def _get_reservation_timeouts(self):
    ...
    YANG Description: The number of Reservation State Blocks (RSBs) that
have been timed out by the local system.
    """
...
messages
  ...
  def _get_errors(self):
    """
    Getter method for errors, mapped from YANG variable /network_instances/network_instance/mpls/signaling_protocols/rsvp_te/global/state/counters/errors (container)
...
instance.
  ...
  def _set_errors(self, v, load=False):
    """
    Setter method for errors, mapped from YANG variable /network_instances/network_instance/mpls/signaling_protocols/rsvp_te/global/state/counters/errors (container)
    If this variable is read-only (config: false) in the
