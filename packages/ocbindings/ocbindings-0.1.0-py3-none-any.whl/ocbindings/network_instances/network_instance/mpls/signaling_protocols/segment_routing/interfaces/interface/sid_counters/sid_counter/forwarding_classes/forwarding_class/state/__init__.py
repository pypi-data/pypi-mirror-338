...
with the MPLS dataplane
  """
  __slots__ = ('_path_helper', '_extmethods', '__exp','__in_pkts','__in_octets','__out_pkts','__out_octets',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'signaling-protocols', 'segment-routing', 'interfaces', 'interface', 'sid-counters', 'sid-counter', 'forwarding-classes', 'forwarding-class', 'state']
...
corresponds to an SR Segment Identifier.
  ...
  _pyangbind_elements = OrderedDict([('exp', exp), ('in_pkts', in_pkts), ('in_octets', in_octets), ('out_pkts', out_pkts), ('out_octets', out_octets), ])
