...
class aggregate_sid_counters(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'signaling-protocols', 'segment-routing', 'aggregate-sid-counters']
...
particular SID
  ...
  aggregate_sid_counter = __builtin__.property(_get_aggregate_sid_counter)
