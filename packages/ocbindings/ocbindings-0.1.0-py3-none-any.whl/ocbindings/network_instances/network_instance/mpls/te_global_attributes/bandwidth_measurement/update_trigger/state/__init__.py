...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/mpls/te-global-attributes/bandwidth-measurement/update-trigger/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state parameters related to the bandwidth
measurement update trigger.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'te-global-attributes', 'bandwidth-measurement', 'update-trigger', 'state']

  def _get_update_trigger(self):
    """
    Getter method for update_trigger, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/update_trigger/state/update_trigger (enumeration)
...
(adjusted-absolute-subscription-bw)
  ...
  def _set_update_trigger(self, v, load=False):
    """
    Setter method for update_trigger, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/update_trigger/state/update_trigger (enumeration)
...
(adjusted-absolute-subscription-bw)
  ...
  def _get_adjusted_max_reservable_bw_pct(self):
    """
    Getter method for adjusted_max_reservable_bw_pct, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/update_trigger/state/adjusted_max_reservable_bw_pct (oc-types:percentage)
...
adjusted-absolute-subscription-bw RSVP-TE leaf.
  ...
  def _set_adjusted_max_reservable_bw_pct(self, v, load=False):
    """
    Setter method for adjusted_max_reservable_bw_pct, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/update_trigger/state/adjusted_max_reservable_bw_pct (oc-types:percentage)
    If this variable is read-only (config: false) in the
...
adjusted-absolute-subscription-bw RSVP-TE leaf.
  ...
  def _get_sr_traffic_pct(self):
    """
    Getter method for sr_traffic_pct, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/update_trigger/state/sr_traffic_pct (oc-types:percentage)
...
last-calculated-sr-traffic state leaf.
  ...
  def _set_sr_traffic_pct(self, v, load=False):
    """
    Setter method for sr_traffic_pct, mapped from YANG variable /network_instances/network_instance/mpls/te_global_attributes/bandwidth_measurement/update_trigger/state/sr_traffic_pct (oc-types:percentage)
    If this variable is read-only (config: false) in the
...
last-calculated-sr-traffic state leaf.
  ...
  update_trigger = __builtin__.property(_get_update_trigger)
  adjusted_max_reservable_bw_pct = __builtin__.property(_get_adjusted_max_reservable_bw_pct)
  sr_traffic_pct = __builtin__.property(_get_sr_traffic_pct)
...
class state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/mpls/te-global-attributes/bandwidth-measurement/update-trigger/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
