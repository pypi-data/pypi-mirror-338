...
class path_metric_bound_constraints(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/mpls/lsps/constrained-path/tunnels/tunnel/p2p-tunnel-attributes/p2p-secondary-paths/p2p-secondary-path/path-metric-bound-constraints. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'lsps', 'constrained-path', 'tunnels', 'tunnel', 'p2p-tunnel-attributes', 'p2p-secondary-paths', 'p2p-secondary-path', 'path-metric-bound-constraints']

  def _get_path_metric_bound_constraint(self):
    """
    Getter method for path_metric_bound_constraint, mapped from YANG variable /network_instances/network_instance/mpls/lsps/constrained_path/tunnels/tunnel/p2p_tunnel_attributes/p2p_secondary_paths/p2p_secondary_path/path_metric_bound_constraints/path_metric_bound_constraint (list)
...
or be communicated to a PCE for calculation.
  ...
  def _set_path_metric_bound_constraint(self, v, load=False):
    """
    Setter method for path_metric_bound_constraint, mapped from YANG variable /network_instances/network_instance/mpls/lsps/constrained_path/tunnels/tunnel/p2p_tunnel_attributes/p2p_secondary_paths/p2p_secondary_path/path_metric_bound_constraints/path_metric_bound_constraint (list)
...
class path_metric_bound_constraints(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/mpls/lsps/constrained-path/tunnels/tunnel/p2p-tunnel-attributes/p2p-secondary-paths/p2p-secondary-path/path-metric-bound-constraints. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
