...
class lsp_next_hops(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/mpls/lsps/static-lsps/static-lsp/egress/lsp-next-hops. Each member element of
...
route being specified
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'lsps', 'static-lsps', 'static-lsp', 'egress', 'lsp-next-hops']

  def _get_lsp_next_hop(self):
    """
    Getter method for lsp_next_hop, mapped from YANG variable /network_instances/network_instance/mpls/lsps/static_lsps/static_lsp/egress/lsp_next_hops/lsp_next_hop (list)
...
static route being specified.
  ...
  def _set_lsp_next_hop(self, v, load=False):
    """
    Setter method for lsp_next_hop, mapped from YANG variable /network_instances/network_instance/mpls/lsps/static_lsps/static_lsp/egress/lsp_next_hops/lsp_next_hop (list)
...
class lsp_next_hops(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/mpls/lsps/static-lsps/static-lsp/egress/lsp-next-hops. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
