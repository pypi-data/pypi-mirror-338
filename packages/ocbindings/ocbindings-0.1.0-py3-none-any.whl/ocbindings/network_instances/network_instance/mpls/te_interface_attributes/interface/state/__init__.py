...
class state(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__interface_id','__te_metric','__srlg_membership','__admin_group',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'mpls', 'te-interface-attributes', 'interface', 'state']
