...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/connection-points/connection-point/endpoints/endpoint/vxlan/local-endpoint-vnis/local-endpoint-vni/config. Each member element of
...
L3VNI
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__l3_vrf_name = YANGDynClass(base=str, is_leaf=True, yang_name="l3-vrf-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'connection-points', 'connection-point', 'endpoints', 'endpoint', 'vxlan', 'local-endpoint-vnis', 'local-endpoint-vni', 'config']

  def _get_vni(self):
    """
    Getter method for vni, mapped from YANG variable /network_instances/network_instance/connection_points/connection_point/endpoints/endpoint/vxlan/local_endpoint_vnis/local_endpoint_vni/config/vni (oc-evpn-types:evi-id)
  ...
  def _set_vni(self, v, load=False):
    """
    Setter method for vni, mapped from YANG variable /network_instances/network_instance/connection_points/connection_point/endpoints/endpoint/vxlan/local_endpoint_vnis/local_endpoint_vni/config/vni (oc-evpn-types:evi-id)
  ...
  def _get_vni_type(self):
    """
    Getter method for vni_type, mapped from YANG variable /network_instances/network_instance/connection_points/connection_point/endpoints/endpoint/vxlan/local_endpoint_vnis/local_endpoint_vni/config/vni_type (enumeration)
  ...
  def _set_vni_type(self, v, load=False):
    """
    Setter method for vni_type, mapped from YANG variable /network_instances/network_instance/connection_points/connection_point/endpoints/endpoint/vxlan/local_endpoint_vnis/local_endpoint_vni/config/vni_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_bridge_domain(self):
    """
    Getter method for bridge_domain, mapped from YANG variable /network_instances/network_instance/connection_points/connection_point/endpoints/endpoint/vxlan/local_endpoint_vnis/local_endpoint_vni/config/bridge_domain (uint32)
...
L2VNI in the VXLAN fabric
  ...
  def _set_bridge_domain(self, v, load=False):
    """
    Setter method for bridge_domain, mapped from YANG variable /network_instances/network_instance/connection_points/connection_point/endpoints/endpoint/vxlan/local_endpoint_vnis/local_endpoint_vni/config/bridge_domain (uint32)
    If this variable is read-only (config: false) in the
...
L2VNI in the VXLAN fabric
  ...
  def _get_l3_vrf_name(self):
    """
    Getter method for l3_vrf_name, mapped from YANG variable /network_instances/network_instance/connection_points/connection_point/endpoints/endpoint/vxlan/local_endpoint_vnis/local_endpoint_vni/config/l3_vrf_name (string)
...
that is used for routing between subnets in the VXLAN fabric
  ...
  def _set_l3_vrf_name(self, v, load=False):
    """
    Setter method for l3_vrf_name, mapped from YANG variable /network_instances/network_instance/connection_points/connection_point/endpoints/endpoint/vxlan/local_endpoint_vnis/local_endpoint_vni/config/l3_vrf_name (string)
    If this variable is read-only (config: false) in the
...
that is used for routing between subnets in the VXLAN fabric
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="l3-vrf-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """l3_vrf_name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="l3-vrf-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='string', is_config=True)""",
        })
  ...
  vni_type = __builtin__.property(_get_vni_type, _set_vni_type)
  bridge_domain = __builtin__.property(_get_bridge_domain, _set_bridge_domain)
  l3_vrf_name = __builtin__.property(_get_l3_vrf_name, _set_l3_vrf_name)
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/connection-points/connection-point/endpoints/endpoint/vxlan/local-endpoint-vnis/local-endpoint-vni/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
