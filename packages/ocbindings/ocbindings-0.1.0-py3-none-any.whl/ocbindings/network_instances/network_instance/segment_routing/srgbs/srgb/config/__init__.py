...
class config(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__local_id','__dataplane_type','__mpls_label_blocks','__ipv6_prefixes',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['network-instances', 'network-instance', 'segment-routing', 'srgbs', 'srgb', 'config']
...
the local system.
  ...
  def _get_dataplane_type(self):
    """
    Getter method for dataplane_type, mapped from YANG variable /network_instances/network_instance/segment_routing/srgbs/srgb/config/dataplane_type (oc-srt:sr-dataplane-type)
...
prefixes specified in the ipv6-prefixes list are used.
  ...
  def _set_dataplane_type(self, v, load=False):
    """
    Setter method for dataplane_type, mapped from YANG variable /network_instances/network_instance/segment_routing/srgbs/srgb/config/dataplane_type (oc-srt:sr-dataplane-type)
    If this variable is read-only (config: false) in the
