...
class prefixes(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/interfaces/interface/tunnel/ipv6/router-advertisement/prefixes. Each member element of
...
router advertisement message.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'interfaces', 'interface', 'tunnel', 'ipv6', 'router-advertisement', 'prefixes']

  def _get_prefix(self):
    """
    Getter method for prefix, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/router_advertisement/prefixes/prefix (list)
...
be advertised in the router advertisement message.
  ...
  def _set_prefix(self, v, load=False):
    """
    Setter method for prefix, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/router_advertisement/prefixes/prefix (list)
