...
class state(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/interfaces/interface/subinterfaces/subinterface/ipv4/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Top level IPv4 operational state data
  """
  __slots__ = ('_path_helper', '_extmethods', '__enabled','__mtu','__gratuitous_arp_accepted','__dhcp_client','__counters',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'interfaces', 'interface', 'subinterfaces', 'subinterface', 'ipv4', 'state']

  def _get_enabled(self):
    """
    Getter method for enabled, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/enabled (boolean)
...
and receive IPv4 packets.
  ...
  def _set_enabled(self, v, load=False):
    """
    Setter method for enabled, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/enabled (boolean)
...
and receive IPv4 packets.
  ...
  def _get_mtu(self):
    """
    Getter method for mtu, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/mtu (uint16)
...
depends on the interface's type.
  ...
  def _set_mtu(self, v, load=False):
    """
    Setter method for mtu, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/mtu (uint16)
    If this variable is read-only (config: false) in the
...
depends on the interface's type.
  ...
  def _get_gratuitous_arp_accepted(self):
    """
    Getter method for gratuitous_arp_accepted, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/gratuitous_arp_accepted (boolean)
...
the ARP table will be updated.
  ...
  def _set_gratuitous_arp_accepted(self, v, load=False):
    """
    Setter method for gratuitous_arp_accepted, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/gratuitous_arp_accepted (boolean)
    If this variable is read-only (config: false) in the
...
the ARP table will be updated.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="gratuitous-arp-accepted", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/ap-interfaces', defining_module='openconfig-ap-interfaces', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _get_dhcp_client(self):
    """
    Getter method for dhcp_client, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/dhcp_client (boolean)
...
an address
  ...
  def _set_dhcp_client(self, v, load=False):
    """
    Setter method for dhcp_client, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/dhcp_client (boolean)
    If this variable is read-only (config: false) in the
...
an address
  ...
  def _get_counters(self):
    """
    Getter method for counters, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/counters (container)
...
reception for the address family.
  ...
  def _set_counters(self, v, load=False):
    """
    Setter method for counters, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv4/state/counters (container)
    If this variable is read-only (config: false) in the
...
reception for the address family.
  ...
  gratuitous_arp_accepted = __builtin__.property(_get_gratuitous_arp_accepted)
  dhcp_client = __builtin__.property(_get_dhcp_client)
  counters = __builtin__.property(_get_counters)


  _pyangbind_elements = OrderedDict([('enabled', enabled), ('mtu', mtu), ('gratuitous_arp_accepted', gratuitous_arp_accepted), ('dhcp_client', dhcp_client), ('counters', counters), ])
