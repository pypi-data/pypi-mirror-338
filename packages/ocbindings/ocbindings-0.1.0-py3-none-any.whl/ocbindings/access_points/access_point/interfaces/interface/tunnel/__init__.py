...
class tunnel(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/interfaces/interface/tunnel. Each member element of
...
with them.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'interfaces', 'interface', 'tunnel']

  def _get_config(self):
    """
    Getter method for config, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/config (container)
...
tunnel interface
  ...
  def _set_config(self, v, load=False):
    """
    Setter method for config, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/config (container)
...
tunnel interface
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/state (container)
...
the tunnel interface.
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/state (container)
    If this variable is read-only (config: false) in the
...
the tunnel interface.
  ...
  def _get_ipv4(self):
    """
    Getter method for ipv4, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv4 (container)
  ...
  def _set_ipv4(self, v, load=False):
    """
    Setter method for ipv4, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv4 (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6(self):
    """
    Getter method for ipv6, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6 (container)
  ...
  def _set_ipv6(self, v, load=False):
    """
    Setter method for ipv6, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6 (container)
    If this variable is read-only (config: false) in the
