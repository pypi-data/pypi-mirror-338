...
class config(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/interfaces/interface/tunnel/ipv6/neighbors/neighbor/config. Each member element of
...
the interface
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'interfaces', 'interface', 'tunnel', 'ipv6', 'neighbors', 'neighbor', 'config']

  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/neighbors/neighbor/config/ip (oc-inet:ipv6-address)
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/neighbors/neighbor/config/ip (oc-inet:ipv6-address)
  ...
  def _get_link_layer_address(self):
    """
    Getter method for link_layer_address, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/neighbors/neighbor/config/link_layer_address (oc-yang:phys-address)
  ...
  def _set_link_layer_address(self, v, load=False):
    """
    Setter method for link_layer_address, mapped from YANG variable /access_points/access_point/interfaces/interface/tunnel/ipv6/neighbors/neighbor/config/link_layer_address (oc-yang:phys-address)
    If this variable is read-only (config: false) in the
