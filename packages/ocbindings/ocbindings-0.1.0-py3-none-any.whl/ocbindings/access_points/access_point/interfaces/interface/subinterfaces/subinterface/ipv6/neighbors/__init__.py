...
class neighbors(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/interfaces/interface/subinterfaces/subinterface/ipv6/neighbors. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'interfaces', 'interface', 'subinterfaces', 'subinterface', 'ipv6', 'neighbors']

  def _get_neighbor(self):
    """
    Getter method for neighbor, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor (list)
  ...
  def _set_neighbor(self, v, load=False):
    """
    Setter method for neighbor, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv6/neighbors/neighbor (list)
