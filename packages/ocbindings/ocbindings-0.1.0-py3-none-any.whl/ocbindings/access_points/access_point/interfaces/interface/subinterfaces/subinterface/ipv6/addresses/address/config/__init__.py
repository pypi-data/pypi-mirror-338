...
the interface
  ...
  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv6/addresses/address/config/type (oc-inet:ipv6-address-type)
...
configured, this leaf should be set to LINK_LOCAL.
  ...
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /access_points/access_point/interfaces/interface/subinterfaces/subinterface/ipv6/addresses/address/config/type (oc-inet:ipv6-address-type)
    If this variable is read-only (config: false) in the
