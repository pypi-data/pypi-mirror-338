...
class state(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/system/mount-points/mount-point/state. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__storage_component = YANGDynClass(base=str, is_leaf=True, yang_name="storage-component", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='leafref', is_config=False)
    ...
    self.__type = YANGDynClass(base=str, is_leaf=True, yang_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'system', 'mount-points', 'mount-point', 'state']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/name (string)
  ...
  def _get_storage_component(self):
    """
    Getter method for storage_component, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/storage_component (leafref)
...
otherwise a reference to /dev/sda may be provided.
  ...
  def _set_storage_component(self, v, load=False):
    """
    Setter method for storage_component, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/storage_component (leafref)
    If this variable is read-only (config: false) in the
...
otherwise a reference to /dev/sda may be provided.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="storage-component", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='leafref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """storage_component must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="storage-component", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='leafref', is_config=False)""",
        })
  ...
  def _get_size(self):
    """
    Getter method for size, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/size (uint64)
  ...
  def _set_size(self, v, load=False):
    """
    Setter method for size, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/size (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_available(self):
    """
    Getter method for available, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/available (uint64)
  ...
  def _set_available(self, v, load=False):
    """
    Setter method for available, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/available (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_utilized(self):
    """
    Getter method for utilized, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/utilized (uint64)
  ...
  def _set_utilized(self, v, load=False):
    """
    Setter method for utilized, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/utilized (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/type (string)
...
or remote/network based storage.
  ...
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /access_points/access_point/system/mount_points/mount_point/state/type (string)
    If this variable is read-only (config: false) in the
...
or remote/network based storage.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """type must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=False)""",
        })
