...
class state(PybindBase):
  ...
  from YANG module openconfig-access-points - based on the path /access-points/access-point/system/logging/files/file/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state data for logfile servers
  """
  __slots__ = ('_path_helper', '_extmethods', '__filename_prefix','__path','__rotate','__max_size','__max_open_time','__open_logfile',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__open_logfile = YANGDynClass(base=RestrictedClassType(base_type=str, restriction_dict={'length': ['0..511']}), is_leaf=True, yang_name="open-logfile", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['access-points', 'access-point', 'system', 'logging', 'files', 'file', 'state']

  def _get_filename_prefix(self):
    """
    Getter method for filename_prefix, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/filename_prefix (string)
...
other identifier to the filename.
  ...
  def _set_filename_prefix(self, v, load=False):
    """
    Setter method for filename_prefix, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/filename_prefix (string)
...
other identifier to the filename.
  ...
  def _get_path(self):
    """
    Getter method for path, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/path (string)
...
and may include attributes such as a drive identifier.
  ...
  def _set_path(self, v, load=False):
    """
    Setter method for path, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/path (string)
    If this variable is read-only (config: false) in the
...
and may include attributes such as a drive identifier.
  ...
  def _get_rotate(self):
    """
    Getter method for rotate, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/rotate (uint32)
...
old versions are removed rather than rotated.
  ...
  def _set_rotate(self, v, load=False):
    """
    Setter method for rotate, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/rotate (uint32)
    If this variable is read-only (config: false) in the
...
old versions are removed rather than rotated.
  ...
  def _get_max_size(self):
    """
    Getter method for max_size, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/max_size (uint32)
...
If needed oldest logfile of same prefix shall be deleted to
  ...
  def _set_max_size(self, v, load=False):
    """
    Setter method for max_size, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/max_size (uint32)
    If this variable is read-only (config: false) in the
...
If needed oldest logfile of same prefix shall be deleted to
  ...
  def _get_max_open_time(self):
    """
    Getter method for max_open_time, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/max_open_time (uint32)
...
deleted to 
  ...
  def _set_max_open_time(self, v, load=False):
    """
    Setter method for max_open_time, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/max_open_time (uint32)
    If this variable is read-only (config: false) in the
...
deleted to 
  ...
  def _get_open_logfile(self):
    """
    Getter method for open_logfile, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/open_logfile (string)

    YANG Description: the currently active/open filename prepended by folder path
and including suffix appended to filename-prefix by system
    """
    return self.__open_logfile
      
  def _set_open_logfile(self, v, load=False):
    """
    Setter method for open_logfile, mapped from YANG variable /access_points/access_point/system/logging/files/file/state/open_logfile (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_open_logfile is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_open_logfile() directly.
...
and including suffix appended to filename-prefix by system
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=str, restriction_dict={'length': ['0..511']}), is_leaf=True, yang_name="open-logfile", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """open_logfile must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=str, restriction_dict={'length': ['0..511']}), is_leaf=True, yang_name="open-logfile", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=False)""",
        })

    self.__open_logfile = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_open_logfile(self):
    self.__open_logfile = YANGDynClass(base=RestrictedClassType(base_type=str, restriction_dict={'length': ['0..511']}), is_leaf=True, yang_name="open-logfile", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='string', is_config=False)

  filename_prefix = __builtin__.property(_get_filename_prefix)
  path = __builtin__.property(_get_path)
  rotate = __builtin__.property(_get_rotate)
  max_size = __builtin__.property(_get_max_size)
  max_open_time = __builtin__.property(_get_max_open_time)
  open_logfile = __builtin__.property(_get_open_logfile)


  _pyangbind_elements = OrderedDict([('filename_prefix', filename_prefix), ('path', path), ('rotate', rotate), ('max_size', max_size), ('max_open_time', max_open_time), ('open_logfile', open_logfile), ])
