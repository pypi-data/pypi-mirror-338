...
radio or otherwise.
  ...
  def _get_allowed_max_eirp(self):
    """
    Getter method for allowed_max_eirp, mapped from YANG variable /access_points/access_point/radios/radio/state/allowed_max_eirp (uint8)
  ...
  def _set_allowed_max_eirp(self, v, load=False):
    """
    Setter method for allowed_max_eirp, mapped from YANG variable /access_points/access_point/radios/radio/state/allowed_max_eirp (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_allowed_max_txpower(self):
    """
    Getter method for allowed_max_txpower, mapped from YANG variable /access_points/access_point/radios/radio/state/allowed_max_txpower (uint8)
  ...
  def _set_allowed_max_txpower(self, v, load=False):
    """
    Setter method for allowed_max_txpower, mapped from YANG variable /access_points/access_point/radios/radio/state/allowed_max_txpower (uint8)
    If this variable is read-only (config: false) in the
