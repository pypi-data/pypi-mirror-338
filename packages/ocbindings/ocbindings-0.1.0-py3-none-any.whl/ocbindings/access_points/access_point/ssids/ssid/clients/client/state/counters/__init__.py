...
class counters(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__tx_bytes','__rx_bytes','__rx_retries','__rx_total','__tx_retries','__tx_total',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__rx_total = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="rx-total", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='oc-yang:counter64', is_config=False)
    ...
    self.__tx_total = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="tx-total", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='oc-yang:counter64', is_config=False)
  ...
  def _get_rx_total(self):
    """
    Getter method for rx_total, mapped from YANG variable /access_points/access_point/ssids/ssid/clients/client/state/counters/rx_total (oc-yang:counter64)

    YANG Description: Rx frames from this client.
    """
    return self.__rx_total
      
  def _set_rx_total(self, v, load=False):
    """
    Setter method for rx_total, mapped from YANG variable /access_points/access_point/ssids/ssid/clients/client/state/counters/rx_total (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_rx_total is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_rx_total() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="rx-total", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='oc-yang:counter64', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """rx_total must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="rx-total", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='oc-yang:counter64', is_config=False)""",
        })
  ...
  def _get_tx_total(self):
    """
    Getter method for tx_total, mapped from YANG variable /access_points/access_point/ssids/ssid/clients/client/state/counters/tx_total (oc-yang:counter64)

    YANG Description: Tx frames to this client.
    """
    return self.__tx_total
      
  def _set_tx_total(self, v, load=False):
    """
    Setter method for tx_total, mapped from YANG variable /access_points/access_point/ssids/ssid/clients/client/state/counters/tx_total (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_tx_total is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_tx_total() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="tx-total", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='oc-yang:counter64', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """tx_total must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="tx-total", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='oc-yang:counter64', is_config=False)""",
        })
  ...
  rx_total = __builtin__.property(_get_rx_total)
  tx_retries = __builtin__.property(_get_tx_retries)
  tx_total = __builtin__.property(_get_tx_total)


  _pyangbind_elements = OrderedDict([('tx_bytes', tx_bytes), ('rx_bytes', rx_bytes), ('rx_retries', rx_retries), ('rx_total', rx_total), ('tx_retries', tx_retries), ('tx_total', tx_total), ])
