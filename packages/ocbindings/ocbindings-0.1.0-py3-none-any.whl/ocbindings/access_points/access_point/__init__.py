...
list entry.
  """
  __slots__ = ('_path_helper', '_extmethods', '__hostname','__config','__state','__radios','__ssids','__system','__assigned_ap_managers','__interfaces',)
  ...
  def _set_hostname(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="hostname", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='leafref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """hostname must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="hostname", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/wifi/access-points', defining_module='openconfig-access-points', yang_type='leafref', is_config=True)""",
        })
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /access_points/access_point/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /access_points/access_point/state (container)
    If this variable is read-only (config: false) in the
...
configuration and state data.
  ...
  _pyangbind_elements = OrderedDict([('hostname', hostname), ('config', config), ('state', state), ('radios', radios), ('ssids', ssids), ('system', system), ('assigned_ap_managers', assigned_ap_managers), ('interfaces', interfaces), ])
