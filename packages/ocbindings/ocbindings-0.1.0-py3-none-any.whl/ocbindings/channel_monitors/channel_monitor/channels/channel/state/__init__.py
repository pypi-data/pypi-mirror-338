...
class state(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__lower_frequency','__upper_frequency','__power','__target_power',)
  ...
  def _get_target_power(self):
    """
    Getter method for target_power, mapped from YANG variable /channel_monitors/channel_monitor/channels/channel/state/target_power (decimal64)

    YANG Description: Target optical power over the specified spectrum
    """
    return self.__target_power
      
  def _set_target_power(self, v, load=False):
    """
    Setter method for target_power, mapped from YANG variable /channel_monitors/channel_monitor/channels/channel/state/target_power (decimal64)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = OrderedDict([('lower_frequency', lower_frequency), ('upper_frequency', upper_frequency), ('power', power), ('target_power', target_power), ])
