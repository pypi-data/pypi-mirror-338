...
interface.
  ...
  def _get_transmit_power(self):
    """
    Getter method for transmit_power, mapped from YANG variable /radios/radio/config/transmit_power (int8)
  ...
  def _set_transmit_power(self, v, load=False):
    """
    Setter method for transmit_power, mapped from YANG variable /radios/radio/config/transmit_power (int8)
    If this variable is read-only (config: false) in the
  ...
  def _get_transmit_eirp(self):
    """
    Getter method for transmit_eirp, mapped from YANG variable /radios/radio/config/transmit_eirp (uint8)
  ...
  def _set_transmit_eirp(self, v, load=False):
    """
    Setter method for transmit_eirp, mapped from YANG variable /radios/radio/config/transmit_eirp (uint8)
    If this variable is read-only (config: false) in the
...
40,80,160MHz channel.
  ...
  def _get_bss_coloring(self):
    """
    Getter method for bss_coloring, mapped from YANG variable /radios/radio/config/bss_coloring (boolean)
  ...
  def _set_bss_coloring(self, v, load=False):
    """
    Setter method for bss_coloring, mapped from YANG variable /radios/radio/config/bss_coloring (boolean)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, default=YANGBool("true"), is_leaf=True, yang_name="bss-coloring", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/wifi-phy', defining_module='openconfig-wifi-phy', yang_type='boolean', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _get_bss_color_id(self):
    """
    Getter method for bss_color_id, mapped from YANG variable /radios/radio/config/bss_color_id (uint8)
  ...
  def _set_bss_color_id(self, v, load=False):
    """
    Setter method for bss_color_id, mapped from YANG variable /radios/radio/config/bss_color_id (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_dtp_min(self):
    """
    Getter method for dtp_min, mapped from YANG variable /radios/radio/config/dtp_min (int8)
...
dtp. Expressed in dBm.
  ...
  def _set_dtp_min(self, v, load=False):
    """
    Setter method for dtp_min, mapped from YANG variable /radios/radio/config/dtp_min (int8)
    If this variable is read-only (config: false) in the
...
dtp. Expressed in dBm.
  ...
  def _get_dtp_max(self):
    """
    Getter method for dtp_max, mapped from YANG variable /radios/radio/config/dtp_max (int8)
...
dtp. Expressed in dBm.
  ...
  def _set_dtp_max(self, v, load=False):
    """
    Setter method for dtp_max, mapped from YANG variable /radios/radio/config/dtp_max (int8)
    If this variable is read-only (config: false) in the
