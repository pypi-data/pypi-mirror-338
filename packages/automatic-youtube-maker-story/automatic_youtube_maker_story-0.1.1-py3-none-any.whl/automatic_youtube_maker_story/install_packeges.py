...
def configPaths():
    ...
    path_video = input("Passe o caminho de output dos videos do comfy  ")
    ...
    # Exemplo de uso
    config_data = {"path_audio": add_trailing_slash(path_root), "path_base_comfy": add_trailing_slash(path_base), "historic_history": historic_history, "path_video": add_trailing_slash(path_video)}
