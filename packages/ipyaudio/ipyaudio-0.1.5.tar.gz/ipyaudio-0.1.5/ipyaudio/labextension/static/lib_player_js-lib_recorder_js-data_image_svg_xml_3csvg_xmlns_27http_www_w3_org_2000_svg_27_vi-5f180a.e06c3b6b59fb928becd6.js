...
class RecorderModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: RecorderModel.model_name, _model_module: RecorderModel.model_module, _model_module_version: RecorderModel.model_module_version, _view_name: RecorderModel.view_name, _view_module: RecorderModel.view_module, _view_module_version: RecorderModel.view_module_version, audio: new Int16Array(0) });
    }
}
...
RecorderModel.serializers = Object.assign(Object.assign({}, base_1.DOMWidgetModel.serializers), { 
    ...
    audio: jupyter_dataserializers_1.simplearray_serialization });
    ...
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordChunk((blob) => __awaiter(this, void 0, void 0, function* () {
                this.model.set('chunk', blob);
                const arrayBuffer = yield blob.arrayBuffer();
                let combinedBuffer;
                if (leftoverBytes) {
                    const newBuffer = new Uint8Array(leftoverBytes.length + arrayBuffer.byteLength);
                    newBuffer.set(leftoverBytes, 0);
                    newBuffer.set(new Uint8Array(arrayBuffer), leftoverBytes.length);
                    combinedBuffer = newBuffer.buffer;
                    leftoverBytes = null;
                }
                else {
                ...
                const int16Count = Math.floor(uint8Array.length / 2);
                const remainingBytes = uint8Array.length % 2;
                if (remainingBytes > 0) {
                    leftoverBytes = new Uint8Array(remainingBytes);
                    leftoverBytes[0] = uint8Array[uint8Array.length - 1];
                }
                const int16Array = new Int16Array(combinedBuffer, 0, int16Count);
                console.log('record-chunk', int16Array);
            }));
            this._recorder.onRecordEnd((blob) => {
                this.model.set('audio', blob);
                console.log('record-end', blob.size);
            });
        }));
    }
}
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.e06c3b6b59fb928becd6.js.map