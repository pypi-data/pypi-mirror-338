...
class Recorder {
    ...
    static decodeAudioData(blob, sampleRate) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    onRecordEnd(callback) {
        this._recorder.on('record-end', (blob) => __awaiter(this, void 0, void 0, function* () {
            ...
            const audioData = yield Recorder.decodeAudioData(blob, this.sampleRate);
            callback(audioData);
        }));
    }
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.031c6b2628b240d56555.js.map