"use strict";
(self["webpackChunkipyaudio"] = self["webpackChunkipyaudio"] || []).push([["lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a"],{
...
class RecorderModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: RecorderModel.model_name, _model_module: RecorderModel.model_module, _model_module_version: RecorderModel.model_module_version, _view_name: RecorderModel.view_name, _view_module: RecorderModel.view_module, _view_module_version: RecorderModel.view_module_version, audio: new Float32Array(0), chunk: new Float32Array(0) });
    }
}
...
RecorderModel.serializers = Object.assign(Object.assign({}, base_1.DOMWidgetModel.serializers), { 
    ...
    audio: jupyter_dataserializers_1.simplearray_serialization, chunk: jupyter_dataserializers_1.simplearray_serialization });
...
class RecorderView extends base_1.DOMWidgetView {
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordChunk((audioData) => __awaiter(this, void 0, void 0, function* () {
                this.model.set('chunk', {
                    array: new Float32Array(audioData),
                    shape: [audioData.length],
                });
                this.model.set('rate', this._recorder.sampleRate);
                this.model.save_changes();
            }));
            this._recorder.onRecordEnd((audioData) => __awaiter(this, void 0, void 0, function* () {
...
class Player {
    ...
    createDownloadButton() {
        this._downloadButton = (0, utils_1.createElement)('button', 'btn btn-success my-3');
...
class Recorder {
    ...
    onRecordEnd(callback) {
        this._recorder.on('record-end', (blob) => __awaiter(this, void 0, void 0, function* () {
            ...
            callback(yield (0, utils_1.decodeAudioData)(blob, this.sampleRate));
        }));
    }
    onRecordChunk(callback) {
        this._recorder.on('record-data-available', (blob) => __awaiter(this, void 0, void 0, function* () {
            console.log(blob);
            console.log(yield (0, utils_1.decodeAudioData)(blob, this.sampleRate));
            callback(yield (0, utils_1.decodeAudioData)(blob, this.sampleRate));
        }));
    }
    createRecorder() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.decodeAudioData = exports.createObjectURL = exports.formatTime = exports.createElement = void 0;
...
const decodeAudioData = (blob, sampleRate) => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.c92a697515bb3717efb0.js.map