    ...
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordStart(() => {
                ...
                console.log('rate before', this.model.get('rate'));
                this.model.set('end', false);
                this.model.set('rate', this._recorder.sampleRate);
                this.model.save_changes();
                console.log('rate after', this.model.get('rate'));
            });
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.d1f58690862dfe4e588d.js.map