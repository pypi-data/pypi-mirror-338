    ...
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordEnd((blob) => __awaiter(this, void 0, void 0, function* () {
                console.log('end', blob.size);
                const audioBuffer = yield this._audioContext.decodeAudioData(yield blob.arrayBuffer());
                const audioData = audioBuffer.getChannelData(0);
                console.log('end', audioData.length);
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.506e45e4cebf4350c149.js.map