    ...
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordChunk((blob) => __awaiter(this, void 0, void 0, function* () {
                ...
                const evenLengthBuffer = new ArrayBuffer(int16Length * 2);
                const evenUint8Array = new Uint8Array(evenLengthBuffer);
                evenUint8Array.set(uint8Array.subarray(0, int16Length * 2));
                const int16Array = new Int16Array(evenLengthBuffer);
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.43ed7c15592710a8be16.js.map