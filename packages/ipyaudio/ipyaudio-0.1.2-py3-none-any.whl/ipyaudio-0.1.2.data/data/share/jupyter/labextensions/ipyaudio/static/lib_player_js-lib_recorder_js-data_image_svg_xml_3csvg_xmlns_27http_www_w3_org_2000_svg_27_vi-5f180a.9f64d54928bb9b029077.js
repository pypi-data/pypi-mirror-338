...
class Recorder {
    ...
    onRecordChunk(callback) {
        this._recorder.on('record-data-available', (data) => {
            var _a;
            const blob = new Blob([data], { type: (_a = this._config.recordOptions) === null || _a === void 0 ? void 0 : _a.mimeType });
            callback(blob);
        });
    }
    createRecorder() {
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.9f64d54928bb9b029077.js.map