    ...
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordChunk((blob) => __awaiter(this, void 0, void 0, function* () {
                this.model.set('chunk', new Uint8Array(yield blob.arrayBuffer()));
                this.model.save_changes();
            }));
            this._recorder.onRecordEnd((blob) => __awaiter(this, void 0, void 0, function* () {
                this.model.set('audio', new Uint8Array(yield blob.arrayBuffer()));
                this.model.save_changes();
            }));
        }));
    }
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.994065a09de5f598f187.js.map