    ...
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordChunk((blob) => __awaiter(this, void 0, void 0, function* () {
                console.log('chunk-blob', blob.size);
                const audioBuffer = yield this._audioContext.decodeAudioData(yield blob.arrayBuffer());
                const audioData = audioBuffer.getChannelData(0);
                console.log('chunk-audio', audioData.length);
            ...
            //   console.log('end-blob', blob.size)
            //   const audioBuffer = await this._audioContext.decodeAudioData(await blob.arrayBuffer())
            //   const audioData = audioBuffer.getChannelData(0)
            //   console.log('end-audio', audioData.length)
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.c7d41a86b32f5fd81f6b.js.map