...
class RecorderModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: RecorderModel.model_name, _model_module: RecorderModel.model_module, _model_module_version: RecorderModel.model_module_version, _view_name: RecorderModel.view_name, _view_module: RecorderModel.view_module, _view_module_version: RecorderModel.view_module_version });
    }
}
exports.RecorderModel = RecorderModel;
RecorderModel.serializers = Object.assign({}, base_1.DOMWidgetModel.serializers);
    ...
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordEnd((blob) => __awaiter(this, void 0, void 0, function* () {
                ...
                // })
                // this.model.set('rate', this._recorder.sampleRate)
                this.model.set('rate', 22000);
                this.model.save_changes();
                console.log('record-end', this.model.get('rate'));
            }));
        }));
    }
}
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.2d7b8caaddd52b1855d1.js.map