    ...
    render() {
        ...
        this.displayed.then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._recorder.onRecordChunk((blob) => __awaiter(this, void 0, void 0, function* () {
                console.log('blob', blob.arrayBuffer().then(console.log));
                const opus = new Blob([blob], { type: 'audio/webm' });
                console.log('opus', opus.arrayBuffer().then(console.log));
                const arrayBuffer = yield opus.arrayBuffer();
...
//# sourceMappingURL=lib_player_js-lib_recorder_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_vi-5f180a.207d39d951dcc5225689.js.map