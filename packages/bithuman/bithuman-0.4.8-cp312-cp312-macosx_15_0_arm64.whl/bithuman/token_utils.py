...
# Note: Removed direct imports of Bithuman and AsyncBithuman to avoid circular dependencies

from bithuman.token_config import TokenRequestConfig, TokenRequestError, prepare_request_data, prepare_headers, log_request_debug
...
def _prepare_request(
    fingerprint: str, config: Union[TokenRequestConfig, Any], model_hash: Optional[str] = None
