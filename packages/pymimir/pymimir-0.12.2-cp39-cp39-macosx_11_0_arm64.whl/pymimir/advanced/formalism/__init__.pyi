...
class FluentNumericAssignmentSet:
    ...
    def insert_ground_function_values(self, ground_functions: FluentGroundFunctionList, numeric_values: _pymimir.advanced.common.FlatDoubleList) -> None: ...
...
class GeneralizedProblem:
    @overload
    def __init__(self, domain_filepath: str, problem_filepaths: Sequence[str], options: ParserOptions = ...) -> None: ...

    @overload
    def __init__(self, domain_filepath: str, problems_directory: str, options: ParserOptions = ...) -> None: ...

    @overload
    def __init__(self, domain: Domain, problems: ProblemList) -> None: ...
...
class GroundAction:
    ...
    def get_object_indices(self) -> _pymimir.advanced.common.FlatIndexList: ...

    def get_conjunctive_condition(self) -> GroundConjunctiveCondition: ...

    def get_conjunctive_effect(self) -> GroundConjunctiveEffect: ...

    def get_conditional_effects(self) -> "cista::basic_vector<mimir::formalism::GroundConditionalEffect, cista::offset::ptr, false, unsigned int, cista::allocator<mimir::formalism::GroundConditionalEffect, cista::offset::ptr>>": ...
...
class GroundConjunctiveCondition:
    def get_fluent_positive_condition(self) -> _pymimir.advanced.common.FlatIndexList: ...

    def get_static_positive_condition(self) -> _pymimir.advanced.common.FlatIndexList: ...

    def get_derived_positive_condition(self) -> _pymimir.advanced.common.FlatIndexList: ...

    def get_fluent_negative_condition(self) -> _pymimir.advanced.common.FlatIndexList: ...

    def get_static_negative_condition(self) -> _pymimir.advanced.common.FlatIndexList: ...

    def get_derived_negative_condition(self) -> _pymimir.advanced.common.FlatIndexList: ...

class GroundConjunctiveEffect:
    def get_positive_effects(self) -> _pymimir.advanced.common.FlatIndexList: ...

    def get_negative_effects(self) -> _pymimir.advanced.common.FlatIndexList: ...

    def get_fluent_numeric_effects(self) -> "cista::basic_vector<cista::basic_external_ptr<mimir::formalism::GroundNumericEffectImpl<mimir::formalism::FluentTag> const>, cista::offset::ptr, false, unsigned int, cista::allocator<cista::basic_external_ptr<mimir::formalism::GroundNumericEffectImpl<mimir::formalism::FluentTag> const>, cista::offset::ptr>>": ...

    def get_auxiliary_numeric_effect(self) -> "cista::optional<cista::basic_external_ptr<mimir::formalism::GroundNumericEffectImpl<mimir::formalism::AuxiliaryTag> const>>": ...
...
class NumericConstraint:
    ...
    def get_binary_comparator(self) -> "loki::BinaryComparatorEnum": ...
...
class Problem:
    ...
    def get_or_create_numeric_constraint(self, comparator: "loki::BinaryComparatorEnum", left_expression: FunctionExpression, right_expression: FunctionExpression, terms: TermList) -> NumericConstraint: ...
...
class Requirements:
    ...
    def get_requirements(self) -> "std::__1::set<loki::RequirementEnum, std::__1::less<loki::RequirementEnum>, std::__1::allocator<loki::RequirementEnum>>": ...
...
class StaticNumericAssignmentSet:
    ...
    def insert_ground_function_values(self, ground_functions: StaticGroundFunctionList, numeric_values: _pymimir.advanced.common.FlatDoubleList) -> None: ...
