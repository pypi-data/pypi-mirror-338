...
class DeleteRelaxedProblemExplorator:
    ...
    def create_grounded_axiom_evaluator(self, match_tree_options: MatchTreeOptions = ..., axiom_evaluator_event_handler: IGroundedAxiomEvaluatorEventHandler | None = None) -> IAxiomEvaluator: ...

    def create_grounded_applicable_action_generator(self, match_tree_options: MatchTreeOptions = ..., axiom_evaluator_event_handler: IGroundedApplicableActionGeneratorEventHandler | None = None) -> IApplicableActionGenerator: ...
...
def find_solution_astar(search_context: SearchContext, heuristic: IHeuristic, start_state: State | None = None, astar_event_handler: IAStarEventHandler | None = None, goal_strategy: "mimir::search::IGoalStrategy" | None = None, pruning_strategy: "mimir::search::IPruningStrategy" | None = None) -> SearchResult: ...

def find_solution_brfs(search_context: SearchContext, start_state: State | None = None, brfs_event_handler: IBrFSEventHandler | None = None, goal_strategy: "mimir::search::IGoalStrategy" | None = None, pruning_strategy: "mimir::search::IPruningStrategy" | None = None, exhaustive: bool = False) -> SearchResult: ...

def find_solution_iw(search_context: SearchContext, start_state: State | None = None, max_arity: int | None = None, iw_event_handler: IIWEventHandler | None = None, brfs_event_handler: IBrFSEventHandler | None = None, goal_strategy: "mimir::search::IGoalStrategy" | None = None) -> SearchResult: ...

def find_solution_siw(search_context: SearchContext, start_state: State | None = None, max_arity: int | None = None, siw_event_handler: ISIWEventHandler | None = None, iw_event_handler: IIWEventHandler | None = None, brfs_event_handler: IBrFSEventHandler | None = None, goal_strategy: "mimir::search::IGoalStrategy" | None = None) -> SearchResult: ...
