...
if getenv("ENVIRONMENT") == "testing":
    from data.env import ENVIRONMENT, MONGODB_TOKEN, DATABASE_NAME, REPLICA_NAME, CONNECTIONS_LIMIT, SUPER_ADMIN_ID
    from data.config import USER_ID_KEY, USER_COLLECTION
    from users.UserT import UserT

else:
    from bot_engine.data.env import ENVIRONMENT, MONGODB_TOKEN, DATABASE_NAME, REPLICA_NAME, CONNECTIONS_LIMIT, SUPER_ADMIN_ID
...
class MongoDB:
    ...
    def __new__(cls, *args, **kwargs):
        if cls._mongoDB_instance is None:
            ...
            cls._mongoDB_instance._client = MongoClient(MONGODB_TOKEN, maxPoolSize=CONNECTIONS_LIMIT)
