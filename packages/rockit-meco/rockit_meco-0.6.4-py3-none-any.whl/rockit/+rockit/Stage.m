classdef Stage < handle
  ...
  methods
    ...
    function varargout = clear_objective(obj,varargin)
      % 
      % Arguments: 
      ...
      [args,kwargs] = pythoncasadiinterface.matlab2python_arg(varargin,0,{});
      if isempty(kwargs)
        res = obj.parent.clear_objective(args{:});
      else
        res = obj.parent.clear_objective(args{:},pyargs(kwargs{:}));
      end
      varargout = pythoncasadiinterface.python2matlab_ret(res);
    end
    function varargout = subject_to(obj,varargin)
      % Adds a constraint to the problem
      % Arguments: constr, grid=None, include_first=True, include_last=True, scale=1, refine=1, group_refine=<rockit.grouping_techniques.GroupingTechnique object at 0x7fa315907b80>, group_dim=<rockit.grouping_techniques.GroupingTechnique object at 0x7fa315907bb0>, group_control=<rockit.grouping_techniques.GroupingTechnique object at 0x7fa315907be0>, meta=None
      % 
      %         Parameters
      %         ----------
