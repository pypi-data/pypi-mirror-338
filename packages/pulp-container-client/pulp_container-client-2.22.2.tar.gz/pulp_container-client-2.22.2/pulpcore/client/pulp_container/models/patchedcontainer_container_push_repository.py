...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, pulp_labels=None, description=None, name=None, manifest_signing_service=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
