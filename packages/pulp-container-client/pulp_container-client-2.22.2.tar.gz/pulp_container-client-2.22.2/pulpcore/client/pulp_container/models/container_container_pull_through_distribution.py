...
class ContainerContainerPullThroughDistribution(object):
    ...
    def __init__(self, repository=None, pulp_labels=None, content_guard=None, base_path=None, hidden=False, name=None, remote=None, distributions=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
