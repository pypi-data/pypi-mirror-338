...
class SheetLikeSetter(BaseSetter):
    ...
    def header(self, header: Union[list, tuple], table: str = None, to_file: bool = True) -> SheetLikeSetter: ...
    ...
    def table(self, name: Union[str, bool, None]) -> SheetLikeSetter: ...

    def header_row(self, num: int) -> SheetLikeSetter: ...

    def fit_header(self, on_off: bool = True) -> SheetLikeSetter: ...

    def follow_styles(self, on_off: bool = True) -> SheetLikeSetter: ...
...
class FillerSetter(SheetLikeSetter):
    ...
    def table(self, name: Union[str, bool, None]) -> FillerSetter: ...
    ...
    def header(self, head: Union[list, tuple], table: str = None, to_file: bool = True) -> FillerSetter: ...

    def header_row(self, num: int) -> FillerSetter: ...
    ...
    def path(self, path: Union[str, Path], file_type: str = None) -> FillerSetter: ...

    def follow_styles(self, on_off: bool = True) -> FillerSetter: ...

    # -------------------上级结束-------------------

    def signs(self, values: Any, deny: bool = False) -> FillerSetter: ...
...
class RecorderSetter(SheetLikeSetter):
    ...
    def header(self, head: Union[list, tuple], table: str = None, to_file: bool = True) -> RecorderSetter: ...
    ...
    def fit_header(self, on_off: bool = True, add_new: bool = False) -> RecorderSetter: ...
...
def set_csv_header(recorder: Union[Recorder, Filler],
                   header: Union[list, tuple],
                   to_file: bool,
                   row: int = 1) -> None: ...


def set_xlsx_header(recorder: Union[Recorder, Filler],
                    header: Union[list, tuple],
                    table: str,
                    to_file: bool,
                    row: int = 1) -> None: ...
...
def get_key_cols(cols: Union[str, int, list, tuple, bool]) -> list: ...


def get_sign_col(col: Union[str, int, bool]) -> int: ...
