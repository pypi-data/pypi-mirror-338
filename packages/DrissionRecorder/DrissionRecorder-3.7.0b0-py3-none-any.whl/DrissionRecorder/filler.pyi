...
class Filler(BaseRecorder):
    ...
    def key2col(self, key: str, table: str = None) -> int: ...
    ...
    def rows(self,
             ...
             signs: Any = None,
             deny_sign: bool = None,
             count: int = None) -> List[Union[FillerList, FillerDict]]: ...
...
def get_xlsx_rows(filler: Filler, as_dict: bool, count: int) -> List[Union[list, dict]]: ...


def get_csv_rows(filler: Filler, as_dict: bool, count: int) -> List[Union[list, dict]]: ...
