...
class JobResponseData(betterproto.Message):
    ...
    is_simulation: bool = betterproto.bool_field(5)
...
class SimulationSuccess(betterproto.Message):
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("simulated"):
            warnings.warn(
                "SimulationSuccess.simulated is deprecated", DeprecationWarning
            )
...
class GetNamedResultResponseGetNamedResultResponseSuccess(betterproto.Message):
    ...
    data_chunk: "GetNamedResultResponseGetNamedResultResponseSuccessDataChunk" = (
        betterproto.message_field(3, group="data_oneof")
    )
    data_summary: "GetNamedResultResponseGetNamedResultResponseSuccessDataSummary" = (
        betterproto.message_field(4, group="data_oneof")
    )

    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("count_of_items"):
            warnings.warn(
                "GetNamedResultResponseGetNamedResultResponseSuccess.count_of_items is deprecated",
                DeprecationWarning,
            )
        if self.is_set("data"):
            warnings.warn(
                "GetNamedResultResponseGetNamedResultResponseSuccess.data is deprecated",
                DeprecationWarning,
            )


@dataclass(eq=False, repr=False)
class GetNamedResultResponseGetNamedResultResponseSuccessDataChunk(betterproto.Message):
    data: bytes = betterproto.bytes_field(1)


@dataclass(eq=False, repr=False)
class GetNamedResultResponseGetNamedResultResponseSuccessDataSummary(
    betterproto.Message
):
...
@dataclass(eq=False, repr=False)
class GetWaveformReportRequest(betterproto.Message):
    job_id: str = betterproto.string_field(1)


@dataclass(eq=False, repr=False)
class GetWaveformReportResponse(betterproto.Message):
    success: "GetWaveformReportResponseGetWaveformReportSuccess" = (
        betterproto.message_field(1, group="response_oneof")
    )
    error: "GetWaveformReportResponseGetWaveformReportError" = (
        betterproto.message_field(2, group="response_oneof")
    )


@dataclass(eq=False, repr=False)
class GetWaveformReportResponseGetWaveformReportSuccess(betterproto.Message):
...
@dataclass(eq=False, repr=False)
class GetWaveformReportResponseGetWaveformReportError(betterproto.Message):
    details: str = betterproto.string_field(1)
...
class JobServiceStub(betterproto.ServiceStub):
    ...
    async def get_waveform_report(
        self,
        get_waveform_report_request: "GetWaveformReportRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ) -> "GetWaveformReportResponse":
        return await self._unary_unary(
            "/qm.grpc.v2.JobService/GetWaveformReport",
            get_waveform_report_request,
            GetWaveformReportResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class JobServiceBase(ServiceBase):
    ...
    async def get_waveform_report(
        self, get_waveform_report_request: "GetWaveformReportRequest"
    ) -> "GetWaveformReportResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_get_waveform_report(
        self,
        stream: "grpclib.server.Stream[GetWaveformReportRequest, GetWaveformReportResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_waveform_report(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/qm.grpc.v2.JobService/GetWaveformReport": grpclib.const.Handler(
                self.__rpc_get_waveform_report,
                grpclib.const.Cardinality.UNARY_UNARY,
