...
class Document:
    ...
    def get_history(self):
        ...
        '''
        warnings.warn(
            "Foi detectada uma chamada para o método get_history. Esse método" \
            " foi depreciado e será removido em uma versão futura do Conector.",
