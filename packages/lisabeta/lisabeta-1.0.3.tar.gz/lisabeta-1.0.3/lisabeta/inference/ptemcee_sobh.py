...
"""
    Python functions for ptemcee simulated inference of SBHBs with LISA.
"""
...
# Parse arguments
parser = argparse.ArgumentParser(description='Run SBHB parameter inference \
...
if __name__ == '__main__':
    ...
    likelihoodClass = lisa.LikelihoodLISASOBH(source_params_SSBframe,
                                                  **waveform_params)
