...
import lisabeta.multiband.multiband as multiband
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Run Multiband parameter inference \
    ...
    # Load and interpolate LVK noise data
    noises = {}
    ...
    signal_inj = multiband.GenerateMultibandSignal(source_params, noises, **waveform_params)
    ...
    def loglike(cube, ndim, nparams):
        ...
        lnL = multiband.LogLikelihoodMultiband(template_params_m1m2, signal_inj, noises,
                                               likelihood_bands=likelihood_bands, **waveform_params)
        #print(lnL)
        return lnL
