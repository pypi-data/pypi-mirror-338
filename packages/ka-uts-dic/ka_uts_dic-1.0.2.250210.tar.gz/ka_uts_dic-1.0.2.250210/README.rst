...
#. *log*
  ...
  .. table:: *Naming conventions for logging file*
   ...
   +-----+--------------------------------------------+-------------------+
   |info |/data/<tenant>/RUN/<package>/<function>/logs|logs_<pid>_<ts>.log|
   +-----+--------------------------------------------+-------------------+
...
#. **Management Modules for Dictionary**
#. **Management Modules for Dictionary of Dictionaries**
#. **Management Modules for Dictionary of Arrays**
#. **Management Modules for Dictionary of Objects**
...
^^^^^^^^^^^^^^^^^^^^
  ...
  .. Dic-Flatten-Methods-label:
  .. table:: *Dic-Flatten-Methods*
...
*************************************************
  ...
  .. Management-Modules-for-Dictionary-of-Dictionaries-label:
  .. table:: *Management Modules for Dictionary of Dictionaries*
...
*******************************************
  ...
  .. Management-Modules-for-Dictionary-of-Arrays-label:
  .. table:: *Management Modules for Dictionary of Arrays*
...
Management Modules for Dictionaries of Dictionaries
*************************************+++++++*******

  .. Management-Modules-for-Dictionaries-of-Dictionaries-label:
  .. table:: *Management Modules for Dictionaries of Dictionaries*
...
^^^^^^^^^^^^^^
  ...
  .. DoDoWs-Methods-label:
  .. table:: *DoDoWs Methods*
...
The static Class ``DoPdDf`` is used to manage ``Dictionary of Panda Dataframes``;
it contains the subsequent methods.

DoPdDf Methods
^^^^^^^^^^^^^^

  .. DoPdDf-Methods-label:
  .. table:: *DoPdDf Methods*
...
^^^^^^^^^^^^^^
  ...
  .. DoPlDf-Methods-label:
  .. table:: *DoPlDf Methods*
