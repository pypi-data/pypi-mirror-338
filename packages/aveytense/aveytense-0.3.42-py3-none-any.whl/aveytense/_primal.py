...
if __name__ == "__main__":
    error = RuntimeError("This file is not for compiling, moreover, this file does not have a complete AveyTense declarations collection. Consider importing module 'aveytense' instead.")
    raise error
