...
- `aveytense.fencord` - connection with discord
...
class Tense( # 0.3.24
    ...
    @classmethod
    @_tc.overload
    def isDecimal2(self, v: _Any, /) -> bool: ...
    
    @classmethod
    @_tc.overload
    def isDecimal2(self, v: _Any, /, *_: _Any, mode: _Mode = _MODE_AND) -> bool: ...
    
    @classmethod
    def isDecimal2(self, v, /, *_, mode = _MODE_AND):
        """
        \\@since 0.3.41
    ...
    if versionInfo >= (0, 3, 42) or True:
        ...
        @classmethod
        @_tc.overload
        def isFinalProperty(self, v: _Any, /) -> _tc.TypeIs[_util.finalproperty]: ...
    ...
    if versionInfo >= (0, 3, 42) or True:
        ...
        def isFinalProperty(self, v, /, *_, mode = _MODE_AND):
            ...
            for one in _many:
                ...
                # parent in separate parameter, hence we need a tuple with the class and its member as a string.
                # 29.03.2025
        ...
        def _check_if_final(value):
            ...
            if self.isClass(value):
                ...
                try:
                    ...
                    return (
                        ("__subclasses__" in value.__dict__ and _util.Final in value.__subclasses__()) or
    ...
    def test(self, target, pattern, flags = 0):
        ...
        if (
            ...
            error = TypeError("expected '{}' and '{}' to match one of following type patterns: 'str' + 'str', 'str' + 're.Pattern[str]', 'bytes' + 'collections.abc.Buffer', 'bytes' + 're.Pattern[bytes]', and expected '{}' to be an integer or 're.RegexFlag'".format(*tuple(_get_all_params())))
            raise error
