...
class rubino:
    ...
    def _print_banner(self):
        """Print a beautiful banner only once"""
        colors = ['white', 'cyan']
        text = colored("aminpy", "cyan", attrs=['bold'])
        text1 = colored("AminEbrahimi", "red", attrs=['bold'])    
        arrow = colored("=", "green", attrs=['bold'])
        arrow1 = colored(">", "green", attrs=['bold'])
        dot_stages = ['•', '••', '•••']
        ...
        header = f"""
        {colored('╔══════════════════════════════════════╗', 'cyan')}
        {colored('║', 'cyan')}      {colored('RUBINO API WRAPPER', 'yellow', attrs=['bold'])}       {colored('║', 'cyan')}
        {colored('╠══════════════════════════════════════╣', 'cyan')}
        {colored('║', 'cyan')}   {text} - {text1} {colored('║', 'cyan')}
        {colored('╚══════════════════════════════════════╝', 'cyan')}
        """
        print(header)
