...
if( fckit_IS_BUILD_DIR_EXPORT )
  set( FCTEST_GENERATOR /usr/local/bin/python3.13 /src/proj/tools/fctest-generate-runner.py )
  set( FYPP /src/proj/tools/fckit-eval.sh;/src/proj/contrib/fypp-3.2-b8dd58b-20230822/bin/fypp )
  if( 0 )
     set( FCKIT_VENV_EXE  )
  endif()
else()
  ...
  set( FCTEST_GENERATOR /usr/local/bin/python3.13 ${fckit_BASE_DIR}/libexec/fctest-generate-runner.py )
endif()
