...
class Nodes(BaseSDK):
    ...
    def nodes_create(
        ...
        *,
        data: Union[
            models.NodePublicAddressAssignment,
            models.NodePublicAddressAssignmentTypedDict,
        ],
        signature: str,
        ...
        * `InternalError` - If:
        ...
        :param data: Represents the payload for the node public address registration request.  This struct represents the payload for the node public address registration request.
        :param signature: The signature of the data base 64 encoded
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.NodesCreateRequest
            ),
