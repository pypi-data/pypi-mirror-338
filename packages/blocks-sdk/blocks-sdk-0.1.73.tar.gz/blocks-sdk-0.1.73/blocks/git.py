...
class Git:
    ...
    def clone(self, ref="", target_dir=".", depth=None, single_branch=False, recursive=False, shallow_submodules=False):
        """
        Clone a repository.
        ...
        if target_dir != "." and not os.path.exists(os.path.dirname(target_dir)):
        ...
        options_str = " ".join(options)
        return bash(f"git clone {options_str} {url} {target_dir}")
