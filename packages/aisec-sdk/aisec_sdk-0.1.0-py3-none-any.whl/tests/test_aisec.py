...
class TestAISec(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = AISec(
            ...
            oneai_api_key=self.test_api_key
        )
    ...
    def test_init_with_missing_params(self):
        ...
        with self.assertRaises(ValueError):
            AISec(app_uk="", oneai_api_key="key")
            
        with self.assertRaises(ValueError):
            AISec(app_uk="app", oneai_api_key="")
    ...
    def test_init_with_valid_params(self):
        ...
        client = AISec(
            app_uk="valid_app",
            oneai_api_key="valid_key"
        )
        
        self.assertEqual(client.app_uk, "valid_app")
        self.assertEqual(client.oneai_api_key, "valid_key")
