...
class ProjectConfig(dict):
    def __init__(__self__, *,
                 configs: Mapping[str, '_types.outputs.ConfigObjConfig'],
                 name: builtins.str,
                 networks: Mapping[str, '_types.outputs.NetworkConfig'],
                 secrets: Mapping[str, '_types.outputs.SecretConfig'],
                 services: Mapping[str, '_types.outputs.ServiceConfig'],
                 volumes: Mapping[str, '_types.outputs.VolumeConfig']):
    ...
    @property
    @pulumi.getter
    def configs(self) -> Mapping[str, '_types.outputs.ConfigObjConfig']:
    ...
    @property
    @pulumi.getter
    def networks(self) -> Mapping[str, '_types.outputs.NetworkConfig']:
        return pulumi.get(self, "networks")

    @property
    @pulumi.getter
    def secrets(self) -> Mapping[str, '_types.outputs.SecretConfig']:
    ...
    @property
    @pulumi.getter
    def volumes(self) -> Mapping[str, '_types.outputs.VolumeConfig']:
