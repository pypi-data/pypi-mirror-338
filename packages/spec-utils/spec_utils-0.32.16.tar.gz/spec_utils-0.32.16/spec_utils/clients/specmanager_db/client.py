...
class Client:
    ...
    def __init__(
        ...
        self.engine = sqlalchemy.create_engine(
            self.engine_params, poolclass=NullPool
        )
    ...
    def set_export_status(
        ...
        **kwargs,
        ...
        # _result = "NULL" if result == None else result
        ...
        **kwargs,
        ...
        try:
            ...
            return self.run_import_lips(
                table=table, lips_name=lips_name, **kwargs
            )
