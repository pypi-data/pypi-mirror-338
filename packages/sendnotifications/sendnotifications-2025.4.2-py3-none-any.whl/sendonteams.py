...
class NotifyMsTeams:
    ...
    def send_message_to_ms_teams(self, webhook, title: str, message_body: str, theme: str = "2DC72D"):
        try:
    ...
    def __init__(self, channel: str = "dba-test-notifications", messages: str = "", header_text: str = None, color: str = "good",
        ...
        if messagetype == 0:
            ...
            self.send_message_to_ms_teams(self.webhook, header_text, message, color)
        elif messagetype == 1:
            ...
            self.send_adaptive_card_to_ms_teams(webhook, adaptive_card)
