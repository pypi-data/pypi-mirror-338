...
class DeviceApi():
    ...
    # 设置设备投屏配置
    def device_airplay_set(self, id: List[str], air_ratio: int, air_refresh: int, air_fps: int, air_audio: int,
                           air_img_fps: int, timeout: int = 0, is_async: bool = False) -> CommonResponse:
        """
        设置设备的投屏配置
        :param id: 设备 ID 列表
