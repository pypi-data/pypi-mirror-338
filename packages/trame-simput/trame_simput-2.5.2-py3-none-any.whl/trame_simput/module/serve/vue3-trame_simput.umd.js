(function(global, factory) {
  ...
  const { ref: ref$7, computed: computed$a, onMounted: onMounted$6, onBeforeUnmount: onBeforeUnmount$5, watch: watch$1, provide: provide$1, inject: inject$a } = window.Vue;
  const emitter = mitt();
  const _sfc_main$b = {
    name: "Simput",
    emits: ["query"],
    ...
    setup(props, { emit }) {
      ...
      const manager = ref$7(null);
      const managerId = ref$7(null);
  ...
  const { ref: ref$6, computed: computed$9, onMounted: onMounted$5, onBeforeUnmount: onBeforeUnmount$4, watch, provide, inject: inject$9 } = window.Vue;
  const _sfc_main$a = {
    name: "SimputItem",
    emits: ["dirty"],
    props: {
    ...
    setup(props) {
      ...
      const data = ref$6(null);
      const ui = ref$6(null);
      const domains = ref$6(null);
  ...
  const _hoisted_2$2 = { style: { "display": "none" } };
  function render$a(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return _ctx.available ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$3, [
      ...
      vue.createElementVNode("span", _hoisted_2$2, vue.toDisplayString(_ctx.data), 1),
  ...
  const { ref: ref$5, computed: computed$8, onMounted: onMounted$4, onBeforeUnmount: onBeforeUnmount$3, inject: inject$8, nextTick, toRef: toRef$5 } = window.Vue;
  ...
  const { ref: ref$4, computed: computed$7, onMounted: onMounted$3, onBeforeUnmount: onBeforeUnmount$2, inject: inject$7, toRef: toRef$4 } = window.Vue;
  const _sfc_main$8 = {
    name: "swSlider",
    props: {
      name: {
    ...
    setup(props) {
      ...
      const dynamicSize = ref$4(props.size);
      const query = ref$4("");
      const { decorator } = useDecorator({
        domains,
                      ...
                      _ctx.computedSizeControl ? (vue.openBlock(), vue.createBlock(_component_v_btn, {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(_component_v_icon, null, {
                            default: vue.withCtx(() => [
                              vue.createTextVNode("mdi-minus-circle-outline")
                            ]),
                            _: 1
                          })
                        ]),
                        _: 2
                      }, 1032, ["onClick", "disabled"])) : vue.createCommentVNode("", true)
                    ]),
                    _: 2
                  }, 1024),
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.hints, (hint, idx) => {
  ...
  const { ref: ref$3, computed: computed$6, onMounted: onMounted$2, onBeforeUnmount: onBeforeUnmount$1, inject: inject$6, toRef: toRef$3 } = window.Vue;
  const _sfc_main$7 = {
    name: "swSwitch",
    props: {
      name: {
  ...
  const { ref: ref$2, computed: computed$5, inject: inject$5 } = window.Vue;
  const _sfc_main$6 = {
    name: "swTextArea",
    props: {
      name: {
  ...
  const { ref: ref$1, computed: computed$4, onMounted: onMounted$1, onBeforeUnmount, inject: inject$4, toRef: toRef$2 } = window.Vue;
  const _sfc_main$5 = {
    name: "swTextField",
    props: {
      name: {
    ...
    setup(props) {
      ...
      const showHelp = ref$1(false);
      const dynamicSize = ref$1(props.size.value);
      const query = ref$1("");
      const { decorator } = useDecorator({
        domains,
      ...
      const addEntry = function addEntry2() {
        ...
        if (props.newValue === "null") {
          ...
          model.value[model.value.length - 1] = model.value[model.value.length - 2];
        }
        validate(dynamicSize.value);
      };
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("div", _hoisted_1$1, [
          _ctx.allowRefresh ? (vue.openBlock(), vue.createBlock(_component_v_btn, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_v_icon, { small: "" }, {
                default: vue.withCtx(() => [
                  vue.createTextVNode("mdi-sync")
                ]),
                _: 1
              })
            ]),
                  ...
                  vue.createVNode(_component_v_row, {
                    ...
                    default: vue.withCtx(() => [
                      ...
                      _ctx.computedSizeControl ? (vue.openBlock(), vue.createBlock(_component_v_btn, {
                        ...
                        _: 2
                      }, 1032, ["onClick", "disabled", "readonly"])) : vue.createCommentVNode("", true)
                    ]),
                    _: 2
                  }, 1024)
                ]),
  ...
  const { computed: computed$3, inject: inject$3, toRef: toRef$1 } = window.Vue;
  const _sfc_main$4 = {
    name: "swProxy",
    props: {
      name: {
  ...
  function render$4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.withDirectives((vue.openBlock(), vue.createBlock(_component_SimputInput, { itemId: _ctx.itemId }, null, 8, ["itemId"])), [
      [vue.vShow, _ctx.decorator.show]
    ]);
  }
