...
class SecurityCompliance(
    ...
    @jsii.data_type(
        ...
        jsii_struct_bases=[SecurityCompliance.DisableableSetting],
        name_mapping={
            "disabled": "disabled",
            "concurrent_execution_count": "concurrentExecutionCount",
        },
    )
    class ReservedConcurrentSettings(SecurityCompliance.DisableableSetting):
        def __init__(
            self,
            *,
    ...
    class StageMethodLogging(SecurityCompliance.DisableableSetting):
        def __init__(
            self,
            *,
            disabled: typing.Optional[builtins.bool] = None,
    ...
    @jsii.data_type(
        ...
        jsii_struct_bases=[],
        name_mapping={
            "cdk_generated": "cdkGenerated",
            "iam_common_cdk_grants": "iamCommonCdkGrants",
    ...
    class Suppressions:
        def __init__(
            self,
            *,
            cdk_generated: typing.Optional[builtins.str] = None,
            iam_common_cdk_grants: typing.Optional[builtins.str] = None,
            ...
            '''
            :param cdk_generated: (experimental) Suppressions to add for CDK Nag on CDK generated resources. If enabled this will suppress ``AwsSolutions-IAM5`` on the policies that are created by CDK Generated Lambda functions, as well as other CDK generated resources such as Log Groups and Step Functions that support CDK generated custom resources. This only applies to resources that are created by the underlying CDK. - Policy suppression: AwsSolutions-IAM5 - Log Group suppression: NIST.800.53.R5-CloudWatchLogGroupEncrypted - Step Function suppression: AwsSolutions-SF1
            :param iam_common_cdk_grants: (experimental) Suppressions to add for CDK Nag on CDK generated policies. If enabled this will add a stack suppression for ``AwsSolutions-IAM5`` on the actions that CDK commonly generates when using ``.grant(...)`` methods.
            ...
            if __debug__:
                ...
                check_type(argname="argument cdk_generated", value=cdk_generated, expected_type=type_hints["cdk_generated"])
                check_type(argname="argument iam_common_cdk_grants", value=iam_common_cdk_grants, expected_type=type_hints["iam_common_cdk_grants"])
            ...
            self._values: typing.Dict[builtins.str, typing.Any] = {}
            if cdk_generated is not None:
                self._values["cdk_generated"] = cdk_generated
            if iam_common_cdk_grants is not None:
                self._values["iam_common_cdk_grants"] = iam_common_cdk_grants
        ...
        @builtins.property
        def cdk_generated(self) -> typing.Optional[builtins.str]:
            ...
            :stability: experimental
            '''
            result = self._values.get("cdk_generated")
            return typing.cast(typing.Optional[builtins.str], result)

        @builtins.property
        def iam_common_cdk_grants(self) -> typing.Optional[builtins.str]:
            ...
            :stability: experimental
            '''
            result = self._values.get("iam_common_cdk_grants")
            return typing.cast(typing.Optional[builtins.str], result)
