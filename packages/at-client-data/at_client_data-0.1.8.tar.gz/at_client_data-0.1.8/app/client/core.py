...
from at_common_schemas.service.data.quote import (
    QuoteGetRequest, QuoteGetResponse, QuoteBatchGetRequest, QuoteBatchGetResponse
)
from at_common_schemas.service.data.news import (
    Category,
    NewsListRequest, NewsListResponse,
    NewsSearchRequest, NewsSearchResponse,
)
from at_common_schemas.service.data.candlestick import (
    CandlestickListRequest, CandlestickListResponse, Interval as CandlestickInterval
)
from at_common_schemas.service.data.entry import (
    StockListResponse,
...
from at_common_schemas.service.data.stock.company import (
    CompanyProfileGetRequest, CompanyProfileGetResponse
)
from at_common_schemas.service.data.stock.analyst import (
...
from at_common_schemas.service.data.stock.calendar import (
...
from at_common_schemas.service.data.stock.financial import (
...
class CoreClient(BaseClient):
    ...
    async def quote_get(self, symbol: str) -> QuoteGetResponse:
        ...
        return await self.post("quote/get", json=request.model_dump())
    ...
    async def quote_batch_get(self, symbols: List[str]) -> QuoteBatchGetResponse:
        ...
        return await self.post("quote/batch-get", json=request.model_dump())
    ...
    async def news_list(
        ...
        return await self.post("news/list", json=request.model_dump())
    ...
    async def news_search(
        ...
        return await self.post("news/search", json=request.model_dump())
    ...
    async def candlestick_list(
        ...
        return await self.post("candlestick/list", json=request.model_dump())
    ...
    async def entry_stock_list(self) -> StockListResponse:
        ...
        Returns:
            Stock list data
        """
        return await self.post("entry/stock/list", json={})
    ...
    async def entry_exchange_list(self) -> ExchangeListResponse:
        ...
        Returns:
            Exchange list data
        """
        return await self.post("entry/exchange/list", json={})
    ...
    async def entry_sector_list(self) -> SectorListResponse:
        ...
        Returns:
            Sector list data
        """
        return await self.post("entry/sector/list", json={})
    ...
    async def entry_industry_list(self) -> IndustryListResponse:
        ...
        Returns:
            Industry list data
        """
        return await self.post("entry/industry/list", json={})
    ...
    async def entry_country_list(self) -> CountryListResponse:
        ...
        Returns:
            Country list data
        """
        return await self.post("entry/country/list", json={})
    ...
    async def stock_company_profile_get(self, symbol: str) -> CompanyProfileGetResponse:
        ...
        return await self.post("stock/company/profile/get", json=request.model_dump())
    ...
    async def stock_analyst_price_target_summary_get(self, symbol: str) -> PriceTargetSummaryGetResponse:
        ...
        return await self.post("stock/analyst/price-target/summary/get", json=request.model_dump())
    ...
    async def stock_analyst_price_target_consensus_get(self, symbol: str) -> PriceTargetConsensusGetResponse:
        ...
        return await self.post("stock/analyst/price-target/consensus/get", json=request.model_dump())
    ...
    async def stock_analyst_grade_detail_list(self, symbol: str, limit: int = 50) -> GradeDetailListResponse:
        ...
        return await self.post("stock/analyst/grade/detail/list", json=request.model_dump())
    ...
    async def stock_analyst_grade_summary_list(self, symbol: str, limit: int = 50) -> GradeSummaryListResponse:
        ...
        return await self.post("stock/analyst/grade/summary/list", json=request.model_dump())
    ...
    async def stock_analyst_grade_consensus_get(self, symbol: str) -> GradeConsensusGetResponse:
        ...
        return await self.post("stock/analyst/grade/consensus/get", json=request.model_dump())
    ...
    async def stock_calendar_earnings_list(self, symbol: str, limit: int = 50) -> CalendarEarningsListResponse:
        ...
        return await self.post("stock/calendar/earnings/list", json=request.model_dump())
    ...
    async def stock_calendar_dividends_list(self, symbol: str, limit: int = 50) -> CalendarDividendsListResponse:
        ...
        return await self.post("stock/calendar/dividends/list", json=request.model_dump())
    ...
    async def stock_calendar_splits_list(self, symbol: str, limit: int = 50) -> CalendarSplitsListResponse:
        ...
        return await self.post("stock/calendar/splits/list", json=request.model_dump())
    ...
    async def stock_financial_income_list(
        ...
        return await self.post("stock/financial/income/list", json=request.model_dump())
    ...
    async def stock_financial_balance_sheet_list(
        ...
        return await self.post("stock/financial/balance_sheet/list", json=request.model_dump())
    ...
    async def stock_financial_cash_flow_list(
        ...
        return await self.post("stock/financial/cash_flow/list", json=request.model_dump())
    ...
    async def stock_financial_income_growth_list(
        ...
        return await self.post("stock/financial/income/growth/list", json=request.model_dump())
    ...
    async def stock_financial_balance_sheet_growth_list(
        ...
        return await self.post("stock/financial/balance_sheet/growth/list", json=request.model_dump())
    ...
    async def stock_financial_cash_flow_growth_list(
        ...
        return await self.post("stock/financial/cash_flow/growth/list", json=request.model_dump())
    ...
    async def stock_financial_comprehensive_growth_list(
        ...
        return await self.post("stock/financial/comprehensive/growth/list", json=request.model_dump())
    ...
    async def stock_financial_metrics_list(
        ...
        return await self.post("stock/financial/metrics/list", json=request.model_dump())
    ...
    async def stock_financial_metrics_ttm_get(self, symbol: str) -> MetricsTTMGetResponse:
        ...
        return await self.post("stock/financial/metrics/ttm/get", json=request.model_dump())
    ...
    async def stock_financial_ratios_list(
        ...
        return await self.post("stock/financial/ratios/list", json=request.model_dump())
    ...
    async def stock_financial_ratios_ttm_get(self, symbol: str) -> RatiosTTMGetResponse:
        ...
        return await self.post("stock/financial/ratios/ttm/get", json=request.model_dump()) 