...
# source: kurrentdbclient/protos/Grpc/gossip.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'kurrentdbclient/protos/Grpc/gossip.proto'
)
