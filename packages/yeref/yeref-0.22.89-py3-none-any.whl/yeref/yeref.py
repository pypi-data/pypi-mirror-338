...
async def save_posts(chat_id, lz, username, bot, data, tz, MEDIA_D, BASE_D, KEYS_JSON, PROJECT_USERNAME, PROJECT_TYPE):
    ...
    try:
        ...
        POST_MEDIA = posts['POST_MEDIA']
        POST_BUTTONS = posts['POST_BUTTONS']
        POST_CHKBOX = posts['POST_CHKBOX']
        ...
        if BOT_TOKEN and len(POST_MEDIA):
            POST_MEDIA, res_bot = await update_media(bot, chat_id, lz, ENT_TID, BOT_TOKEN, POST_MEDIA, MEDIA_D, PROJECT_USERNAME)
        ...
        if POST_APPTOKEN and len(POST_MEDIA):
