...
async def convert_webm_to_mp4(webm_path):
    ...
    try:
        ...
        output_path = os.path.join(MEDIA_D, str(ENT_TID), f"{file_begin}_copy.mp4")
                ...
                try:
                    ...
                    if MSG_TYPE == 'photo':
                        ...
                        if F_NAME.lower().endswith('.webm') and not IS_LINK:
                            ...
                            POST_FNAME_COPY = os.path.join(MEDIA_D, str(BOT_TID), f"{POST_FNAME1}_copy.mp4")
                ...
                if 'filew_id' not in POST_MEDIA[index]:
                    ...
                    if BOT_TOKEN:
                        ...
                        try:
                            ...
                            POST_FNAME_COPY = os.path.join(MEDIA_D, str(ENT_TID), f"{POST_FNAME1}_copy{ext}")
