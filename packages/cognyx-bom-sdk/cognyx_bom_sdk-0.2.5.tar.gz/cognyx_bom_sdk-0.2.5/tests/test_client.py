...
def create_client_with_file_input(bom_file_path: Path, callback: None|Callable = None) -> BomClient:
...
def test_it_gets_instance_attribute():
    ...
    attribute_value = bom_client.get_instance_attribute(
        "a1d86ee1-def4-4abc-9282-96606db4fb0c",
        "Level"
    )
...
def test_it_sets_instance_attribute():
    ...
    bom_client.set_instance_attribute(
        "a1d86ee1-def4-4abc-9282-96606db4fb0c",
        "Level",
        "foobar"
    )
    assert bom_client.get_instance_attribute(
        "a1d86ee1-def4-4abc-9282-96606db4fb0c",
        "Level"
    ) == "foobar"
