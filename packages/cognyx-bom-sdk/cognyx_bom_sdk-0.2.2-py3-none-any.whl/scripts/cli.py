...
def lint(args: Optional[List[str]] = None) -> int:
    """Run linting.
...
def format_code(args: Optional[List[str]] = None) -> int:
    """Run code formatting.
...
def typecheck(args: Optional[List[str]] = None) -> int:
    """Run type checking.
...
def test(args: Optional[List[str]] = None) -> int:
    """Run tests.
