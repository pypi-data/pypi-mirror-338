...
class BomInstanceSystemAttributes(BaseModel):
    ...
    statuses: List[Union[str, BomInstanceSystemStatus]] = Field(default_factory=list)
...
class ObjectType(BaseModel):
    ...
    def get_attribute_id(self, attribute_name: str) -> Union[str, None]:
...
class BomInstance(BaseModel):
    ...
    def get_attribute(self, attribute_name: str) -> Union[str, int, float, bool, dict, list, None]:
    ...
    def set_attribute(
        self, attribute_name: str, value: Union[str, int, float, bool, dict, list, None]
    ) -> None:
    ...
    def set_property(self, property_name: str, value: Union[str, int]) -> None:
    ...
    ) -> Optional[VariabilityConfiguration]:
...
class UpdatePayload(TypedDict):
    ...
    type: BomUpdates
    payload: Union[AttributeUpdatePayload, InstanceUpdatePayload]
...
class Bom(BaseModel):
    ...
    def get_instance(self, name: str) -> Optional[BomInstance]:
    ...
    def get_instance_by_id(self, instance_id: str) -> Optional[BomInstance]:
