...
class BomClient:
    ...
    def __init__(
        ...
        update_callback: Optional[Callable[[UpdatePayload], None]] = None,
    ) -> None:
    ...
    def get_bom_instance(self, name: str) -> Optional[BomInstance]:
    ...
    def get_bom_instance_by_id(self, instance_id: str) -> Optional[BomInstance]:
    ...
    def find_bom_instance(self, predicate: Callable[[BomInstance], bool]) -> Optional[BomInstance]:
    ...
    def set_instance_attribute(
        ...
        if self.update_callback:
            attribute_id = instance.object_type.get_attribute_id(attribute_name)
