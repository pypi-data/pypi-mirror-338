                ...
                with Live(initial_table, refresh_per_second=4, transient=True) as live:
                    ...
                    while True:
                        ...
                        if not transitioning or (changed and previous_instances is not None):
                            ...
                            final_table = table
                            live.update(table)
                            # Exit the loop if changes detected (and not first run)
                            break
...
@click.option('--gpu', type=click.Choice(['t4', 'a100', 'a100xl']), default='a100',
              help='GPU type: T4 (16GB, inference), A100 (40GB, training), A100XL (80GB, training)')
...
@click.option('--gpu', type=click.Choice(['t4', 'a100', 'a100xl']),
              help='New GPU type: T4 (16GB, inference), A100 (40GB, training), A100XL (80GB, training)')
