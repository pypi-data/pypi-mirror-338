...
def gensamplefromxy(static_board_config, net_sample_uuid, x_json, y_json=None, augmentation=False):
    x = json.loads(x_json)
...
def gensample(config, static_board_config_map, sample_raw, augmentation=False):
    ...
    return gensamplefromxy(static_board_config, net_sample_uuid, x_json, y_json)
...
def load_dataset(url, api_key, raw_samples, model_config):
    ...
    return [
        gensample(model_config, static_board_config_map, item, augmentation=False)
