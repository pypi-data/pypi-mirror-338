...
def filter_models_by_name_count(dataset: UMLDataset, min_count: int = 25, max_count: int = 2000, inplace: bool = False) -> list:
    ...
    Args:
        ...
        max_count (int): The maximum number of names a model should have. Defaults to 2000.
        inplace (bool): If True, modifies the dataset in-place. If False, returns a new dataset.
            Defaults to False.
    ...
    Example:
        >>> filtered_dataset = filter_models_by_name_count(dataset, min_count=50, max_count=1000)
