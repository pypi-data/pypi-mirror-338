...
To-do
- Add fallback if classified UNKNOWN
"""
...
def assign_bldgfm(buildings_gdf):
    ...
    # Mapping for 13 fuel models: (fire_resistance, fire_size) -> BLDG_FUEL_MODEL
    # fuel_model_map = {
    #     ('unprotected', 'small'): 1,
    ...
    # Mapping for 7 fuel models: (fire_resistance, occupancy) -> BLDG_FUEL_MODEL
    fuel_model_map = {
        ("unprotected", "RES"): 1,
        ("unprotected", "COM"): 2,
        ("unprotected", "IND"): 3,
    ...
    buildings_gdf.loc[buildings_gdf["BLDG_AREA_m2"] < 85, "BLDG_FUEL_MODEL"] = 7
...
def bldg_fuel_models():
    fuel_model_map = {
        ...
        ("hardened", "COM"): 5,
        ("hardened", "IND"): 6,
        ("small_bldg", "any"): "ST07",  # Special case for buildings < 85 m²
    }
