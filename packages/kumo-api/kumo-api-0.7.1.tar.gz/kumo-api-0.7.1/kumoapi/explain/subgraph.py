...
class SubgraphFeatureStore:
    ...
    def add(
        ...
        """
        self.features[node_id] = {col.name: col for col in cols}
...
class Subgraph:
    ...
    Args:
        subgraph_store (SubgraphStore): The subgraph store, which mainly
            stores the subgraph structure.
        feature_store (FeatureStore): The subgraph feature store, which
            stores the features for each node.
    """
    subgraph_store: SubgraphStore
    feature_store: SubgraphFeatureStore
