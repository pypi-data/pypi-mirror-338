...
def _make_file(uid, data, encoding, metadata: dict | None = None, **kwargs) -> DocumentInterface:
    ...
    return FileInputProvider(fid=uid, encoding=encoding, metadata=metadata, **kwargs)
...
class Factory:
    ...
    @staticmethod
    def from_json(id: str, data: Any, provider_type: str) -> DocumentInterface:
        """
        ...
        :rtype: ``Document``
        """
        return creators.get(provider_type, _invalid_type)(id, data)
