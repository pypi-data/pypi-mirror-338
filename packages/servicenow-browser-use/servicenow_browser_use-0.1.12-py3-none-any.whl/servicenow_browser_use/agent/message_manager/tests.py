...
from servicenow_browser_use.agent.prompts import SystemPrompt
from servicenow_browser_use.agent.views import ActionResult
from servicenow_browser_use.browser.views import BrowserState, TabInfo
from servicenow_browser_use.dom.views import DOMElementNode, DOMTextNode
...
def test_token_overflow_handling_with_real_flow(message_manager: MessageManager, max_tokens):
	...
	for i in range(200):  # Simulate 40 steps of interaction
		...
		from servicenow_browser_use.agent.views import AgentBrain, AgentOutput
...
# pytest -s servicenow_browser_use/agent/message_manager/tests.py
