...
public class SeleniumTest_20250404_092417 {
            ...
            for action in actions:
                ...
                if action_type == "type":
                    ...
                    if element.get("hasShadowDOM"):
                        ...
                        if element.get("id"):
                            code.append(f"            WebElement inputElement = waitForElement(By.id(\"{element.get('id')}\"));")
                        elif element.get("xpath"):
                            code.append(f"            WebElement inputElement = waitForElement(By.xpath(\"{element.get('xpath')}\"));")
                    ...
                    if element.get("hasShadowDOM"):
                        ...
                        if element.get("id"):
                            code.append(f"            WebElement clickElement = waitForElementClickable(By.id(\"{element.get('id')}\"));")
                        elif element.get("xpath"):
                            code.append(f"            WebElement clickElement = waitForElementClickable(By.xpath(\"{element.get('xpath')}\"));")
                    code.append("            clickElement.click();")
                    code.append("            waitForPageLoad();")
