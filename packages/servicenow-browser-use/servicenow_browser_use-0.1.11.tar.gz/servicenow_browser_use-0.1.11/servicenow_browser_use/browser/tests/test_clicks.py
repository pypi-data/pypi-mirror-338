...
from servicenow_browser_use.browser.browser import Browser, BrowserConfig
from servicenow_browser_use.dom.views import ElementTreeSerializer
from servicenow_browser_use.utils import time_execution_sync


# run with: pytest servicenow_browser_use/browser/tests/test_clicks.py
@pytest.mark.asyncio
