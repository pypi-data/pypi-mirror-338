...
from servicenow_browser_use.browser.views import BrowserState, BrowserStateHistory, TabInfo
from servicenow_browser_use.controller.registry.service import Registry
from servicenow_browser_use.controller.views import ClickElementAction, DoneAction, ExtractPageContentAction
from servicenow_browser_use.dom.views import DOMElementNode
...
# run this with:
# pytest servicenow_browser_use/agent/tests.py
