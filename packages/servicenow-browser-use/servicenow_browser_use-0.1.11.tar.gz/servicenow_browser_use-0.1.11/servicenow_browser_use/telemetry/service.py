...
from servicenow_browser_use.telemetry.views import BaseTelemetryEvent
from servicenow_browser_use.utils import singleton
...
class ProductTelemetry:
	...
	USER_ID_PATH = str(Path.home() / '.cache' / 'servicenow_browser_use' / 'telemetry_user_id')
