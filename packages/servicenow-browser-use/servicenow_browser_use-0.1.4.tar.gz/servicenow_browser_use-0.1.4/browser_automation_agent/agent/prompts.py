...
2. ACTIONS: You can specify multiple actions in the list to be executed in sequence. But always specify only one action name per item.
   ...
   - Custom prompt mapping:Use custom prompt with the following mapping:[
    {"prompt": "log in", "action": "Open https://k8s0722360-node1.thunder.devsnc.com/now/workflow-studio/home/process ,then wait for page to load, reload the page. login with username: a, password: b then click on login button."}
    {"prompt": "login with username 'a' and password 'b'", "action": "Open https://k8s0722360-node1.thunder.devsnc.com/now/workflow-studio/home/process ,then wait for page to load, reload the page. login with username: a, password: b then click on login button."},
