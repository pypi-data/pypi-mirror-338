...
from browser_automation_agent.dom.history_tree_processor.view import HashedDomElement
...
class SelectorMap:
    def __init__(self):
        self._map: Dict[int, DOMElementNode] = {}

    def __getitem__(self, key: int) -> DOMElementNode:
        return self._map[key]

    def __setitem__(self, key: int, value: DOMElementNode) -> None:
        self._map[key] = value
