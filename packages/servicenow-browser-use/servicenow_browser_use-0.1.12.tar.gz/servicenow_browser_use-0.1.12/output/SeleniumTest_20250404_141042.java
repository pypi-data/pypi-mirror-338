...
public class SeleniumTest_20250404_141042 {
    ...
    public void testServiceNowAutomation() {{
        try {{
            ...
            // Click shadow DOM element
            WebElement clickElement = findElementWithShadowDOM("macroponent-d469c54f433f61106c4bb0117fb8f267 >>> sn-user-preferences-provider#userPrefProvider >>> sn-aria-live-region >>> now-popover-panel >>> seismic-hoist >>> seismic-hoist#behavior-tooltip");
            clickElement.click();
            waitForPageLoad();
