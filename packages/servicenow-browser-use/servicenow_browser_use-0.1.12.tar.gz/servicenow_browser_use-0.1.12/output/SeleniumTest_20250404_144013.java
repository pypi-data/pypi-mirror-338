...
public class SeleniumTest_20250404_144013 {
    ...
    public void testServiceNowAutomation() {{
        try {{
            ...
            WebElement clickElement = findElementWithShadowDOM("macroponent-d469c54f433f61106c4bb0117fb8f267");
            clickElement.click();

            // Click shadow DOM element
            WebElement clickElement = findElementWithShadowDOM("macroponent-d469c54f433f61106c4bb0117fb8f267 >>> seismic-hoist#logo-tooltip");
            clickElement.click();

            // Click shadow DOM element
            WebElement clickElement = findElementWithShadowDOM("macroponent-d469c54f433f61106c4bb0117fb8f267 >>> sn-user-preferences-provider#userPrefProvider >>> sn-aria-live-region >>> seismic-hoist#logo-tooltip");
            clickElement.click();
