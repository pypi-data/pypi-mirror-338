...
public class SeleniumTest_20250404_141636 {
    ...
    public void testServiceNowAutomation() {{
        try {{
            ...
            WebElement clickElement = findElementWithShadowDOM("macroponent-d469c54f433f61106c4bb0117fb8f267 >>> sn-user-preferences-provider#userPrefProvider >>> sn-aria-live-region");
            clickElement.click();
            waitForPageLoad();
