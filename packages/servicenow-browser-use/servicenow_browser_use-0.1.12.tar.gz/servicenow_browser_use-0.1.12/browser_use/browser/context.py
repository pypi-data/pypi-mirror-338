...
from browser_use.browser.shadow_dom import setup_shadow_dom_listeners, handle_console
from browser_use.browser.streamlined_recorder import StreamlinedRecorder
