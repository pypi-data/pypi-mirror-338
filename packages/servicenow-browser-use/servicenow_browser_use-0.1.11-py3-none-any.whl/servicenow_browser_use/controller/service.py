...
from servicenow_browser_use.agent.views import ActionModel, ActionResult
...
from servicenow_browser_use.controller.views import (
	ClickElementAction,
	DoneAction,
...
from servicenow_browser_use.utils import time_execution_async, time_execution_sync
...
class Controller:
	...
	def _register_default_actions(self):
		...
		async def input_text(params: InputTextAction, browser: BrowserContext):
			...
			element_node = state.selector_map[params.index]
			await browser._input_text(element_node, params.text)
