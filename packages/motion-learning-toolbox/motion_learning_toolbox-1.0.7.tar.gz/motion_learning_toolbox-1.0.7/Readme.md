...
3. ["Versatile User Identification in Extended Reality using Pretrained Similarity-Learning"](https://arxiv.org/abs/2302.07517), 2023, C. Rack, K. Kobs, T. Fernando, A. Hotho, M. E. Latoschik, *arXiv e-prints*
