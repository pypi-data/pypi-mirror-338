...
SOCIAL_SHARE_PARAMS={
    "x":{
        ...
        "params":{
            ...
            "url":{"alias":["url","u","link","site","domain","intentUrl","link_address","address","canonical"],"description":"A URL to include in the tweet."},
     ...
     "facebook":{
         ...
         "params":{
             "u":{"alias":["url","u","link","site","domain","intentUrl","link_address","address","canonical"],"description":"The URL you want to share."}
             },
    ...
    "minds":{
        ...
        "params":{
            "intentUrl":{"alias":["url","u","link","site","domain","intentUrl","link_address","address","canonical"],"description":"A URL to include in the post."}
            },
    ...
    for key,value in output_params.items():
        if value:
            ...
            if url == None:
               ...
               url += f"{url}&{key}={value}"
    return url
def create_post_url(platform,text=None,url=None,via=None,hashtags=None):
