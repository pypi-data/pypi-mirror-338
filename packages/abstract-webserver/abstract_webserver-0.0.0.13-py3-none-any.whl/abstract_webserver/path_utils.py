...
def get_server_mgr(src_folder=None,domain=None,imgs_dir=None,fb_id=None,directory=None):
    server_mgr = serverManager(src_folder=src_folder,domain=domain,imgs_dir=imgs_dir,fb_id=fb_id,directory=directory)
    return server_mgr
def get_abs_path():
