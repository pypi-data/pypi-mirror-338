...
class serverManager(metaclass=SingletonMeta):
    def __init__(self, src_dir=None,domain=None,imgs_dir=None,fb_id=None,directory=None):
        ...
        self.pages_dir = os.path.join(src_dir, "pages")
        self.json_dir = os.path.join(src_dir, "json_pages")
        self.contents_dir = os.path.join(src_dir, "contents")
        self.public_dir = os.path.join(src_dir, "../public")
