...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 定义“表征`二维数据区域平滑器`的类”。
...
#       Jiwei Huang        0.0.1         2024/09/04     revise
#       Jiwei Huang        0.0.1         2024/09/06     revise
...
from ..datastruct import Data2dRegion
...
class Data2dRegionSmoother(Data2dRegion, ABC):
    ...
    def __init__(
        self,
        data_y: NumberArrayLike,
        data_x: Optional[NumberArrayLike] = None,
        region_start: int = 0,
