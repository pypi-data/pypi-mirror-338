...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 定义“表征`样本`”的类。
#                   Outer Parameters: xxxxxxx
# Class List:       Specimen -- 表征“样本”。
...
class Specimen(DataAnalyzer):
    ...
    抽象类`Specimen`表征“样本”。
        ...
        而样本名与测试编号可合并得到：
            ...
            1. 样品名称（sample_name）：str,样本名_测试编号。
    """
    ...
    def __init__(self, **kwargs):
        ...
        if 'specimen_name' in kwargs:
            ...
            if __specimen_name is not None and isinstance(__specimen_name, str):
                self.__specimen_name: str = __specimen_name
            else:
        ...
        if 'specimen_no' in kwargs:
            ...
            if __specimen_no is not None and isinstance(__specimen_no, int):
