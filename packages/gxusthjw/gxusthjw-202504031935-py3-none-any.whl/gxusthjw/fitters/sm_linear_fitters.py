...
from ..commons import NumberArrayLike, unique_string
...
# 定义 ==============================================================
def static_linear_fitting_sm(y: NumberArrayLike, x: NumberArrayLike, **kwargs):
    """
...
def interactive_linear_fitting_sm(y: NumberArrayLike, x: NumberArrayLike, **kwargs):
    """
    基于statsmodels提供的线性拟合方法（OLS或RLM）对指定的数据（y，x）执行拟合。
