...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 定义“表征`POOTAB-PT1198GDP拉伸仪输出
#                                  文件`”的类。
#                                  POOTAB是东莞市宝大仪器有限公司的产品的商标，
...
#       Jiwei Huang        0.0.1         2024/09/29     revise
# ------------------------------------------------------------------
# 导包 ==============================================================
...
__doc__ = """
Defining a class that represents ‘output file of POOTAB-PT1198GDP
 tensioner’.
"""
__all__ = [
    'PootabPt1198Gdp'
