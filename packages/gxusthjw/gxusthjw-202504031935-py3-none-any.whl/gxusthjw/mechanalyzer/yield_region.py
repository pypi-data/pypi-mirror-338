...
# ------------------------------------------------------------------
# File Name:        yield_region.py
# Author:           Jiwei Huang
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 定义“屈服区域”相关的函数和类。
...
from ..commons import NumberArrayLike
...
__doc__ = """
Defining the functions and classes  associated with 'yield region'.
"""
...
# 定义 ============================================================
class YieldRegion(Data2dRegionViewSmLinearFitter):
    """
    类`YieldRegion`表征“应力应变曲线的屈服区域”。
    """

    def __init__(
        self,
        stress: NumberArrayLike,
        strain: Optional[NumberArrayLike] = None,
        region_start: int = 0,
        ...
        """
        类`YieldRegion`的初始化方法。

        :param stress: 应力应变曲线的应力数据。
        :param strain: 应力应变曲线的应变数据。
        ...
        """
        # -----------------------------------------------------------------
        super(YieldRegion, self).__init__(
            data_y=stress,
            data_x=strain,
