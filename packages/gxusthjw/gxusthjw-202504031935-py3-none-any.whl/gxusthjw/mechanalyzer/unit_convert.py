...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 定义与“单位转换”相关的函数。
...
# 定义 ============================================================
def length_unit_to_mm(length: Union[NumberArrayLike, Number],
                      unit: str) -> Union[NumberArrayLike, Number]:
    """
...
def force_unit_to_cn(force: Union[NumberArrayLike, Number],
                     unit: str) -> Union[NumberArrayLike, Number]:
    """
...
def area_unit_to_mm2(area: Union[NumberArrayLike, Number],
                     unit: str) -> Union[NumberArrayLike, Number]:
    """
...
def time_unit_to_s(time: Union[NumberArrayLike, Number],
                   unit: str) -> Union[NumberArrayLike, Number]:
    """
...
def speed_unit_to_mms(speed: Union[NumberArrayLike, Number],
                      unit: str) -> Union[NumberArrayLike, Number]:
    """
