...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 基于scipy.signal.savgol_filter，
#                                  对指定数据执行滤波处理。
...
def simple_interactive_savgol_filter(
        y: NumberArrayLike,
        x: Optional[NumberArrayLike] = None,
...
# =========================================================================
def interactive_savgol_filter(y: NumberArrayLike,
                              x: Optional[NumberArrayLike] = None,
                              **kwargs):
    """
...
# =========================================================================
def static_savgol_filter(y: NumberArrayLike,
                         x: Optional[NumberArrayLike] = None,
                         **kwargs):
    """
