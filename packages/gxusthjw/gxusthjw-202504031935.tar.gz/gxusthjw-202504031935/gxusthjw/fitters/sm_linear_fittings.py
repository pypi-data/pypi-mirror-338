...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 基于`statsmodels`包提供的线性拟合方法，
#                                  对指定的数据（y，x）执行拟合。
...
def linear_fitting_sm_rlm(y: NumberArrayLike, x: NumberArrayLike) -> Any:
    """
...
# noinspection PyTypeChecker
def linear_fitting_sm_ols(y: NumberArrayLike, x: NumberArrayLike) -> Any:
    """
...
def linear_fitting_sm(
    y: NumberArrayLike, x: NumberArrayLike, method: str = "ols"
) -> Any:
    """
