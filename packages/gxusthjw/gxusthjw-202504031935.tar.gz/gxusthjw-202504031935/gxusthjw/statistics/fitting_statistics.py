...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 定义与“拟合统计”相关的类和函数。
...
#       Jiwei Huang        0.0.1         2024/10/18     finish
# ------------------------------------------------------------------
# 导包 ==============================================================
...
def rsquared(y_true: NumberArrayLike,
             y_pred: NumberArrayLike):
    """
    计算拟合优度（R^2）。
...
def chisqr(y_true: NumberArrayLike,
           y_pred: NumberArrayLike):
    """
...
def chisqr_p(y_true: NumberArrayLike,
             y_pred: NumberArrayLike,
             nvars_fitted: int):
    """
    计算卡方检验的p值。
...
def redchi(y_true: NumberArrayLike,
           y_pred: NumberArrayLike,
           nvars_fitted: int):
    """
...
# noinspection DuplicatedCode
def aic(y_true: NumberArrayLike,
        y_pred: NumberArrayLike,
        nvars_fitted: int):
    """
...
# noinspection DuplicatedCode
def bic(y_true: NumberArrayLike,
        y_pred: NumberArrayLike,
        nvars_fitted: int):
    """
...
class FittingStatistics(Residuals):
    ...
    def __init__(self, y_true: NumberArrayLike,
                 y_pred: NumberArrayLike,
