...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 测试file_path.py。
...
from .file_path import (sep_file_path,
                        join_file_path,
...
class TestFilePath(unittest.TestCase):
    ...
    def test_get_this_path(self):
        ...
        print(get_this_path())
        self.assertEqual(
            r"I:\Projects\Aliyun\huangjiwei\gxusthjw-workbench\Python\gxusthjw-pythons\Packages\package-gxusthjw"
            r"\gxusthjw\commons",
            get_this_path())
    ...
    def test_get_project_path(self):
        ...
        self.assertEqual(r"I:\Projects\Aliyun\huangjiwei\gxusthjw-workbench\Python\gxusthjw-pythons",
                         get_project_path())
