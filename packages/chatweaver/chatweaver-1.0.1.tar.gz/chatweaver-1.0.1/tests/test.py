...
my_api = "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"
here = str(pathlib.Path(__file__).parent / "data.txt")
pkl_path = str(pathlib.Path(__file__).parent / "pkl_data.txt")

def save_chats(n):
    model = cw.Model(
        model="gpt-4o", api_key="sk-KPOY9tZ03J0zX6BDXoi29BAUHFVYa34dAAz2zHD8q2T3BlbkFJ7zn_V7x2qEgQ7R6ihDWMfKd8EZI873wU-TLzoupn8A"
        )

    bot = cw.Bot(
        rules=cw.chat_weaver_rules["default"], 
        name="AiBot", 
        cw_model=model
        )
...
def test_model() -> None:
    ...
    model_instance.model_api_key = "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"
...
def test_archive() -> None:
    from src.chatweaver import CWArchive, Chat
...
if __name__ == "__main__":
    ...
    # load_multiprocessing(archive=archive)
