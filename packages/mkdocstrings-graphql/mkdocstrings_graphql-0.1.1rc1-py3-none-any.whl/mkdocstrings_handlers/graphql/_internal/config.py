...
class GraphQLOptions:
    ...
    Attributes:
        ...
        show_root_full_path: (Docstrings) Show the full path for the root
            object heading.
        show_root_heading: (Heading) Show the heading of the object at the root
            of the documentation tree. The root object is the object referenced
            by the identifier after `:::`.
    ...
    show_root_heading: bool = field(default=False)
