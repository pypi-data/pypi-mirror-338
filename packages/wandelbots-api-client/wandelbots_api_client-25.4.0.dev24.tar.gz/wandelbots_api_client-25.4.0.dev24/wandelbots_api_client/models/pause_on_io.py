...
class PauseOnIO(BaseModel):
    ...
    """ # noqa: E501
    io: IOValue
    comparator: Comparator = Field(description="Comparator for the comparison of two values. The lest side of the comparison is the measured I/O value and the right side is the expected I/O value. ")
