...
class Category(models.Model):
    ...
    extract_metadata = models.BooleanField(default=False, null=False, blank=False, verbose_name=_("Generate metadata"), help_text=_("Generate metadata for this category if file type is compatible."))
