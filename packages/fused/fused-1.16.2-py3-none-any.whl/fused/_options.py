...
class Options(OptionsBaseModel):
    ...
    """Base delay before retrying a UDF run in seconds"""
    run_retry_base_delay: int = 1

    efs_items_per_request: int = 500
    """ Maximum number of items to retrieve per page in EFS API requests. """
