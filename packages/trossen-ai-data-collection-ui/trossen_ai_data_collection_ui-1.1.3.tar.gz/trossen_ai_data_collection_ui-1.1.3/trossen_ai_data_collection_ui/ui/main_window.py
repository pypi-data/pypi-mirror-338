...
from trossen_ai_data_collection_ui.utils.constants import TROSSEN_AI_ROBOT_PATH,TROSSEN_AI_TASK_PATH,PACKAGE_ROOT
from trossen_ai_data_collection_ui.utils.utils import load_config, paintEvent, set_image, get_last_episode_index, create_robot_config,  remove_corrupted_files
...
def safe_disconnect(func):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        for arg in args:
            if hasattr(arg, "disconnect") and hasattr(arg, "is_connected"):  # Assuming `Robot` is the correct class name.
                robot = arg
                break
...
class MainWindow(QMainWindow):
    ...
    def edit_robot_config(self) -> None:
        ...
        """
        self.open_edit_dialog("Edit Robot Configuration", TROSSEN_AI_ROBOT_PATH)  # Call the open_edit_dialog method.
    ...
    def edit_task_config(self) -> None:
        ...
        """
        self.open_edit_dialog("Edit Task Configuration", TROSSEN_AI_TASK_PATH)  # Call the open_edit_dialog method.
        ...
        def log_dt(shortname: str, dt_val_s: float) -> None:
            ...
            if fps is not None:  # Check for FPS consistency.
                ...
                if actual_fps < fps - 1:  # Highlight low FPS in yellow.
                    info_str = f'<span style="color:yellow;">{info_str}</span>'  # Use HTML for coloring.
