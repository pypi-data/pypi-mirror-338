...
<%block name="mainblock">
        ...
        <% url=request.current_route_path(_query=dict(template_id=template.id)) %>
            <li>
                <a href="${url}" class="icon">
                    <svg>
                        <use href="${request.static_url('caerp:static/icons/endi.svg')}#file-alt"></use>
                    </svg>
    ...
    <div class='alert alert-info'>
        <span class="icon"><svg>
                <use href="${request.static_url('caerp:static/icons/endi.svg')}#info-circle"></use>
            </svg></span>
    ...
    <div class='actions'>
        <a class='btn' href="${admin_url}">
            <svg>
                <use href="${request.static_url('caerp:static/icons/endi.svg')}#plus"></use>
            </svg>
