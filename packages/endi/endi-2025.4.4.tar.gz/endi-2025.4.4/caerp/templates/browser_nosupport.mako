...
<%block name="content">
    <div class="content_vertical_double_padding align_center">
        <h2 class="content_vertical_double_padding">
            Votre navigateur n'est pas compatible avec enDI
        </h2>
        ...
        <p class="content_vertical_double_padding">
            ...
            % else:
                Il est conseillé d'utiliser le navigateur <strong>Firefox</strong> pour utiliser enDI. Vous pouvez le télécharger depuis le site : 
            % endif
    ...
    <div class="content_vertical_double_padding align_center collapsible">
        <h2 class="title collapse_title">
            <a href="javascript:void(0);" onclick="toggleCollapse( this );" aria-expanded="false" title="Afficher le moyen d’accéder quand même à enDI" aria-label="Afficher le moyen d’accéder quand même à enDI">
                <small>> Accéder quand même à enDI</small>
            </a>
        </h2>
        <div class="collapse_content" hidden>
            <div class="content">
                <form action="/login" method="post" class="content_vertical_double_padding">
                    <div>
                        <p>Si vous souhaitez malgré tout accéder à enDI, bien que cela pourrait entrainer des erreurs, vous pouvez outrepasser le contrôle de support du navigateur.</p>
                    </div>
                    <div>
                        <label for="force_support">
                            <input type="checkbox" name="force_support" id="force_support" required /> 
                            Je comprend qu'en poursuivant l'utilisation d'enDI avec ce navigateur des problèmes pourraient survenir sur certaines pages
                        </label>
                    </div>
                    <div>
                        <button type="submit" class="btn">Accéder à enDI</button>
                    </div>
                </form>
            </div>
        </div>
