			...
			<div>
				<h3>
					% if not company.active:
						<small><span class="icon status closed"><svg><use href="${request.static_url('caerp:static/icons/endi.svg')}#lock"></use></svg></span></small>
					% endif
		...
		<div class="data_display content_vertical_padding">
			...
			<dl class="data_number">
				<% accounting_data = [
					...
					('Compte de banque', company.bank_account),
				]
				%>
