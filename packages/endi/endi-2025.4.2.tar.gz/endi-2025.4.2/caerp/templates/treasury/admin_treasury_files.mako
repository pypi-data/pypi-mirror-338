                    ...
                    <tr>
                        ...
                        <td class="col_select">
                            ...
                            <span class="icon" title="e-mail non renseigné" aria-label="e-mail non renseigné">
                                <svg class="caution"><use href="${request.static_url('caerp:static/icons/endi.svg')}#exclamation-circle"></use></svg>
                            </span>
                            % endif
                        </td>
                        ...
                        <td class="col_text">
                            <a href="${file_obj.url(request, company_id=id_)}" title="Visualisez le fichier" aria-label="Visualisez le fichier">
                                ${filename}&nbsp;
                                <span class="icon">
                                    <svg><use href="${request.static_url('caerp:static/icons/endi.svg')}#file-pdf"></use></svg>
                                </span>
                            </a>
                        </td>
                        <td>
                            % if file_obj.is_in_mail_history(file_dict['company']):
                                <span class="icon" title="Déjà envoyé" aria-label="Déjà envoyé">
                                    <svg><use href="${request.static_url('caerp:static/icons/endi.svg')}#check"></use></svg>
                                </span>
                            % endif
                        </td>
                    </tr>
        ...
        <div class="content_vertical_padding">
            <div class="form-actions">
                <button class="btn btn-primary"
                    ...
                    <svg><use href="${request.static_url('caerp:static/icons/endi.svg')}#arrow-right"></use></svg>
