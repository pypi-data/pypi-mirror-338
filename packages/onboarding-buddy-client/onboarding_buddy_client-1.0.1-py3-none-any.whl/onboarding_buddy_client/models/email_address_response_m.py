...
class EmailAddressResponseM(BaseModel):
    ...
    email_status: Optional[StrictInt] = Field(default=None, alias="emailStatus")
    ...
    domain_age_days: Optional[StrictInt] = Field(default=None, alias="domainAgeDays")
    ...
    check_status: Optional[StrictInt] = Field(default=None, alias="checkStatus")
    has_sanction_match: Optional[StrictBool] = Field(default=None, alias="hasSanctionMatch")
    sanction_record: Optional[EmailSanctionRecordM] = Field(default=None, alias="sanctionRecord")
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "emailAddress", "emailStatus", "freeEmail", "didYouMean", "domain", "domainAgeDays", "smtpProvider", "mxFound", "mxRecord", "isDisposableDomain", "checkStatus", "hasSanctionMatch", "sanctionRecord"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domainAgeDays": obj.get("domainAgeDays"),
            ...
            "hasSanctionMatch": obj.get("hasSanctionMatch"),
