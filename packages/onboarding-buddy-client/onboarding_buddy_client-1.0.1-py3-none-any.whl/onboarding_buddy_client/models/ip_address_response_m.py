...
class IpAddressResponseM(BaseModel):
    """
    IpAddressResponseM
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["messageId", "correlationId", "idempotencyKey", "inError", "errorType", "messages", "ipAddress", "isoCode", "country", "threat", "riskLevel", "isTorAddress", "isVpnAddress", "checkStatus"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IpAddressResponseM from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IpAddressResponseM from a dict"""
        if obj is None:
            return None
