...
_ModelComponent = Union[Cone, Var, PsdVar, Constraint,
                        LmiConstraint, QConstraint, PsdConstraint, GenConstr, SOS]
...
class ExpConeArray:
    def __init__(
        self,
        cones: Optional[Union[ExpCone, Iterable[ExpCone], Mapping[Any, ExpCone]]]
    ) -> None: ...
    ...
    def pushBack(
        self, cone: Union[ExpCone, Iterable[ExpCone], Mapping[Any, ExpCone]]) -> None: ...
...
class ExpConeBuilderArray:
    def __init__(
        self,
        conebuilders: Optional[Union[ExpConeBuilder,
                                     Iterable[ExpConeBuilder], Mapping[Any, ExpConeBuilder]]] = None
    ) -> None: ...
    ...
    def pushBack(
        self,
        conebuilder: Union[ExpConeBuilder,
                           Iterable[ExpConeBuilder], Mapping[Any, ExpConeBuilder]]
    ) -> None: ...
...
class AffineConeArray:
    def __init__(
        self,
        cones: Optional[Union[AffineCone, Iterable[AffineCone], Mapping[Any, AffineCone]]]
    ) -> None: ...
    ...
    def pushBack(
        self, cone: Union[AffineCone, Iterable[AffineCone], Mapping[Any, AffineCone]]) -> None: ...
...
class AffineConeBuilder:
    ...
    def setBuilder(
        self,
        conetype: int,
        exprs: Union[MLinExpr, MPsdExpr, _PsdExprLike, Iterable[_PsdExprLike], Mapping[Any, _PsdExprLike]]
    ) -> None: ...
    ...
    def getPsdExprs(self, idx: Optional[Iterable[int]] = None) -> Union[List[PsdExpr], MPsdExpr]: ...
    def getExprs(self,
...
class AffineConeBuilderArray:
    def __init__(
        self,
        conebuilders: Optional[Union[AffineConeBuilder,
                                     Iterable[AffineConeBuilder], Mapping[Any, AffineConeBuilder]]] = None
    ) -> None: ...
    ...
    def pushBack(
        self,
        conebuilder: Union[AffineConeBuilder,
                           Iterable[AffineConeBuilder], Mapping[Any, AffineConeBuilder]]
    ) -> None: ...
...
class PsdVar:
    ...
    def __getitem__(
        self, 
        idx: Union[int, slice, Tuple[Union[int, slice], ...]]
        ) -> MPsdExpr: ...
...
class LmiConstrArray:
    def __init__(
        self,
        constrs: Optional[Union[LmiConstraint,
                                Iterable[LmiConstraint], Mapping[Any, LmiConstraint]]] = None
    ) -> None: ...

    def __getitem__(self, idx: int) -> LmiConstraint: ...
    def __iter__(self) -> LmiConstrArray: ...
    def __next__(self) -> LmiConstraint: ...
    def pushBack(self, constrs: Union[LmiConstraint,
                                      Iterable[LmiConstraint], Mapping[Any, LmiConstraint]]) -> None: ...
...
class LmiExpr:
    ...
    def __init__(
        self,
        arg1: Var,
        arg2: Union[SymMatrix, SymMatExpr]
    ) -> None: ...
    ...
    def __add__(self, other: Union[LmiExpr,
                SymMatrix, SymMatExpr]) -> LmiExpr: ...

    def __radd__(self, other: Union[LmiExpr,
                 SymMatrix, SymMatExpr]) -> LmiExpr: ...

    def __iadd__(self, other: Union[LmiExpr,
                 SymMatrix, SymMatExpr]) -> LmiExpr: ...

    def __sub__(self, other: Union[LmiExpr,
                SymMatrix, SymMatExpr]) -> LmiExpr: ...

    def __rsub__(self, other: Union[LmiExpr,
                 SymMatrix, SymMatExpr]) -> LmiExpr: ...
    def __isub__(self, other: Union[LmiExpr,
                 SymMatrix, SymMatExpr]) -> LmiExpr: ...
...
class Model:
    ...
    def addVars(
        ...
        *,
        ...
        ub: Union[float, Iterable[float],
                  Iterable[Iterable[float]]] = COPT.INFINITY,
        obj: Union[float, Iterable[float], Iterable[Iterable[float]]] = 0.0,
        vtype: Union[str, Iterable[str],
                     Iterable[Iterable[str]]] = COPT.CONTINUOUS,
        nameprefix: str = "C"
    ) -> tupledict[Any, Var]: ...
    ...
    def addCones(
        self,
        vars: Union[ConeBuilderArray, MVar],
        ctype: int = None
    ) -> ConeArray: ... 
    ...
    def addExpCone(
        self,
        vars: Union[VarArray, Iterable[Var], Mapping[Any, Var]],
        ctype: int
    ) -> ExpCone: ...
    ...
    def addExpCones(
        self,
        vars: Union[ExpConeBuilderArray, MVar],
        ctype: int = None
    ) -> ExpConeArray: ... 
    ...
    def getGenConstrIndicators(
        self, genconstrs: List[GenConstr]) -> GenConstrBuilderArray: ...
    ...
    def getExpConeBuilders(
        self,
        cones: Union[Iterable[ExpCone], Mapping[Any, ExpCone]] = None
    ) -> ExpConeBuilderArray: ...
    ...
    @overload
    def getCoeff(self, constr: Union[Constraint,
                 LmiConstraint], var: Var) -> float: ...
    ...
    @overload
    def setCoeff(self, constr: LmiConstraint, var: Var,
    ...
    def setNames(
        self,
        args: Union[Var, PsdVar, Constraint, GenConstr, QConstraint, PsdConstraint, LmiConstraint],
        names: str
    ) -> None: ...
    ...
    def setNames(
        self,
        args: Iterable[Union[Var, PsdVar, Constraint, GenConstr, QConstraint, PsdConstraint, LmiConstraint]],
    ...
    def setNames(
        self,
        args: Mapping[_T, Union[Var, PsdVar, Constraint, GenConstr, QConstraint, PsdConstraint, LmiConstraint]],
    ...
    def setNames(
        self,
        args: Union[VarArray, ConstrArray, GenConstrArray, QConstrArray, PsdVarArray, PsdConstrArray, LmiConstrArray],
        names: Union[str, Iterable[str]]
    ) -> None: ...
...
class MConstrBuilder:
    ...
    def setBuilder(
        self,
        expr: Union[MLinExpr, _LinExprLike, Iterable[_LinExprLike], Mapping[Any, _LinExprLike]],
        sense: str,
...
class MQConstrBuilder:
    ...
    def setBuilder(
        self,
        expr: Union[MQuadExpr, _QuadExprLike, Iterable[_QuadExprLike], Mapping[Any, _QuadExprLike]],
        sense: str,
...
class MPsdConstr(MBase):
    ...
    def pick(self, indexes: Union[List[int], List[List[int]], NdArray]) -> MPsdConstr: ...
    def squeeze(self, axis: int = 0) -> MPsdConstr: ...
    def stack(self, other: Union[PsdConstraint, MPsdConstr], axis: int) -> MPsdConstr: ...
...
class MPsdConstrBuilder:
    ...
    def setBuilder(
        self,
        expr: Union[MPsdExpr, _PsdExprLike, Iterable[_PsdExprLike], Mapping[Any, _PsdExprLike]],
        sense: str,
...
class MQuadExpr(MBase):
    ...
    def pick(self, indexes: Union[List[int], List[List[int]], NdArray]) -> MQuadExpr: ...
...
class MPsdExpr(MBase):
    ...
    def addTerm(self, var: Union[Var, PsdVar], mat: Union[float, SymMatrix, SymMatExpr]) -> None: ...
    def addTerms(self, vars: MVar, coeffs: Union[float, List[float]]) -> None: ...
    def addLinExpr(self, expr: Union[LinExpr, ExprBuilder], mult: float = 1.0) -> None: ...
    def addPsdExpr(self, expr: PsdExpr, mult: float = 1.0) -> None: ...
    def addMLinExpr(self, exprs: MLinExpr, mult: float = 1.0) -> None: ...
    ...
    def __matmul__(
        self, other: Union[float, Iterable[float], NdArray]) -> MPsdExpr: ...
...
class View:
    ...
    def apply(self, idx: Union[int, slice, Tuple[Union[int, slice], ...]] = None) -> View: ...
...
class NdArray:
    ...
    @overload
    def __add__(self, other: Union[float, List[float], List[List[float]]]) -> NdArray: ...
    @overload
    ...
    @overload
    def __sub__(self, other: Union[float, List[float], List[List[float]]]) -> NdArray: ...
    @overload
    ...
    @overload
    def __mul__(self, other: Union[float, List[float], List[List[float]]]) -> NdArray: ...
    @overload
    ...
    @overload
    def __matmul__(self, other: Union[float, List[float], List[List[float]]]) -> NdArray: ...
    @overload
