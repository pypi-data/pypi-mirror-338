...
_option_group = "remote_policy"
_options = [
    cfg.StrOpt('server_url',
               default='http://localhost:8000/check',
               help='Remote policy server URL'),
    cfg.StrOpt('service',
               default='global',
               help='Global or specific service'),
    cfg.IntOpt('timeout',
               default=2,
               help='Request timeout in seconds'),
    cfg.BoolOpt('fail_closed',
                default=True,
                help='Deny access if server is unreachable'),
    cfg.BoolOpt('ssl_verify',
                default=False,
                help='Verify SSL certificates'),
    cfg.BoolOpt('verify_server_crt',
                help=_("server identity verification for REST based "
                       "policy check"),
                default=False),
    cfg.StrOpt('ca_crt_file',
               help=_("Absolute path to ca cert file for REST based "
                      "policy check")),
    cfg.StrOpt('client_crt_file',
               help=_("Absolute path to client cert for REST based "
                      "policy check")),
    cfg.StrOpt('client_key_file',
