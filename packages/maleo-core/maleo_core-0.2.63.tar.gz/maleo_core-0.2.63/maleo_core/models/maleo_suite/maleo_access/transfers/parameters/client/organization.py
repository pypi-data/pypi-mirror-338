...
class MaleoAccessOrganizationClientParameters:
    class Get(MaleoAccessOrganizationGeneralParameters.Get, BaseClientParameters.Get): pass
    class GetQuery(MaleoAccessOrganizationGeneralParameters.Get, BaseClientParameters.GetQuery): pass