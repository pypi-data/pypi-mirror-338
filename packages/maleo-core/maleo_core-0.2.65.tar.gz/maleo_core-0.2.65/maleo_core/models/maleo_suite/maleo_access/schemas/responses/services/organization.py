...
class MaleoAccessOrganizationServiceResponsesSchemas:
    ...
    class GetMultipleResponse(BaseServiceResponsesSchemas.MultipleData):
        ...
        def serialize_data(self, data:list[Any], info:FieldSerializationInfo) -> list[dict[str, Any]]:
            ...
            for organization in data:
                ...
                if "organization_type" not in expand:
                    organization_dict.pop("organization_type", None)
                if "parent_organization" not in expand:
                    organization_dict.pop("parent_organization", None)
                if "child_organizations" not in expand:
                    organization_dict.pop("child_organizations", None)
                serialized.append(organization_dict)
            return serialized
