...
class Template:
    def cfmt(self,line,n=4):
        ...
        x[0]=f"{Fore.orange_red_1}{x[0][0]}{Fore.cyan}{x[0][1:]}{Style.reset}"
        ...
        x[-1]=f"{Fore.light_red}{x[-1][:-1]}{Fore.dark_goldenrod}{x[-1][-1]}{Style.reset}"
        cformat=rebar=" '"+('-'.join(x))+"' "
        return cformat
...
{Fore.light_yellow}{self.Name} [{Fore.misty_rose_3}EID={Fore.pale_green_1b}{self.EntryId}{Fore.light_yellow}] ({Fore.light_magenta}{rebar}{Fore.light_magenta}[{Fore.spring_green_3a}UPC{Style.reset}{Fore.light_magenta}]:{Fore.light_red}{self.cfmt(self.Code,n=4)}[{Fore.orange_red_1}SHELF/TAG/CIC]{Fore.light_red}){Style.reset}'''
        return msg
