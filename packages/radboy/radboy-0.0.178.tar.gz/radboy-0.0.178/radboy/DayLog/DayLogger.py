    ...
    def PriceChange(self):
        ...
        with Session(ENGINE) as session:
            ...
            for k in different:
                if len(different[k]) > 1:
                    for num,z in enumerate(different[k]):
                        msg=f"{Fore.light_cyan}{num}/{Fore.light_yellow}{num+1} of {Fore.light_red}{len(different[k])} -> {z.seeShort()} - {Fore.light_steel_blue}Price:{i.Price}{Fore.orange_red_1}{Back.grey_15}Price Changed!{Fore.medium_violet_red}{i.DayLogDate}{Style.reset}"
                        print(msg)
                        simmer+=1
            if simmer == 0:
            ...
            for k in different:
                if len(different[k]) > 1:
                    for num,z in enumerate(different[k]):
                        msg=f"{Fore.light_cyan}{num}/{Fore.light_yellow}{num+1} of {Fore.light_red}{len(different[k])} -> {z.seeShort()} - {Fore.light_steel_blue}Tax:{i.Tax}{Fore.orange_red_1}{Back.grey_15}Tax Changed!{Fore.medium_violet_red}{i.DayLogDate}{Style.reset}"
                        print(msg)
                        simmer+=1
            if simmer == 0:
            ...
            for k in different:
                if len(different[k]) > 1:
                    for num,z in enumerate(different[k]):
                        msg=f"{Fore.light_cyan}{num}/{Fore.light_yellow}{num+1} of {Fore.light_red}{len(different[k])} -> {z.seeShort()} - {Fore.light_steel_blue}CRV:{i.CRV}{Fore.orange_red_1}{Back.grey_15}CRV Changed!{Fore.medium_violet_red}{i.DayLogDate}{Style.reset}"
                        print(msg)
                        simmer+=1
