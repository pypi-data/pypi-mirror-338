...
def naive_converter(
    frame: np.ndarray, is_yuv: bool, is_tv: bool, orig_bits: int = 1
) -> np.ndarray:
    """Pure numpy implementation."""
    if frame.ndim == 2:
        frame = frame[:, :, None]
    if frame.dtype != np.float32:
        frame >>= 8 * frame.itemsize - orig_bits
...
def test_uint8_y_pc():
    ...
    is_yuv, is_tv, orig_bits = True, False, 8
    assert np.allclose(
        normalize_video_frame(frame.copy(), is_yuv, is_tv, orig_bits),
        naive_converter(frame.copy(), is_yuv, is_tv, orig_bits),
    )
    timer(np.empty((1080, 1920), dtype=np.uint8), "u8-y-pc", is_yuv, is_tv, orig_bits)


def test_uint8_y_tv():
    """Test this convertion."""
    frame = np.array([[16, 219]], dtype=np.uint8)
    is_yuv, is_tv, orig_bits = True, True, 8
    assert np.allclose(
        normalize_video_frame(frame.copy(), is_yuv, is_tv, orig_bits),
        naive_converter(frame.copy(), is_yuv, is_tv, orig_bits),
    )
    timer(np.empty((1080, 1920), dtype=np.uint8), "u8-y-tv", is_yuv, is_tv, orig_bits)
...
def test_uint8_yuv_pc():
    ...
    timer(np.empty((1080, 1920, 3), dtype=np.uint8), "u8-yuv-pc", is_yuv, is_tv, orig_bits)
...
def test_uint8_yuv_tv():
    ...
    timer(np.empty((1080, 1920, 3), dtype=np.uint8), "u8-yuv-tv", is_yuv, is_tv, orig_bits)
...
def test_uint8_yuva_pc():
    ...
    timer(np.empty((1080, 1920, 4), dtype=np.uint8), "u8-yuva-pc", is_yuv, is_tv, orig_bits)
...
def test_uint8_yuva_tv():
    ...
    timer(np.empty((1080, 1920, 4), dtype=np.uint8), "u8-yuva-tv", is_yuv, is_tv, orig_bits)


def test_uint16_y_pc_10b():
    """Test this convertion."""
    frame = np.array([[0, 1023]], dtype=np.uint16) << 6
    is_yuv, is_tv, orig_bits = True, False, 10
    assert np.allclose(
        normalize_video_frame(frame.copy(), is_yuv, is_tv, orig_bits),
        naive_converter(frame.copy(), is_yuv, is_tv, orig_bits),
    )
    timer(np.empty((1080, 1920), dtype=np.uint16), "u16-y-pc-10b", is_yuv, is_tv, orig_bits)


def test_uint16_y_pc_12b():
    """Test this convertion."""
    frame = np.array([[0, 4095]], dtype=np.uint16) << 4
    is_yuv, is_tv, orig_bits = True, False, 12
    assert np.allclose(
        normalize_video_frame(frame.copy(), is_yuv, is_tv, orig_bits),
        naive_converter(frame.copy(), is_yuv, is_tv, orig_bits),
    )
    timer(np.empty((1080, 1920), dtype=np.uint16), "u16-y-pc-12b", is_yuv, is_tv, orig_bits)


def test_uint16_y_tv_10b():
    """Test this convertion."""
    frame = np.array([[64, 876]], dtype=np.uint16) << 6
    is_yuv, is_tv, orig_bits = True, True, 10
    assert np.allclose(
        normalize_video_frame(frame.copy(), is_yuv, is_tv, orig_bits),
        naive_converter(frame.copy(), is_yuv, is_tv, orig_bits),
    )
    timer(np.empty((1080, 1920), dtype=np.uint16), "u16-y-tv-10b", is_yuv, is_tv, orig_bits)


def test_uint16_y_tv_12b():
    """Test this convertion."""
    frame = np.array([[256, 3504]], dtype=np.uint16) << 4
    is_yuv, is_tv, orig_bits = True, True, 12
    assert np.allclose(
        normalize_video_frame(frame.copy(), is_yuv, is_tv, orig_bits),
        naive_converter(frame.copy(), is_yuv, is_tv, orig_bits),
    )
    timer(np.empty((1080, 1920), dtype=np.uint16), "u16-y-tv-12b", is_yuv, is_tv, orig_bits)
...
def test_uint16_yuv_pc_10b():
    ...
    timer(np.empty((1080, 1920, 3), dtype=np.uint16), "u16-yuv-pc_10b", is_yuv, is_tv, orig_bits)
...
def test_uint16_yuv_pc_12b():
    ...
    timer(np.empty((1080, 1920, 3), dtype=np.uint16), "u16-yuv-pc_12b", is_yuv, is_tv, orig_bits)
...
def test_uint16_yuv_tv_10b():
    ...
    timer(np.empty((1080, 1920, 3), dtype=np.uint16), "u16-yuv-tv-10b", is_yuv, is_tv, orig_bits)
...
def test_uint16_yuv_tv_12b():
    ...
    timer(np.empty((1080, 1920, 3), dtype=np.uint16), "u16-yuv-tv-12b", is_yuv, is_tv, orig_bits)
...
def test_uint16_yuva_pc_10b():
    ...
    timer(np.empty((1080, 1920, 4), dtype=np.uint16), "u16-yuva-pc-10b", is_yuv, is_tv, orig_bits)
...
def test_uint16_yuva_pc_12b():
    ...
    timer(np.empty((1080, 1920, 4), dtype=np.uint16), "u16-yuva-pc-12b", is_yuv, is_tv, orig_bits)
...
def test_uint16_yuva_tv_10b():
    ...
    timer(np.empty((1080, 1920, 4), dtype=np.uint16), "u16-yuva-tv-10b", is_yuv, is_tv, orig_bits)
...
def test_uint16_yuva_tv_12b():
    ...
    timer(np.empty((1080, 1920, 4), dtype=np.uint16), "u16-yuva-tv-12b", is_yuv, is_tv, orig_bits)
