...
from torch._utils import IMPORT_MAPPING as IMPORT_MAPPING, NAME_MAPPING as NAME_MAPPING
from typing import Any, Callable

_blocklisted_modules: Incomplete
_marked_safe_globals_set: set[Any]
...
class _safe_globals:
    ...
    def __init__(self, safe_globals: list[Any]) -> None: ...
