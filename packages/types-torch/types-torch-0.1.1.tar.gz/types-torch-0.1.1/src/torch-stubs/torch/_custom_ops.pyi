...
def custom_op(qualname, func_or_schema: Incomplete | None = None):
    ...
    '''
def impl(qualname, *, device_types=('cpu', 'cuda'), func: Incomplete | None = None):
    ...
    '''
def impl_abstract(qualname, *, func: Incomplete | None = None):
    ...
    '''
def impl_save_for_backward(qualname, *, func: Incomplete | None = None):
    """Register a function that tells us what to save for backward.

    Please see :func:`impl_backward` for more details.
    """
def impl_backward(qualname, output_differentiability: Incomplete | None = None, *, func: Incomplete | None = None):
