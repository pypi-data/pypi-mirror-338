...
from torch._prims import ELEMENTWISE_PRIM_TYPE_PROMOTION_KIND as ELEMENTWISE_PRIM_TYPE_PROMOTION_KIND, _prim_elementwise_meta as _prim_elementwise_meta
...
def meta_linspace_logspace(start, end, steps, base: Incomplete | None = None, dtype: Incomplete | None = None, device: Incomplete | None = None, layout=..., pin_memory: bool = False, requires_grad: bool = False): ...
...
def meta_randperm_default(n, *, dtype=..., layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: Incomplete | None = None): ...
...
def meta__cslt_sparse_mm(compressed_A: torch.Tensor, dense_B: torch.Tensor, bias: Tensor | None = None, alpha: Tensor | None = None, out_dtype: torch.dtype | None = None, transpose_result: bool = False, alg_id: int = 0, split_k: int = 1, split_k_one_kernel: bool = False): ...
...
def meta_segment_reduce(data: Tensor, reduce: str, *, lengths: Tensor | None = None, indices: Tensor | None = None, offsets: Tensor | None = None, axis: int = 0, unsafe: bool = False, initial: Incomplete | None = None) -> Tensor: ...
def meta_max(self): ...
...
def make_dep_token(*, dtype: Incomplete | None = None, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: Incomplete | None = None, memory_format: Incomplete | None = None): ...
def sym_constrain_range(size, min: Incomplete | None = None, max: Incomplete | None = None) -> None: ...
def functional_sym_constrain_range(size, min: Incomplete | None = None, max: Incomplete | None = None, dep_token: Incomplete | None = None): ...
def sym_constrain_range_for_size(size, min: Incomplete | None = None, max: Incomplete | None = None) -> None: ...
...
def meta_poisson(self, generator: Incomplete | None = None): ...
...
def meta_avg_pool3d(input, kernel_size, stride=(), padding=(0,), ceil_mode: bool = False, count_include_pad: bool = True, divisor_override: Incomplete | None = None): ...
...
def meta__fused_adam_(self, grads, exp_avgs, exp_avg_sqs, max_exp_avg_sqs, state_steps, *, lr, beta1, beta2, weight_decay, eps, amsgrad, maximize, grad_scale: Incomplete | None = None, found_inf: Incomplete | None = None): ...
def meta__fused_adam(self, grads, exp_avgs, exp_avg_sqs, max_exp_avg_sqs, state_steps, *, lr, beta1, beta2, weight_decay, eps, amsgrad, maximize, grad_scale: Incomplete | None = None, found_inf: Incomplete | None = None): ...
...
def meta_multinomial(input, num_samples, replacement: bool = False, *, generator: Incomplete | None = None): ...
...
def meta_sort(self, stable: Incomplete | None = None, dim: int = -1, descending: bool = False, values: Incomplete | None = None, indices: Incomplete | None = None): ...
def rnn_cell_checkSizes(input_gates, hidden_gates, input_bias, hidden_bias, factor, prev_hidden): ...
def _thnn_fused_lstm_cell_meta(input_gates, hidden_gates, cx, input_bias: Incomplete | None = None, hidden_bias: Incomplete | None = None): ...
...
def meta__segment_reduce_backward(grad, output, data, reduce, lengths: Incomplete | None = None, offsets: Incomplete | None = None, axis: int = 0, initial: Incomplete | None = None): ...
...
def meta_upsample_bimode2d_aa(input, output_size, align_corners, scales_h: Incomplete | None = None, scales_w: Incomplete | None = None): ...
def _amp_foreach_non_finite_check_and_unscale_(self, found_inf, inv_scale): ...
def nan_to_num(self, nan: Incomplete | None = None, posinf: Incomplete | None = None, neginf: Incomplete | None = None): ...
def transpose_(self, dim0, dim1): ...
def t_(self): ...
def meta_searchsorted(sorted_sequence, self, *, out_int32: bool = False, right: bool = False, side: Incomplete | None = None, sorter: Incomplete | None = None): ...
