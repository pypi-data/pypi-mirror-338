...
class TestStaking:
    ...
    def inject_tester(self, client: ChainClient, me_client: ChainClient, rollup_client: ChainClient):
        """
        Pytest fixture to automatically inject clients and create a KYC instance.

        Args:
            client (ChainClient): The client for the data access layer.
            me_client (ChainClient): The client for the ME execution layer.
            rollup_client (ChainClient): The client for the rollup layer.
        """
        self.da_client = client
        self.me_client = me_client
        self.rollup_client = rollup_client
        self.kyc_instance = TestKyc.create_instance(client, me_client, rollup_client)
