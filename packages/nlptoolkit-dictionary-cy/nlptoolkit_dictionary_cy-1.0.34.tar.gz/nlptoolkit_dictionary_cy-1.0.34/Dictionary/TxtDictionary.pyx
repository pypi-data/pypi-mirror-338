...
cdef class TxtDictionary(Dictionary):
    ...
    cpdef mergeDictionary(self,
        ...
        cdef list first_lines, second_lines
    ...
    cpdef Trie prepareTrie(self):
        ...
        cdef int i, length
        cdef Word word
        cdef str root, root_without_last, root_without_last_two
        cdef Py_UNICODE last_before
        result = Trie()
        last_before = ' '
