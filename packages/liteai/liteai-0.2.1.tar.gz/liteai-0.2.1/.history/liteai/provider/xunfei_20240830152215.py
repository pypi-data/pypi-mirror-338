...
class XunfeiProvider(BaseProvider):
    ...
    def asr(self, voice: Voice, model: ModelCard, app_id:  business_args: dict = DEFAULT_BUSINESS_ARGS, interval=0.1, frame_size=64*1000, ** kwargs) -> str:
        ...
        def onopen(ws: WebSocket):
            _thread.start_new_thread(send_voice, (ws, voice,  {"app_id": self.app_id}, business_args, interval, frame_size))
