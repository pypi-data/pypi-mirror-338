...
## 批量请求模型
```bash
liteai batch -d liteai/data/batch_test.jsonl -m glm-4v -w 2 --input_column text --image_column image --image_dir liteai/data --system "用英文回答" --overwrite false --log_level="info"
