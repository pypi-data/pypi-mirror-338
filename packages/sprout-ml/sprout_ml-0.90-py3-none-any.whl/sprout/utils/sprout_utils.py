...
def train_binary_adjudicator(x_train: numpy.ndarray, y_train: numpy.ndarray,
                             ...
                             misc_ratios: list = [None, 0.05, 0.1, 0.2, 0.3],
                             candidate_classifiers:list = None, verbose=True):
    """
    Trains a binary adjudicator using uncertainty measures as data, and 0/1 misclassification as label
    :param candidate_classifiers: set of potential binary adjudicators
    ...
    best_ratio = None
    best_metrics = {"MCC": -10}
    candidate_classifiers = CLASSIFIERS if candidate_classifiers is None else candidate_classifiers
    ...
    for clf_base in candidate_classifiers:
