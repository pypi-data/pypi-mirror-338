...
class SPROUTObject:
    ...
    def __init__(self, models_folder, candidate_adjudicators: list = None):
        """
        Constructor for the SPROUT object
        """
        self.trust_calculators = []
        self.models_folder = models_folder
        self.candidate_adjudicators = candidate_adjudicators
    ...
    def train_model(self, main_clf, x_train, y_train, x_val, y_val, features: list = None):
        ...
        :param candidate_classifiers: the list of candidate binary adjudicators
        ...
        self.binary_adjudicator, f_imp, ba_metrics = \
            train_binary_adjudicator(unc_train, misc_train, unc_val, misc_val, features,
                                     candidate_classifiers=self.candidate_adjudicators, verbose=False)
