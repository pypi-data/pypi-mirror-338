...
if __name__ == '__main__':
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/jiankang10T"
    utils_file.makedir_for_file_or_dir(output_dir)
    old2new_dir = "/home/work_nfs9/ghliu/bigdata/stage1/init_lists"
    vad_info_dir = "/home/work_nfs12/ghliu/bigdata/ny_1wh/stage4/cut_points.txt"
    # text_dir = "/home/work_nfs6/tlzuo/data_handle/lists/5txts"
    final_tts_scp_path = "/home/work_nfs12/ghliu/bigdata/ny_1wh/stage6/final.scp"
    # solution(final_tts_scp_path, output_dir, old2new_dir, vad_info_dir)
    sys.path.insert(0, '../')
    from gxl_common_utils.common_utils import post_process
    shard_output_dir = "/home/work_nfs9/xlgeng/asr_data_shard/pachong_data/2_shangye_caijing10T/"
    # text_dir = "/home/work_nfs6/tlzuo/data_handle/lists/5txts"
