...
if __name__ == '__main__':
    param_from_cmd = sys.argv[1]
    print(f"param_from_cmd", param_from_cmd)
    if param_from_cmd == "1":
        data_list = "/home/work_nfs3/syliu/aslp_data/gender/2.5/sex.list"
        dataname = "gender_add_2025_2_4"
        output_dir = f"/home/work_nfs6/xlgeng/for_gxl/{dataname}"
        ...
        input_shards_path = f"{output_dir}/shards_list.txt"
        fake_file = utils_file.do_replace_str_for_file_and_return_new_file(input_shards_path,
                                                                           f'{output_dir}',
                                                                           f"/mnt/sfs/asr/update_data/{dataname}")
    ...
    elif param_from_cmd == "2":
        data_list = "/home/work_nfs3/syliu/aslp_data/gender/simu_sex/simu_gender.list"
        dataname = "gender_with_noize_add_2025_2_4"
        output_dir = f"/home/work_nfs6/xlgeng/for_gxl/{dataname}"
        utils_file.makedir_sil(output_dir)
        # make_shards(
        #     data_list,
        ...
        print("param_from_cmd error,不是1 或者 2")