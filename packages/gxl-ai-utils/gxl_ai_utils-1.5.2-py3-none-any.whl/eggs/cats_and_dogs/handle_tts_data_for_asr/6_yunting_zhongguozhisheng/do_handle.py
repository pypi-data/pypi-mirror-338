...
if __name__ == '__main__':
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/yunting_zhongguozhisheng"
    utils_file.makedir_for_file_or_dir(output_dir)
    old2new_dir = "/home/work_nfs8/ypjiang/data_process/yunting/中国之声/*_info/init_lists"
    vad_info_dir = "/home/work_nfs8/ypjiang/data_process/yunting/中国之声/*_info/vad_info"
    # text_dir = "/home/work_nfs6/tlzuo/data_handle/lists/5txts"
    final_tts_scp_path = "/home/work_nfs8/ypjiang/data_process/yunting/中国之声/final.scp"

    # utils_file.logging_print('开始一些专属的特殊处理')
    # directories = glob.glob('/home/work_nfs8/ypjiang/data_process/yunting/中国之声/*_info/')
    # # 打印匹配到的目录
    # print(directories)
    # old2new_res_list = []
    ...
    sys.path.insert(0, '../')
    from gxl_common_utils.common_utils import post_process
    shard_output_dir = "/home/work_nfs9/xlgeng/asr_data_shard/pachong_data/6_yunting_zhongguozhisheng/"
