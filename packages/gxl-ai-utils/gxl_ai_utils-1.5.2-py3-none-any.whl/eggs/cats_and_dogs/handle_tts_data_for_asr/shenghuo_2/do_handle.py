...
def post_process(output_dir, tts_final_path):
    ...
    # utils_file.logging_print('开始得到text.scp,完成')
    text_dir = "/home/work_nfs13/kxxia/data/score2/asr"
    ...
    text_dict = utils_file.load_dict_from_scp(os.path.join(output_dir, "text"))
    new_text_dict = {}
    ...
    shard_output_dir = "/home/work_nfs14/xlgeng/asr_data_shard/pachong_data/shenghuo_2/"
...
if __name__ == '__main__':
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/ximalaya_shenghuo_10T_2"
    # output_dir = './output/ximalaya_shenghuo_10T_1/'
    utils_file.makedir_for_file_or_dir(output_dir)
    input_vad_info_dir = "/home/work_nfs13/kxxia/data/vad_result2/cut_points.txt"
    # 表格里写的如果不是dir,而是成品scp文件， 就把scp文件的路径传入即可
    old2new_dir = "/home/node36_data/kxxia/life/list/init_lists"
    final_tts_scp_path = "/home/work_nfs13/kxxia/data/score2/final_2.scp"
