...
def post_process(output_dir,tts_final_path):
    ...
    asr_final_path = os.path.join(output_dir,'all.list')
    ...
    text_dir = "/home/work_nfs10/zcwang/xmly/5txts_0"
    text_dir2 = "/home/work_nfs10/zcwang/xmly/5txts_rest/0"
    text_scp_dict = utils_file.get_scp_for_wav_dir(text_dir2,suffix='.txt')
...
def do_get_vad_scp_file(input_dir, output_dir='./'):
    ...
    res_list = []
    for intput_path in input_dir:
        res_list.extend(utils_file.load_list_file_clean(intput_path))
    vad_res_dict = {}
...
if __name__ == '__main__':
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/shangye_caijing_2/"
    # output_dir = './output/ximalaya_shenghuo_10T_1/'
    utils_file.makedir_for_file_or_dir(output_dir)
    input_vad_info_dir = ['/home/work_nfs10/zcwang/xmly/vad_stage4_rest/cut_points.txt']
    # 表格里写的如果不是dir,而是成品scp文件， 就把scp文件的路径传入即可
    old2new_dir = "/home/work_nfs7/zcwang/xmly_re/init_lists"
    final_tts_scp_path = "/home/work_nfs10/zcwang/xmly/list_rest/0/final.scp"
    ...
    shard_output_dir = "/home/work_nfs14/xlgeng/asr_data_shard/pachong_data/shangye_caijing_2/"
    utils_file.do_make_shard_file(os.path.join(output_dir, "wav.scp"), os.path.join(output_dir, "text"), shard_output_dir,num_threads=50)