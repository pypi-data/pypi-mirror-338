...
def get_args():
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="gxl_data/fbank_common",
        help="Output directory. Default: data/fbank.",
    )
    parser.add_argument(
        "--src-dir",
        type=str,
        default="gxl_data/manifest",
        help="清单文件的位置",
    )
...
if __name__ == "__main__":
    ...
    args = get_args()
    root_dir = "/home/work_nfs8/xlgeng/new_workspace/icefall/egs/aishell/ASR"
    compute_fbank_gxldata(
        num_mel_bins=args.num_mel_bins,
        perturb_speed=args.perturb_speed,
        whisper_fbank=args.whisper_fbank,
        fbank_dir=os.path.join(root_dir, args.output_dir),
        manifests_dir=os.path.join(root_dir, args.src_dir),
    )
