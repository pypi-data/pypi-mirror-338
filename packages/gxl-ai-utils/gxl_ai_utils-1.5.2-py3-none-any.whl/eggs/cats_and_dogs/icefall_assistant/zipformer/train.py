...
def run(rank, world_size, args):
    ...
    logging.info("Training started,嘻嘻嘻,我是耿雪龙")
    ...
    if torch.cuda.is_available() and params['world_size']>0:
    ...
    logging.info(f"Number of model parameters: {num_param}, {num_param/1024/1024}M")
    ...
    logging.info('dataloader 加载顺利完成')
    # return
