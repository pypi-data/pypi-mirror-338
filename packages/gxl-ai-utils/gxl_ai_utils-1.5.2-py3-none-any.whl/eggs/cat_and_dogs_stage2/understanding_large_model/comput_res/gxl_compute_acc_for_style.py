...
if __name__ == '__main__':
    ...
    utils_file.logging_info('开始计算style正确率，wer')
    ...
    utils_file.logging_info('开始计算style正确率，acc')
    ...
    # 输出相同标签的数量
    print(f"style的正确率为: {same_num / len(tag_hyp_dict)}")
