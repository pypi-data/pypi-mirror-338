...
def post_process(output_dir,tts_final_path):
    ...
    shard_output_dir = "/home/work_nfs14/xlgeng/asr_data_shard/pachong_data/shangye_caijing_1/"
...
if __name__ == '__main__':
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/shangye_caijing_1/"
    ...
    final_tts_scp_path = "/home/work_nfs10/zcwang/xmly/list_0/final.scp"
    # get_little_final(final_tts_scp_path, output_dir)
    # final_tts_scp_path = os.path.join(output_dir, "final_scp_little.scp")
    # solution(final_tts_scp_path,output_dir,old2new_dir,input_vad_info_dir)
