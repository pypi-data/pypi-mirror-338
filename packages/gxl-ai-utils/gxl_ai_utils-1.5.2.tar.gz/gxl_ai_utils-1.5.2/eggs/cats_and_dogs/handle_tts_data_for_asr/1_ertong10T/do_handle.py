...
def post_process(output_dir,tts_final_path,shard_output_dir, text_dir=None):
    ...
    if TTS_FINAL_TYPE == 0:
        ...
        for key, value in tqdm.tqdm(tts_dict):
...
if __name__ == '__main__':
    ...
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/ertong10T"
    utils_file.makedir_for_file_or_dir(output_dir)
    old2new_dir = "/home/work_nfs14/xlgeng/new_workspace/checkpoint/temp"
    vad_info_dir = "/home/work_nfs6/tlzuo/data_handle/lists/vad_result"
    # text_dir = "/home/work_nfs6/tlzuo/data_handle/lists/5txts"
    final_tts_scp_path = "/home/work_nfs14/zhguo/data/child_10T/final_cmn.scp"
    # solution(final_tts_scp_path, output_dir, old2new_dir, vad_info_dir)
    sys.path.insert(0, '../')
    from gxl_common_utils.common_utils import post_process
    shard_output_dir = "/home/work_nfs9/xlgeng/asr_data_shard/pachong_data/1_ertong10T/"
    text_dir = "/home/work_nfs6/tlzuo/data_handle/lists/5txts"
    post_process(output_dir, final_tts_scp_path, shard_output_dir,text_dir ,TTS_FINAL_TYPE=TTS_FINAL_TYPE)