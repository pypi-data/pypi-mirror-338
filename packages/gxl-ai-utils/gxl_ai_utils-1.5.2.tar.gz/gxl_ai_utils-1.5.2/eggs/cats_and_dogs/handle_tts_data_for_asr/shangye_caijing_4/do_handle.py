...
def post_process(output_dir,tts_final_path):
    ...
    text_dir2 = "/home/work_nfs10/zcwang/xmly/5txts_rest/2"
...
if __name__ == '__main__':
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/shangye_caijing_4/"
    ...
    final_tts_scp_path = "/home/work_nfs10/zcwang/xmly/list_rest/2/final.scp"
    ...
    # shard_dir = "/home/work_nfs14/xlgeng/asr_data_shard/pachong_data/shangye_caijing_4/"
    # utils_file.do_make_shard_file(os.path.join(output_dir,"wav.scp"),os.path.join(output_dir,"text"),shard_dir, num_threads=50)
