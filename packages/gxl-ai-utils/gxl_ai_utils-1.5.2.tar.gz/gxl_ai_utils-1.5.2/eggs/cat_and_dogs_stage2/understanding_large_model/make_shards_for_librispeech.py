...
input_wav_scp = "/home/work_nfs15/asr_data/data/LibriSpeech/LibriSpeech_shard/wav.scp"
input_text_scp = "/home/work_nfs15/asr_data/data/LibriSpeech/LibriSpeech_shard/text"


wav_dict = utils_file.load_dict_from_scp(input_wav_scp)
text_dict = utils_file.load_dict_from_scp(input_text_scp)

# 得到data.list
data_list_path = "/home/work_nfs15/asr_data/data/LibriSpeech/LibriSpeech_shard/data_common.list"
res_dict_list = do_get_formatted_datalist_for_chat_task(wav_dict, text_dict, "librispeech")
utils_file.write_dict_list_to_jsonl(res_dict_list, data_list_path)
shard_dir = "/home/work_nfs15/asr_data/data/LibriSpeech/LibriSpeech_shard_common"
utils_file.makedir_sil(shard_dir)
from make_shard_for_common_format import make_shards
make_shards(data_list_path, shard_dir, prefix='librispeech')
