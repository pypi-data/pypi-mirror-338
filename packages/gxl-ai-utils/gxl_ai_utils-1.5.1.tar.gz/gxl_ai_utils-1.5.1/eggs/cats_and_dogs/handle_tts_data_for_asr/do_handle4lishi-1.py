...
def final_handle():
    """"""
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/ximalaya_lishi_10T-1"
    ...
    wav_dict_all = utils_file.get_scp_for_wav_dir(os.path.join(output_dir, "final_wav"))
    utils_file.write_dict_to_scp(wav_dict_all, os.path.join(output_dir, "all_wav.scp"))
...
def copy_file_to_nfs():
    """"""
    source_list_path = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/ximalaya_lishi_10T-1/all.list"
    dict_list = utils_file.load_dict_list_from_jsonl(source_list_path)
    target_dir = "/home/work_nfs14/xlgeng/asr_data_from_pachong/ximalaya_lishi_10T-1"
...
if __name__ == '__main__':
    ...
    # output_dir = './data_output/lishi-1'
    output_dir = "/home/node36_data/xlgeng/asr_data_from_pachong/gxl_output/ximalaya_lishi_10T-1"
