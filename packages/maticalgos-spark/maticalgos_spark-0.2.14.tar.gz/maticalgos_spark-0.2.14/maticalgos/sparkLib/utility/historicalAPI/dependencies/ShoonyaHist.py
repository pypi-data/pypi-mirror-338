        ...
        for i in range(0, len(tokenMapKeys), self.MaxQuoteSymbolLimit):
            ...
            try:
                ...
                main_data[tokenMap[tokenMapKeys[i]]] = {
                    ...
                    "ltp": float(api_data.get('lp', 0)),
                    "prev_day_close": float(api_data.get('c', 0)),
                    "oi": 0,
                    "prev_day_oi": 0,
                    "turnover": int(api_data.get('v', 0)),
                    "best_bid_price": float(api_data.get('bp1', 0)),
                    "best_ask_price": float(api_data.get('sp1', 0)),
                    "best_bid_qty": int(api_data.get('bq1', 0)),
                    "best_ask_qty": int(api_data.get('sq1', 0)),
                    "ttq": int(api_data.get('v', 0)),
