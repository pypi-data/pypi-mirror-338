...
def get_policy_object_preferred_color_group(feature_profile_id: Optional[str] = None,
...
def get_policy_object_preferred_color_group_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
