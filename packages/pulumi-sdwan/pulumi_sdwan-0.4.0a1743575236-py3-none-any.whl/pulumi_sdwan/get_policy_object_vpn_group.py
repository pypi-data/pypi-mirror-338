...
__all__ = [
    'GetPolicyObjectVpnGroupResult',
    'AwaitableGetPolicyObjectVpnGroupResult',
    'get_policy_object_vpn_group',
    'get_policy_object_vpn_group_output',
]

@pulumi.output_type
class GetPolicyObjectVpnGroupResult:
    """
...
class AwaitableGetPolicyObjectVpnGroupResult(GetPolicyObjectVpnGroupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPolicyObjectVpnGroupResult(
...
def get_policy_object_vpn_group(feature_profile_id: Optional[str] = None,
    ...
    return AwaitableGetPolicyObjectVpnGroupResult(
...
def get_policy_object_vpn_group_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
