...
def get_service_feature_profile_output(id: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetServiceFeatureProfileResult]:
    """
    This data source can read the Service Feature Profile .
    ...
    __ret__ = pulumi.runtime.invoke_output('sdwan:index/getServiceFeatureProfile:getServiceFeatureProfile', __args__, opts=opts, typ=GetServiceFeatureProfileResult)
    return __ret__.apply(lambda __response__: GetServiceFeatureProfileResult(
