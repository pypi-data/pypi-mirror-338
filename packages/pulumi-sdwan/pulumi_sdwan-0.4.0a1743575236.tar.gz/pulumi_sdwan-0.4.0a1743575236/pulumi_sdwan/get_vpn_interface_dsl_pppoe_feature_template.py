...
def get_vpn_interface_dsl_pppoe_feature_template_output(id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('sdwan:index/getVpnInterfaceDslPppoeFeatureTemplate:getVpnInterfaceDslPppoeFeatureTemplate', __args__, opts=opts, typ=GetVpnInterfaceDslPppoeFeatureTemplateResult)
    return __ret__.apply(lambda __response__: GetVpnInterfaceDslPppoeFeatureTemplateResult(
        ...
        ethernet_description=pulumi.get(__response__, 'ethernet_description'),
        ethernet_description_variable=pulumi.get(__response__, 'ethernet_description_variable'),
        ethernet_dialer_address_negotiated=pulumi.get(__response__, 'ethernet_dialer_address_negotiated'),
        ethernet_dialer_pool_number=pulumi.get(__response__, 'ethernet_dialer_pool_number'),
        ethernet_dialer_pool_number_variable=pulumi.get(__response__, 'ethernet_dialer_pool_number_variable'),
        ...
        ethernet_ppp_maximum_payload=pulumi.get(__response__, 'ethernet_ppp_maximum_payload'),
        ethernet_ppp_maximum_payload_variable=pulumi.get(__response__, 'ethernet_ppp_maximum_payload_variable'),
        ethernet_unnumbered_loopback_interface=pulumi.get(__response__, 'ethernet_unnumbered_loopback_interface'),
        ethernet_unnumbered_loopback_interface_variable=pulumi.get(__response__, 'ethernet_unnumbered_loopback_interface_variable'),
        ethernet_vlan_id=pulumi.get(__response__, 'ethernet_vlan_id'),
        ethernet_vlan_id_variable=pulumi.get(__response__, 'ethernet_vlan_id_variable'),
        ...
        vpn_qos_map=pulumi.get(__response__, 'vpn_qos_map'),
        vpn_qos_map_variable=pulumi.get(__response__, 'vpn_qos_map_variable'),
