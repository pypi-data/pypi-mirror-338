...
def get_zone_list_policy_object_output(id: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetZoneListPolicyObjectResult]:
    """
    This data source can read the Zone List Policy Object .
    ...
    __ret__ = pulumi.runtime.invoke_output('sdwan:index/getZoneListPolicyObject:getZoneListPolicyObject', __args__, opts=opts, typ=GetZoneListPolicyObjectResult)
    return __ret__.apply(lambda __response__: GetZoneListPolicyObjectResult(
