...
def get_policy_object_security_identity_list(feature_profile_id: Optional[str] = None,
...
def get_policy_object_security_identity_list_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
