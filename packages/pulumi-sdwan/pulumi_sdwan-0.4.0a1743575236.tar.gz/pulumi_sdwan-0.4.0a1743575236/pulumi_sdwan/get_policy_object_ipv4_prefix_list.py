...
def get_policy_object_ipv4_prefix_list_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPolicyObjectIpv4PrefixListResult]:
    """
    This data source can read the Policy Object IPv4 Prefix List Policy_object.
    ...
    __ret__ = pulumi.runtime.invoke_output('sdwan:index/getPolicyObjectIpv4PrefixList:getPolicyObjectIpv4PrefixList', __args__, opts=opts, typ=GetPolicyObjectIpv4PrefixListResult)
    return __ret__.apply(lambda __response__: GetPolicyObjectIpv4PrefixListResult(
