...
def get_vpn_interface_dsl_ipoe_feature_template_output(id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('sdwan:index/getVpnInterfaceDslIpoeFeatureTemplate:getVpnInterfaceDslIpoeFeatureTemplate', __args__, opts=opts, typ=GetVpnInterfaceDslIpoeFeatureTemplateResult)
    return __ret__.apply(lambda __response__: GetVpnInterfaceDslIpoeFeatureTemplateResult(
        ...
        ethernet_dhcp_distance=pulumi.get(__response__, 'ethernet_dhcp_distance'),
        ethernet_dhcp_distance_variable=pulumi.get(__response__, 'ethernet_dhcp_distance_variable'),
        ethernet_dhcp_helper_variable=pulumi.get(__response__, 'ethernet_dhcp_helper_variable'),
        ethernet_dhcp_helpers=pulumi.get(__response__, 'ethernet_dhcp_helpers'),
        ethernet_enable_dhcp=pulumi.get(__response__, 'ethernet_enable_dhcp'),
        ethernet_enable_dhcp_variable=pulumi.get(__response__, 'ethernet_enable_dhcp_variable'),
        ...
        ethernet_ipv4_address=pulumi.get(__response__, 'ethernet_ipv4_address'),
        ethernet_ipv4_address_variable=pulumi.get(__response__, 'ethernet_ipv4_address_variable'),
        id=pulumi.get(__response__, 'id'),
        internal_controller_type=pulumi.get(__response__, 'internal_controller_type'),
