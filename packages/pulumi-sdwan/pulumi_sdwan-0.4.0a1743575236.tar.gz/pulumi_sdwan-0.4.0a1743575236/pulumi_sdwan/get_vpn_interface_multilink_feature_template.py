...
def get_vpn_interface_multilink_feature_template_output(id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('sdwan:index/getVpnInterfaceMultilinkFeatureTemplate:getVpnInterfaceMultilinkFeatureTemplate', __args__, opts=opts, typ=GetVpnInterfaceMultilinkFeatureTemplateResult)
    return __ret__.apply(lambda __response__: GetVpnInterfaceMultilinkFeatureTemplateResult(
        ...
        disable_fragmentation=pulumi.get(__response__, 'disable_fragmentation'),
        ...
        fragment_max_delay=pulumi.get(__response__, 'fragment_max_delay'),
        fragment_max_delay_variable=pulumi.get(__response__, 'fragment_max_delay_variable'),
        ...
        interleaving_fragment=pulumi.get(__response__, 'interleaving_fragment'),
        ...
        multilink_group_number=pulumi.get(__response__, 'multilink_group_number'),
        multilink_group_number_variable=pulumi.get(__response__, 'multilink_group_number_variable'),
        multilink_interfaces=pulumi.get(__response__, 'multilink_interfaces'),
        name=pulumi.get(__response__, 'name'),
        nim_interface_lists=pulumi.get(__response__, 'nim_interface_lists'),
