...
def get_policy_object_tloc_list_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPolicyObjectTlocListResult]:
    """
    This data source can read the Policy Object TLOC List Policy_object.
    ...
    __ret__ = pulumi.runtime.invoke_output('sdwan:index/getPolicyObjectTlocList:getPolicyObjectTlocList', __args__, opts=opts, typ=GetPolicyObjectTlocListResult)
    return __ret__.apply(lambda __response__: GetPolicyObjectTlocListResult(
