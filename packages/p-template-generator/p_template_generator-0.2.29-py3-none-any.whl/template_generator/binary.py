...
def getTpSdkConfig():
    try:
        ...
        if sys.platform == "win32":
            tag = "windows"
            asset_url_bak = "https://m.mecordai.com/res/skymedia-release-1.5-windows.zip"
        elif sys.platform == "linux":
            tag = "linux"
            asset_url_bak = "https://m.mecordai.com/res/skymedia-release-1.5-linux.zip"
        elif sys.platform == "darwin":
            tag = "darwin"
            asset_url_bak = "https://m.mecordai.com/res/skymedia-release-1.5-darwin.zip"
        for s in body_split:
            if "[MD5 🚀]" in s:
                find_md5 = True
            if find_md5:
...
def updateBin(rootDir):
    ...
    getOssResource(rootDir, "https://m.mecordai.com/res/ffmpeg.zip", "a9e6b05ac70f6416d5629c07793b4fcf", "ffmpeg")
    getOssResource(rootDir, "https://m.mecordai.com/res/subEffect.zip", "08651251e4351fd8cd5829b2ef65a8b9", "subEffect")
    getOssResource(rootDir, "https://m.mecordai.com/res/fonts.zip", "b1f190ba1cea49177eccde2eb2a6cb13", "fonts")
    if getOssResource(rootDir, "https://m.mecordai.com/res/effect_text_20240827.zip", "73a8b7484cfd8e327317dbe42d1fb610", "effect_text"):
        cp_skymedia_res("effect_text", "text")
    if getOssResource(rootDir, "https://m.mecordai.com/res/effect_transition_20240827.zip", "d50706dd7439680c2e1233fb9eef2a90", "effect_transition"):
        cp_skymedia_res("effect_transition", "transition")
    if getOssResource(rootDir, "https://m.mecordai.com/res/effect_video_20240827.zip", "e14e9c0ccbbbd28ff386b975f728187a", "effect_video"):
        cp_skymedia_res("effect_video", "video")
    if getOssResource(rootDir, "https://m.mecordai.com/res/effect_blend_20241113.zip", "aee2870c013e9896393081338b448587", "effect_blend"):
        cp_skymedia_res("effect_blend", "blend")
    if getOssResource(rootDir, "https://m.mecordai.com/res/effect_mask_20240827.zip", "95a8c8a896444c878b51465f103b3a47", "effect_mask"):
        cp_skymedia_res("effect_mask", "mask")
    if getOssResource(rootDir, "https://m.mecordai.com/res/effect_sticker_20240827.zip", "8b4ec39a51a5fa0184a62d8922b928f9", "effect_sticker"):
