...
class ApplicationContextClassLoaderDefinedPackagesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["annotations", "declaredAnnotations", "implementationTitle", "implementationVendor", "implementationVersion", "name", "sealed", "specificationTitle", "specificationVendor", "specificationVersion"]
