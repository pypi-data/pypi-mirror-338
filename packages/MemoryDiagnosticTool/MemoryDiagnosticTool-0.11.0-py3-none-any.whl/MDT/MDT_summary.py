...
from rd_wr_eye import get_rd_wr_eye
from rd_eye_scan import get_rd_eye_scan
    ...
    if file_path and os.path.exists(file_path):
        if os.path.isdir(file_path):
            ...
            if decoded_logs:
                ...
                try:
                    get_rd_wr_eye(decoded_logs, mdteye, rdwr_stat_csv)
                except:
                    print("Read Write eye parsing error")
                try:
                    get_rd_eye_scan(decoded_logs, mdteye)
                except:
