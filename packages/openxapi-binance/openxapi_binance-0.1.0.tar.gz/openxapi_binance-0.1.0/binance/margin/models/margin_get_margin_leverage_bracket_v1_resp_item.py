...
class MarginGetMarginLeverageBracketV1RespItem(BaseModel):
    """
    MarginGetMarginLeverageBracketV1RespItem
    """ # noqa: E501
    asset_names: Optional[List[StrictStr]] = Field(default=None, alias="assetNames")
    brackets: Optional[List[MarginGetMarginLeverageBracketV1RespItemBracketsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "brackets": [MarginGetMarginLeverageBracketV1RespItemBracketsInner.from_dict(_item) for _item in obj["brackets"]] if obj.get("brackets") is not None else None,
            "rank": obj.get("rank")
        })
        return _obj
