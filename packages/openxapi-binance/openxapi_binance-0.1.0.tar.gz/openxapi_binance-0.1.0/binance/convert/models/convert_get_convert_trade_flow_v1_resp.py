...
class ConvertGetConvertTradeFlowV1Resp(BaseModel):
    """
    ConvertGetConvertTradeFlowV1Resp
    """ # noqa: E501
    end_time: Optional[StrictInt] = Field(default=None, alias="endTime")
    limit: Optional[StrictInt] = None
    list: Optional[List[ConvertGetConvertTradeFlowV1RespListInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "list": [ConvertGetConvertTradeFlowV1RespListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
