...
class SubaccountGetSubAccountMarginAccountV1Resp(BaseModel):
    """
    SubaccountGetSubAccountMarginAccountV1Resp
    """ # noqa: E501
    email: Optional[StrictStr] = None
    margin_level: Optional[StrictStr] = Field(default=None, alias="marginLevel")
    margin_trade_coeff_vo: Optional[SubaccountGetSubAccountMarginAccountV1RespMarginTradeCoeffVo] = Field(default=None, alias="marginTradeCoeffVo")
    margin_user_asset_vo_list: Optional[List[SubaccountGetManagedSubaccountMarginAssetV1RespUserAssetsInner]] = Field(default=None, alias="marginUserAssetVoList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "marginTradeCoeffVo": SubaccountGetSubAccountMarginAccountV1RespMarginTradeCoeffVo.from_dict(obj["marginTradeCoeffVo"]) if obj.get("marginTradeCoeffVo") is not None else None,
            "marginUserAssetVoList": [SubaccountGetManagedSubaccountMarginAssetV1RespUserAssetsInner.from_dict(_item) for _item in obj["marginUserAssetVoList"]] if obj.get("marginUserAssetVoList") is not None else None,
