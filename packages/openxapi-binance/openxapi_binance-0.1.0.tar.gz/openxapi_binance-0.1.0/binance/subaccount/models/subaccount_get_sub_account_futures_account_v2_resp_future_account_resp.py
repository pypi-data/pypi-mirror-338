...
class SubaccountGetSubAccountFuturesAccountV2RespFutureAccountResp(BaseModel):
    """
    SubaccountGetSubAccountFuturesAccountV2RespFutureAccountResp
    """ # noqa: E501
    assets: Optional[List[SubaccountGetSubAccountFuturesAccountV1RespAssetsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [SubaccountGetSubAccountFuturesAccountV1RespAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
