...
class SubaccountGetSubAccountAssetsV4Resp(BaseModel):
    """
    SubaccountGetSubAccountAssetsV4Resp
    """ # noqa: E501
    balances: Optional[List[SubaccountGetSubAccountAssetsV4RespBalancesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balances": [SubaccountGetSubAccountAssetsV4RespBalancesInner.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
        return _obj
