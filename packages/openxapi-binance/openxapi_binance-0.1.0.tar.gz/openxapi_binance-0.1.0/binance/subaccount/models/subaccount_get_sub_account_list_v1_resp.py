...
class SubaccountGetSubAccountListV1Resp(BaseModel):
    """
    SubaccountGetSubAccountListV1Resp
    """ # noqa: E501
    sub_accounts: Optional[List[SubaccountGetSubAccountListV1RespSubAccountsInner]] = Field(default=None, alias="subAccounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subAccounts": [SubaccountGetSubAccountListV1RespSubAccountsInner.from_dict(_item) for _item in obj["subAccounts"]] if obj.get("subAccounts") is not None else None
        })
        return _obj
