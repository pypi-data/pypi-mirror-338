...
class SubaccountGetSubAccountSpotSummaryV1Resp(BaseModel):
    """
    ...
    spot_sub_user_asset_btc_vo_list: Optional[List[SubaccountGetSubAccountSpotSummaryV1RespSpotSubUserAssetBtcVoListInner]] = Field(default=None, alias="spotSubUserAssetBtcVoList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spotSubUserAssetBtcVoList": [SubaccountGetSubAccountSpotSummaryV1RespSpotSubUserAssetBtcVoListInner.from_dict(_item) for _item in obj["spotSubUserAssetBtcVoList"]] if obj.get("spotSubUserAssetBtcVoList") is not None else None,
