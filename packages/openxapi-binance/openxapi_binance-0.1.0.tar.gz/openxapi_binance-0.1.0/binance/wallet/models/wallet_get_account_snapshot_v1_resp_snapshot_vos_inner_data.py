...
class WalletGetAccountSnapshotV1RespSnapshotVosInnerData(BaseModel):
    """
    WalletGetAccountSnapshotV1RespSnapshotVosInnerData
    """ # noqa: E501
    balances: Optional[List[WalletGetAccountSnapshotV1RespSnapshotVosInnerDataBalancesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balances": [WalletGetAccountSnapshotV1RespSnapshotVosInnerDataBalancesInner.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None,
