...
class PmarginGetCmLeverageBracketV1RespItem(BaseModel):
    """
    PmarginGetCmLeverageBracketV1RespItem
    """ # noqa: E501
    brackets: Optional[List[PmarginGetCmLeverageBracketV1RespItemBracketsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "brackets": [PmarginGetCmLeverageBracketV1RespItemBracketsInner.from_dict(_item) for _item in obj["brackets"]] if obj.get("brackets") is not None else None,
