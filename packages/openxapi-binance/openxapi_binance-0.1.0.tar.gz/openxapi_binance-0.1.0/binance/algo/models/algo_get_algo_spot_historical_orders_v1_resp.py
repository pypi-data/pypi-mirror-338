...
class AlgoGetAlgoSpotHistoricalOrdersV1Resp(BaseModel):
    """
    AlgoGetAlgoSpotHistoricalOrdersV1Resp
    """ # noqa: E501
    orders: Optional[List[AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orders": [AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
            "total": obj.get("total")
        })
        return _obj
