...
class MarginGetMarginIsolatedAccountV1Resp(BaseModel):
    """
    MarginGetMarginIsolatedAccountV1Resp
    """ # noqa: E501
    assets: Optional[List[MarginGetMarginIsolatedAccountV1RespAssetsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [MarginGetMarginIsolatedAccountV1RespAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
