...
class MarginGetMarginIsolatedMarginDataV1RespItem(BaseModel):
    """
    MarginGetMarginIsolatedMarginDataV1RespItem
    """ # noqa: E501
    data: Optional[List[MarginGetMarginIsolatedMarginDataV1RespItemDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MarginGetMarginIsolatedMarginDataV1RespItemDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
