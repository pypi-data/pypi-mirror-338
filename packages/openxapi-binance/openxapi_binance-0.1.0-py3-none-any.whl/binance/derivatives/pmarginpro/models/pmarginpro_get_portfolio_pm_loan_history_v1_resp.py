...
class PmarginproGetPortfolioPmLoanHistoryV1Resp(BaseModel):
    """
    PmarginproGetPortfolioPmLoanHistoryV1Resp
    """ # noqa: E501
    rows: Optional[List[PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,
            "total": obj.get("total")
        })
        return _obj
