...
class PmarginGetUmApiTradingStatusV1Resp(BaseModel):
    """
    PmarginGetUmApiTradingStatusV1Resp
    """ # noqa: E501
    indicators: Optional[PmarginGetUmApiTradingStatusV1RespIndicators] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "indicators": PmarginGetUmApiTradingStatusV1RespIndicators.from_dict(obj["indicators"]) if obj.get("indicators") is not None else None,
