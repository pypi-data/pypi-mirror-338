...
class FuturesdataGetFuturesHistDataLinkV1Resp(BaseModel):
    """
    FuturesdataGetFuturesHistDataLinkV1Resp
    """ # noqa: E501
    data: Optional[List[FuturesdataGetFuturesHistDataLinkV1RespDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [FuturesdataGetFuturesHistDataLinkV1RespDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
