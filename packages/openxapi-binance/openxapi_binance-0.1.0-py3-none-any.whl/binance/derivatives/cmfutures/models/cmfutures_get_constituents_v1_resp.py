...
class CmfuturesGetConstituentsV1Resp(BaseModel):
    """
    CmfuturesGetConstituentsV1Resp
    """ # noqa: E501
    constituents: Optional[List[CmfuturesGetConstituentsV1RespConstituentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "constituents": [CmfuturesGetConstituentsV1RespConstituentsInner.from_dict(_item) for _item in obj["constituents"]] if obj.get("constituents") is not None else None,
