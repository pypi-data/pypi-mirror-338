...
class AlgoGetAlgoFuturesHistoricalOrdersV1Resp(BaseModel):
    """
    AlgoGetAlgoFuturesHistoricalOrdersV1Resp
    """ # noqa: E501
    orders: Optional[List[AlgoGetAlgoFuturesHistoricalOrdersV1RespOrdersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orders": [AlgoGetAlgoFuturesHistoricalOrdersV1RespOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
            "total": obj.get("total")
        })
        return _obj
