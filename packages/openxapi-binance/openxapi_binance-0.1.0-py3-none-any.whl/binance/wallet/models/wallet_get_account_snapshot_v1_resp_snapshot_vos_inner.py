...
class WalletGetAccountSnapshotV1RespSnapshotVosInner(BaseModel):
    """
    WalletGetAccountSnapshotV1RespSnapshotVosInner
    """ # noqa: E501
    data: Optional[WalletGetAccountSnapshotV1RespSnapshotVosInnerData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": WalletGetAccountSnapshotV1RespSnapshotVosInnerData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type"),
