...
class WalletGetCapitalConfigGetallV1RespItem(BaseModel):
    """
    ...
    network_list: Optional[List[WalletGetCapitalConfigGetallV1RespItemNetworkListInner]] = Field(default=None, alias="networkList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "networkList": [WalletGetCapitalConfigGetallV1RespItemNetworkListInner.from_dict(_item) for _item in obj["networkList"]] if obj.get("networkList") is not None else None,
