...
class CopytradingGetCopyTradingFuturesUserStatusV1Resp(BaseModel):
    """
    CopytradingGetCopyTradingFuturesUserStatusV1Resp
    """ # noqa: E501
    code: Optional[StrictStr] = None
    data: Optional[CopytradingGetCopyTradingFuturesUserStatusV1RespData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": CopytradingGetCopyTradingFuturesUserStatusV1RespData.from_dict(obj["data"]) if obj.get("data") is not None else None,
