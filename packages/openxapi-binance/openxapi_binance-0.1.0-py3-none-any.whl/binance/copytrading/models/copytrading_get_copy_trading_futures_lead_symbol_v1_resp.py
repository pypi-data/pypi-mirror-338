...
class CopytradingGetCopyTradingFuturesLeadSymbolV1Resp(BaseModel):
    """
    CopytradingGetCopyTradingFuturesLeadSymbolV1Resp
    """ # noqa: E501
    code: Optional[StrictStr] = None
    data: Optional[List[CopytradingGetCopyTradingFuturesLeadSymbolV1RespDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": [CopytradingGetCopyTradingFuturesLeadSymbolV1RespDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
