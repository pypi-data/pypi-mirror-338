...
class SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp(BaseModel):
    """
    SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp
    """ # noqa: E501
    asset: Optional[StrictStr] = None
    sub_account_list: Optional[List[SubaccountGetSubAccountFuturesAccountSummaryV1RespSubAccountListInner]] = Field(default=None, alias="subAccountList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asset": obj.get("asset"),
            "subAccountList": [SubaccountGetSubAccountFuturesAccountSummaryV1RespSubAccountListInner.from_dict(_item) for _item in obj["subAccountList"]] if obj.get("subAccountList") is not None else None,
