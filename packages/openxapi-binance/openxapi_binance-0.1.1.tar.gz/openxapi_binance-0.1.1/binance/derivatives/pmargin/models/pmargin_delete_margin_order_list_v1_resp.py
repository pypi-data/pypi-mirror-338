...
class PmarginDeleteMarginOrderListV1Resp(BaseModel):
    """
    ...
    order_reports: Optional[List[PmarginDeleteMarginOrderListV1RespOrderReportsInner]] = Field(default=None, alias="orderReports")
    orders: Optional[List[PmarginCreateMarginOrderOcoV1RespOrdersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderReports": [PmarginDeleteMarginOrderListV1RespOrderReportsInner.from_dict(_item) for _item in obj["orderReports"]] if obj.get("orderReports") is not None else None,
            "orders": [PmarginCreateMarginOrderOcoV1RespOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
