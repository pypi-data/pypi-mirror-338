...
class PmarginGetUmOrderAmendmentV1RespItem(BaseModel):
    """
    PmarginGetUmOrderAmendmentV1RespItem
    """ # noqa: E501
    amendment: Optional[PmarginGetCmOrderAmendmentV1RespItemAmendment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amendment": PmarginGetCmOrderAmendmentV1RespItemAmendment.from_dict(obj["amendment"]) if obj.get("amendment") is not None else None,
