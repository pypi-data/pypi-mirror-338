...
class CmfuturesGetOrderAmendmentV1RespItemAmendment(BaseModel):
    """
    CmfuturesGetOrderAmendmentV1RespItemAmendment
    """ # noqa: E501
    count: Optional[StrictInt] = None
    orig_qty: Optional[CmfuturesGetOrderAmendmentV1RespItemAmendmentOrigQty] = Field(default=None, alias="origQty")
    price: Optional[CmfuturesGetOrderAmendmentV1RespItemAmendmentOrigQty] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "origQty": CmfuturesGetOrderAmendmentV1RespItemAmendmentOrigQty.from_dict(obj["origQty"]) if obj.get("origQty") is not None else None,
            "price": CmfuturesGetOrderAmendmentV1RespItemAmendmentOrigQty.from_dict(obj["price"]) if obj.get("price") is not None else None
        })
        return _obj
