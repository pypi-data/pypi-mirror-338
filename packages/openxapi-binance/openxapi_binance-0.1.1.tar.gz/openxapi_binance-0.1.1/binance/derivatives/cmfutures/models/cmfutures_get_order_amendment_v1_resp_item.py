...
class CmfuturesGetOrderAmendmentV1RespItem(BaseModel):
    """
    CmfuturesGetOrderAmendmentV1RespItem
    """ # noqa: E501
    amendment: Optional[CmfuturesGetOrderAmendmentV1RespItemAmendment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amendment": CmfuturesGetOrderAmendmentV1RespItemAmendment.from_dict(obj["amendment"]) if obj.get("amendment") is not None else None,
