...
class OptionsGetMarginAccountV1Resp(BaseModel):
    """
    OptionsGetMarginAccountV1Resp
    """ # noqa: E501
    asset: Optional[List[OptionsGetMarginAccountV1RespAssetInner]] = None
    greek: Optional[List[OptionsGetAccountV1RespGreekInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asset": [OptionsGetMarginAccountV1RespAssetInner.from_dict(_item) for _item in obj["asset"]] if obj.get("asset") is not None else None,
            "greek": [OptionsGetAccountV1RespGreekInner.from_dict(_item) for _item in obj["greek"]] if obj.get("greek") is not None else None,
            "time": obj.get("time")
        })
        return _obj
