...
class SubaccountGetSubAccountMarginAccountSummaryV1Resp(BaseModel):
    """
    SubaccountGetSubAccountMarginAccountSummaryV1Resp
    """ # noqa: E501
    sub_account_list: Optional[List[SubaccountGetSubAccountMarginAccountSummaryV1RespSubAccountListInner]] = Field(default=None, alias="subAccountList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subAccountList": [SubaccountGetSubAccountMarginAccountSummaryV1RespSubAccountListInner.from_dict(_item) for _item in obj["subAccountList"]] if obj.get("subAccountList") is not None else None,
