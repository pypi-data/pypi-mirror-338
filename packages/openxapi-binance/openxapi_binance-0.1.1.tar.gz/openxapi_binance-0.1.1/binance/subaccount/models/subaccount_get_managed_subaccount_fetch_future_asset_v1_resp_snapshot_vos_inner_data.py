...
class SubaccountGetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerData(BaseModel):
    """
    SubaccountGetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerData
    """ # noqa: E501
    assets: Optional[List[SubaccountGetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerDataAssetsInner]] = None
    position: Optional[List[SubaccountGetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerDataPositionInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [SubaccountGetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerDataAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
            "position": [SubaccountGetManagedSubaccountFetchFutureAssetV1RespSnapshotVosInnerDataPositionInner.from_dict(_item) for _item in obj["position"]] if obj.get("position") is not None else None
        })
        return _obj
