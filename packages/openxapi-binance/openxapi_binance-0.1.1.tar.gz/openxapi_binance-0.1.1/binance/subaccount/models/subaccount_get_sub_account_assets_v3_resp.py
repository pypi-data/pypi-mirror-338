...
class SubaccountGetSubAccountAssetsV3Resp(BaseModel):
    """
    SubaccountGetSubAccountAssetsV3Resp
    """ # noqa: E501
    balances: Optional[List[SubaccountGetSubAccountAssetsV3RespBalancesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balances": [SubaccountGetSubAccountAssetsV3RespBalancesInner.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
        return _obj
