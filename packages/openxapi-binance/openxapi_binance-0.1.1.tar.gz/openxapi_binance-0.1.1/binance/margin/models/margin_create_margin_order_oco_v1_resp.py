...
class MarginCreateMarginOrderOcoV1Resp(BaseModel):
    """
    ...
    order_reports: Optional[List[MarginCreateMarginOrderOcoV1RespOrderReportsInner]] = Field(default=None, alias="orderReports")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderReports": [MarginCreateMarginOrderOcoV1RespOrderReportsInner.from_dict(_item) for _item in obj["orderReports"]] if obj.get("orderReports") is not None else None,
