...
class WalletGetAccountApiTradingStatusV1Resp(BaseModel):
    """
    WalletGetAccountApiTradingStatusV1Resp
    """ # noqa: E501
    data: Optional[WalletGetAccountApiTradingStatusV1RespData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": WalletGetAccountApiTradingStatusV1RespData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
