...
class ConvertCreateConvertLimitQueryOpenOrdersV1Resp(BaseModel):
    """
    ConvertCreateConvertLimitQueryOpenOrdersV1Resp
    """ # noqa: E501
    list: Optional[List[ConvertCreateConvertLimitQueryOpenOrdersV1RespListInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [ConvertCreateConvertLimitQueryOpenOrdersV1RespListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
