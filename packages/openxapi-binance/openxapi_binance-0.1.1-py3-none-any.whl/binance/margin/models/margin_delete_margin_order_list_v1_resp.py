...
class MarginDeleteMarginOrderListV1Resp(BaseModel):
    """
    ...
    order_reports: Optional[List[MarginDeleteMarginOrderListV1RespOrderReportsInner]] = Field(default=None, alias="orderReports")
    orders: Optional[List[MarginCreateMarginOrderOcoV1RespOrdersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderReports": [MarginDeleteMarginOrderListV1RespOrderReportsInner.from_dict(_item) for _item in obj["orderReports"]] if obj.get("orderReports") is not None else None,
            "orders": [MarginCreateMarginOrderOcoV1RespOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
