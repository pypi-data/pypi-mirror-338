...
class SubaccountGetSubAccountFuturesAccountSummaryV2Resp(BaseModel):
    """
    SubaccountGetSubAccountFuturesAccountSummaryV2Resp
    """ # noqa: E501
    future_account_summary_resp: Optional[SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp] = Field(default=None, alias="futureAccountSummaryResp")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "futureAccountSummaryResp": SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp.from_dict(obj["futureAccountSummaryResp"]) if obj.get("futureAccountSummaryResp") is not None else None
        })
        return _obj
