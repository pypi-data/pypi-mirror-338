...
class SubaccountGetSubAccountUniversalTransferV1Resp(BaseModel):
    """
    SubaccountGetSubAccountUniversalTransferV1Resp
    """ # noqa: E501
    result: Optional[List[SubaccountGetSubAccountUniversalTransferV1RespResultInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [SubaccountGetSubAccountUniversalTransferV1RespResultInner.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
