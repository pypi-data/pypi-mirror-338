...
class SubaccountGetSubAccountFuturesInternalTransferV1Resp(BaseModel):
    """
    ...
    transfers: Optional[List[SubaccountGetSubAccountFuturesInternalTransferV1RespTransfersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transfers": [SubaccountGetSubAccountFuturesInternalTransferV1RespTransfersInner.from_dict(_item) for _item in obj["transfers"]] if obj.get("transfers") is not None else None
        })
        return _obj
