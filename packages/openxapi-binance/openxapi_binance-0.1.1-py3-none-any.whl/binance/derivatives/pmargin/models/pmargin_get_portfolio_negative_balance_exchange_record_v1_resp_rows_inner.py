...
class PmarginGetPortfolioNegativeBalanceExchangeRecordV1RespRowsInner(BaseModel):
    """
    PmarginGetPortfolioNegativeBalanceExchangeRecordV1RespRowsInner
    """ # noqa: E501
    details: Optional[List[PmarginGetPortfolioNegativeBalanceExchangeRecordV1RespRowsInnerDetailsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [PmarginGetPortfolioNegativeBalanceExchangeRecordV1RespRowsInnerDetailsInner.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
