...
class PmarginGetUmAccountV2Resp(BaseModel):
    """
    PmarginGetUmAccountV2Resp
    """ # noqa: E501
    assets: Optional[List[PmarginGetCmAccountV1RespAssetsInner]] = None
    positions: Optional[List[PmarginGetUmAccountV2RespPositionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "positions": [PmarginGetUmAccountV2RespPositionsInner.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
