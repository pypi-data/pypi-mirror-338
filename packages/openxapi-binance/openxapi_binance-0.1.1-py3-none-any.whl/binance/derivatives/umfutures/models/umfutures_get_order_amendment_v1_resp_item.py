...
class UmfuturesGetOrderAmendmentV1RespItem(BaseModel):
    """
    UmfuturesGetOrderAmendmentV1RespItem
    """ # noqa: E501
    amendment: Optional[UmfuturesGetOrderAmendmentV1RespItemAmendment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amendment": UmfuturesGetOrderAmendmentV1RespItemAmendment.from_dict(obj["amendment"]) if obj.get("amendment") is not None else None,
