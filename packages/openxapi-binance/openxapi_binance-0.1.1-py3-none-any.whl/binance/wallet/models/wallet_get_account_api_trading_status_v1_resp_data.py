...
class WalletGetAccountApiTradingStatusV1RespData(BaseModel):
    """
    ...
    trigger_condition: Optional[WalletGetAccountApiTradingStatusV1RespDataTriggerCondition] = Field(default=None, alias="triggerCondition")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "triggerCondition": WalletGetAccountApiTradingStatusV1RespDataTriggerCondition.from_dict(obj["triggerCondition"]) if obj.get("triggerCondition") is not None else None,
