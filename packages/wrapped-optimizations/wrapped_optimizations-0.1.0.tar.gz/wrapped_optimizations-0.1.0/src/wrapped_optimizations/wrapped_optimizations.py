...
def differential_evolution(func, **kwargs):
    ...
    def wrapped_func(params_list):
        params = _unflatten_params(params_list, params_shape, params_names, constants_names, constants_values)
        nth_parameter = 0
        ...
        def use_const(value, name=None):
            return value
        return func(use_param, use_const)
