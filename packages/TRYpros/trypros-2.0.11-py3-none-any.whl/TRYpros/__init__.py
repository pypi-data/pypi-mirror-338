...
class FeatureHandler:
    ...
    def extract_trait_covariate_data(self, verbose=True):
        ...
        if verbose:
            ...
            print(f"Total no. of raw data points. = {num_total}\n",
                  ...
                  f"No. of covariate data points with ObservationID ",
                  f"matching that of at least 1 row of trait data. = ",
                  f"{num_data_covariate}\n",
                  f"No. of standardized such covariate data points. = ",
                  f"{len(data_covariate["std"])}\n",
                  f"No. of non standardized such covariate ",
                  ...
                  f"Identified LonLat DataIDs: {self.keep_ids[
                      "lonlat"]}\n",
