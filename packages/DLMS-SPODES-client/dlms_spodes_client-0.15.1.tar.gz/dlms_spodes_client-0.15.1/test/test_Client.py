...
class TestType(unittest.TestCase):
    ...
    def test_lowest_connect(self):
        ...
        t_server.start()
        while not t_server.sessions.is_complete():
            time.sleep(1)
    ...
    def test_InitType(self):
        ...
        while not t_server.sessions.is_complete():
            time.sleep(1)
            print(f"{t_server.sessions.is_complete()=}")
        time.sleep(3)
        print(t_server.sessions.ok_results)
