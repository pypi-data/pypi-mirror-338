...
class Nameless5382(ctypes.Structure):
    _fields_ = [
...
class Nameless50617(ctypes.Union):
    _anonymous_  = ('Nameless5382',)
    _fields_ = [
...
class Nameless45821(ctypes.Structure):
...
class Nameless64992(ctypes.Union):
...
class ics_spy_messagew_bms(ctypes.Structure):
    _anonymous_  = ('Nameless60883', 'Nameless64992')
    _fields_ = [
