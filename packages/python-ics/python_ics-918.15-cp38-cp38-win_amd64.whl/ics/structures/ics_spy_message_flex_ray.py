...
class Nameless59525(ctypes.Structure):
    _fields_ = [
...
class Nameless5189(ctypes.Union):
...
class Nameless54558(ctypes.Structure):
    _fields_ = [
...
class Nameless5269(ctypes.Union):
    _anonymous_  = ('Nameless54558', 'Nameless36278')
    _fields_ = [
...
class ics_spy_message_flex_ray(ctypes.Structure):
    _anonymous_  = ('Nameless5189', 'Nameless5269')
    _fields_ = [
