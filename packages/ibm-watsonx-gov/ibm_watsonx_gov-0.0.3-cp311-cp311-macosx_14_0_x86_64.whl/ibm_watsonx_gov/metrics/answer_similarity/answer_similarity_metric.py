...
class AnswerSimilarityMetric(GenAIMetric):
    name: Annotated[str, Field(default="answer_similarity")]
    ...
    method: Annotated[
        Literal["token_recall", "bert_score_recall", "sentence_bert_mini_lm"],
        Field(description=f"The method used to compute the metric. One of \"token_recall\","
