...
If you experience bugs or general issues with `rat-trig`, please have a look
...
You can help improve `rat-trig` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`rat-trig` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `rat-trig`'s files. While this mechanism can
...
```
conda create -n rat-trig python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/rat-trig.git
   cd rat-trig
   ```
...
5. Install [pre-commit]:
   ...
   `rat-trig` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/rat-trig
[issue tracker]: https://github.com/<USERNAME>/rat-trig/issues
