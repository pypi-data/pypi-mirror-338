...
class _EVMMixin:
  ...
  if True:
    ...
    def eth_verify_payload_signature(self, payload: dict, no_hash=False, raise_if_error=False):
      """
      ...
      if error_msg:
        ...
        result = self.eth_verify_text_signature(
          text=str_data, signature=signature, no_hash=no_hash, raise_if_error=raise_if_error
        )
        if result is None:
          if raise_if_error:
