...
Usage:
  bfan.py run  [--image=<path or name>] [--view=(compact | summary | jsonSummary)] [--env=<env1=val1,env2=val2>] [--clearPassed --stdout --genXml --outputName=<outputName> --arch=<binArch> --tags=<equation> (--prefix <paths>)] [<path>...]
  bfan.py clean  [<path>...]
  bfan.py diff   [<path>...]
  bfan.py update [<path>...]
