...
async def integracao_contabil(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    try:
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            field = get_text_from_window(main_window, (1003, 770, 1251, 785))
                        ...
                        if total_debito == total_credito:
                            ...
                            try:
                                ...
                                if diferenca_numerica <= 0.10:
                                    ...
                                    return RpaRetornoProcessoDTO(
                                        sucesso=False,
                                        retorno="Integração não realizada, pois os valores de crédito e débito divergem mesmo após clicar em lotes consistentes. Dif. superior a 0,10.",
                                        status=RpaHistoricoStatusEnum.Falha,
                                        tags=[RpaTagDTO(descricao=RpaTagEnum.Negocio)],
                                    )
                                ...
                                return RpaRetornoProcessoDTO(
                                    sucesso=False,
                                    retorno="Integração não realizada, pois os valores de crédito e débito divergem  após clicar em lotes consistentes. Não foi possível validar se Dif. é superior a 0,10",
                                    status=RpaHistoricoStatusEnum.Falha,
                                    tags=[RpaTagDTO(descricao=RpaTagEnum.Negocio)],
                                )
