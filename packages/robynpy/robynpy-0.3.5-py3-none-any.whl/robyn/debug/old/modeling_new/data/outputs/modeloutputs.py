...
class ModelOutputs:
    ...
    Attributes:
        ...
        bootstrap (bool): Whether bootstrap was used.
        refresh (bool): Whether refresh was used.
    """
    ...
    seed: List[int] = field(default_factory=lambda: [123])
    convergence: Optional[Dict] = None
    ts_validation_plot: Optional[Dict] = None
