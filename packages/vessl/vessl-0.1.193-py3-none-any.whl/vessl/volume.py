...
def _copy_volume_file_local_to_remote(
    ...
    if not os.path.isdir(source_path):
        ...
        use_ssl = not allow_insecure
        uploaded_file = Uploader.upload(source_path, dest_volume_id, dest_path, use_ssl)
    ...
    uploaded_files = Uploader.bulk_upload(source_path, paths, dest_volume_id, dest_path, use_ssl)
