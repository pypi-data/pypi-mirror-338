...
class AnsibleGitRemote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["rate_limit", "download_concurrency", "total_timeout", "client_key", "headers", "tls_validation", "pulp_labels", "sock_connect_timeout", "ca_cert", "password", "url", "proxy_username", "sock_read_timeout", "proxy_url", "username", "client_cert", "max_retries", "name", "proxy_password", "connect_timeout", "metadata_only", "git_ref"]
