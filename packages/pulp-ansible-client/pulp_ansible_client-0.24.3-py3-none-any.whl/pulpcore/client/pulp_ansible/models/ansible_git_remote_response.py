...
class AnsibleGitRemoteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["rate_limit", "download_concurrency", "total_timeout", "headers", "tls_validation", "pulp_labels", "sock_connect_timeout", "ca_cert", "url", "sock_read_timeout", "proxy_url", "prn", "client_cert", "hidden_fields", "pulp_last_updated", "max_retries", "pulp_created", "pulp_href", "name", "connect_timeout", "metadata_only", "git_ref"]
