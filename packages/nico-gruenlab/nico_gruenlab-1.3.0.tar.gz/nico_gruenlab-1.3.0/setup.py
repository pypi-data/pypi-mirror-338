...
# Setting up
setup(name="nico-gruenlab", #"nico-sc-sp"
    version=VERSION,
    author="Christian",
    ...
    install_requires=['scanpy==1.9.6','seaborn==0.12.2','scipy==1.11.3', 'matplotlib==3.7.3','numpy==1.26.1','networkx==3.2.1','gseapy==1.0.6','numba==0.58.1','xlsxwriter==3.1.9',  'pydot==1.4.2','scikit-learn==1.3.2','pandas==2.1.1', 'KDEpy==1.1.8','pygraphviz==1.11', 'leidenalg'],
