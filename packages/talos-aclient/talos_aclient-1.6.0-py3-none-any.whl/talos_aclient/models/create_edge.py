...
class CreateEdge(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["label_id", "label_name", "source_id", "target_id", "properties"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateEdge from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateEdge from a dict"""
        if obj is None:
            return None
