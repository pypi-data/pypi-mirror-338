...
class ParseConfigInput(BaseModel):
    """
    ParseConfigInput
    """ # noqa: E501
    clean_config: Optional[CleanConfig] = None
    splitter_config: Optional[SplitterConfig] = None
    loader_config: Optional[LoaderConfigInput] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ParseConfigInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParseConfigInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "loader_config": LoaderConfigInput.from_dict(obj["loader_config"]) if obj.get("loader_config") is not None else None,
