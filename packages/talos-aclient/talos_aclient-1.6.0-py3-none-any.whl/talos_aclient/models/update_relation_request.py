...
class UpdateRelationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataset_id", "id", "name", "source_id", "target_id", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateRelationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateRelationRequest from a dict"""
        if obj is None:
            return None
