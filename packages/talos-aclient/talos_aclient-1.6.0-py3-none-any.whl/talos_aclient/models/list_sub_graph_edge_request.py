...
class ListSubGraphEdgeRequest(BaseModel):
    """
    ListSubGraphEdgeRequest
    """ # noqa: E501
    ...
    strictly_include: Optional[StrictBool] = Field(default=True, description="起终点是否都在约束范围内")
    with_node_ontology: Optional[StrictBool] = Field(default=False, description="是否返回节点的本体id")
    __properties: ClassVar[List[str]] = ["dataset_id", "resource_id", "label_ids", "label_names", "condition_groups", "strictly_include", "with_node_ontology"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListSubGraphEdgeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListSubGraphEdgeRequest from a dict"""
        if obj is None:
            return None
