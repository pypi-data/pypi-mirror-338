...
class GetSegmentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["resource_id", "dataset_id", "segment_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSegmentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSegmentRequest from a dict"""
        if obj is None:
            return None
