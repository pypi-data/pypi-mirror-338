...
class DeleteEntityRequest(BaseModel):
    ...
    id: StrictStr
    with_node: Optional[StrictBool] = Field(default=False, description="是否删除本体实体对应的节点")
    __properties: ClassVar[List[str]] = ["dataset_id", "id", "with_node"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "with_node": obj.get("with_node") if obj.get("with_node") is not None else False
        })
        return _obj
