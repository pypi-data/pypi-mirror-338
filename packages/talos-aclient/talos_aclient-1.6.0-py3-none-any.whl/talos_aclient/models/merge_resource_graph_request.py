...
class MergeResourceGraphRequest(BaseModel):
    """
    MergeResourceGraphRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["trace_info", "queue", "allow_override", "resource_id", "dataset_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MergeResourceGraphRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MergeResourceGraphRequest from a dict"""
        if obj is None:
            return None
