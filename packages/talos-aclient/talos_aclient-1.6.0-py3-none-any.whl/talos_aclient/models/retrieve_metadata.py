...
class RetrieveMetadata(BaseModel):
    ...
    graph_meta: Optional[AppTalosSchemaGraphGraphMetadata] = None
    areas: Optional[List[Position]] = None
    relevance_score: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["dataset_id", "file_id", "document_id", "position", "enable", "doc_id", "doc_hash", "document_meta", "table_meta", "graph_meta", "areas", "relevance_score"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetrieveMetadata from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of table_meta
        if self.table_meta:
            _dict['table_meta'] = self.table_meta.to_dict()
        # override the default output from pydantic by calling `to_dict()` of graph_meta
        if self.graph_meta:
            _dict['graph_meta'] = self.graph_meta.to_dict()
        ...
        # set to None if table_meta (nullable) is None
        # and model_fields_set contains the field
        if self.table_meta is None and "table_meta" in self.model_fields_set:
            _dict['table_meta'] = None

        # set to None if graph_meta (nullable) is None
        # and model_fields_set contains the field
        if self.graph_meta is None and "graph_meta" in self.model_fields_set:
            _dict['graph_meta'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrieveMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "table_meta": TableMetadata.from_dict(obj["table_meta"]) if obj.get("table_meta") is not None else None,
            "graph_meta": AppTalosSchemaGraphGraphMetadata.from_dict(obj["graph_meta"]) if obj.get("graph_meta") is not None else None,
