...
class CountEdgeRequest(BaseModel):
    """
    CountEdgeRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["trace_info", "dataset_id", "resource_id", "label_ids", "label_names", "keyword", "relation_filter_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CountEdgeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CountEdgeRequest from a dict"""
        if obj is None:
            return None
