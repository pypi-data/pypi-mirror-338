...
class AddResourceToDatasetRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["queue_config", "trace_info", "type", "dry_run", "name", "data", "parse_config", "index_config", "async_mode", "should_parser", "dataset_id"]
