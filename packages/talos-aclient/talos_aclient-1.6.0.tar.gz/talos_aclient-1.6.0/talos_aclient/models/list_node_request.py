...
class ListNodeRequest(BaseModel):
    """
    ListNodeRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["trace_info", "dataset_id", "resource_id", "label_id", "label_name", "keyword", "filter_by_property_value", "order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListNodeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListNodeRequest from a dict"""
        if obj is None:
            return None
