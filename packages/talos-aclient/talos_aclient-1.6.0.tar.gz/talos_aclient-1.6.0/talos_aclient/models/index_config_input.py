...
class IndexConfigInput(BaseModel):
    ...
    relational_db: Optional[RelationalDBConfigInput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relational_db": RelationalDBConfigInput.from_dict(obj["relational_db"]) if obj.get("relational_db") is not None else None
        })
        return _obj
