...
class ExpandSegmentsResponse(BaseModel):
    """
    ExpandSegmentsResponse
    """ # noqa: E501
    code: Optional[StrictInt] = 200
    detail: Optional[StrictStr] = '请求成功'
    data: Optional[Dict[str, VectorDO]]
    ranges: Optional[Dict[str, Annotated[List[Any], Field(min_length=2, max_length=2)]]]
    __properties: ClassVar[List[str]] = ["code", "detail", "data", "ranges"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpandSegmentsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpandSegmentsResponse from a dict"""
        if obj is None:
            return None
