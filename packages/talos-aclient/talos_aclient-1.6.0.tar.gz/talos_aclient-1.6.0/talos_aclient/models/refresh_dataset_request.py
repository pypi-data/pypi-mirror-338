...
class RefreshDatasetRequest(BaseModel):
    ...
    ignore_success: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["queue", "dataset_id", "ignore_success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ignore_success": obj.get("ignore_success") if obj.get("ignore_success") is not None else False
        })
        return _obj
