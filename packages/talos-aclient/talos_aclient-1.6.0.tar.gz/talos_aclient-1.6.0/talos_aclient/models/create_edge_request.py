...
class CreateEdgeRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trace_info", "dataset_id", "resource_id", "edges"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateEdgeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateEdgeRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "edges": [CreateEdge.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None
        })
        return _obj
