...
class ListEntityRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataset_id", "keyword", "ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListEntityRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListEntityRequest from a dict"""
        if obj is None:
            return None
