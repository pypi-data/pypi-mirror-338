...
class DeleteRelationRequest(BaseModel):
    ...
    id: StrictStr
    with_edge: Optional[StrictBool] = Field(default=False, description="是否删除本体关系对应的边")
    __properties: ClassVar[List[str]] = ["dataset_id", "id", "with_edge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "with_edge": obj.get("with_edge") if obj.get("with_edge") is not None else False
        })
        return _obj
