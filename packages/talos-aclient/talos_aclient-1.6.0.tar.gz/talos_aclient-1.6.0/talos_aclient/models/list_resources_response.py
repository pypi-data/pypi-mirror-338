...
class ListResourcesResponse(BaseModel):
    ...
    page_total: Optional[StrictInt] = 0
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [Resource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total") if obj.get("total") is not None else 0,
            "page_total": obj.get("page_total") if obj.get("page_total") is not None else 0
        })
        return _obj
