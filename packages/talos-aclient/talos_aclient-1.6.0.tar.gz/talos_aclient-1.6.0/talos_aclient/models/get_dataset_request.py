...
class GetDatasetRequest(BaseModel):
    ...
    resource_counted: Optional[StrictBool] = False
    graph_counted: Optional[StrictBool] = Field(default=False, description="若是图谱库，标记是否返回图谱的计数信息")
    __properties: ClassVar[List[str]] = ["dataset_id", "resource_counted", "graph_counted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resource_counted": obj.get("resource_counted") if obj.get("resource_counted") is not None else False,
