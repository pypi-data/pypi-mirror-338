...
SYNOPSIS
    geai ai-studio <subcommand> --[flag] [flag_arg]

DESCRIPTION
    geai ai-studio is a command from geai cli utility, developed to interact with AI Studio in GEAI.
