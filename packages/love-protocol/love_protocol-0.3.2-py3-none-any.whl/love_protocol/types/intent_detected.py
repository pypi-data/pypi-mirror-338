...
class INTENTDETECTED(LOVEMESSAGE):
    type: str = Field('INTENT_DETECTED', const=True)
    intent: str
    confidence: confloat(ge=0.0, le=1.0)
    entities: Optional[
        dict[str, Optional[Union[str, float, bool, dict[str, Any], list[Any]]]]
    ] = None
