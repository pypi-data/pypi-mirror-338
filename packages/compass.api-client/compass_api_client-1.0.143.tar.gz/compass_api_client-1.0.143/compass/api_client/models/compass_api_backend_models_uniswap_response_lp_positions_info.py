...
class CompassApiBackendModelsUniswapResponseLPPositionsInfo(BaseModel):
    """
    CompassApiBackendModelsUniswapResponseLPPositionsInfo
    """ # noqa: E501
    positions: Dict[str, CompassApiBackendModelsUniswapResponsePosition] = Field(description="Liquidity provision positions belonging to a particular user. The key is a tuple of the token0, token1, fee, tick_lower, and tick_upper of the position.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "positions": dict(
                (_k, CompassApiBackendModelsUniswapResponsePosition.from_dict(_v))
