...
class BaseTransactionRequestAerodromeSlipstreamIncreaseLiquidityProvisionCallData(BaseModel):
    """
    BaseTransactionRequestAerodromeSlipstreamIncreaseLiquidityProvisionCallData
    """ # noqa: E501
    chain: Chain
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "call_data": AerodromeSlipstreamIncreaseLiquidityProvisionCallData.from_dict(obj["call_data"]) if obj.get("call_data") is not None else None
        })
        return _obj
