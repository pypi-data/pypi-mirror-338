...
class Token0Token1(BaseModel):
    """
    Token0Token1
    """ # noqa: E501
    token0: StrictStr = Field(description="The value in units of token0.")
    token1: StrictStr = Field(description="The value in units of token1.")
    __properties: ClassVar[List[str]] = ["token0", "token1"]
