...
class CompassApiBackendModelsAerodromeSlipstreamResponseLPPositionsInfo(BaseModel):
    """
    CompassApiBackendModelsAerodromeSlipstreamResponseLPPositionsInfo
    """ # noqa: E501
    positions: Dict[str, CompassApiBackendModelsAerodromeSlipstreamResponsePosition] = Field(description="Liquidity provision positions belonging to a particular user. The key is a tuple of the token0, token1, tick_spacing, tick_lower, and tick_upper of the position.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "positions": dict(
                (_k, CompassApiBackendModelsAerodromeSlipstreamResponsePosition.from_dict(_v))
