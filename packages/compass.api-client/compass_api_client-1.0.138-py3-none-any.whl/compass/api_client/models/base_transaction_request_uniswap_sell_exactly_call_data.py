...
class BaseTransactionRequestUniswapSellExactlyCallData(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "call_data": UniswapSellExactlyCallData.from_dict(obj["call_data"]) if obj.get("call_data") is not None else None
        })
        return _obj
