    ...
    def test_info_as_json(self):
        ...
        with mock.patch.object(log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 34, "function": "test_info_as_json"}}\n'
            )
    ...
    def test_info_as_json_with_labels(self):
        ...
        with mock.patch.object(log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": false, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 52, "function": "test_info_as_json_with_labels"}}\n'
            )
    ...
    def test_info_as_json_with_labels_as_bytes(self):
        ...
        with mock.patch.object(log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": false, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 70, "function": "test_info_as_json_with_labels_as_bytes"}}\n'
            )
    ...
    def test_info_as_json_with_labels_with_bytes(self):
        ...
        with mock.patch.object(log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": false, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 88, "function": "test_info_as_json_with_labels_with_bytes"}}\n'
            )
    ...
    def test_info_as_json_with_http_headers(self):
        ...
        with mock.patch.object(log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 107, "function": "test_info_as_json_with_http_headers"}}\n'
            )
    ...
    def test_error_as_json(self):
        ...
        with mock.patch.object(log._log.handler, 'stream') as stream:
            ...
            stream.write.assert_called_once_with(
                ...
                '"logging.googleapis.com/trace_sampled": false, '
                '"logging.googleapis.com/sourceLocation":'
                ' {"file": "/var/app/src/everysk/core/_tests/log.py", "line": 130, "function": "test_error_as_json"}}\n'
            )
