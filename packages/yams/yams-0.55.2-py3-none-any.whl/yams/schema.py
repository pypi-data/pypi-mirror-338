    ...
    def __init__(
        ...
        **kwargs,
        ...
        if relation_definition is not None:
            ...
            self.subject_relations: Dict["RelationSchema", "RelationSchema"] = (
                _RetroCompatRelationsDict(old_name="subject_relations")
            )
            self.object_relations: Dict["RelationSchema", "RelationSchema"] = (
...
class RelationSchema(ERSchema):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(schema, relation_definition)
