...
from yams.buildobjs import EntityType, RelationType, SubjectRelation, Int, String, Boolean
...
class State(EntityType):
    ...
    name = String(
        required=True, indexed=True, internationalizable=True, constraints=[SizeConstraint(max=256)]
    )
