...
def specific_heat(temperature: float, unit: str) -> float:
    ...
    coefficients = np.array([
        46.6467, -314.292, 866.662, -1298.3, 
        1162.27, -637.795, 210.351, -38.3094, 
        2.96344
    ])
...
def thermal_conductivity(temperature: float, source: str = 'MARQUARDT') -> float:
    """
