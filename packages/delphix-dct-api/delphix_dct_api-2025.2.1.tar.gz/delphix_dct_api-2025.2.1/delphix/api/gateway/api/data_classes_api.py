...
from delphix.api.gateway.model.data_class_create_request import DataClassCreateRequest
from delphix.api.gateway.model.data_class_create_response import DataClassCreateResponse
...
class DataClassesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_data_class(
            self,
            data_class_create_request,
            **kwargs
        ):
            """Create a Data Class.  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.create_data_class(data_class_create_request, async_req=True)
            >>> result = thread.get()

            Args:
                data_class_create_request (DataClassCreateRequest): The new Data Class to create
            ...
            kwargs['data_class_create_request'] = \
                data_class_create_request
            return self.call_with_http_info(**kwargs)

        self.create_data_class = _Endpoint(
            settings={
                'response_type': (DataClassCreateResponse,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/data-classes',
                'operation_id': 'create_data_class',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'openapi_types': {
                    'data_class_create_request':
                        (DataClassCreateRequest,),
                },
                'attribute_map': {
                },
                'location_map': {
                    'data_class_create_request': 'body',
                },
