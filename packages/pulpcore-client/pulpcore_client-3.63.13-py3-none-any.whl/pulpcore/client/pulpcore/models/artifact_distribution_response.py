...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, prn=None, content_guard=None, base_path=None, base_url=None, hidden=False, pulp_last_updated=None, no_content_change_since=None, pulp_href=None, pulp_created=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
