...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, name=None, pulp_labels=None, pulp_last_updated=None, base_url=None, pulp_href=None, pulp_created=None, hidden=False, content_guard=None, local_vars_configuration=None):  # noqa: E501
