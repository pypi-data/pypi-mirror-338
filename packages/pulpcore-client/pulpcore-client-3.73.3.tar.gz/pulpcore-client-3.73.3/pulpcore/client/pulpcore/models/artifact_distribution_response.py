...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "pulp_last_updated", "base_path", "hidden", "content_guard", "pulp_href", "pulp_labels", "pulp_created", "no_content_change_since", "base_url", "prn"]
