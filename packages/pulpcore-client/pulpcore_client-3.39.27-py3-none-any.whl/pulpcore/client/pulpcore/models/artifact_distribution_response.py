...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, name=None, content_guard=None, pulp_labels=None, base_path=None, base_url=None, pulp_href=None, hidden=False, local_vars_configuration=None):  # noqa: E501
