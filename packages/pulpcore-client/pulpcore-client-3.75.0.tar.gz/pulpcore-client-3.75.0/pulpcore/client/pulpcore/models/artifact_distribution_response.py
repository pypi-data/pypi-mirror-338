...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "content_guard", "pulp_labels", "base_path", "no_content_change_since", "hidden", "name", "pulp_created", "prn", "pulp_last_updated", "pulp_href"]
