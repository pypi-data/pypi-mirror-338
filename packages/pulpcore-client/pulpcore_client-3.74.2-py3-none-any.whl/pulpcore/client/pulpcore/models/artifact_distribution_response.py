...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "pulp_href", "hidden", "no_content_change_since", "prn", "pulp_labels", "pulp_last_updated", "content_guard", "base_path", "name", "pulp_created"]
