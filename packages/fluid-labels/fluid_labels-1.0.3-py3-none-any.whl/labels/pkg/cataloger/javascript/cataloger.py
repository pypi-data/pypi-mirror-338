...
from labels.pkg.cataloger.javascript.parse_html_scripts import (
    parse_html_scripts,
)
from labels.pkg.cataloger.javascript.parse_package_json import (
    parse_package_json,
)
from labels.pkg.cataloger.javascript.parse_package_lock import (
    parse_package_lock,
)
from labels.pkg.cataloger.javascript.parse_pnpm_lock import (
    parse_pnpm_lock,
)
from labels.pkg.cataloger.javascript.parse_yarn_lock import (
    parse_yarn_lock,
)
