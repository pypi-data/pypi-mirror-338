...
def deploy(
    ...
    package_repository_username = package_repository_username or getenv("GITLAB_USER")
    package_repository_password = package_repository_password or getenv("GITLAB_PASSWORD")
    buildargs = {}
