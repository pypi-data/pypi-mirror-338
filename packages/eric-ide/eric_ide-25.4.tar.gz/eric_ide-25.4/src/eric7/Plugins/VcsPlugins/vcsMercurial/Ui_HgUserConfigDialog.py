...
class Ui_HgUserConfigDialog(object):
    def setupUi(self, HgUserConfigDialog):
        ...
        self.fastexportCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_2)
        self.fastexportCheckBox.setObjectName("fastexportCheckBox")
        self.gridLayout_2.addWidget(self.fastexportCheckBox, 0, 1, 1, 1)
        self.uncommitCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_2)
        self.uncommitCheckBox.setObjectName("uncommitCheckBox")
        self.gridLayout_2.addWidget(self.uncommitCheckBox, 3, 1, 1, 1)
        ...
        HgUserConfigDialog.setTabOrder(self.closeheadCheckBox, self.fastexportCheckBox)
        HgUserConfigDialog.setTabOrder(self.fastexportCheckBox, self.gpgCheckBox)
        ...
        HgUserConfigDialog.setTabOrder(self.largefilesCheckBox, self.queuesCheckBox)
        HgUserConfigDialog.setTabOrder(self.queuesCheckBox, self.rebaseCheckBox)
        HgUserConfigDialog.setTabOrder(self.rebaseCheckBox, self.uncommitCheckBox)
        HgUserConfigDialog.setTabOrder(self.uncommitCheckBox, self.lfFileSizeSpinBox)
    ...
    def retranslateUi(self, HgUserConfigDialog):
        ...
        self.fastexportCheckBox.setToolTip(_translate("HgUserConfigDialog", "Select to activate the fastexport extension"))
        self.fastexportCheckBox.setText(_translate("HgUserConfigDialog", "Fastexport"))
        self.uncommitCheckBox.setToolTip(_translate("HgUserConfigDialog", "Select to activate the uncommit extension"))
        self.uncommitCheckBox.setText(_translate("HgUserConfigDialog", "Uncommit"))
