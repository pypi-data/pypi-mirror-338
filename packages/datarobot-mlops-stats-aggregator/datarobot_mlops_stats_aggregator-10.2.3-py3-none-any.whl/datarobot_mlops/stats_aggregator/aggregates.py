...
class NumericAggregate(Aggregate):
    ...
    @property
    def decision_count(self) -> Optional[int]:
    ...
    def merge(self, other: "Aggregate") -> "Aggregate":
        ...
        if self._decision_count is None and other._decision_count is None:
            merged_decision_count = None
        elif self._decision_count is None:
            merged_decision_count = other._decision_count
        elif other._decision_count is None:
            merged_decision_count = self._decision_count
        else:
            merged_decision_count = self._decision_count + other._decision_count
        return NumericAggregate(
            ...
            decision_count=merged_decision_count,
        )
