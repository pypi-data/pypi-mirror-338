...
from mangokit.exceptions import MangoKitError, ERROR_MSG_0013, ERROR_MSG_0049, ERROR_MSG_0058
    ...
    async def w_goto(self, url: str):
        ...
        try:
            ...
            if not all([result.scheme, result.netloc]):
                raise MangoKitError(*ERROR_MSG_0049)
            await self.base_data.page.goto(url, timeout=60000)
            await asyncio.sleep(2)
        except TimeoutError:
            raise MangoKitError(*ERROR_MSG_0013, value=(url,))
        except Error:
            raise MangoKitError(*ERROR_MSG_0058, value=(url,))
