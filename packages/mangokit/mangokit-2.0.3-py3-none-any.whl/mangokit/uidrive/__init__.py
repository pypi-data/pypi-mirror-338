...
from mangokit.enums.ui_enum import ElementOperationEnum, DriveTypeEnum
...
from mangokit.models.ui_model import ElementResultModel, ElementModel
from mangokit.uidrive.android import AndroidDriver
from mangokit.uidrive.web import WebDevice
    ...
    async def __error_screenshot(self, file_path):
        match self.drive_type:
            ...
            case DriveTypeEnum.DESKTOP.value:
                pass
            case _:
                self.base_data.log.error('自动化类型不存在，请联系管理员检查！')
