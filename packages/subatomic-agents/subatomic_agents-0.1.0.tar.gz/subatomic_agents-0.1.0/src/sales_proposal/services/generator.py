...
from src.sales_proposal.models.input_schema import SalesProposalInput
from src.sales_proposal.factories.config_factory import SalesProposalConfigFactory
from src.sales_proposal.agents.invoke_sales_proposal_agent import get_sales_proposal_agent
...
class SalesProposalGeneratorService:
    ...
    def generate(self) -> Tuple[Dict[str, Any], int]:
        try:
            agent = get_sales_proposal_agent()
