"""
System prompts for the Pica API client.
"""
...
def generate_full_system_prompt(system_prompt: str, user_system_prompt: Optional[str] = None) -> str:
    """
    Generate a full system prompt by combining a user-provided system prompt and the built-in system prompt.
    
    Args:
        system_prompt: The built-in system prompt.
        user_system_prompt: An optional user-provided system prompt to include.
