"""Test CpraGrch37Annotator class with BRAF V600E."""
...
class CpraGrch37AnnotatorBrafV600eTestCase(unittest.TestCase):
    """Test CpraGrch37Annotator class with BRAF V600E."""
    ...
    def test_hgvs_annotation_hgvs_g(self):
        ...
        self.assertEqual(
            str(self.hgvs_annotation.hgvs_g), "NC_000007.13:g.140453136A>T"
        )

    def test_hgvs_annotation_hgvs_g_normalized(self):
        self.assertTrue(isinstance(self.hgvs_annotation.hgvs_g_normalized, HgvsG))
        self.assertEqual(
            str(self.hgvs_annotation.hgvs_g_normalized), "NC_000007.13:g.140453136A>T"
        )
    ...
    def test_hgvs_annotation_hgvs_t(self):
        for hgvs_tp_annotation in self.hgvs_annotation.hgvs_tp_annotations:
            ...
            if hgvs_tp_annotation.tx_ac == self.tx_ac:
                self.assertEqual(
                    str(hgvs_tp_annotation.hgvs_t), f"{self.tx_ac}(BRAF):c.1799T>A"
                )
    ...
    def test_hgvs_annotation_hgvs_p(self):
        for hgvs_tp_annotation in self.hgvs_annotation.hgvs_tp_annotations:
            ...
            if hgvs_tp_annotation.tx_ac == self.tx_ac:
                self.assertEqual(
                    str(hgvs_tp_annotation.hgvs_p), "NP_004324.2:p.Val600Glu"
                )
    ...
    def test_transcript_feature_range_annotation(self):
        for (
            ...
            if (
                ...
                self.assertEqual(
                    transcript_feature_range_annotation.format(), "exon 15"
                )
                ...
                raw={
                    ...
                    "clinvar": {
                        ...
                        "rcv": [
                            ...
                            },
                            {
                                ...
                                "conditions": {
                                    "name": "Trametinib-Dabrafenib Response"
                                },
                                "number_submitters": 1,
                                "origin": "somatic",
                                "preferred_name": "NM_004333.6(BRAF):c.1799T>A (p.Val600Glu)",
                            ...
                            },
                            {
                                ...
                                "clinical_significance": "drug response",
                                "conditions": {
                                    "name": "Vemurafenib-Cobimetinib Response"
                                },
                                "number_submitters": 1,
                                "origin": "somatic",
                                "preferred_name": "NM_004333.6(BRAF):c.1799T>A (p.Val600Glu)",
                    ...
                    "dbsnp": {
                        ...
                        "alleles": [
                            {
                                "allele": "A",
                                "freq": {"exac": 1.0, "gnomad_exomes": 1.0},
                            },
                            {
                                "allele": "T",
                                "freq": {"exac": 0.0, "gnomad_exomes": 0.0},
                            },
                        ],
                        "alt": "T",
                        "chrom": "7",
