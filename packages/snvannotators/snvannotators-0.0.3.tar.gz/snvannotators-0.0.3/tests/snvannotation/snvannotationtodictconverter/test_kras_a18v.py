"""Test SnvAnnotationToDictConverter class with KRAS A18V."""
...
class SnvAnnotationToDictConverterKrasA18vTestCase(unittest.TestCase):
    """Test SnvAnnotationToDictConverter class with KRAS A18V."""
    ...
    def setUpClass(cls) -> None:
        ...
        d = {
            ...
            "hgvs_annotation": {
                "hgvs_g": hgvs_parser.parse("NC_000012.11:g.25398266G>A"),
                "hgvs_g_normalized": hgvs_parser.parse("NC_000012.11:g.25398266G>A"),
                "hgvs_tp_annotations": [
                    {
                        "tx_ac": "NM_001369787.1",
                        "hgvs_t": hgvs_parser.parse("NM_001369787.1(KRAS):c.53C>T"),
                        "hgvs_p": hgvs_parser.parse("NP_001356716.1:p.Ala18Val"),
                    },
                    {
                        "tx_ac": "NM_033360.2",
                        "hgvs_t": hgvs_parser.parse("NM_033360.2(KRAS):c.53C>T"),
                        "hgvs_p": hgvs_parser.parse("NP_203524.1:p.Ala18Val"),
                    },
                ],
            },
        ...
        snv_annotation = snv_annotation_builder.from_dict(data=d)
