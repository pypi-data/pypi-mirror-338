"""Test SnvAnnotationSerializer class with KRAS A18V."""

import unittest

from pyoncokb.oncokbapi import OncokbApi
from snvannotators.cpraannotators.cpragrch37annotator import CpraGrch37Annotator
from snvannotators.snvannotation.snvannotationtodictconverter import SnvAnnotationSerializer
from snvmodels.cpra import Cpra

from tests.testconfig import TestConfig


class SnvAnnotationSerializerKrasA18vTestCase(unittest.TestCase):
    """Test SnvAnnotationSerializer class with KRAS A18V."""
    ...
    def setUpClass(cls) -> None:
        ...
        cls.snv_annotation_serializer = SnvAnnotationSerializer(
            snv_annotation=snv_annotation
        )

    def test_serialize(self):
        d = self.snv_annotation_serializer.serialize()
        self.assertEqual(
            d,
            {
                "snv": {
