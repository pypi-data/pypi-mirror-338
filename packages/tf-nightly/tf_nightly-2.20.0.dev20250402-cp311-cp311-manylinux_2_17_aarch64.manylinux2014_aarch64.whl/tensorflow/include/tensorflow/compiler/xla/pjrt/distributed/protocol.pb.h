...
class PROTOBUF_EXPORT DeviceProto final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_fabric_uuid(ArgT0&& arg0, ArgT... args);
  std::string* mutable_fabric_uuid();
  PROTOBUF_NODISCARD std::string* release_fabric_uuid();
  void set_allocated_fabric_uuid(std::string* fabric_uuid);
  private:
  const std::string& _internal_fabric_uuid() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_fabric_uuid(const std::string& value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr fabric_uuid_;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DeviceProto::set_fabric_uuid(ArgT0&& arg0, ArgT... args) {
 
 _impl_.fabric_uuid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xla.DeviceProto.fabric_uuid)
}
inline std::string* DeviceProto::mutable_fabric_uuid() {
...
inline void DeviceProto::_internal_set_fabric_uuid(const std::string& value) {
  ...
  _impl_.fabric_uuid_.Set(value, GetArenaForAllocation());
}
inline std::string* DeviceProto::_internal_mutable_fabric_uuid() {
  
  return _impl_.fabric_uuid_.Mutable(GetArenaForAllocation());
}
...
inline void DeviceProto::set_allocated_fabric_uuid(std::string* fabric_uuid) {
  if (fabric_uuid != nullptr) {
    
  } else {
    
  }
  _impl_.fabric_uuid_.SetAllocated(fabric_uuid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.fabric_uuid_.IsDefault()) {
    _impl_.fabric_uuid_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
