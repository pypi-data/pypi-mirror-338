...
class TrossenArmDriver:
    ...
    def set_continuity_factors(self, continuity_factors: list[float]) -> None:
        """
                ...
                Each element in the vector should be within the range [1.0, 10.0] for arm joints and
                additionally negative for the gripper joint to disable the continuity constraint.
        
                Warning
                -------
                Disabling the continuity constraint for the gripper joint removes protection against
    ...
    def set_joint_characteristics(self, joint_characteristics: list[JointCharacteristic]) -> None:
        """
                ...
                - continuity_factor: [1.0, 10.0] for arm joints and additionally negative for the gripper
                  joint to disable the continuity constraint
