...
class Houston2013(CommonHsiDsmDataset):
    def __init__(self, subset, patch_radius=5, *args, **kwargs):
        super().__init__(fetch_houston2013, subset, patch_radius, *args, **kwargs)
...
class Muufl(CommonHsiDsmDataset):
    ...
    """
    def __init__(self, subset, patch_radius=5, n_train_perclass=20, *args, **kwargs):
        def get_data():
        ...
        super().__init__(get_data, subset, patch_radius, *args, **kwargs)
