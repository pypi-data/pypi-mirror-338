...
from pychemstation.utils.sequence_types import SequenceTable, InjectionSource, SequenceEntry, SampleType
from pychemstation.utils.tray_types import FiftyFourVialPlate
from tests.constants import (
    clean_up,
    set_up_utils,
    DEFAULT_METHOD_242,
    DEFAULT_METHOD_254, DEFAULT_SEQUENCE, DEFAULT_METHOD,
)
...
class TestSequence(unittest.TestCase):
    ...
    def test_run_sequence(self):
        ...
        chrom : List[AgilentChannelChromatogramData] = self.hplc_controller.get_last_run_sequence_data()
        uv = self.hplc_controller.get_last_run_sequence_data(read_uv=True)
