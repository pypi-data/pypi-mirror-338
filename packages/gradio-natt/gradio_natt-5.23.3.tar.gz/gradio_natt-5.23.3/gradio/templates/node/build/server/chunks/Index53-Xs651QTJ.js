...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-Dd-Yw8ID.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-CvEYc3pf.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-k2_0izC4.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-CFi5KMI_.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-Xs651QTJ.js.map
