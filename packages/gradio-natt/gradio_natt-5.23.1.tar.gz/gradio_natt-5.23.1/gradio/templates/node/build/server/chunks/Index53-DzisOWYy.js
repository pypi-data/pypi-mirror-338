...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-D2ULSBj6.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-C1LrDU2I.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-uc1tIq8J.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-Hfxwf-0m.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-DzisOWYy.js.map
