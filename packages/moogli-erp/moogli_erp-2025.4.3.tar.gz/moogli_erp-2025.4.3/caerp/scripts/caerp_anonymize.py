...
class Anonymizer:
    ...
    def _an_config(self):
        ...
        ConfigFiles.set(
            "logo.png",
            {
                "data": resource_stream("static/img/caerp.jpg"),
                "filename": "logo.jpg",
            },
        )
...
rue vieille 23200 Aubusson"""
    ...
    def _an_task_mentions(self):
        from caerp.models.task import Task, Estimation
...
pendant cette période.""",
    ...
    def _an_user(self):
        ...
        from caerp.models.user.user import (
            User,
        )
    ...
    def _an_smtp_settings(self):
        from caerp.models.smtp import SmtpSettings, NodeSmtpHistory
...
def anonymize_entry_point():
    parser = argparse.ArgumentParser(description="MoOGLi database anonymization utility")
