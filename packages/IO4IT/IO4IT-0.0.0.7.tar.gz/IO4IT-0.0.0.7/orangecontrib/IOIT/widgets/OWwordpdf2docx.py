...
if "site-packages/Orange/widgets" in os.path.dirname(os.path.abspath(__file__)).replace("\\", "/"):
    ...
    from Orange.widgets.orangecontrib.IOIT.ocr_function import word_converter
else:
    from orangecontrib.AAIT.utils import thread_management
    from orangecontrib.AAIT.utils.import_uic import uic
    from orangecontrib.IOIT.ocr_function import word_converter
...
class OWwordpdf2docx(widget.OWWidget):
    ...
    def run(self):
        ...
        self.thread = thread_management.Thread(word_converter.convert_pdf_structure, input_dir, output_dir)
