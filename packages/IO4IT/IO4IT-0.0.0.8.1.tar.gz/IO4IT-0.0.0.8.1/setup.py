...
VERSION = "0.0.0.8.1"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
PACKAGES = [pack for pack in PACKAGES if "orangecontrib" in pack and "IOIT" in pack]
...
PACKAGE_DATA = {
    "orangecontrib.IOIT.widgets": ["icons/*", "designer/*"],
}
# /!\ les noms de fichier 'orangecontrib.hkh_bot.widgets' doivent correspondre à l'arborescence

# Dépendances
INSTALL_REQUIRES = ["boto3", "docling", "docling-core", "speechbrain", "whisper", "whisper-openai", "pyannote.audio", "pyannote.core", "wave", "npath", "sklearn", "subprocess"]
