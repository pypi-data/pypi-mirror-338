...
INTEGRATION_STATISTICS = 1000_000
TRAINING_STATISTICS = 1000
SAMPLING = "tropical"
# SAMPLING = "spherical"
...
integrator = Integrator(
    itg,
    dims=PROCESSES[PROCESS]['%s_dimensions' % SAMPLING],
    flow_kwargs={"layers": 3, "units": 5},
...
# a1) Timing breakdown.
# a2) Automated batch size and buffering?
# a3) Live integration metrics, incl. central value.
# a4) Crtl+C support
# a5) Webpage with more insights (e.g. ala "weights and biases")
# a6) How does it fare with integrable singularities.
# a7) statedict I/O fully robust? Is current integration statistics still available/valid.
# a8) Multi-dimensional integrands? How to use as sampler and get access to sample weight.
# a9) Why is "integrator.integration_metrics(INTEGRATION_STATISTICS)" slow? Why is xsec different there?
# a10) API-wise `havana` is sort-of the model to follow.
