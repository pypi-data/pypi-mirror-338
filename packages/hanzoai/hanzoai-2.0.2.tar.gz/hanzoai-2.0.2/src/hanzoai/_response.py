...
from ._exceptions import HanzoError, APIResponseValidationError
...
class MissingStreamClassError(TypeError):
    def __init__(self) -> None:
        super().__init__(
            "The `stream` argument was set to `True` but the `stream_cls` argument was not given. See `hanzoai._streaming` for reference",
        )


class StreamAlreadyConsumed(HanzoError):
    """
