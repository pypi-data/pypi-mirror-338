...
__all__ = ["SpendRetrieveReportResponse", "SpendRetrieveReportResponseItem"]


class SpendRetrieveReportResponseItem(BaseModel):
    api_key: str
...
SpendRetrieveReportResponse: TypeAlias = List[SpendRetrieveReportResponseItem]
