...
__all__ = ["SpendListLogsResponse", "SpendListLogsResponseItem"]


class SpendListLogsResponseItem(BaseModel):
    api_key: str
...
SpendListLogsResponse: TypeAlias = List[SpendListLogsResponseItem]
