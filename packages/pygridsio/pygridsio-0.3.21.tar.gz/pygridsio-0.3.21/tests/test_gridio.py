...
from src.pygridsio.grid_operations import resample_xarray_grid
from src.pygridsio.netcdfIO import write_to_netcdf_raster, write_dataset_to_netcdf_raster
from src.pygridsio import read_grid_to_custom_grid, read_grid, write_grid, combine_grids_in_dataset
...
class GridTest(TestCase):
    ...
    def test_read_netcdf_to_custom_grid(self):
        # Arrange
        grid_original = read_grid_to_custom_grid(Path(self.test_files_path, "SLDNA_top.zmap"))
        write_to_netcdf_raster(grid_original, Path(self.test_files_out_path, "SLDNA_top.nc"))

        # Act
        grid_written = read_grid_to_custom_grid(Path(self.test_files_out_path, "SLDNA_top.nc"))
