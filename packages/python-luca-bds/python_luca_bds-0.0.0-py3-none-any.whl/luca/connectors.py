...
class KeycloakConnection:
    def __init__(self, server_url, realm_name='luca-bds', client_id='luca-bds-web', client_secret_key='', verify_ssl=False):
        """
...
class LucaConnection:
    def __init__(self, server_url, keycloak_connection, username, password):
        """
    ...
    def info(self, return_pd=True):
        ...
        """
        response = requests.get(self.server_url + "/v1/info", headers=self._headers())
