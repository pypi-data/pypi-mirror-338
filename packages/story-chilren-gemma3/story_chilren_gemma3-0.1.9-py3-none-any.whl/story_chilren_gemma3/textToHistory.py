...
def safeTextUnicodeYoutube(texto):
    ...
    texto_final = ''.join(re.findall(r'[\w\s\U0001F300-\U0001FAD6]+', texto_limpo, re.UNICODE))
...
def formatPromptYoutube(history, tema, licao):
    ...
    [title] Um ótimo título incrível para história, adicione também ícones e emojis (\\U0001F300-\\U0001FAD6) o inicio e final do titulo.
     
    [description] Também gere uma ótima descrição, se possível utilize alguns emojis (\\U0001F300-\\U0001FAD6).
