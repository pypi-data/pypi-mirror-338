...
class SchemaFilterPattern(BaseModel):
    includes: Optional[List[str]] = []
    excludes: Optional[List[str]] = ['^information_schema$']


class DatabaseFilterPattern(BaseModel):
    includes: Optional[List[str]] = []
    excludes: Optional[List[str]] = ['^template1$', '^template0$']
...
class PostgresConnection(BaseModel):
    ...
    databaseFilterPattern: Annotated[
        Optional[DatabaseFilterPattern],
        Field(
            None,
