...
class MainFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.menu_presets.AppendSeparator()
...
class MainPanel ( wx.Panel ):
    ...
    def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
        ...
        connection_sizer.Add( self.label_serial_port, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
        ...
        connection_sizer.Add( self.choice_serial_port, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )

        self.button_connect = wx.Button( self, wx.ID_ANY, _(u"Connect"), wx.DefaultPosition, wx.DefaultSize, 0 )
        connection_sizer.Add( self.button_connect, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )


        main_sizer.Add( connection_sizer, 0, wx.ALL|wx.EXPAND, 5 )
        ...
        sizer_wavelength = wx.BoxSizer( wx.HORIZONTAL )

        self.text_wavelength = wx.StaticText( self, wx.ID_ANY, _(u"Wavelength:"), wx.DefaultPosition, wx.DefaultSize, 0 )
        self.text_wavelength.Wrap( -1 )

        sizer_wavelength.Add( self.text_wavelength, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
        ...
        sizer_wavelength.Add( self.choice_wavelength, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
        ...
        sizer_magnification_controls.Add( self.button_magnification_decrease_small, 0, wx.ALL, 5 )
        ...
        sizer_magnification_controls.Add( self.button_magnification_increase_small, 0, wx.ALL, 5 )
        ...
        self.button_preset_add.Bind( wx.EVT_UPDATE_UI, self.on_update_ui )
