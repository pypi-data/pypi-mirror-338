...
class Encryption:
    def __init__(self, is_socket=False, key: Optional[bytes] = None):
        self.key = key or b'floatint201412bool23string' if is_socket else b'ali1343faraz1055antler288based'
