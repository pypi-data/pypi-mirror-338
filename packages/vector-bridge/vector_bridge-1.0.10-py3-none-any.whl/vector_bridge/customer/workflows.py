...
from vector_bridge.schema.workflows import WorkflowData, WorkflowCreate, WorkflowUpdate, WorkflowStatus, WorkflowCache
...
def generate_dynamodb_key(method, args, kwargs):
    ...
    key = f"workflow_{method_name}_{args_str}_{kwargs_str}"
...
def cache_result(method):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        cache_key = generate_dynamodb_key(method, args, kwargs)
