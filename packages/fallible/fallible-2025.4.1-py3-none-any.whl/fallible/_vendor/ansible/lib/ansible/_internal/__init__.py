...
from ansible.module_utils.common.json import _JSONSerializationProfile
...
def get_controller_serialize_map() -> dict[type, t.Callable]:
    ...
    return {
        _lazy_containers._AnsibleLazyTemplateDict: _JSONSerializationProfile.discard_tags,
        _lazy_containers._AnsibleLazyTemplateList: _JSONSerializationProfile.discard_tags,
