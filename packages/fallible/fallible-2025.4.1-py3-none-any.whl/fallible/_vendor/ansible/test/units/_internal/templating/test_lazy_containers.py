...
@pytest.mark.parametrize("expression, expected_result, expected_warning", (
    ...
    ("tuple_with_undefined() | pass_through is first_item_trips", True, None),  # managed access trips
    ("custom_sequence_with_undefined() | pass_through is first_item_trips", False, None),  # unmanaged access doesn't trip
