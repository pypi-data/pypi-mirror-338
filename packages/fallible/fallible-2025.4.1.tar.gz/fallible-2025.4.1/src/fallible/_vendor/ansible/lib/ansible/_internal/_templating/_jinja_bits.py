...
from ._jinja_plugins import JinjaPluginIntercept, _query, _lookup, _now, _wrap_plugin_output, get_first_marker_arg, _DirectCall
...
from ansible.module_utils.common.json import _json_subclassable_scalar_types
...
class AnsibleEnvironment(ImmutableSandboxedEnvironment):
    ...
    def _access_const(const_template: t.LiteralString) -> t.Any:
        ...
        display.deprecated(msg="Jinja constant strings should not contain embedded templates.", obj=const_template, version="2.23")
