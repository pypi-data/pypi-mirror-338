...
class SensorTandem:
    ...
    def detect_jumps(self,threshold=2.5, min_hang_time=350, max_hang_time=800, refractory_period=30) -> List[List[np.float64]]:
        """
        ...
        n = len(z_acc)
        peaks = np.where(np.abs(z_acc) > threshold, z_acc, 0)
