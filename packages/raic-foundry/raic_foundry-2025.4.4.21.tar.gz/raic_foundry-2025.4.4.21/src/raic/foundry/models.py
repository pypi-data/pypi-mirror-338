...
class MLModel(ABC):
    ...
    def _from_existing(cls, identifier: str, version: int | str | None, model_type: str):
        ...
        if version is None or version == 'latest':
            version = model_record['currentVersion']
        else:
...
class UniversalDetector(MLModel):
    ...
    @classmethod
    def from_existing(cls, identifier: str, version: int | str | None = 'latest', iou: Optional[float] = None, confidence: Optional[int] = None, max_detects: Optional[int] = None):
        model_record = cls._get_record('ObjectDetection', identifier)
        if version == 'latest':
            version = model_record['currentVersion']
        else:
            model_version = next((v for v in model_record['modelVersions'] if v['versionNumber'] == version), None)
    ...
    @classmethod
    def from_prompt(cls):
        return cls._from_prompt(model_type='ObjectDetection')   
...
class VectorizerModel(MLModel):
    ...
    @classmethod
    def from_existing(cls, identifier: str, version: int | str | None = 'latest'):
        return cls._from_existing(identifier=identifier, version=version, model_type='Embedder')   

    @classmethod
    def from_prompt(cls):
        return cls._from_prompt(model_type='Embedder')    
...
class PredictionModel(MLModel):
    ...
    @classmethod
    def from_existing(cls, identifier: str, version: int | str | None = 'latest'):
        return cls._from_existing(identifier=identifier, version=version, model_type='Prediction')   

    @classmethod
    def from_prompt(cls):
        return cls._from_prompt(model_type='Prediction')   
...
class CascadeVisionModel(MLModel):
    ...
    @classmethod
    def from_existing(cls, identifier: str, version: int | str | None = 'latest'):
        return cls._from_existing(identifier=identifier, version=version, model_type='CascadeVision')   

    @classmethod
    def from_prompt(cls):
        return cls._from_prompt(model_type='CascadeVision')   
