...
class Postprocess(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bore", b"bore", "counterbore", b"counterbore", "countersink", b"countersink", "description", b"description", "details", b"details", "finish", b"finish", "geom_id", b"geom_id", "group", b"group", "is_default", b"is_default", "kind", b"kind", "markers", b"markers", "method_id", b"method_id", "post_id", b"post_id", "thread", b"thread", "weld", b"weld"]) -> None: ...
