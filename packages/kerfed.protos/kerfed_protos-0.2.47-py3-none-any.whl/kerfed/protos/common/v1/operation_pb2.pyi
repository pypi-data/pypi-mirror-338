...
class Operation(google.protobuf.message.Message):
    ...
    @property
    def finish(self) -> kerfed.protos.common.v1.post_pb2.Finish:
        """If this operation is a finish, what are the details?"""
    @property
    ...
    def __init__(
        ...
        *,
        ...
        finish: kerfed.protos.common.v1.post_pb2.Finish | None = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["finish", b"finish", "machine", b"machine", "post", b"post", "price", b"price", "stock", b"stock"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address_id", b"address_id", "files", b"files", "finish", b"finish", "kind", b"kind", "machine", b"machine", "note", b"note", "operation_id", b"operation_id", "post", b"post", "price", b"price", "shop_id", b"shop_id", "stock", b"stock"]) -> None: ...
