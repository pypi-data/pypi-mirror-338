...
class MillSettings(google.protobuf.message.Message):
    ...
    DEFAULT_RADIAL_FINISH_ALLOWANCE_FIELD_NUMBER: builtins.int
    ...
    value for the default radial depth of cut (i.e step over).
    For example, if you have a 0.5" diameter endmill and this value
    is 0.24 (24% of diameter) the step over between passes is 0.12".
    """
    default_radial_finish_allowance: builtins.float
    ...
    *before* any toolpathing and will return results that are a subset
    ...
    def ClearField(self, field_name: typing_extensions.Literal["angle_helix", b"angle_helix", "default_radial_depth_of_cut", b"default_radial_depth_of_cut", "default_radial_finish_allowance", b"default_radial_finish_allowance", "default_skip_ball", b"default_skip_ball", "detail", b"detail", "machine", b"machine", "material_id", b"material_id", "max_directions", b"max_directions", "plane_normals", b"plane_normals", "preprocess", b"preprocess", "return_gcode", b"return_gcode", "return_plan", b"return_plan", "return_volume", b"return_volume", "skip_fixture_collisions", b"skip_fixture_collisions", "skip_prune", b"skip_prune", "tools", b"tools"]) -> None: ...
