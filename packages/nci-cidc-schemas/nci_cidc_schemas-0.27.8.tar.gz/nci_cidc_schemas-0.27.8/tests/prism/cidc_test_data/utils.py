...
def get_test_trial(
    ...
    allowed_collection_event_names=None,
    allowed_cohort_names=None,
):
    """
    ...
    trial = {PROTOCOL_ID_FIELD_NAME: "test_prism_trial_id"}
    if allowed_cohort_names:
        trial["allowed_cohort_names"] = allowed_cohort_names
    if allowed_collection_event_names:
        trial["allowed_collection_event_names"] = allowed_collection_event_names
