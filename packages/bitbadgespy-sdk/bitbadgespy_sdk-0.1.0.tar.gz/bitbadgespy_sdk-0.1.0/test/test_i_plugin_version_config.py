...
from bitbadgespy-sdk.models.i_plugin_version_config import IPluginVersionConfig
        ...
        if include_optional:
            return IPluginVersionConfig(
                ...
                claim_creator_redirect = bitbadgespy-sdk.models.plugin_version_config_payload_claim_creator_redirect.PluginVersionConfigPayload_claimCreatorRedirect(
                    ...
                    tutorial_uri = '', 
                    tester_uri = '', ),
                verification_call = bitbadgespy-sdk.models.i_plugin_version_config_verification_call.iPluginVersionConfig_verificationCall(
                    uri = '', 
                    method = 'POST', 
                    hardcoded_inputs = [
