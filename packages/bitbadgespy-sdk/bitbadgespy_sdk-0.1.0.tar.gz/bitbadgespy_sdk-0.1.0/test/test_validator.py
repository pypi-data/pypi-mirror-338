...
from bitbadgespy-sdk.models.validator import Validator
...
class TestValidator(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Validator:
        ...
        if include_optional:
            return Validator(
                commission = bitbadgespy-sdk.models.validator_commission.Validator_commission(
                    commission_rates = bitbadgespy-sdk.models.validator_commission_commission_rates.Validator_commission_commission_rates(
                        max_change_rate = '', 
                        max_rate = '', 
                        rate = '', ), 
                    update_time = '', ),
                consensus_pubkey = bitbadgespy-sdk.models.validator_consensus_pubkey.Validator_consensus_pubkey(
                    '@type' = '', 
                    key = '', ),
                delegator_shares = '',
                description = bitbadgespy-sdk.models.validator_description.Validator_description(
                    details = '', 
                    identity = '', 
                    moniker = '', 
                    security_contact = '', 
