    ...
    def make_instance(self, include_optional) -> IPerformStoreActionBatchWithBodyAuthPayload:
        ...
        if include_optional:
            return IPerformStoreActionBatchWithBodyAuthPayload(
                ...
                data_secret = '',
                actions = [
                    bitbadgespy-sdk.models.i_perform_store_action_batch_with_body_auth_payload_actions_inner.iPerformStoreActionBatchWithBodyAuthPayload_actions_inner(
                        action_name = '', 
                        payload = bitbadgespy-sdk.models.i_perform_store_action_payload.iPerformStoreActionPayload(), )
                    ]
            )
        else:
            return IPerformStoreActionBatchWithBodyAuthPayload(
