    ...
    def make_instance(self, include_optional) -> IClaimDetails:
        ...
        if include_optional:
            return IClaimDetails(
                ...
                list_id = '',
                tracker_details = bitbadgespy-sdk.models.i_challenge_tracker_id_details.iChallengeTrackerIdDetails(
                    collection_id = null, 
                    approval_id = '', 
                    challenge_tracker_id = '', 
                    approval_level = 'collection', 
                    approver_address = '', ),
                balances_to_set = bitbadgespy-sdk.models.i_predetermined_balances.iPredeterminedBalances(
                    manual_balances = [
                ...
                template_info = bitbadgespy-sdk.models.i_claim_details__template_info.iClaimDetails__templateInfo(
