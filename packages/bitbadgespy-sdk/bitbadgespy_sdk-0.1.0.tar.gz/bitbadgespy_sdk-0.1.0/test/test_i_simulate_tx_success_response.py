...
from bitbadgespy-sdk.models.i_simulate_tx_success_response import ISimulateTxSuccessResponse
    ...
    def make_instance(self, include_optional) -> ISimulateTxSuccessResponse:
        ...
        if include_optional:
            return ISimulateTxSuccessResponse(
                gas_info = bitbadgespy-sdk.models.i_simulate_tx_success_response_gas_info.iSimulateTxSuccessResponse_gas_info(
                    gas_used = '', 
                    gas_wanted = '', ),
                result = bitbadgespy-sdk.models.i_simulate_tx_success_response_result.iSimulateTxSuccessResponse_result(
                    data = '', 
                    log = '', 
                    events = [
