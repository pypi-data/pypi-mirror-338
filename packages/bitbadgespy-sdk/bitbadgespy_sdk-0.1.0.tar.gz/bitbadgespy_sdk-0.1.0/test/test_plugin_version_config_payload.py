...
from bitbadgespy-sdk.models.plugin_version_config_payload import PluginVersionConfigPayload
    ...
    def make_instance(self, include_optional) -> PluginVersionConfigPayload:
        ...
        if include_optional:
            return PluginVersionConfigPayload(
                ...
                user_input_redirect = bitbadgespy-sdk.models.plugin_version_config_payload_user_input_redirect.PluginVersionConfigPayload_userInputRedirect(
                    base_uri = '', 
                    tutorial_uri = '', ),
                user_inputs_schema = [
                    {
                ...
                claim_creator_redirect = bitbadgespy-sdk.models.plugin_version_config_payload_claim_creator_redirect.PluginVersionConfigPayload_claimCreatorRedirect(
                    tool_uri = '', 
                    tutorial_uri = '', 
                    tester_uri = '', ),
                ...
                verification_call = bitbadgespy-sdk.models.plugin_version_config_payload_verification_call.PluginVersionConfigPayload_verificationCall(
                    uri = '', 
                    method = 'POST', 
                    hardcoded_inputs = [
                        bitbadgespy-sdk.models.json_body_input_with_value.JsonBodyInputWithValue(
                            key = '', 
                            label = '', 
                            type = '', 
                            value = null, 
