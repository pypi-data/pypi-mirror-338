    ...
    def make_instance(self, include_optional) -> INotificationPreferences:
        ...
        if include_optional:
            return INotificationPreferences(
                email = '',
                discord = bitbadgespy-sdk.models.i_notification_preferences_discord.iNotificationPreferences_discord(
                    id = '', 
                    username = '', 
                    discriminator = '', 
                    token = '', ),
                email_verification = bitbadgespy-sdk.models.i_email_verification_status.iEmailVerificationStatus(
                    verified = True, 
                    verified_at = null, 
                    token = '', 
                    expiry = null, 
                    anti_phishing_code = '', ),
                preferences = bitbadgespy-sdk.models.i_notification_preferences_preferences.iNotificationPreferences_preferences(
                    list_activity = True, 
