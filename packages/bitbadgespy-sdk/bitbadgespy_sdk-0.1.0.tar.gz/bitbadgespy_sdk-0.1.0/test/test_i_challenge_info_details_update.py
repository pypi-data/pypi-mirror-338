...
from bitbadgespy-sdk.models.i_challenge_info_details_update import IChallengeInfoDetailsUpdate
    ...
    def make_instance(self, include_optional) -> IChallengeInfoDetailsUpdate:
        ...
        if include_optional:
            return IChallengeInfoDetailsUpdate(
                ...
                claim = bitbadgespy-sdk.models.create_claim_request.CreateClaimRequest(
                    claim_id = '', 
                    collection_id = null, 
                    list_id = '', 
