    ...
    def make_instance(self, include_optional) -> JsonBodyInputSchema:
        ...
        if include_optional:
            return JsonBodyInputSchema(
                ...
                label = '',
                type = '',
                hyperlink = bitbadgespy-sdk.models.json_body_input_schema_hyperlink.JsonBodyInputSchema_hyperlink(
                    url = '', 
                ...
                default_value = None,
                options = [
                    bitbadgespy-sdk.models.json_body_input_schema_options_inner.JsonBodyInputSchema_options_inner(
                        label = '', 
                        value = null, )
                    ],
                array_field = True
