...
from bitbadgespy-sdk.models.i_perform_store_action_batch_with_body_auth_payload_actions_inner import IPerformStoreActionBatchWithBodyAuthPayloadActionsInner
