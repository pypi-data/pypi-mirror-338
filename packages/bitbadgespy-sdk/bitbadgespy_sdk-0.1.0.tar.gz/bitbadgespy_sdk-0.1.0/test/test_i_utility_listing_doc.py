    ...
    def make_instance(self, include_optional) -> IUtilityListingDoc:
        ...
        if include_optional:
            return IUtilityListingDoc(
                ...
                inherit_metadata_from = bitbadgespy-sdk.models.i_inherit_metadata_from.iInheritMetadataFrom(
                    claim_id = '', 
                    application_id = '', 
                    collection_id = null, 
                    list_id = '', 
                    ...
                    badge_id = '', ),
                content = [
                    bitbadgespy-sdk.models.i_utility_listing_content.iUtilityListingContent(
                        type = '', 
                        label = '', 
                        content = '', )
                    ],
                links = [
                    bitbadgespy-sdk.models.i_utility_listing_link.iUtilityListingLink(
                        url = '', 
                        claim_id = '', 
                        application_id = '', 
                        collection_id = null, 
                ...
                display_times = bitbadgespy-sdk.models.i_uint_range.iUintRange(
                    start = null, 
                    end = null, ),
                visibility = 'public',
                categories = [
                ...
                approval_status = bitbadgespy-sdk.models.i_utility_listing_doc_approval_status.iUtilityListingDoc_approvalStatus(
                    is_approved = True, 
                    is_featured = True, 
                    ...
                    updated_by = '', ),
                view_count = None,
                estimated_cost = bitbadgespy-sdk.models.i_estimated_cost.iEstimatedCost(
                    amount = null, 
                    denom = '', ),
                estimated_time = '',
                views_by_period = bitbadgespy-sdk.models.i_utility_listing_doc_views_by_period.iUtilityListingDoc_viewsByPeriod(
                    hourly = 1.337, 
                    daily = 1.337, 
                    weekly = 1.337, 
                    monthly = 1.337, ),
                linked_to = bitbadgespy-sdk.models.i_linked_to.iLinkedTo(
                    collection_id = null, 
                    badge_ids = [
                    ...
                    list_id = '', ),
                locale = '',
                home_page_view = bitbadgespy-sdk.models.i_utility_listing_doc_home_page_view.iUtilityListingDoc_homePageView(
                    type = 'badges', 
                    category = '', )
            )
        else:
