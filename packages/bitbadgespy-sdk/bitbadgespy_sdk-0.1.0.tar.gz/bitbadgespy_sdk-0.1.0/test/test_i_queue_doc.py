...
from bitbadgespy-sdk.models.i_queue_doc import IQueueDoc
    ...
    def make_instance(self, include_optional) -> IQueueDoc:
        ...
        if include_optional:
            return IQueueDoc(
                ...
                initiated_by = '',
                action_config = None,
                claim_info = bitbadgespy-sdk.models.i_queue_doc_claim_info.iQueueDoc_claimInfo(
                    session = null, 
                    body = null, 
                    claim_id = '', 
                    bitbadges_address = '', 
                    ip = '', ),
                faucet_info = bitbadgespy-sdk.models.i_queue_doc_faucet_info.iQueueDoc_faucetInfo(
                    tx_hash = '', 
                    amount = null, 
                    recipient = '', 
                    denom = '', )
