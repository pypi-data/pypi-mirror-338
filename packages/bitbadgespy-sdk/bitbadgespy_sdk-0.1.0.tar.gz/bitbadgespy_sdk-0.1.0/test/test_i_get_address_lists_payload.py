    ...
    def make_instance(self, include_optional) -> IGetAddressListsPayload:
        ...
        if include_optional:
            return IGetAddressListsPayload(
                lists_to_fetch = [
                    bitbadgespy-sdk.models.i_get_address_lists_payload_lists_to_fetch_inner.iGetAddressListsPayload_listsToFetch_inner(
                        list_id = '', 
                        views_to_fetch = [
                            bitbadgespy-sdk.models.i_get_address_lists_payload_lists_to_fetch_inner_views_to_fetch_inner.iGetAddressListsPayload_listsToFetch_inner_viewsToFetch_inner(
                                view_id = '', 
