...
from typing_extensions import Annotated
from bitbadgespy-sdk.models.i_get_plugin_success_response import IGetPluginSuccessResponse
from bitbadgespy-sdk.models.i_get_plugins_payload import IGetPluginsPayload
from bitbadgespy-sdk.models.i_search_plugins_success_response import ISearchPluginsSuccessResponse
...
class PluginsApi:
    ...
    def search_plugins(
        self,
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        plugins_for_signed_in_user: Optional[StrictBool] = None,
        ...
        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param plugins_for_signed_in_user:
        :type plugins_for_signed_in_user: bool
        :param bookmark:
        :type bookmark: str
        :param search_value:
        ...
        _param = self._search_plugins_serialize(
            x_api_key=x_api_key,
            plugins_for_signed_in_user=plugins_for_signed_in_user,
            bookmark=bookmark,
    ...
    def _search_plugins_serialize(
        ...
        # process the path parameters
        # process the query parameters
        if plugins_for_signed_in_user is not None:
            
            _query_params.append(('pluginsForSignedInUser', plugins_for_signed_in_user))
