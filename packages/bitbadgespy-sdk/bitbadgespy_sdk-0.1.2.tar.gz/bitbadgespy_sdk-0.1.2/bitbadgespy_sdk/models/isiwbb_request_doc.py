...
from bitbadgespy-sdk.models.o_auth_scope_details import OAuthScopeDetails
...
class ISIWBBRequestDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "code", "bitbadgesAddress", "address", "chain", "name", "description", "image", "scopes", "expiresAt", "attestations", "createdAt", "deletedAt", "clientId", "redirectUri"]
