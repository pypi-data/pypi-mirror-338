...
from bitbadgespy-sdk.models.i_challenge_tracker_id_details import IChallengeTrackerIdDetails
from bitbadgespy-sdk.models.i_claim_details_template_info import IClaimDetailsTemplateInfo
from bitbadgespy-sdk.models.i_claim_reward import IClaimReward
from bitbadgespy-sdk.models.i_metadata import IMetadata
from bitbadgespy-sdk.models.i_predetermined_balances import IPredeterminedBalances
from bitbadgespy-sdk.models.i_satisfy_method import ISatisfyMethod
from bitbadgespy-sdk.models.integration_plugin_details import IntegrationPluginDetails
...
class IClaimDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_includesPrivateParams", "claimId", "createdBy", "managedBy", "collectionId", "standaloneClaim", "listId", "trackerDetails", "balancesToSet", "plugins", "rewards", "estimatedCost", "showInSearchResults", "categories", "estimatedTime", "manualDistribution", "approach", "seedCode", "metadata", "assignMethod", "lastUpdated", "version", "satisfyMethod", "_templateInfo"]
