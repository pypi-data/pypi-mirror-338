...
from bitbadgespy-sdk.models.verify_siwbb_options import VerifySIWBBOptions
...
class IExchangeSIWBBAuthorizationCodePayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "options", "client_secret", "client_id", "redirect_uri", "grant_type", "refresh_token"]
