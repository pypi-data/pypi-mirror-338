...
from bitbadgespy-sdk.models.i_tier_with_optional_weight import ITierWithOptionalWeight
...
class IApplicationPage(BaseModel):
    ...
    tiers: Optional[List[ITierWithOptionalWeight]] = Field(default=None, description="Tiers to display in the page")
    quests: Optional[List[ITierWithOptionalWeight]] = Field(default=None, description="Quests to display in the page")
    __properties: ClassVar[List[str]] = ["pageId", "metadata", "points", "tiers", "quests"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tiers": [ITierWithOptionalWeight.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None,
            "quests": [ITierWithOptionalWeight.from_dict(_item) for _item in obj["quests"]] if obj.get("quests") is not None else None
        })
        return _obj
