...
from bitbadgespy-sdk.models.i_filter_badges_in_collection_payload_attributes_inner import IFilterBadgesInCollectionPayloadAttributesInner
...
class IFilterBadgesInCollectionPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["badgeIds", "categories", "tags", "mostViewed", "bookmark", "attributes"]
