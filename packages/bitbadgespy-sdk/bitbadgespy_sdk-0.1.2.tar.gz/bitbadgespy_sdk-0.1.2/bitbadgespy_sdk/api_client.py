...
from bitbadgespy-sdk.configuration import Configuration
from bitbadgespy-sdk.api_response import ApiResponse, T as ApiResponseT
import bitbadgespy-sdk.models
from bitbadgespy-sdk import rest
from bitbadgespy-sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bitbadgespy-sdk.models, klass)
