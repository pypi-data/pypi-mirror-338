    ...
    def make_instance(self, include_optional) -> ICreateAttestationPayload:
        ...
        if include_optional:
            return ICreateAttestationPayload(
                ...
                proof_of_issuance = bitbadgespy-sdk.models.i_create_attestation_payload_proof_of_issuance.iCreateAttestationPayload_proofOfIssuance(
                    message = '', 
                    signature = '', 
                    signer = '', 
                    public_key = '', ),
                ...
                data_integrity_proof = bitbadgespy-sdk.models.i_create_attestation_payload_data_integrity_proof.iCreateAttestationPayload_dataIntegrityProof(
                    signature = '', 
                    signer = '', 
                    public_key = '', 
                    is_derived = True, ),
                ...
                description = '',
                anchors = [
                    bitbadgespy-sdk.models.i_create_attestation_payload_anchors_inner.iCreateAttestationPayload_anchors_inner(
                        tx_hash = '', 
                        message = '', )
                    ]
            )
