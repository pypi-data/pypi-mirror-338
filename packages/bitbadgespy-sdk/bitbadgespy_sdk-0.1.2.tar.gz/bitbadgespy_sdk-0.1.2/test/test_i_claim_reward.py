    ...
    def make_instance(self, include_optional) -> IClaimReward:
        ...
        if include_optional:
            return IClaimReward(
                reward_id = '',
                instance_id = '',
                metadata = bitbadgespy-sdk.models.i_claim_reward_metadata.iClaimReward_metadata(
                    name = '', 
                    description = '', 
                    image = '', ),
                automatic = True,
                ...
                calculation_method = bitbadgespy-sdk.models.i_claim_reward_calculation_method.iClaimReward_calculationMethod(
                    always_show = True, 
