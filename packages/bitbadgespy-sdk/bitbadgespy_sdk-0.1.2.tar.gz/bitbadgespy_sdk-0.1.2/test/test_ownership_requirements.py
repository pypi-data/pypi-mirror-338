...
from bitbadgespy-sdk.models.ownership_requirements import OwnershipRequirements
    ...
    def make_instance(self, include_optional) -> OwnershipRequirements:
        ...
        if include_optional:
            return OwnershipRequirements(
                assets = [
                    bitbadgespy-sdk.models.asset_details.AssetDetails(
                        chain = '', 
                        collection_id = null, 
                        asset_ids = [
                            null
                        ...
                        must_own_amounts = bitbadgespy-sdk.models.i_uint_range.iUintRange(
                            start = null, 
                            end = null, ), 
                        additional_criteria = '', )
                    ],
                options = bitbadgespy-sdk.models.ownership_requirements_options.OwnershipRequirements_options(
