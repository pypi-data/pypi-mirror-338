...
from bitbadgespy-sdk.models.i_get_browse_success_response import IGetBrowseSuccessResponse
    ...
    def make_instance(self, include_optional) -> IGetBrowseSuccessResponse:
        ...
        if include_optional:
            return IGetBrowseSuccessResponse(
                ...
                applications = {
                    'key' : [
                        bitbadgespy-sdk.models.i_application_doc.iApplicationDoc(
                            _doc_id = '', 
                            _id = '', 
                            application_id = '', 
                            type = '', 
                            ...
                            pages = [
                                bitbadgespy-sdk.models.i_application_page.iApplicationPage(
                                    page_id = '', 
                                    metadata = {
                                        'key' : null
                                        }, 
                                    points = [
                                        bitbadgespy-sdk.models.i_tier_with_optional_weight.iTierWithOptionalWeight(
                                            claim_id = '', 
                                            weight = null, 
                                            uncheckable = True, 
                ...
                maps = {
                    'key' : [
                        bitbadgespy-sdk.models.i_map_with_values.iMapWithValues(
                            creator = '', 
                            map_id = '', 
                            ...
                            update_criteria = bitbadgespy-sdk.models.i_map_update_criteria.iMapUpdateCriteria(
                                manager_only = True, 
                                collection_id = null, 
                                creator_only = True, 
                                first_come_first_serve = True, ), 
                            value_options = bitbadgespy-sdk.models.i_value_options.iValueOptions(
                                no_duplicates = True, 
                                ...
                                expect_uri = True, ), 
                            default_value = '', 
                            permissions = bitbadgespy-sdk.models.i_map_permissions.iMapPermissions(
                                can_update_metadata = [
                            ...
                            metadata_timeline = [
                                bitbadgespy-sdk.models.i_map_metadata_timeline.iMapMetadataTimeline(
                                    timeline_times = [
                                        
                                        ], 
                                    metadata = bitbadgespy-sdk.models.i_collection_metadata.iCollectionMetadata(
                                        uri = '', 
                                        custom_data = '', ), )
                                ], 
                            values = {
                                'key' : bitbadgespy-sdk.models.i_value_store.iValueStore(
                                    key = '', 
                                    value = '', 
                                    last_set_by = '', )
                                }, 
