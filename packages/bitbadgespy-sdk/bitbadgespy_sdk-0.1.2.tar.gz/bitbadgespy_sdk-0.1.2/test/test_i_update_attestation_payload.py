    ...
    def make_instance(self, include_optional) -> IUpdateAttestationPayload:
        ...
        if include_optional:
            return IUpdateAttestationPayload(
                ...
                holders_to_set = [
                    bitbadgespy-sdk.models.i_update_attestation_payload_holders_to_set_inner.iUpdateAttestationPayload_holdersToSet_inner(
                        bitbadges_address = '', 
                        delete = True, )
                    ],
                anchors_to_add = [
                    bitbadgespy-sdk.models.i_update_attestation_payload_anchors_to_add_inner.iUpdateAttestationPayload_anchorsToAdd_inner(
                        tx_hash = '', 
                        message = '', )
                    ],
                proof_of_issuance = bitbadgespy-sdk.models.i_update_attestation_payload_proof_of_issuance.iUpdateAttestationPayload_proofOfIssuance(
                    message = '', 
                    signature = '', 
                    signer = '', 
                    public_key = '', ),
                ...
                data_integrity_proof = bitbadgespy-sdk.models.i_update_attestation_payload_data_integrity_proof.iUpdateAttestationPayload_dataIntegrityProof(
                    signature = '', 
                    signer = '', 
                    public_key = '', 
                    derived_proof = True, ),
