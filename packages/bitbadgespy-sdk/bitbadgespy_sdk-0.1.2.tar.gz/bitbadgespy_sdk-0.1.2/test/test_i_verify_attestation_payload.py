    ...
    def make_instance(self, include_optional) -> IVerifyAttestationPayload:
        ...
        if include_optional:
            return IVerifyAttestationPayload(
                ...
                message_format = 'json',
                data_integrity_proof = bitbadgespy-sdk.models.i_verify_attestation_payload_data_integrity_proof.iVerifyAttestationPayload_dataIntegrityProof(
                    signature = '', 
                    signer = '', 
                    public_key = '', 
                    is_derived = True, ),
                proof_of_issuance = bitbadgespy-sdk.models.i_verify_attestation_payload_proof_of_issuance.iVerifyAttestationPayload_proofOfIssuance(
                    message = '', 
                    signature = '', 
                    signer = '', 
                    public_key = '', )
