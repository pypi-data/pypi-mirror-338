...
from bitbadgespy-sdk.models.i_update_address_lists_payload import IUpdateAddressListsPayload
    ...
    def make_instance(self, include_optional) -> IUpdateAddressListsPayload:
        ...
        if include_optional:
            return IUpdateAddressListsPayload(
                address_lists = [
                    bitbadgespy-sdk.models.i_address_list_create_object.iAddressListCreateObject(
                        list_id = '', 
                        addresses = [
                            ''
                            ], 
                        ...
                        claims = [
                            bitbadgespy-sdk.models.create_claim_request.CreateClaimRequest(
                                claim_id = '', 
                                collection_id = null, 
                                list_id = '', 
