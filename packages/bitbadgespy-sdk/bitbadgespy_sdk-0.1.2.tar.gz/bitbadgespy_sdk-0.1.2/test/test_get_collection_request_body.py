...
from bitbadgespy-sdk.models.get_collection_request_body import GetCollectionRequestBody
    ...
    def make_instance(self, include_optional) -> GetCollectionRequestBody:
        ...
        if include_optional:
            return GetCollectionRequestBody(
                views_to_fetch = [
                    bitbadgespy-sdk.models.get_collection_request_body_views_to_fetch_inner.GetCollectionRequestBody_viewsToFetch_inner(
                ...
                challenge_trackers_to_fetch = [
                    bitbadgespy-sdk.models.i_challenge_tracker_id_details.iChallengeTrackerIdDetails(
                        collection_id = null, 
                        approval_id = '', 
                ...
                approval_trackers_to_fetch = [
                    bitbadgespy-sdk.models.i_amount_tracker_id_details.iAmountTrackerIdDetails(
                        collection_id = null, 
                        approval_id = '', 
                        amount_tracker_id = '', 
                        approval_level = '', 
                ...
                metadata_to_fetch = bitbadgespy-sdk.models.metadata_fetch_options.MetadataFetchOptions(
