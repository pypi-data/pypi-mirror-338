...
with bitbadgespy-sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = bitbadgespy-sdk.AccountsApi(api_client)
    ...
    try:
        # Get Account
        api_response = api_instance.get_account(x_api_key, address=address, username=username)
