...
from bitbadgespy-sdk.models.create_claim_request_metadata import CreateClaimRequestMetadata
...
from bitbadgespy-sdk.models.integration_plugin_details_update import IntegrationPluginDetailsUpdate
...
class CreateClaimRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["claimId", "collectionId", "listId", "balancesToSet", "rewards", "estimatedCost", "showInSearchResults", "categories", "estimatedTime", "manualDistribution", "approach", "seedCode", "metadata", "assignMethod", "satisfyMethod", "cid", "plugins"]
