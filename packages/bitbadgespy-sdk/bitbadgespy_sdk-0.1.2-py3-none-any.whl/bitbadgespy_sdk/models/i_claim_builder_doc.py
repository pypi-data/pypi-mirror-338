...
from bitbadgespy-sdk.models.i_claim_builder_doc_action import IClaimBuilderDocAction
...
from bitbadgespy-sdk.models.integration_plugin_params import IntegrationPluginParams
...
class IClaimBuilderDoc(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "cid", "createdBy", "docClaimed", "collectionId", "managedBy", "trackerDetails", "deletedAt", "plugins", "pluginIds", "manualDistribution", "approach", "metadata", "state", "assignMethod", "satisfyMethod", "action", "rewards", "estimatedCost", "estimatedTime", "showInSearchResults", "categories", "lastUpdated", "createdAt", "version", "testOnly"]
