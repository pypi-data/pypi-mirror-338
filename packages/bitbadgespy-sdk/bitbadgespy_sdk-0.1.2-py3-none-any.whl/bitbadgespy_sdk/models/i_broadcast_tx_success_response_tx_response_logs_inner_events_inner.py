...
from bitbadgespy-sdk.models.i_broadcast_tx_success_response_tx_response_logs_inner_events_inner_attributes_inner import IBroadcastTxSuccessResponseTxResponseLogsInnerEventsInnerAttributesInner
