...
class UpdateClaimRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["claimId", "collectionId", "listId", "balancesToSet", "rewards", "estimatedCost", "showInSearchResults", "categories", "estimatedTime", "manualDistribution", "approach", "metadata", "assignMethod", "satisfyMethod", "cid", "plugins"]
