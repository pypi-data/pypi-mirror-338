...
from bitbadgespy-sdk.models.i_batch_badge_details import IBatchBadgeDetails
from bitbadgespy-sdk.models.i_custom_link import ICustomLink
from bitbadgespy-sdk.models.i_social_connections import ISocialConnections
from bitbadgespy-sdk.models.i_update_account_info_payload_approved_sign_in_methods import IUpdateAccountInfoPayloadApprovedSignInMethods
from bitbadgespy-sdk.models.i_update_account_info_payload_custom_pages import IUpdateAccountInfoPayloadCustomPages
from bitbadgespy-sdk.models.i_update_account_info_payload_notifications import IUpdateAccountInfoPayloadNotifications
from bitbadgespy-sdk.models.i_update_account_info_payload_public_social_connections_to_set_inner import IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner
from bitbadgespy-sdk.models.i_update_account_info_payload_watchlists import IUpdateAccountInfoPayloadWatchlists
from bitbadgespy-sdk.models.number_type import NumberType
from typing import Optional, Set
from typing_extensions import Self

class IUpdateAccountInfoPayload(BaseModel):
    """
    
    """ # noqa: E501
    discord: Optional[StrictStr] = Field(default=None, description="The Discord username.")
    twitter: Optional[StrictStr] = Field(default=None, description="The Twitter username.")
    github: Optional[StrictStr] = Field(default=None, description="The GitHub username.")
    telegram: Optional[StrictStr] = Field(default=None, description="The Telegram username.")
    bluesky: Optional[StrictStr] = Field(default=None, description="The Bluesky username.")
    ...
    readme: Optional[StrictStr] = Field(default=None, description="The README details (markdown supported).")
    hidden_badges: Optional[List[IBatchBadgeDetails]] = Field(default=None, description="The badges to hide and not view for this profile's portfolio", alias="hiddenBadges")
    hidden_lists: Optional[List[StrictStr]] = Field(default=None, description="The lists to hide and not view for this profile's portfolio", alias="hiddenLists")
    custom_links: Optional[List[ICustomLink]] = Field(default=None, description="Custom URL links to display on the user's portfolio.", alias="customLinks")
    custom_pages: Optional[IUpdateAccountInfoPayloadCustomPages] = Field(default=None, alias="customPages")
    watchlists: Optional[IUpdateAccountInfoPayloadWatchlists] = None
    profile_pic_url: Optional[StrictStr] = Field(default=None, description="The profile picture URL.", alias="profilePicUrl")
    banner_image: Optional[StrictStr] = Field(default=None, description="The banner image URL.", alias="bannerImage")
    username: Optional[StrictStr] = Field(default=None, description="The username.")
    profile_pic_image_file: Optional[Any] = Field(default=None, description="The profile picture image file to set. We will then upload to our CDN.", alias="profilePicImageFile")
    notifications: Optional[IUpdateAccountInfoPayloadNotifications] = None
    approved_sign_in_methods: Optional[IUpdateAccountInfoPayloadApprovedSignInMethods] = Field(default=None, alias="approvedSignInMethods")
    social_connections: Optional[ISocialConnections] = Field(default=None, description="The social connections for the user. Only returned if user is authenticated with full access.", alias="socialConnections")
    public_social_connections_to_set: Optional[List[IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner]] = Field(default=None, description="The public social connections for the user. Will be returned for all queries and may be publicly displayed on profile", alias="publicSocialConnectionsToSet")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["discord", "twitter", "github", "telegram", "bluesky", "seenActivity", "readme", "hiddenBadges", "hiddenLists", "customLinks", "customPages", "watchlists", "profilePicUrl", "bannerImage", "username", "profilePicImageFile", "notifications", "approvedSignInMethods", "socialConnections", "publicSocialConnectionsToSet"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IUpdateAccountInfoPayload from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in public_social_connections_to_set (list)
        _items = []
        if self.public_social_connections_to_set:
            for _item_public_social_connections_to_set in self.public_social_connections_to_set:
                if _item_public_social_connections_to_set:
                    _items.append(_item_public_social_connections_to_set.to_dict())
            _dict['publicSocialConnectionsToSet'] = _items
        # puts key-value pairs in additional_properties in the top level
        if self.additional_properties is not None:
            for _key, _value in self.additional_properties.items():
                _dict[_key] = _value

        # set to None if profile_pic_image_file (nullable) is None
        # and model_fields_set contains the field
        if self.profile_pic_image_file is None and "profile_pic_image_file" in self.model_fields_set:
            _dict['profilePicImageFile'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IUpdateAccountInfoPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "customPages": IUpdateAccountInfoPayloadCustomPages.from_dict(obj["customPages"]) if obj.get("customPages") is not None else None,
            "watchlists": IUpdateAccountInfoPayloadWatchlists.from_dict(obj["watchlists"]) if obj.get("watchlists") is not None else None,
            "profilePicUrl": obj.get("profilePicUrl"),
            "bannerImage": obj.get("bannerImage"),
            "username": obj.get("username"),
            "profilePicImageFile": obj.get("profilePicImageFile"),
            "notifications": IUpdateAccountInfoPayloadNotifications.from_dict(obj["notifications"]) if obj.get("notifications") is not None else None,
            "approvedSignInMethods": IUpdateAccountInfoPayloadApprovedSignInMethods.from_dict(obj["approvedSignInMethods"]) if obj.get("approvedSignInMethods") is not None else None,
            "socialConnections": ISocialConnections.from_dict(obj["socialConnections"]) if obj.get("socialConnections") is not None else None,
            "publicSocialConnectionsToSet": [IUpdateAccountInfoPayloadPublicSocialConnectionsToSetInner.from_dict(_item) for _item in obj["publicSocialConnectionsToSet"]] if obj.get("publicSocialConnectionsToSet") is not None else None
        })
