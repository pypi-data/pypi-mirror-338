...
from typing_extensions import Annotated
from bitbadgespy-sdk.models.i_get_badge_activity_success_response import IGetBadgeActivitySuccessResponse
from bitbadgespy-sdk.models.i_get_badge_balance_by_address_specific_badge_success_response import IGetBadgeBalanceByAddressSpecificBadgeSuccessResponse
from bitbadgespy-sdk.models.i_get_badge_balance_by_address_success_response import IGetBadgeBalanceByAddressSuccessResponse
from bitbadgespy-sdk.models.i_get_badge_metadata_success_response import IGetBadgeMetadataSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_amount_tracker_by_id_success_response import IGetCollectionAmountTrackerByIdSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_amount_trackers_success_response import IGetCollectionAmountTrackersSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_challenge_tracker_by_id_success_response import IGetCollectionChallengeTrackerByIdSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_challenge_trackers_success_response import IGetCollectionChallengeTrackersSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_claims_success_response import IGetCollectionClaimsSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_listings_success_response import IGetCollectionListingsSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_owners_success_response import IGetCollectionOwnersSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_success_response import IGetCollectionSuccessResponse
from bitbadgespy-sdk.models.i_get_collection_transfer_activity_success_response import IGetCollectionTransferActivitySuccessResponse
from bitbadgespy-sdk.models.i_get_collections_payload import IGetCollectionsPayload
from bitbadgespy-sdk.models.i_get_collections_success_response import IGetCollectionsSuccessResponse
from bitbadgespy-sdk.models.i_get_owners_for_badge_success_response import IGetOwnersForBadgeSuccessResponse
from bitbadgespy-sdk.models.i_refresh_status_success_response import IRefreshStatusSuccessResponse
from bitbadgespy-sdk.models.i_upload_balances_payload import IUploadBalancesPayload

from bitbadgespy-sdk.api_client import ApiClient, RequestSerialized
from bitbadgespy-sdk.api_response import ApiResponse
from bitbadgespy-sdk.rest import RESTResponseType
...
class BadgesApi:
    ...
    def get_badge_activity(
        ...
        bitbadges_address: Optional[StrictStr] = None,
        ...
        :param bookmark:
        :type bookmark: str
        :param bitbadges_address:
        :type bitbadges_address: str
        ...
        _param = self._get_badge_activity_serialize(
            ...
            x_api_key=x_api_key,
            bookmark=bookmark,
            bitbadges_address=bitbadges_address,
    ...
    def _get_badge_activity_serialize(
        ...
        if bitbadges_address is not None:
            
            _query_params.append(('bitbadgesAddress', bitbadges_address))
    ...
    def get_badge_balance_by_address(
        ...
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        fetch_private_params: Optional[StrictBool] = None,
        forceful: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param fetch_private_params:
        :type fetch_private_params: bool
        :param forceful:
        :type forceful: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._get_badge_balance_by_address_serialize(
            ...
            address=address,
            x_api_key=x_api_key,
            fetch_private_params=fetch_private_params,
            forceful=forceful,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_badge_balance_by_address_serialize(
        ...
        # process the query parameters
        if fetch_private_params is not None:
            
            _query_params.append(('fetchPrivateParams', fetch_private_params))
            
        if forceful is not None:
            
            _query_params.append(('forceful', forceful))
    ...
    def get_collection_amount_tracker_by_id(
        ...
        amount_tracker_id: StrictStr,
        approval_level: StrictStr,
        approver_address: StrictStr,
        tracker_type: StrictStr,
        approved_address: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type collection_id: NumberType
        :param approval_id: (required)
        :type approval_id: str
        :param amount_tracker_id: (required)
        :type amount_tracker_id: str
        :param approval_level: (required)
        :type approval_level: str
        :param approver_address: (required)
        :type approver_address: str
        :param tracker_type: (required)
        :type tracker_type: str
        :param approved_address: (required)
        :type approved_address: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_collection_amount_tracker_by_id_serialize(
            ...
            amount_tracker_id=amount_tracker_id,
    ...
    def _get_collection_amount_tracker_by_id_serialize(
        ...
        if approval_id is not None:
            ...
            _query_params.append(('approvalId', approval_id))
            
        if amount_tracker_id is not None:
            
            _query_params.append(('amountTrackerId', amount_tracker_id))
            
        if approval_level is not None:
            
            _query_params.append(('approvalLevel', approval_level))
            
        if approver_address is not None:
            
            _query_params.append(('approverAddress', approver_address))
            
        if tracker_type is not None:
            
            _query_params.append(('trackerType', tracker_type))
            
        if approved_address is not None:
            
            _query_params.append(('approvedAddress', approved_address))
    ...
    def get_collection_challenge_tracker_by_id(
        ...
        collection_id: Any,
        approval_id: StrictStr,
        challenge_tracker_id: StrictStr,
        approval_level: StrictStr,
        approver_address: StrictStr,
        _request_timeout: Union[
            None,
        ...
        :param approval_id: (required)
        :type approval_id: str
        :param challenge_tracker_id: (required)
        :type challenge_tracker_id: str
        :param approval_level: (required)
        :type approval_level: str
        :param approver_address: (required)
        :type approver_address: str
        ...
        _param = self._get_collection_challenge_tracker_by_id_serialize(
            collection_id=collection_id,
            approval_id=approval_id,
            challenge_tracker_id=challenge_tracker_id,
            approval_level=approval_level,
            approver_address=approver_address,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_collection_challenge_tracker_by_id_serialize(
        ...
        if challenge_tracker_id is not None:
            
            _query_params.append(('challengeTrackerId', challenge_tracker_id))
