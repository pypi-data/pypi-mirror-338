...
from typing_extensions import Annotated
from bitbadgespy-sdk.models.i_create_dynamic_data_store_payload import ICreateDynamicDataStorePayload
from bitbadgespy-sdk.models.i_create_dynamic_data_store_success_response import ICreateDynamicDataStoreSuccessResponse
from bitbadgespy-sdk.models.i_delete_dynamic_data_store_payload import IDeleteDynamicDataStorePayload
from bitbadgespy-sdk.models.i_delete_dynamic_data_store_success_response import IDeleteDynamicDataStoreSuccessResponse
from bitbadgespy-sdk.models.i_get_dynamic_data_activity_success_response import IGetDynamicDataActivitySuccessResponse
from bitbadgespy-sdk.models.i_get_dynamic_data_store_success_response import IGetDynamicDataStoreSuccessResponse
from bitbadgespy-sdk.models.i_get_dynamic_data_store_value_success_response import IGetDynamicDataStoreValueSuccessResponse
from bitbadgespy-sdk.models.i_get_dynamic_data_store_values_paginated_success_response import IGetDynamicDataStoreValuesPaginatedSuccessResponse
from bitbadgespy-sdk.models.i_get_dynamic_data_stores_payload import IGetDynamicDataStoresPayload
from bitbadgespy-sdk.models.i_get_dynamic_data_stores_success_response import IGetDynamicDataStoresSuccessResponse
from bitbadgespy-sdk.models.i_perform_store_action_batch_with_body_auth_payload import IPerformStoreActionBatchWithBodyAuthPayload
from bitbadgespy-sdk.models.i_perform_store_action_single_with_body_auth_payload import IPerformStoreActionSingleWithBodyAuthPayload
from bitbadgespy-sdk.models.i_search_dynamic_data_stores_success_response import ISearchDynamicDataStoresSuccessResponse
from bitbadgespy-sdk.models.i_update_dynamic_data_store_payload import IUpdateDynamicDataStorePayload
from bitbadgespy-sdk.models.i_update_dynamic_data_store_success_response import IUpdateDynamicDataStoreSuccessResponse
...
class DynamicStoresApi:
    ...
    def get_dynamic_data_activity(
        self,
        x_api_key: Annotated[StrictStr, Field(description="BitBadges API Key for authentication")],
        dynamic_data_id: StrictStr,
        bookmark: Optional[StrictStr] = None,
        data_secret: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_api_key: BitBadges API Key for authentication (required)
        :type x_api_key: str
        :param dynamic_data_id: (required)
        :type dynamic_data_id: str
        :param bookmark:
        :type bookmark: str
        :param data_secret:
        :type data_secret: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _get_dynamic_data_activity_serialize(
        ...
        if dynamic_data_id is not None:
            ...
            _query_params.append(('dynamicDataId', dynamic_data_id))
            
        if bookmark is not None:
            
            _query_params.append(('bookmark', bookmark))
            
        if data_secret is not None:
            
            _query_params.append(('dataSecret', data_secret))
    ...
    def get_dynamic_data_store_value(
        ...
        key: StrictStr,
        data_secret: Optional[StrictStr] = None,
        lookup_type: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
