...
from typing_extensions import Annotated
from bitbadgespy-sdk.models.generate_code200_response import GenerateCode200Response
from bitbadgespy-sdk.models.i_check_claim_success_success_response import ICheckClaimSuccessSuccessResponse
from bitbadgespy-sdk.models.i_complete_claim_payload import ICompleteClaimPayload
from bitbadgespy-sdk.models.i_complete_claim_success_response import ICompleteClaimSuccessResponse
from bitbadgespy-sdk.models.i_create_claim_payload import ICreateClaimPayload
from bitbadgespy-sdk.models.i_delete_claim_payload import IDeleteClaimPayload
from bitbadgespy-sdk.models.i_get_attempt_data_from_request_bin_success_response import IGetAttemptDataFromRequestBinSuccessResponse
from bitbadgespy-sdk.models.i_get_claim_attempt_status_success_response import IGetClaimAttemptStatusSuccessResponse
from bitbadgespy-sdk.models.i_get_claim_attempts_success_response import IGetClaimAttemptsSuccessResponse
from bitbadgespy-sdk.models.i_get_claim_success_response import IGetClaimSuccessResponse
from bitbadgespy-sdk.models.i_get_claims_payload_v1 import IGetClaimsPayloadV1
from bitbadgespy-sdk.models.i_get_claims_success_response import IGetClaimsSuccessResponse
from bitbadgespy-sdk.models.i_get_gated_content_for_claim_success_response import IGetGatedContentForClaimSuccessResponse
from bitbadgespy-sdk.models.i_get_reserved_claim_codes_success_response import IGetReservedClaimCodesSuccessResponse
from bitbadgespy-sdk.models.i_search_claims_success_response import ISearchClaimsSuccessResponse
from bitbadgespy-sdk.models.i_simulate_claim_payload import ISimulateClaimPayload
from bitbadgespy-sdk.models.i_simulate_claim_success_response import ISimulateClaimSuccessResponse
from bitbadgespy-sdk.models.i_update_claim_payload import IUpdateClaimPayload
...
class ClaimsApi:
    ...
    def get_claim(
        ...
        fetch_all_claimed_users: Optional[StrictBool] = None,
        private_states_to_fetch: Optional[List[StrictStr]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param fetch_all_claimed_users:
        :type fetch_all_claimed_users: bool
        :param private_states_to_fetch:
        :type private_states_to_fetch: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_claim_serialize(
            ...
            fetch_all_claimed_users=fetch_all_claimed_users,
            private_states_to_fetch=private_states_to_fetch,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _get_claim_serialize(
        ...
        if fetch_all_claimed_users is not None:
            
            _query_params.append(('fetchAllClaimedUsers', fetch_all_claimed_users))
            
        if private_states_to_fetch is not None:
            
            _query_params.append(('privateStatesToFetch', private_states_to_fetch))
    ...
    def get_claim_attempts(
        ...
        include_errors: Optional[StrictBool] = None,
        address: Optional[StrictStr] = None,
        include_request_bin_attempt_data: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param address:
        :type address: str
        :param include_request_bin_attempt_data:
        :type include_request_bin_attempt_data: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_claim_attempts_serialize(
            ...
            address=address,
            include_request_bin_attempt_data=include_request_bin_attempt_data,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _get_claim_attempts_serialize(
        ...
        include_errors,
        address,
        include_request_bin_attempt_data,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if include_errors is not None:
            ...
            _query_params.append(('includeErrors', include_errors))
            
        if address is not None:
            
            _query_params.append(('address', address))
            
        if include_request_bin_attempt_data is not None:
            
            _query_params.append(('includeRequestBinAttemptData', include_request_bin_attempt_data))
