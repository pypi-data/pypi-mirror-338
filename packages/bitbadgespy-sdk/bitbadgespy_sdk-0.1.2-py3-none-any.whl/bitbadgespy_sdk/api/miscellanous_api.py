...
from typing_extensions import Annotated
from bitbadgespy-sdk.models.i_get_status_success_response import IGetStatusSuccessResponse
...
class MiscellanousApi:
    ...
    def get_status(
        ...
        with_out_of_sync_check: Optional[StrictBool] = None,
        ...
        :type x_api_key: str
        :param with_out_of_sync_check:
        :type with_out_of_sync_check: bool
        ...
        _param = self._get_status_serialize(
            x_api_key=x_api_key,
            with_out_of_sync_check=with_out_of_sync_check,
    ...
    def _get_status_serialize(
        ...
        if with_out_of_sync_check is not None:
            
            _query_params.append(('withOutOfSyncCheck', with_out_of_sync_check))
