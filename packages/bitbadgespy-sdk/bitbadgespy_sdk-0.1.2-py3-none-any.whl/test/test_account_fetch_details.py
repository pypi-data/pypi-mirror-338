...
from bitbadgespy-sdk.models.account_fetch_details import AccountFetchDetails
    ...
    def make_instance(self, include_optional) -> AccountFetchDetails:
        ...
        if include_optional:
            return AccountFetchDetails(
                ...
                views_to_fetch = [
                    bitbadgespy-sdk.models.account_fetch_details_views_to_fetch_inner.AccountFetchDetails_viewsToFetch_inner(
                        view_id = '', 
