...
from bitbadgespy-sdk.models.i_bit_badges_collection import IBitBadgesCollection
        ...
        if include_optional:
            return IBitBadgesCollection(
                ...
                off_chain_balances_metadata_timeline = [
                    bitbadgespy-sdk.models.i_off_chain_balances_metadata_timeline.iOffChainBalancesMetadataTimeline(
                        timeline_times = [
                            bitbadgespy-sdk.models.i_uint_range.iUintRange(
                                start = null, 
                                end = null, )
                            ], 
                        off_chain_balances_metadata = bitbadgespy-sdk.models.i_off_chain_balances_metadata.iOffChainBalancesMetadata(
                            uri = '', 
                            custom_data = '', ), )
                    ],
                custom_data_timeline = [
                    bitbadgespy-sdk.models.i_custom_data_timeline.iCustomDataTimeline(
                        timeline_times = [
                            bitbadgespy-sdk.models.i_uint_range.iUintRange(
                                start = null, 
                                end = null, )
                ...
                manager_timeline = [
                    bitbadgespy-sdk.models.i_manager_timeline.iManagerTimeline(
                        timeline_times = [
                            bitbadgespy-sdk.models.i_uint_range.iUintRange(
                                start = null, 
                                end = null, )
                ...
                collection_permissions = bitbadgespy-sdk.models.i_collection_permissions.iCollectionPermissions(
                    ...
                    can_archive_collection = [
                        bitbadgespy-sdk.models.i_timed_update_permission.iTimedUpdatePermission(
                            timeline_times = [
                    ...
                    can_update_valid_badge_ids = [
                        bitbadgespy-sdk.models.i_badge_ids_action_permission.iBadgeIdsActionPermission(
                            badge_ids = [
                    ...
                    can_update_badge_metadata = [
                        bitbadgespy-sdk.models.i_timed_update_with_badge_ids_permission.iTimedUpdateWithBadgeIdsPermission(
                            timeline_times = , 
                            badge_ids = [
                    ...
                    can_update_collection_approvals = [
                        bitbadgespy-sdk.models.i_collection_approval_permission.iCollectionApprovalPermission(
                            from_list_id = '', 
                            from_list = bitbadgespy-sdk.models.i_address_list.iAddressList(
                                ...
                                alias_address = '', ), 
                            to_list_id = '', 
                            to_list = bitbadgespy-sdk.models.i_address_list.iAddressList(
                                list_id = '', 
                                addresses = [
                                    ''
                                    ], 
                ...
                standards_timeline = [
                    bitbadgespy-sdk.models.i_standards_timeline.iStandardsTimeline(
                        timeline_times = [
                            bitbadgespy-sdk.models.i_uint_range.iUintRange(
                                start = null, 
                                end = null, )
                ...
                is_archived_timeline = [
                    bitbadgespy-sdk.models.i_is_archived_timeline.iIsArchivedTimeline(
                        timeline_times = [
                            bitbadgespy-sdk.models.i_uint_range.iUintRange(
                                start = null, 
                                end = null, )
                ...
                default_balances = bitbadgespy-sdk.models.i_user_balance_store.iUserBalanceStore(
                    balances = [
                ...
                nsfw = bitbadgespy-sdk.models.i_collection_nsfw.iCollectionNSFW(
                    badge_ids = null, 
                    reason = '', ),
                reported = bitbadgespy-sdk.models.i_collection_nsfw.iCollectionNSFW(
                    badge_ids = null, 
                    reason = '', ),
                views = {
                    'key' : bitbadgespy-sdk.models.i_bit_badges_collection_views_value.iBitBadgesCollection_views_value(
                        ids = [
                            ''
                            ], 
                        type = '', 
