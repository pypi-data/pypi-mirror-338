    ...
    def make_instance(self, include_optional) -> IGetDynamicDataActivitySuccessResponse:
        ...
        if include_optional:
            return IGetDynamicDataActivitySuccessResponse(
                pending = [
                    bitbadgespy-sdk.models.i_get_dynamic_data_activity_success_response_pending_inner.iGetDynamicDataActivitySuccessResponse_pending_inner(
                        dynamic_data_id = '', 
                        handler_id = '', 
                        actions = [
                            null
                ...
                history = bitbadgespy-sdk.models.i_get_dynamic_data_activity_success_response_history.iGetDynamicDataActivitySuccessResponse_history(
                    docs = [
                        bitbadgespy-sdk.models.i_get_dynamic_data_activity_success_response_history_docs_inner.iGetDynamicDataActivitySuccessResponse_history_docs_inner(
                            dynamic_data_id = '', 
                            updated_at = 1.337, 
                            actions = [
                                null
                    ...
                    pagination = bitbadgespy-sdk.models.i_get_dynamic_data_activity_success_response_history_pagination.iGetDynamicDataActivitySuccessResponse_history_pagination(
                        bookmark = '', 
                        has_more = True, ), )
            )
        else:
