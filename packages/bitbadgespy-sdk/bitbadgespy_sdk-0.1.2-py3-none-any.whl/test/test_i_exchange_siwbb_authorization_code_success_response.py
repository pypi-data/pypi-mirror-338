    ...
    def make_instance(self, include_optional) -> IExchangeSIWBBAuthorizationCodeSuccessResponse:
        ...
        if include_optional:
            return IExchangeSIWBBAuthorizationCodeSuccessResponse(
                ...
                bitbadges_address = '',
                verification_response = bitbadgespy-sdk.models.i_exchange_siwbb_authorization_code_success_response_verification_response.iExchangeSIWBBAuthorizationCodeSuccessResponse_verificationResponse(
                    success = True, 
                    error_message = '', ),
                attestations = [
