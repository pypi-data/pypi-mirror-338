    ...
    def make_instance(self, include_optional) -> IGetDynamicDataStoreValuesPaginatedSuccessResponse:
        ...
        if include_optional:
            return IGetDynamicDataStoreValuesPaginatedSuccessResponse(
                lookup_values = [
                    bitbadgespy-sdk.models.i_get_dynamic_data_store_values_paginated_success_response_lookup_values_inner.iGetDynamicDataStoreValuesPaginatedSuccessResponse_lookupValues_inner(
                        key = '', 
                        lookup_type = 'id', 
                        in_store = True, )
                    ],
