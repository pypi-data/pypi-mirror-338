...
from bitbadgespy-sdk.models.i_broadcast_tx_success_response import IBroadcastTxSuccessResponse
    ...
    def make_instance(self, include_optional) -> IBroadcastTxSuccessResponse:
        ...
        if include_optional:
            return IBroadcastTxSuccessResponse(
                tx_response = bitbadgespy-sdk.models.i_broadcast_tx_success_response_tx_response.iBroadcastTxSuccessResponse_tx_response(
                    code = 1.337, 
                    codespace = '', 
                    data = '', 
                    events = [
                        bitbadgespy-sdk.models.i_broadcast_tx_success_response_tx_response_events_inner.iBroadcastTxSuccessResponse_tx_response_events_inner(
                            type = '', 
                            attributes = [
                                bitbadgespy-sdk.models.i_broadcast_tx_success_response_tx_response_events_inner_attributes_inner.iBroadcastTxSuccessResponse_tx_response_events_inner_attributes_inner(
                                    key = '', 
                                    value = '', 
                                    index = True, )
                                ], )
                    ...
                    height = '', 
                    logs = [
                        bitbadgespy-sdk.models.i_broadcast_tx_success_response_tx_response_logs_inner.iBroadcastTxSuccessResponse_tx_response_logs_inner(
                            events = [
                                bitbadgespy-sdk.models.i_broadcast_tx_success_response_tx_response_logs_inner_events_inner.iBroadcastTxSuccessResponse_tx_response_logs_inner_events_inner(
                                    type = '', 
                                    attributes = [
                                        bitbadgespy-sdk.models.i_broadcast_tx_success_response_tx_response_logs_inner_events_inner_attributes_inner.iBroadcastTxSuccessResponse_tx_response_logs_inner_events_inner_attributes_inner(
                                            key = '', 
                                            value = '', 
                                            index = True, )
                                        ], )
                    ...
                    raw_log = '', 
                    timestamp = '', 
                    tx = bitbadgespy-sdk.models.tx.tx(), 
                    txhash = '', )
            )
        else:
            return IBroadcastTxSuccessResponse(
