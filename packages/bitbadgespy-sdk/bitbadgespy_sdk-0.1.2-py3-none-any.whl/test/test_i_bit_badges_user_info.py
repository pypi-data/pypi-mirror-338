...
from bitbadgespy-sdk.models.i_bit_badges_user_info import IBitBadgesUserInfo
    ...
    def make_instance(self, include_optional) -> IBitBadgesUserInfo:
        ...
        if include_optional:
            return IBitBadgesUserInfo(
                ...
                btc_address = '',
                sequence = None,
                balance = bitbadgespy-sdk.models.i_cosmos_coin.iCosmosCoin(
                    amount = null, 
                    denom = '', ),
                ...
                readme = '',
                custom_links = [
                    bitbadgespy-sdk.models.i_custom_link.iCustomLink(
                        title = '', 
                        url = '', 
                        image = '', )
                    ],
                hidden_badges = [
                    bitbadgespy-sdk.models.i_batch_badge_details.iBatchBadgeDetails(
                        collection_id = null, 
                        badge_ids = [
                            bitbadgespy-sdk.models.i_uint_range.iUintRange(
                                start = null, 
                                end = null, )
                            ], )
                    ],
                ...
                custom_pages = bitbadgespy-sdk.models.i_bit_badges_user_info_custom_pages.iBitBadgesUserInfo_customPages(
                    badges = [
                        bitbadgespy-sdk.models.i_custom_page.iCustomPage(
                            title = '', 
                            description = '', 
                            items = [
                                bitbadgespy-sdk.models.i_batch_badge_details.iBatchBadgeDetails(
                    ...
                    lists = [
                        bitbadgespy-sdk.models.i_custom_list_page.iCustomListPage(
                            title = '', 
                            description = '', 
                            items = [
                                ''
                ...
                watchlists = bitbadgespy-sdk.models.i_bit_badges_user_info_watchlists.iBitBadgesUserInfo_watchlists(
                    badges = [
                        bitbadgespy-sdk.models.i_custom_page.iCustomPage(
                            title = '', 
                            description = '', 
                ...
                approved_sign_in_methods = bitbadgespy-sdk.models.i_bit_badges_user_info_approved_sign_in_methods.iBitBadgesUserInfo_approvedSignInMethods(
                    discord = bitbadgespy-sdk.models.i_bit_badges_user_info_approved_sign_in_methods_discord.iBitBadgesUserInfo_approvedSignInMethods_discord(
                        scopes = [
                            bitbadgespy-sdk.models.o_auth_scope_details.OAuthScopeDetails(
                                scope_name = '', 
                                options = bitbadgespy-sdk.models.options.options(), )
                            ], 
                        username = '', 
                        discriminator = '', 
                        id = '', ), 
                    github = bitbadgespy-sdk.models.i_bit_badges_user_info_approved_sign_in_methods_github.iBitBadgesUserInfo_approvedSignInMethods_github(
                        scopes = [
                            bitbadgespy-sdk.models.o_auth_scope_details.OAuthScopeDetails(
                                scope_name = '', 
                                options = bitbadgespy-sdk.models.options.options(), )
                        ...
                        username = '', 
                        id = '', ), 
                    google = bitbadgespy-sdk.models.i_bit_badges_user_info_approved_sign_in_methods_google.iBitBadgesUserInfo_approvedSignInMethods_google(
                        scopes = , 
                        username = '', 
                        id = '', ), 
                    twitter = bitbadgespy-sdk.models.i_bit_badges_user_info_approved_sign_in_methods_google.iBitBadgesUserInfo_approvedSignInMethods_google(
                        scopes = , 
                        username = '', 
                        id = '', ), 
                    facebook = , 
                    addresses = [
                        bitbadgespy-sdk.models.i_bit_badges_user_info_approved_sign_in_methods_addresses_inner.iBitBadgesUserInfo_approvedSignInMethods_addresses_inner(
                            address = '', 
                            scopes = , )
                        ], 
                    passwords = [
                        bitbadgespy-sdk.models.i_bit_badges_user_info_approved_sign_in_methods_passwords_inner.iBitBadgesUserInfo_approvedSignInMethods_passwords_inner(
                            password_hash = '', 
                            salt = '', 
                            scopes = , )
                        ], ),
                ...
                airdropped = True,
                collected = [
                    bitbadgespy-sdk.models.i_balance_doc.iBalanceDoc(
                        balances = [
                            bitbadgespy-sdk.models.i_balance.iBalance(
                                amount = null, 
                                badge_ids = [
                                    bitbadgespy-sdk.models.i_uint_range.iUintRange(
                                        start = null, 
                        ...
                        incoming_approvals = [
                            bitbadgespy-sdk.models.i_user_incoming_approval.iUserIncomingApproval(
                                from_list_id = '', 
                                from_list = bitbadgespy-sdk.models.i_address_list.iAddressList(
                                    list_id = '', 
                                    addresses = [
                                        ''
                                        ], 
                                ...
                                initiated_by_list = bitbadgespy-sdk.models.i_address_list.iAddressList(
                                    list_id = '', 
                                    addresses = [
                                        ''
                                        ], 
                                ...
                                uri = '', 
                                custom_data = '', 
                                approval_criteria = bitbadgespy-sdk.models.i_incoming_approval_criteria.iIncomingApprovalCriteria(
                                    must_own_badges = [
                                        bitbadgespy-sdk.models.i_must_own_badges.iMustOwnBadges(
                                            collection_id = null, 
                                            amount_range = , 
                                            ownership_times = [
                                    ...
                                    zk_proofs = [
                                        bitbadgespy-sdk.models.i_zk_proof.iZkProof(
                                            verification_key = '', 
                                            uri = '', 
                                            custom_data = '', 
                                            zkp_tracker_id = '', )
                                    ...
                                    coin_transfers = [
                                        bitbadgespy-sdk.models.i_coin_transfer.iCoinTransfer(
                                            to = '', 
                                            coins = [
                                                bitbadgespy-sdk.models.i_cosmos_coin.iCosmosCoin(
                                                    amount = null, 
                                                    denom = '', )
                                                ], )
                                        ], 
                                    merkle_challenges = [
                                        bitbadgespy-sdk.models.i_merkle_challenge.iMerkleChallenge(
                                            root = '', 
                                    ...
                                    predetermined_balances = bitbadgespy-sdk.models.i_predetermined_balances.iPredeterminedBalances(
                                        manual_balances = [
                                            bitbadgespy-sdk.models.i_manual_balances.iManualBalances(
                                                balances = [
                                                    bitbadgespy-sdk.models.i_balance.iBalance(
                                                        amount = null, 
                                                        badge_ids = [
                                        ...
                                        incremented_balances = bitbadgespy-sdk.models.i_incremented_balances.iIncrementedBalances(
                                            start_balances = [
                                                
                                                ], 
                                            increment_badge_ids_by = null, 
                                            increment_ownership_times_by = null, ), 
                                        order_calculation_method = bitbadgespy-sdk.models.i_predetermined_order_calculation_method.iPredeterminedOrderCalculationMethod(
                                            ...
                                            challenge_tracker_id = '', ), ), 
                                    approval_amounts = bitbadgespy-sdk.models.i_approval_amounts.iApprovalAmounts(
                                        ...
                                        amount_tracker_id = '', ), 
                                    max_num_transfers = bitbadgespy-sdk.models.i_max_num_transfers.iMaxNumTransfers(
                        ...
                        outgoing_approvals = [
                            bitbadgespy-sdk.models.i_user_outgoing_approval.iUserOutgoingApproval(
                                to_list_id = '', 
                                to_list = , 
                                initiated_by_list_id = '', 
                                initiated_by_list = , 
                        ...
                        user_permissions = bitbadgespy-sdk.models.i_user_permissions.iUserPermissions(
                            can_update_outgoing_approvals = [
                                bitbadgespy-sdk.models.i_user_outgoing_approval_permission.iUserOutgoingApprovalPermission(
                                    to_list_id = '', 
                                    to_list = , 
                                    initiated_by_list_id = '', 
                                    initiated_by_list = , 
                            ...
                            can_update_incoming_approvals = [
                                bitbadgespy-sdk.models.i_user_incoming_approval_permission.iUserIncomingApprovalPermission(
                                    from_list_id = '', 
                                    from_list = , 
                                    initiated_by_list_id = '', 
                                    initiated_by_list = , 
                            ...
                            can_update_auto_approve_self_initiated_outgoing_transfers = [
                                bitbadgespy-sdk.models.i_action_permission.iActionPermission(
                                    permanently_permitted_times = [
                        ...
                        content_hash = '', 
                        update_history = [
                            bitbadgespy-sdk.models.i_update_history.iUpdateHistory(
                                tx_hash = '', 
                                block = null, 
                ...
                activity = [
                    bitbadgespy-sdk.models.i_transfer_activity_doc.iTransferActivityDoc(
                        _doc_id = '', 
                        _id = '', 
                        timestamp = null, 
                        block = null, 
                        ...
                        collection_id = null, 
                        memo = '', 
                        precalculate_balances_from_approval = bitbadgespy-sdk.models.i_approval_identifier_details.iApprovalIdentifierDetails(
                            approval_id = '', 
                            approval_level = '', 
                            approver_address = '', ), 
                        prioritized_approvals = [
                            bitbadgespy-sdk.models.i_approval_identifier_details.iApprovalIdentifierDetails(
                                approval_id = '', 
                                approval_level = '', 
                                approver_address = '', )
                            ], 
                ...
                list_activity = [
                    bitbadgespy-sdk.models.i_list_activity_doc.iListActivityDoc(
                        _doc_id = '', 
                        _id = '', 
                        timestamp = null, 
                        block = null, 
                ...
                claim_activity = [
                    bitbadgespy-sdk.models.i_claim_activity_doc.iClaimActivityDoc(
                        _doc_id = '', 
                        _id = '', 
                        timestamp = null, 
                        block = null, 
                ...
                points_activity = [
                    bitbadgespy-sdk.models.i_points_activity_doc.iPointsActivityDoc(
                        _doc_id = '', 
                        _id = '', 
                        timestamp = null, 
                        block = null, 
                ...
                challenge_trackers = [
                    bitbadgespy-sdk.models.i_merkle_challenge_tracker_doc.iMerkleChallengeTrackerDoc(
                        _doc_id = '', 
                        _id = '', 
                        collection_id = null, 
                        challenge_tracker_id = '', 
                        ...
                        approver_address = '', 
                        used_leaf_indices = [
                            bitbadgespy-sdk.models.i_used_leaf_status.iUsedLeafStatus(
                                leaf_index = null, 
                                used_by = '', )
                            ], )
                    ],
                approval_trackers = [
                    bitbadgespy-sdk.models.i_approval_tracker_doc.iApprovalTrackerDoc(
                        collection_id = null, 
                        approval_id = '', 
                        amount_tracker_id = '', 
                        approval_level = '', 
                ...
                claim_alerts = [
                    bitbadgespy-sdk.models.i_claim_alert_doc.iClaimAlertDoc(
                        _doc_id = '', 
                        _id = '', 
                        timestamp = null, 
                        block = null, 
                ...
                siwbb_requests = [
                    bitbadgespy-sdk.models.i_siwbb_request_doc.iSIWBBRequestDoc(
                        _doc_id = '', 
                        _id = '', 
                        code = '', 
                        bitbadges_address = '', 
                        ...
                        expires_at = null, 
                        attestations = [
                            bitbadgespy-sdk.models.i_attestations_proof.iAttestationsProof(
                                _doc_id = '', 
                                _id = '', 
                                ...
                                proof_of_issuance = bitbadgespy-sdk.models.i_attestations_proof_proof_of_issuance.iAttestationsProof_proofOfIssuance(
                                    message = '', 
                                    signature = '', 
                                    signer = '', 
                                    public_key = '', ), 
                                ...
                                data_integrity_proof = bitbadgespy-sdk.models.i_attestations_proof_data_integrity_proof.iAttestationsProof_dataIntegrityProof(
                                    signature = '', 
                                    signer = '', 
                                    public_key = '', 
                                    is_derived = True, ), 
                                ...
                                anchors = [
                                    bitbadgespy-sdk.models.i_attestations_proof_anchors_inner.iAttestationsProof_anchors_inner(
                                        tx_hash = '', 
                                        message = '', )
                                    ], 
                                update_history = [
                ...
                address = '',
                nsfw = bitbadgespy-sdk.models.i_bit_badges_user_info_nsfw.iBitBadgesUserInfo_nsfw(
                    reason = '', ),
                reported = bitbadgespy-sdk.models.i_bit_badges_user_info_reported.iBitBadgesUserInfo_reported(
                    reason = '', ),
                views = {
                    'key' : bitbadgespy-sdk.models.i_bit_badges_user_info_views_value.iBitBadgesUserInfo_views_value(
                        ids = [
                            ''
                            ], 
                        type = '', 
                        pagination = bitbadgespy-sdk.models.pagination_info.PaginationInfo(
                            bookmark = '', 
                            has_more = True, ), )
                    },
                alias = bitbadgespy-sdk.models.i_bit_badges_user_info_alias.iBitBadgesUserInfo_alias(
                    collection_id = null, 
                    list_id = '', )
            )
        else:
