...
from bitbadgespy-sdk.models.i_add_to_ipfs_payload_contents_inner import IAddToIpfsPayloadContentsInner
    ...
    def make_instance(self, include_optional) -> IAddToIpfsPayloadContentsInner:
        ...
        if include_optional:
            return IAddToIpfsPayloadContentsInner(
                ...
                off_chain_transferability_info = bitbadgespy-sdk.models.i_metadata_off_chain_transferability_info.iMetadata_offChainTransferabilityInfo(
                    host = '', 
                    assign_method = '', ),
                attributes = [
                    bitbadgespy-sdk.models.i_metadata_attributes_inner.iMetadata_attributes_inner(
                        type = '', 
                        name = '', 
                        value = null, )
                    ],
                additional_info = [
                    bitbadgespy-sdk.models.i_metadata_additional_info_inner.iMetadata_additionalInfo_inner(
                        name = '', 
                        image = '', 
                        description = '', 
                        url = '', )
