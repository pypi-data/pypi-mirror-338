...
from bitbadgespy-sdk.models.verify_challenge_options import VerifyChallengeOptions
    ...
    def make_instance(self, include_optional) -> VerifyChallengeOptions:
        ...
        if include_optional:
            return VerifyChallengeOptions(
                expected_challenge_params = bitbadgespy-sdk.models.verify_challenge_options_expected_challenge_params.VerifyChallengeOptions_expectedChallengeParams(
                    domain = '', 
                    statement = '', 
                    address = '', 
                    uri = '', 
