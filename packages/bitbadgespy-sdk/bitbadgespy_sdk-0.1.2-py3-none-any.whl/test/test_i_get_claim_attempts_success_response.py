    ...
    def make_instance(self, include_optional) -> IGetClaimAttemptsSuccessResponse:
        ...
        if include_optional:
            return IGetClaimAttemptsSuccessResponse(
                docs = [
                    bitbadgespy-sdk.models.i_get_claim_attempts_success_response_docs_inner.iGetClaimAttemptsSuccessResponse_docs_inner(
                        success = True, 
                        attempted_at = null, 
                        claim_id = '', 
                        bitbadges_address = '', 
                        ...
                        claim_number = 1.337, 
                        error = '', 
                        attempt_data = bitbadgespy-sdk.models.attempt_data.attemptData(), )
                    ],
                bookmark = '',
                total = 1.337
            )
