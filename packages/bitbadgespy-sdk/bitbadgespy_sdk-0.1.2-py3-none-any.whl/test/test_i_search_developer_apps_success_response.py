...
from bitbadgespy-sdk.models.i_search_developer_apps_success_response import ISearchDeveloperAppsSuccessResponse
    ...
    def make_instance(self, include_optional) -> ISearchDeveloperAppsSuccessResponse:
        ...
        if include_optional:
            return ISearchDeveloperAppsSuccessResponse(
                developer_apps = [
                    bitbadgespy-sdk.models.i_developer_app_doc.iDeveloperAppDoc(
                        _doc_id = '', 
                        _id = '', 
                        created_by = '', 
                        managed_by = '', 
