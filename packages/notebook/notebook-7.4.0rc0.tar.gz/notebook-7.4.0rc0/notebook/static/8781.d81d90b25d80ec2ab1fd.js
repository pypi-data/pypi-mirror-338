...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3213);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(44203),
    __webpack_require__(97810),
    __webpack_require__(2636),
    __webpack_require__(51522),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(62935),
  __webpack_require__(18910),
  __webpack_require__(70014),
  __webpack_require__(116),
  __webpack_require__(55579),
  __webpack_require__(20869),
  __webpack_require__(83579),
  
      (__webpack_require__(13203)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(29179)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(84380),
  
      (__webpack_require__(38761)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(8908)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      (__webpack_require__(30848)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(44633)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(41047)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(8544)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(47725)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(14145),
  __webpack_require__(71734),
  __webpack_require__(45051),
  
      (__webpack_require__(28385)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(62532),
  __webpack_require__(29965),
  __webpack_require__(58033),
  
      (__webpack_require__(74733)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(44977),
  __webpack_require__(86196),
  __webpack_require__(16777),
  __webpack_require__(28372),
  __webpack_require__(71217),
  __webpack_require__(43837),
  __webpack_require__(14628),
  __webpack_require__(89746),
  __webpack_require__(27369),
  __webpack_require__(31945),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(14261),
  
      (__webpack_require__(64459)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(40560),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(82919),
  __webpack_require__(52811),
  
      (__webpack_require__(90421)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:sources',
      ...
      __webpack_require__(92767),
  __webpack_require__(62448),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(64742)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(31879)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(14993).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(17993).IServiceManager);
...
//# sourceMappingURL=8781.d81d90b25d80ec2ab1fd.js.map?v=d81d90b25d80ec2ab1fd