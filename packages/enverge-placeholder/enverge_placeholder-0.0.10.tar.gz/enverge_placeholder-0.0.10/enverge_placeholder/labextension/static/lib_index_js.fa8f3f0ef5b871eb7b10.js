...
/* harmony import */ var _config_gpu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config/gpu */ "./lib/config/gpu.js");
      ...
      <div style="margin-bottom: 24px">
        ...
        ">
          ...
          <select id="gpu-type-select" style="
            ...
            min-width: 150px;
          ">
            ${Object.entries(_config_gpu__WEBPACK_IMPORTED_MODULE_1__.GPU_CONFIGS).map(([type, config]) => `
              <option value="${type}" ${type === _config_gpu__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_GPU_CONFIG.type ? 'selected' : ''} ${type === 'H200' || type === 'L4' ? 'disabled' : ''}>
      ...
      <div style="margin-bottom: 24px">
        ...
        ">
          ...
          <div style="display: flex; justify-content: space-between; margin-bottom: 12px">
            <span>Model:</span>
            <span style="font-weight: 500">NVIDIA ${_config_gpu__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_GPU_CONFIG.type} ${_config_gpu__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_GPU_CONFIG.memoryGB}GB</span>
          </div>
          <div style="display: flex; justify-content: space-between; margin-bottom: 12px">
            <span>GPU Load:</span>
          ...
          <div>
            <div style="display: flex; justify-content: space-between; margin-bottom: 8px">
              ...
              <span id="memory-usage-value" style="font-weight: 500">0GB / ${_config_gpu__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_GPU_CONFIG.memoryGB}GB (0%)</span>
            </div>
            <div style="
              width: 100%;
              height: 8px;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DEFAULT_GPU_CONFIG: () => (/* binding */ DEFAULT_GPU_CONFIG),
/* harmony export */   GPU_CONFIGS: () => (/* binding */ GPU_CONFIGS)
/* harmony export */ });
const GPU_CONFIGS = {
    H200: {
        type: 'H200',
...
const DEFAULT_GPU_CONFIG = GPU_CONFIGS.A100;
...
/* harmony export */ });
/* harmony import */ var _config_gpu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config/gpu */ "./lib/config/gpu.js");
...
const updateGPUStats = (gpuUsageDetected = false) => {
    ...
    if (gpuUsageDetected) {
        ...
        const memoryGB = Math.round((memoryPercentage / 100) * _config_gpu__WEBPACK_IMPORTED_MODULE_0__.DEFAULT_GPU_CONFIG.memoryGB);
        // Update the DOM elements with active GPU values
        if (gpuLoadElement) {
            gpuLoadElement.textContent = `${gpuLoad}%`;
        }
        if (memoryUsageElement) {
            memoryUsageElement.textContent = `${memoryGB}GB / ${_config_gpu__WEBPACK_IMPORTED_MODULE_0__.DEFAULT_GPU_CONFIG.memoryGB}GB (${memoryPercentage}%)`;
        }
        if (memoryUsageBar) {
        ...
        if (memoryUsageElement) {
            memoryUsageElement.textContent = `0GB / ${_config_gpu__WEBPACK_IMPORTED_MODULE_0__.DEFAULT_GPU_CONFIG.memoryGB}GB (0%)`;
        }
        if (memoryUsageBar) {
...
//# sourceMappingURL=lib_index_js.fa8f3f0ef5b871eb7b10.js.map