...
class HttpClient():
    ...
    def fix_headers(self, headers: Dict, timestamp: datetime = None) -> Dict:
    ...
    def get(self, path: str, headers: Dict = None, timestamp: datetime = None) -> Dict:
        if not self.app.__is_test__:
            raise Exception("Test mode not enabled")
        if headers is None:
            headers = {}
    ...
    def post(self, path: str, payload: Dict,  headers: Dict = None, timestamp: datetime = None) -> Dict:
        if not self.app.__is_test__:
            raise Exception("Test mode not enabled")
        if isinstance(payload, Dict):
            payload = dumps(payload)
    ...
    def put(self, path: str, payload: Dict,  headers: Dict = None, timestamp: datetime = None) -> Dict:
        if not self.app.__is_test__:
            raise Exception("Test mode not enabled")
        if isinstance(payload, Dict):
            payload = dumps(payload)
    ...
    def delete(self, path: str,  headers: Dict = None, timestamp: datetime = None) -> Dict:
        if not self.app.__is_test__:
            raise Exception("Test mode not enabled")
        if headers is None:
            headers = {}
    ...
    def patch(self, path: str, payload: Dict,  headers: Dict = None, timestamp: datetime = None) -> Dict:
        if not self.app.__is_test__:
            raise Exception("Test mode not enabled")
        if isinstance(payload, Dict):
            payload = dumps(payload)
