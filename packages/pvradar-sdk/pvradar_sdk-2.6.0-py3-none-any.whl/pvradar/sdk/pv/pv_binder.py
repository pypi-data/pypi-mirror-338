...
from .irradiance import sky_diffuse_irradiance_on_front_pvlib_perez_driesse
...
class PvBinder(AbstractBinder):
    ...
    def bind(
        ...
        *,
        ...
        if resource_name == 'sky_diffuse_irradiance_on_front':
            if not context:
                return BindingNotFound
            model = context.wrap_model(sky_diffuse_irradiance_on_front_pvlib_perez_driesse)
