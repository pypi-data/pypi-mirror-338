...
def revenue(
    available_grid_power: Annotated[pd.Series, R.available_grid_power(to_freq='h')],
    ...
    return available_grid_power * electricity_sales_price / 1e6  # price in USD per MWh!


@resource_type(R.energy_sales_price(set_unit='USD/MWh'))
def ppa_electricity_sales_price(
    ppa_price: float,
