...
class snow_loss_factor(ResourceTypeDescriptor):
    """A dimensionless factor that describes the loss of dc power due to snow including potential non-linear effects due to partial and inhomogeneous shading of pv module. """
