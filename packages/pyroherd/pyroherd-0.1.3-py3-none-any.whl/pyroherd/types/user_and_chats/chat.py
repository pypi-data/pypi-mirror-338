...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~pyroherd.enums.ChatType`, *optional*):
            Type of chat.
        ...
        usernames (List of :obj:`~pyroherd.types.Username`, *optional*):
        ...
        stories (List of :obj:`~pyroherd.types.Story`, *optional*):
            The list of chat's stories if available.

        wallpaper (:obj:`~pyroherd.types.Document`, *optional*):
            Chat wallpaper.
        ...
        personal_channel (:obj:`~pyroherd.types.Chat`, *optional*):
            The personal channel linked to this chat.
            Returned only in :meth:`~pyroherd.Client.get_chat`.

        personal_channel_message (:obj:`~pyroherd.types.Message`, *optional*):
        ...
        reply_color (:obj:`~pyroherd.types.ChatColor`, *optional*):
            Chat reply color.

        profile_color (:obj:`~pyroherd.types.ChatColor`, *optional*):
            Chat profile color.

        business_info (:obj:`~pyroherd.types.BusinessInfo`, *optional*):
            Business information of a chat.

        business_intro (:obj:`~pyroherd.types.BusinessIntro`, *optional*):
            For private chats with business accounts, the intro of the business.

        birthday (:obj:`~pyroherd.types.Birthday`, *optional*):
        ...
        raw (:obj:`~pyroherd.raw.base.Chat` | :obj:`~pyroherd.raw.base.User` | :obj:`~pyroherd.raw.base.ChatFull` | :obj:`~pyroherd.raw.base.UserFull`, *optional*):
    ...
    async def set_ttl(self, ttl_seconds: int) -> "types.Message":
        """Bound method *set_ttl* of :obj:`~pyroherd.types.Chat`.
        ...
        Returns:
            :obj:`~pyroherd.types.Message`: On success, the generated service message is returned.
        """
    ...
    async def mute(self, mute_until: datetime = None) -> bool:
        """Bound method *mute* of :obj:`~pyroherd.types.Chat`.
    ...
    async def unmute(self) -> bool:
        """Bound method *unmute* of :obj:`~pyroherd.types.Chat`.
