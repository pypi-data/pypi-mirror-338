...
from pyroherd.errors import ChannelPrivate, MessageIdsEmpty, PeerIdInvalid, ChannelForumMissing
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        topic (:obj:`~pyroherd.types.ForumTopic`, *optional*):
        ...
        reply_to_story (:obj:`~pyroherd.types.Story`, *optional*):
        ...
        quote_entities (List of :obj:`~pyroherd.types.MessageEntity`, *optional*):
        ...
        forum_topic_created (:obj:`~pyroherd.types.ForumTopicCreated`, *optional*):
            Service message: forum topic created

        forum_topic_closed (:obj:`~pyroherd.types.ForumTopicClosed`, *optional*):
            Service message: forum topic closed

        forum_topic_reopened (:obj:`~pyroherd.types.ForumTopicReopened`, *optional*):
            Service message: forum topic reopened

        forum_topic_edited (:obj:`~pyroherd.types.ForumTopicEdited`, *optional*):
            Service message: forum topic edited

        general_topic_hidden (:obj:`~pyroherd.types.GeneralTopicHidden`, *optional*):
            Service message: forum general topic hidden

        general_topic_unhidden (:obj:`~pyroherd.types.GeneralTopicUnhidden`, *optional*):
        ...
        gift_code (:obj:`~pyroherd.types.GiftCode`, *optional*):
            Service message: gift code information.

        requested_chats (:obj:`~pyroherd.types.RequestedChats`, *optional*):
            Service message: requested chats information.

        successful_payment (:obj:`~pyroherd.types.SuccessfulPayment`, *optional*):
        ...
        raw (``pyroherd.raw.types.Message``, *optional*):
    ...
    async def reply_text(
        ...
        Parameters:
            ...
            quote_entities (List of :obj:`~pyroherd.types.MessageEntity`):
    ...
    async def reply_poll(
        ...
        Parameters:
            ...
            quote_parse_mode (:obj:`~pyroherd.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.
    ...
    async def reply_web_page(
        ...
        """Bound method *reply_web_page* of :obj:`~pyroherd.types.Message`.
        ...
        .. code-block:: python
            ...
            await client.send_web_page(
                chat_id=message.chat.id,
                url="https://docs.pyroherd.org"
            )

        Example:
            .. code-block:: python

                await message.reply_web_page("https://docs.pyroherd.org")
    ...
    async def click(
        ...
        Parameters:
            ...
            request_write_access (``bool``, *optional*):
                Only used in case of :obj:`~pyroherd.types.LoginUrl` button.
            ...
            password (``str``, *optional*):
                ...
                The 2-step verification password for the current user. Only applicable, if the :obj:`~pyroherd.types.InlineKeyboardButton` contains ``requires_password``.
        ...
        Returns:
            ...
            -   A :obj:`~pyroherd.types.Chat` object in case of a ``KeyboardButtonUserProfile`` button.
    ...
    async def read(self) -> bool:
        """Bound method *read* of :obj:`~pyroherd.types.Message`.
    ...
    async def view(self) -> bool:
        """Bound method *view* of :obj:`~pyroherd.types.Message`.
    ...
    async def pay(self) -> List[Union["types.Photo", "types.Video"]]:
        """Bound method *pay* of :obj:`~pyroherd.types.Message`.
