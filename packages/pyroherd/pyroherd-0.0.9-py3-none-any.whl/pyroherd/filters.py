...
from pyroherd.types import Message, CallbackQuery, InlineQuery, PreCheckoutQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update
...
"""Filter messages that contain :obj:`~pyroherd.types.Giveaway` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.GiveawayResult` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.GiftCode` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Story` objects."""
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyroherd.types.PreCheckoutQuery`: The filter will match ``payload``.
