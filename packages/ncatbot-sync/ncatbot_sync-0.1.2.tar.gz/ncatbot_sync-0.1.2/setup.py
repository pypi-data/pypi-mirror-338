...
# 基础配置 --------------------------------------------------------------
PACKAGE_NAME = "ncatbot_sync"  # 更改为你的包名 (PyPI显示的名称)
AUTHOR = "木子"         # 作者/维护者姓名
EMAIL = "lyh_02@qq.com"  # 联系邮箱
URL = "https://github.com/liyihao1110/ncatbot_sync"  # 项目主页
DESCRIPTION = "完整实现OneBot v11规范并支持Napcat,LLonebot,Lagrange多协议"  # 简短描述
LICENSE = "MIT"  # 许可证类型 (MIT/Apache 2.0/GPL等)
...
setup(
    ...
    #         "your-command=your_package.cli:main",  # 示例配置
    #     ],
    # },
    ...
    project_urls={  # 扩展项目链接 (PyPI右侧显示)
        "Documentation": "https://ncatbot-1.gitbook.io/ncatbot",
        "Source Code": URL,
