                    ...
                    if target.execute_ddl:
                        try:
                            ...
                            if query:
                                ...
                                self.logger.info(f"The below query was executed in: {target.registered_name()}.")
                            ...
                            self.logger.error(f"[{target.registered_name()}] -- {error}")
