...
ElementResponseModel ElementResponseModelFromString(
  ...
  } else if (element_response_upper == "HAMAKER_LBA") {
    element_response_enum = everybeam::ElementResponseModel::kHamakerLba;
  } else if (element_response_upper == "LOBES") {
    element_response_enum = everybeam::ElementResponseModel::kLOBES;
  } else if (element_response_upper == "LWA") {
    element_response_enum = everybeam::ElementResponseModel::kLwa;
  } else if (element_response_upper == "OSKAR_DIPOLE" ||
             element_response_upper == "OSKARDIPOLE") {
    element_response_enum = everybeam::ElementResponseModel::kOSKARDipole;
  } else if (element_response_upper == "OSKARSPHERICALWAVE" ||
             element_response_upper == "SKALA40_WAVE") {
    element_response_enum =
        everybeam::ElementResponseModel::kOSKARSphericalWave;
  } else if (element_response_upper == "SKAMID_ANALYTICAL") {
    element_response_enum = everybeam::ElementResponseModel::kSkaMidAnalytical;
  } else {
