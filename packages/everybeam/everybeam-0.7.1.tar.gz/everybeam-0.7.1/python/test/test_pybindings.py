...
import numpy as np
import pytest
from everybeam import LOFAR, ElementResponseModel, GridSettings, load_telescope
...
@pytest.mark.parametrize("ref", [lba_setup(), hba_setup()])
...
@pytest.mark.parametrize("ref", [hba_setup()])
