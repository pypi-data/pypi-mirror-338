...
execute_process(
  COMMAND "/usr/bin/git" show-ref "de91714da1e4bad78ba96cc05173ec8835a879dc"
  WORKING_DIRECTORY "/var/scratch/dijkema/everybeambuild/_deps/ska-sdp-func-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "de91714da1e4bad78ba96cc05173ec8835a879dc")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("de91714da1e4bad78ba96cc05173ec8835a879dc" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/de91714da1e4bad78ba96cc05173ec8835a879dc")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/var/scratch/dijkema/everybeambuild/_deps/ska-sdp-func-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/var/scratch/dijkema/everybeambuild/_deps/ska-sdp-func-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
