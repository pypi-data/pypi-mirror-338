...
execute_process(
  COMMAND "/usr/bin/git" show-ref "e6be85a376624da10629b6525c81759e02020308"
  WORKING_DIRECTORY "/var/scratch/dijkema/everybeambuild/_deps/xtensor-fftw-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "e6be85a376624da10629b6525c81759e02020308")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("e6be85a376624da10629b6525c81759e02020308" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/e6be85a376624da10629b6525c81759e02020308")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/var/scratch/dijkema/everybeambuild/_deps/xtensor-fftw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/var/scratch/dijkema/everybeambuild/_deps/xtensor-fftw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
