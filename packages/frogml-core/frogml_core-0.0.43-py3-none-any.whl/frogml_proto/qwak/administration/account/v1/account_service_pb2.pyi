...
class CreateAccountRequest(google.protobuf.message.Message):
    ...
    @property
    def jfrog_tenant_spec(self) -> frogml_proto.qwak.administration.account.v1.jfrog_tenant_details_pb2.JfrogTenantSpec:
    ...
    def __init__(
        ...
        *,
        ...
        type: frogml_proto.qwak.administration.account.v1.account_pb2.AccountType.ValueType = ...,
        tier: frogml_proto.qwak.administration.account.v1.account_pb2.AccountTier.ValueType = ...,
        jfrog_tenant_spec: frogml_proto.qwak.administration.account.v1.jfrog_tenant_details_pb2.JfrogTenantSpec | None = ...,
    ) -> None: ...
...
class CreateAccountResponse(google.protobuf.message.Message):
    ...
    @property
    def account(self) -> frogml_proto.qwak.administration.account.v1.account_pb2.Account:
        """Created account"""
    def __init__(
        self,
        *,
        account: frogml_proto.qwak.administration.account.v1.account_pb2.Account | None = ...,
    ) -> None: ...
...
class ListAccountsRequest(google.protobuf.message.Message):
    ...
    @property
    def filter(self) -> frogml_proto.qwak.administration.account.v1.account_pb2.ListAccountFilter:
        """Filter to filter account list"""
    def __init__(
        self,
        *,
        filter: frogml_proto.qwak.administration.account.v1.account_pb2.ListAccountFilter | None = ...,
    ) -> None: ...
...
class GetAccountBriefResponse(google.protobuf.message.Message):
    ...
    @property
    def account_brief(self) -> frogml_proto.qwak.administration.account.v1.account_pb2.AccountBrief: ...
    def __init__(
        self,
        *,
        account_brief: frogml_proto.qwak.administration.account.v1.account_pb2.AccountBrief | None = ...,
    ) -> None: ...
