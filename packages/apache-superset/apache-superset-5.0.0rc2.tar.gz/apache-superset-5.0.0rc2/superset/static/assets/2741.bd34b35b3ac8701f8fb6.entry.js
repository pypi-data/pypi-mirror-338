...
`,k=(0,s.I4)((({icon:e,altText:a,buttonText:t,...n})=>(0,D.FD)(F,{...n,children:[(0,D.FD)(E,{children:[e&&(0,D.Y)("img",{src:e,alt:a}),!e&&(0,D.Y)(f.A.DatabaseOutlined,{className:"default-db-icon","aria-label":"default-icon"})]}),(0,D.Y)($,{children:(0,D.Y)(N,{children:(0,D.Y)(A,{text:t,maxLine:"2",basedOn:"words",trimRight:!0})})})]})))`
  text-transform: none;
