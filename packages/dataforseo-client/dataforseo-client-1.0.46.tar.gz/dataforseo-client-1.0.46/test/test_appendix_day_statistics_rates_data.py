...
class TestAppendixDayStatisticsRatesData(unittest.TestCase):
    """AppendixDayStatisticsRatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixDayStatisticsRatesData:
        """Test AppendixDayStatisticsRatesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixDayStatisticsRatesData`
        """
        model = AppendixDayStatisticsRatesData()
        if include_optional:
            return AppendixDayStatisticsRatesData(
    ...
    def testAppendixDayStatisticsRatesData(self):
        """Test AppendixDayStatisticsRatesData"""
