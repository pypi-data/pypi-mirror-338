...
class TestAppendixBusinessDataDayStatisticsRatesData(unittest.TestCase):
    """AppendixBusinessDataDayStatisticsRatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixBusinessDataDayStatisticsRatesData:
        """Test AppendixBusinessDataDayStatisticsRatesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixBusinessDataDayStatisticsRatesData`
        """
        model = AppendixBusinessDataDayStatisticsRatesData()
        if include_optional:
            return AppendixBusinessDataDayStatisticsRatesData(
                ...
                yelp = dataforseo_client.models.appendix_business_data_day_limits_rates_data_info.AppendixBusinessDataDayLimitsRatesDataInfo(
                    reviews = dataforseo_client.models.appendix_info.AppendixInfo(
                        task_post = 1.337, 
                        task_get = 1.337, 
                        tasks_ready = 1.337, 
                        live = 1.337, ), 
    ...
    def testAppendixBusinessDataDayStatisticsRatesData(self):
        """Test AppendixBusinessDataDayStatisticsRatesData"""
