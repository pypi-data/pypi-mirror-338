...
class TestAppendixAppDataDayStatisticsRatesData(unittest.TestCase):
    """AppendixAppDataDayStatisticsRatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixAppDataDayStatisticsRatesData:
        """Test AppendixAppDataDayStatisticsRatesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixAppDataDayStatisticsRatesData`
        """
        model = AppendixAppDataDayStatisticsRatesData()
        if include_optional:
            return AppendixAppDataDayStatisticsRatesData(
                ...
                app_list = dataforseo_client.models.appendix_serp_limits_rates_data_info.AppendixSerpLimitsRatesDataInfo(
                    ...
                    jobs = dataforseo_client.models.appendix_jobs_serp_limits_rates_data_info.AppendixJobsSerpLimitsRatesDataInfo(
                        task_post = 1.337, ), 
                    screenshot = 1.337, ),
                app_reviews = dataforseo_client.models.appendix_serp_limits_rates_data_info.AppendixSerpLimitsRatesDataInfo(
                    task_post = 1.337, 
                    task_get = dataforseo_client.models.appendix_function_type_info.AppendixFunctionTypeInfo(
                        regular = 1.337, 
                        advanced = 1.337, 
                    ...
                    jobs = dataforseo_client.models.appendix_jobs_serp_limits_rates_data_info.AppendixJobsSerpLimitsRatesDataInfo(
                        task_post = 1.337, ), 
                    screenshot = 1.337, ),
                app_searches = dataforseo_client.models.appendix_serp_limits_rates_data_info.AppendixSerpLimitsRatesDataInfo(
                    task_post = 1.337, 
                    task_get = dataforseo_client.models.appendix_function_type_info.AppendixFunctionTypeInfo(
                        regular = 1.337, 
                        advanced = 1.337, 
    ...
    def testAppendixAppDataDayStatisticsRatesData(self):
        """Test AppendixAppDataDayStatisticsRatesData"""
