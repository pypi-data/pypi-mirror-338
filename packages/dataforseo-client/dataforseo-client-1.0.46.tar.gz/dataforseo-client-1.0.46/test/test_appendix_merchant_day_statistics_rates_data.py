...
class TestAppendixMerchantDayStatisticsRatesData(unittest.TestCase):
    """AppendixMerchantDayStatisticsRatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixMerchantDayStatisticsRatesData:
        """Test AppendixMerchantDayStatisticsRatesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixMerchantDayStatisticsRatesData`
        """
        model = AppendixMerchantDayStatisticsRatesData()
        if include_optional:
            return AppendixMerchantDayStatisticsRatesData(
    ...
    def testAppendixMerchantDayStatisticsRatesData(self):
        """Test AppendixMerchantDayStatisticsRatesData"""
