...
class TestAppendixKeywordsDataDayStatisticsRatesData(unittest.TestCase):
    """AppendixKeywordsDataDayStatisticsRatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixKeywordsDataDayStatisticsRatesData:
        """Test AppendixKeywordsDataDayStatisticsRatesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixKeywordsDataDayStatisticsRatesData`
        """
        model = AppendixKeywordsDataDayStatisticsRatesData()
        if include_optional:
            return AppendixKeywordsDataDayStatisticsRatesData(
    ...
    def testAppendixKeywordsDataDayStatisticsRatesData(self):
        """Test AppendixKeywordsDataDayStatisticsRatesData"""
