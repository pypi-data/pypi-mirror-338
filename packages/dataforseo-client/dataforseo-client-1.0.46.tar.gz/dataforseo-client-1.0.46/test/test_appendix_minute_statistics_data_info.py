...
class TestAppendixMinuteStatisticsDataInfo(unittest.TestCase):
    """AppendixMinuteStatisticsDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixMinuteStatisticsDataInfo:
        """Test AppendixMinuteStatisticsDataInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixMinuteStatisticsDataInfo`
        """
        model = AppendixMinuteStatisticsDataInfo()
        if include_optional:
            return AppendixMinuteStatisticsDataInfo(
    ...
    def testAppendixMinuteStatisticsDataInfo(self):
        """Test AppendixMinuteStatisticsDataInfo"""
