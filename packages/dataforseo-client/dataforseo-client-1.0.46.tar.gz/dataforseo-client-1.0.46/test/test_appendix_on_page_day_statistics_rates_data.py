...
class TestAppendixOnPageDayStatisticsRatesData(unittest.TestCase):
    """AppendixOnPageDayStatisticsRatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixOnPageDayStatisticsRatesData:
        """Test AppendixOnPageDayStatisticsRatesData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixOnPageDayStatisticsRatesData`
        """
        model = AppendixOnPageDayStatisticsRatesData()
        if include_optional:
            return AppendixOnPageDayStatisticsRatesData(
                task_post = 1.337,
                tasks_ready = 1.337,
                summary = 1.337,
                resources = 1.337,
    ...
    def testAppendixOnPageDayStatisticsRatesData(self):
        """Test AppendixOnPageDayStatisticsRatesData"""
