...
class TestAppendixKeywordsDataDayStatisticsMoneyData(unittest.TestCase):
    """AppendixKeywordsDataDayStatisticsMoneyData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixKeywordsDataDayStatisticsMoneyData:
        """Test AppendixKeywordsDataDayStatisticsMoneyData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixKeywordsDataDayStatisticsMoneyData`
        """
        model = AppendixKeywordsDataDayStatisticsMoneyData()
        if include_optional:
            return AppendixKeywordsDataDayStatisticsMoneyData(
    ...
    def testAppendixKeywordsDataDayStatisticsMoneyData(self):
        """Test AppendixKeywordsDataDayStatisticsMoneyData"""
