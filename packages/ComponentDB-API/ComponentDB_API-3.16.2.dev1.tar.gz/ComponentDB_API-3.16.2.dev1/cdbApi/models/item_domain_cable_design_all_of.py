...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, connection_list=None, technical_system_list=None, assigned_item=None, inventory_item=None, catalog_item=None, alternate_name=None, is_housed=None, local_vars_configuration=None):  # noqa: E501
