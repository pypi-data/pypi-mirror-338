    ...
    def predict(self,
        ...
        forecast_method : {'formula_forecast', 'innovations_algorithm', 'truncation_algorithm'}, optional
            Specify the forecast method.
              ...
              - 'truncation_algorithm': a forecast method much faster than the innovations algorithm when
            the AR representation of the ARIMA model can be truncated to finite order.
        ...
        allow_new_index : bool, optional
            Indicates whether a new index column is allowed in the result.
              ...
              - True: return the result with a new integer or timestamp index column.
              - False: return the result with an index column starting from 0.
        ...
        show_explainer : bool, optional
            ...
            shown in an attribute called explainer\_ of the ARIMA/auto ARIMA instance.
