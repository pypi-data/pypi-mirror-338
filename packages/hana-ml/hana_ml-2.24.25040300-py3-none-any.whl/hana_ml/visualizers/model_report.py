...
class _UnifiedClassificationReportBuilder(object):
    ...
    def generate_html_report(self, filename):
        ...
        if self.framework_version == 'v2':
            ...
            if self.__report_html is None:
                raise Exception(self.__build_error_msg)
            EmbeddedUI.generate_file('{}_unified_classification_model_report.html'.format(filename), self.__report_html)
...
class _UnifiedRegressionReportBuilder(object):
    ...
    def generate_html_report(self, filename):
        ...
        if self.framework_version == 'v2':
            ...
            if self.__report_html is None:
                raise Exception(self.__build_error_msg)
            EmbeddedUI.generate_file('{}_unified_regression_model_report.html'.format(filename), self.__report_html)
