...
if __name__ == "__main__":
    ...
    arena = LSVMArena(
            ...
            save_path = f"{server_config['save_path']}",
            local_save_path=f"{server_config['local_save_path']}"
        )
    # arena.set_ignores(["TA - Truthful", "TA - SECRET", "TA - RANDOM", "TA - MinBidder", "TA - Confidence", "TA - Jumper", "PW - Hot'n'Cold"])
    arena.run()
    end = datetime.now()
