    ...
    def run_ad_auctions(self, bid_bundles : List[BidBundle], users: List[MarketSegment], day: int) -> None:
        ...
        for bid_bundle in bid_bundles:
            try:
                ...
                print(f"Error processing bid bundle {bid_bundle}: {e}")
                continue
        ...
        for user_segment in users:
            try:
                ...
                print(f"Error processing user segment {user_segment}: {e}")
                continue
        ...
        for campaign in new_campaigns:
            ...
            for agent in self.agents:
                try:
                    ...
                    print(f"Error processing campaign auction for agent {agent}: {e}")
                    continue
            ...
            if bids:
                try:
                    ...
                    print(f"Error processing campaign auction results for campaign {campaign.uid}: {e}")
