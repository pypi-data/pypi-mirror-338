...
class TestDentrixService:
    ...
    def test_gets_patient_procedures_correctly(self, mock_get_solution_data: MagicMock):
        ...
        mock_get_solution_data.assert_called_once_with(
            {"problemType": "UNATTACHED_PROCEDURE"}, "entity_id", "entity_type", "2023-01-01"
        )
    ...
    def test_gets_patient_unsent_claim_correctly(self, mock_get_solution_data: MagicMock):
        ...
        mock_get_solution_data.assert_called_once_with(
            {"problemType": "UNSENT_CLAIM"}, "entity_id", "entity_type", "2023-01-01"
        )
    ...
    def test_query_aged_receivables_patients_list(self, mock_now_timestamp, mock_get_aged_receivables):
        """Test public get aged receivables patients list."""
        test_ds = self._generate_dentrix_service_instance()
        ...
        mock_get_aged_receivables.return_value = {"receivables": {"agedReceivables": expected_result}}
        ...
        mock_get_aged_receivables.assert_called_once_with(payload=payload)
    ...
    def test_unlocks_ledger_for_modification_correctly(
        self, mock_encrypt_password: MagicMock, mock_unlock_ledger: MagicMock
    ):
    ...
    def test_gets_transaction_charges_correctly(self, mock_get_transaction_charges: MagicMock):
        """Tests the get_transaction_charges method."""
        mock_get_transaction_charges.return_value = [{"charge": "test"}]
        test_ds = self._generate_dentrix_service_instance()
    ...
    def test_posts_appointment_note_correctly(
        self, mock_change_location: MagicMock, mock_post_appointment_note: MagicMock
    ):
    ...
    def test_get_patient_ledger_transactions_guarantor_view(self, mock_get_ledger_list):
        ...
        expected_result = [{"id": 1, "amount": 200}]
        mock_get_ledger_list.return_value = expected_result
    ...
    def test_get_patient_ledger_transactions_patient_view(self, mock_get_ledger_list):
        ...
        expected_result = [{"id": 2, "amount": 150}]
        mock_get_ledger_list.return_value = expected_result
