...
class AscendService(AscendRequests):
    ...
    def fetch_patient_insurance_plan_by_id(
        self, patient_insurance_plan_id: int, response_fields: Optional[str] = None
    ) -> dict:
    ...
    def get_aging_balance_for_patient_ownership(self, patient_id: str, response_fields: str = "ALL") -> dict:
        """Get aging balance for a patient based on ownership type.

        Args:
            ownership (OwnershipTypes): 'PATIENT' or 'GUARANTOR'
