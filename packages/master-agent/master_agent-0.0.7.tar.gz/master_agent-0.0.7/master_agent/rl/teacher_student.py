...
from master_agent.envs.complexEnv import ComplexEnv
from master_agent.rl import DAG, MinigridFeaturesExtractor, LEARNING_RATE, NUM_STEPS, ETA, EPSILON, EPISODES, MU
...
class TeacherStudent:
    def __init__(self, input_data, grid_mapping: dict[str, tuple[WorldObj, tuple[int, int]]], render_mode="rgb_array"):
        """
        ...
        self.dag = DAG(input_data, grid_mapping)
    ...
    def _create_env(self, src_node, dest_node, edge):
        ...
        task_env = modify_env_reward(base_env, src_node, dest_node)
