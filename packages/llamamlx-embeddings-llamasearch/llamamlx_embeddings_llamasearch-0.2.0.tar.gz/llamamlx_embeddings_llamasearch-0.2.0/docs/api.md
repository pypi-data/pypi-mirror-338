...
## llamamlx-embeddings API

### Class: Client

The main client interface for interacting with the llamamlx-embeddings library.
...
def process(self, query, options=None):
    """
    Process a query using the llamamlx-embeddings engine.
