# CDKTF prebuilt bindings for hashicorp/aws provider version 5.94.1

This repo builds and publishes the [Terraform aws provider](https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform aws provider](https://registry.terraform.io/providers/hashicorp/aws/5.94.1)
