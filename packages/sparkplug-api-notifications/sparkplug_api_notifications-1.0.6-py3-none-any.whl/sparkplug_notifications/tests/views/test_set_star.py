...
from sparkplug_notifications.views.set_star import SetStarView

from ..utils import create_partition_for_today


@patch("sparkplug_notifications.permissions.recipient.test_rule")
class TestSetStarView(TestCase):
    ...
    def test_set_star_view_updates_is_starred_field(self, mock_test_rule):
        # Mock test_rule to return True for the recipient
    ...
    def test_set_star_view_fails_for_unauthorized_user(self, mock_test_rule):
        # Mock test_rule to return False for unauthorized user
    ...
    def test_set_star_view_fails_for_invalid_data(self, mock_test_rule):
        # Mock test_rule to return True for the recipient
        mock_test_rule.return_value = True
