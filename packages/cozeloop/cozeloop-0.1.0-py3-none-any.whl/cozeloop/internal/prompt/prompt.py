...
from cozeloop.attribute.trace.span_key import PROMPT_KEY, INPUT, PROMPT_VERSION
from cozeloop.attribute.trace.span_value import V_SCENE_PROMPT_TEMPLATE, V_SCENE_PROMPT_HUB
