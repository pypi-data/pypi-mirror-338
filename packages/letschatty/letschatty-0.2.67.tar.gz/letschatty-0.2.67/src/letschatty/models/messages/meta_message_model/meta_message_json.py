...
class MetaMessageJson(BaseMetaNotificationJson):
    ...
    def get_message_content(self) -> MetaTextContent | MetaImageContent | MetaStickerContent | MetaAudioContent | MetaVideoContent | MetaDocumentContent | MetaContactContent | MetaSystemContent | MetaLocationContent | MetaButtonContent:
