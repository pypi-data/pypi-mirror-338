...
MetaContent = Union[MetaTextContent, MetaImageContent, MetaAudioContent, MetaVideoContent, MetaDocumentContent, MetaStickerContent, MetaLocationContent, MetaContactContent, MetaSystemContent, MetaInteractiveContent, MetaButtonContent, MetaOrderContent]