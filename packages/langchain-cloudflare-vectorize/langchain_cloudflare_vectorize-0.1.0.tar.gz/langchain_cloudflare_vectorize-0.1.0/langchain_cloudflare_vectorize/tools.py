...
class CloudflareVectorizeToolInput(BaseModel):
    """Input schema for CloudflareVectorize tool.
...
class CloudflareVectorizeTool(BaseTool):  # type: ignore[override]
    """CloudflareVectorize tool.
    ...
    args_schema: Type[BaseModel] = CloudflareVectorizeToolInput
