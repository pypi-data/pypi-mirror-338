"""CloudflareVectorize chat models."""
...
class ChatCloudflareVectorize(BaseChatModel):
    ...
    """CloudflareVectorize chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-cloudflare-vectorize`` and set environment variable ``CLOUDFLAREVECTORIZE_API_KEY``.

        .. code-block:: bash

            pip install -U langchain-cloudflare-vectorize
            export CLOUDFLAREVECTORIZE_API_KEY="your-api-key"

    # TODO: Populate with relevant params.
    Key init args — completion params:
        model: str
            Name of CloudflareVectorize model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            CloudflareVectorize API key. If not passed in will be read from env var CLOUDFLAREVECTORIZE_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatCloudflareVectorize.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatCloudflareVectorize.with_structured_output()`` for more.
    ...
    def _llm_type(self) -> str:
        ...
        return "chat-cloudflare-vectorize"
    ...
    # TODO: Implement if ChatCloudflareVectorize supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatCloudflareVectorize supports async generation. Otherwise delete.
