"""CloudflareVectorize document loader."""
...
class CloudflareVectorizeLoader(BaseLoader):
    ...
    """
    CloudflareVectorize document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import CloudflareVectorizeLoader

            loader = CloudflareVectorizeLoader(
                # required params = ...
                # other params = ...
            )
