...
class RecordingArgs:
    ...
    def __init__(self, height: int = 1920, width: int = 1080, fps: float = 30, bitrate: int = 5000000, vflip: int = 0, hflip: int = 0, encoding: str = '', segmentLengthSeconds: float = 0, audio: int = 0, rotationDegrees: int = 0, h264_i_qp: int = 20, h264_p_qp: int = 23, h264_b_qp: int = 25, **kwargs):
        self.height = height
        self.width = width
        self.fps = fps
        self.bitrate = bitrate
