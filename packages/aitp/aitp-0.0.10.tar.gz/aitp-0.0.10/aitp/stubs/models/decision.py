...
class Decision(BaseModel):
    ...
    decision: DecisionDecision = Field(...)
    additional_properties: Dict[str, Any] = {}
    __properties = ["$schema", "decision"]
    ...
    def from_dict(cls, obj: dict) -> Decision:
        ...
        _obj = Decision.parse_obj({
            ...
            "decision": DecisionDecision.from_dict(obj.get("decision")) if obj.get("decision") is not None else None
        })
