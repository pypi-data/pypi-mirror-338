...
class ParkingUtils:
    ...
    #image resize function for handling the image uploads to s3 from admin interface
    ...
    def subscribe_user(self, email):
        #sends notification to users to subscribe sns arn while they sign up for first time
        try:
            # Validate TopicArn
            ...
            #If user is not subscribed to sns, it creates a new subscription
            ...
            return None
    #its only sends for particular user notifications for parking app operations
    ...
    def notify_user(self, email, subject, message):
        ...
        try:
            ...
            return "error"
    #logs all the  applications metadata tp cloudwatch
