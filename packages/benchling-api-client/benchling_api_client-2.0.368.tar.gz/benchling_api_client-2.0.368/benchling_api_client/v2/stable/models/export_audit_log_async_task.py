...
from ..models.export_audit_log_async_task_response import ExportAuditLogAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExportAuditLogAsyncTask")


@attr.s(auto_attribs=True, repr=False)
class ExportAuditLogAsyncTask:
    """  """

    _status: AsyncTaskStatus
    _response: Union[Unset, ExportAuditLogAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "ExportAuditLogAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_response() -> Union[Unset, ExportAuditLogAsyncTaskResponse]:
            response: Union[Unset, Union[Unset, ExportAuditLogAsyncTaskResponse]] = UNSET
            _response = d.pop("response")

            if not isinstance(_response, Unset):
                response = ExportAuditLogAsyncTaskResponse.from_dict(_response)
        ...
        try:
            ...
            if strict:
                raise
            response = cast(Union[Unset, ExportAuditLogAsyncTaskResponse], UNSET)
        ...
        export_audit_log_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        export_audit_log_async_task.additional_properties = d
        return export_audit_log_async_task
    ...
    @property
    def response(self) -> ExportAuditLogAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: ExportAuditLogAsyncTaskResponse) -> None:
