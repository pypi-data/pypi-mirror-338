...
T = TypeVar("T", bound="AutofillTranscriptionsAsyncTask")


@attr.s(auto_attribs=True, repr=False)
class AutofillTranscriptionsAsyncTask:
    """  """
    ...
    def __repr__(self):
        ...
        return "AutofillTranscriptionsAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        autofill_transcriptions_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        autofill_transcriptions_async_task.additional_properties = d
        return autofill_transcriptions_async_task
