...
def get_document_segmentation_details_url(document_id: int, project_id: int, host: str = None, action='segmentation') -> str:
    """
...
def get_category_url(category_id: int, host: str = None) -> str:
    """
    Get a URL to access a Category.

    :param category_id: ID of a requested Category.
    :param host: Konfuzio host
    :returns: URL to request a Category.
    """
    if host is None:
        host = KONFUZIO_HOST
    return f'{host}/api/v3/categories/{category_id}/'
