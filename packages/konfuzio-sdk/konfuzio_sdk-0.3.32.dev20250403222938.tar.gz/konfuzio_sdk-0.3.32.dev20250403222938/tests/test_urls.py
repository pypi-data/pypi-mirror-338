...
class TestUrls(unittest.TestCase):
    ...
    def test_get_document_segmentation_details_url(self):
        ...
        document_segmentation_details_url = f'{KONFUZIO_HOST}/api/projects/{TEST_PROJECT_ID}/docs/{DOCUMENT_ID}/segmentation/'
        self.assertEqual(get_document_segmentation_details_url(DOCUMENT_ID, TEST_PROJECT_ID), document_segmentation_details_url)
    ...
    def test_page_image_url(self):
        ...
        self.assertEqual(get_page_image_url(page_url='/page/show-image/1923/'), f'{KONFUZIO_HOST}/page/show-image/1923/')

    def test_upload_ai_url(self):
        """Test to get URL to upload new AI file."""
        self.assertEqual(get_create_ai_model_url(ai_type='extraction'), f'{KONFUZIO_HOST}/api/v3/extraction-ais/upload/')
        self.assertEqual(get_create_ai_model_url(ai_type='categorization'), f'{KONFUZIO_HOST}/api/v3/category-ais/upload/')
        self.assertEqual(get_create_ai_model_url(ai_type='filesplitting'), f'{KONFUZIO_HOST}/api/v3/splitting-ais/upload/')
    ...
    def test_restored_snapshot_url(self):
        ...
        self.assertEqual(get_restored_snapshot_url(restored_snapshot_id=1), f'{KONFUZIO_HOST}/api/v3/snapshotrestores/1/')

    def test_category_url(self):
        """Test to get an URL to access a Category."""
        self.assertEqual(get_category_url(category_id=1), f'{KONFUZIO_HOST}/api/v3/categories/1/')
