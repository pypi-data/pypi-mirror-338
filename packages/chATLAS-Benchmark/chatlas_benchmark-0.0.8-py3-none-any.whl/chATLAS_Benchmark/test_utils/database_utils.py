        ...
        for test, scoring in scores.items():
            if test == "LexicalMetrics":
                ...
                answerCorrect_run = answerCorrectScores(
                    ...
                    answerCorrect_score_by_question=scoring[
                        "answerCorrect_score_by_question"
                    ].to_json(),
                )
...
def fetch_metrics_results(db_name: Union[str, Path] = "benchmark.db") -> pd.DataFrame:
    ...
    try:
        ...
        for table in available_tables:
            ...
            for col in available_tables[table]:
