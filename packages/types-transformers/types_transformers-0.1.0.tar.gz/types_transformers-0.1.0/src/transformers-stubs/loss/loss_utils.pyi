...
def ForCausalLMLoss(logits, labels, vocab_size: int, num_items_in_batch: int = ..., ignore_index: int = ..., shift_labels=..., **kwargs): # -> Tensor:
    ...

def ForMaskedLMLoss(logits, labels, vocab_size: int, num_items_in_batch: int = ..., ignore_index: int = ..., **kwargs): # -> Tensor:
    ...
