...
from fwrap.config import load_config, GLOBAL_CONFIG_PATH, create_default_global_config
from fwrap.interface_manager import InterfaceManager
from fwrap.script_parser import ScriptParser
...
def safe(ctx: click.Context, script: str, account: str, password: str, 
    ...
    try:
        ...
        from fwrap.safe import fwrap_safe_command
        ...
        console.print("\nTo use fwrap with uvx:")
        console.print("    uvx fwrap [command] [options]")
        console.print("\nOr install with safe dependencies:")
        console.print("    pip install 'fwrap[safe]'")
        console.print(f"\nError details: {str(e)}")
        sys.exit(1)
