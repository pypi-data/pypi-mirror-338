...
transmittance, absorbance, E, H, V, txt = calculate_component_absorbance_and_transmittance(
    ...
    dens='?',
    roughness=0.0,
    flags=6,  # 0=Filter 1=Mirror 2=Aperture 3=magnifier, 4=Screen rotation  5=Thin object  6=Multilayer 7=External file
    hgap=1000.0,
    vgap=1000.0,
    hgapcenter=0.0,
    vgapcenter=0.0,
    ...
    thin_object_back_profile_flag=0,
    thin_object_back_profile_file='',
    multilayer_file='/users/srio/Oasys/multilayerTiC.h5',
    external_reflectivity_file='',
)
