...
class ApiHTTPAdapter(HTTPAdapter):
    def init_poolmanager(self, *args, **kwargs):
        """ Armo un contexto especial especificando ciphers para prevenir errores de dh key too small """
        kwargs["ssl_context"] = create_urllib3_context(ciphers="DEFAULT:!DH")
...
class WsfexInvoiceDetails(object):
    ...
    def _serialize_item(self, item):
        return self._get_item()(
            ...
            Pro_bonificacion=round(item.bonification, 2)
        )
    ...
    def _get_associated_document_array(self):
        return ApiClient(self.wsfex.url).get_type('ns0:ArrayOfCmp_asoc')

    def _get_document_request(self):
        return ApiClient(self.wsfex.url).type_factory('ns0').ClsFEXRequest()

    def _get_item_array(self):
        return ApiClient(self.wsfex.url).get_type('ns0:ArrayOfItem')

    def _get_item(self):
        return ApiClient(self.wsfex.url).get_type('ns0:Item')

    def _get_associated_document(self):
        return ApiClient(self.wsfex.url).get_type('ns0:Cmp_asoc')
...
class Wsfex(object):
    ...
    def get_cae(self, invoices, pos):
        ...
        for invoice in invoices:
            ...
            response = ApiClient(self.url).service.FEXAuthorize(self.auth_request, request)
    ...
    def check_webservice_status(self):
        ...
        res = ApiClient(self.url).service.FEXDummy()
        if res.AppServer != 'OK':
    ...
    def get_last_number(self, pos_number, document_type_number):
        ...
        request = ApiClient(self.url).service.FEXGetLast_CMP(last_document_req)
    ...
    def get_last_id(self):
        ...
        request = ApiClient(self.url).service.FEXGetLast_ID(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_exportation_types(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_Tipo_Expo(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_measurement_units(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_UMed(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_point_of_sales(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_PtoVenta(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_currencies(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_MON(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_incoterms(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_Incoterms(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_languages(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_Idiomas(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_countries(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_DST_pais(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_countries_cuit(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_DST_CUIT(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_currency_value(self, currency):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_Ctz(self.auth_request, currency)
        self._check_for_errors(request)
    ...
    def get_document_codes(self):
        ...
        request = ApiClient(self.url).service.FEXGetPARAM_Cbte_Tipo(self.auth_request)
        self._check_for_errors(request)
    ...
    def _set_last_document(self, pos_number, document_type_number):
        ClsFEX_LastCMP = ApiClient(self.url).get_type('ns0:ClsFEX_LastCMP')
    ...
    def _create_auth_request(self):
        ...
        ClsFEXAuthRequest = ApiClient(self.url).get_type('ns0:ClsFEXAuthRequest')
    ...
    def retrieve_cae(self, document_type_number, inv_number, pos_number):
        ...
        """
        Cmp = ApiClient(self.url).get_type('ns0:ClsFEXGetCMP')
        _Cmp = Cmp(
            Cbte_tipo=document_type_number,
            Cbte_nro=inv_number,
        ...
        cae_details = ApiClient(self.url).service.FEXGetCMP(
        ...
        req = helpers.serialize_object(_Cmp)
        return res, req
