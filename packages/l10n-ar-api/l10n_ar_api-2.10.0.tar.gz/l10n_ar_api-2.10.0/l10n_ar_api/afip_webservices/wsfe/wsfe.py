...
class Wsfe(object):
    ...
    def check_webservice_status(self):
        ...
        res = ApiClient(self.url).service.FEDummy()
    ...
    def get_cae(self, invoices, pos):
        ...
        return ApiClient(self.url).service.FECAESolicitar(
    ...
    def get_cotization(self, currency):
        ...
        """
        cotiz_response = ApiClient(self.url).service.FEParamGetCotizacion(
            Auth=self.auth_request,
            MonId=currency,
        )
    ...
    def get_last_number(self, pos_number, document_type_number):
        ...
        last_number_response = ApiClient(self.url).service.FECompUltimoAutorizado(
            Auth=self.auth_request,
            PtoVta=pos_number,
    ...
    def _get_header(self):
        return ApiClient(self.url).get_type('ns0:FECAECabRequest')

    def _get_cae_request(self):
        return ApiClient(self.url).get_type('ns0:FECAERequest')

    def _get_array_cae_request(self):
        return ApiClient(self.url).get_type('ns0:ArrayOfFECAEDetRequest')
    ...
    def _set_FECAERequest(self, invoices, pos):
        ...
        for invoice in invoices:
            details.append(WsfeInvoiceDetails(ApiClient(self.url), invoice, last_invoice).get_details())
            last_invoice += 1
    ...
    def _create_auth_request(self):
        ...
        FEAuthRequest = ApiClient(self.url).get_type('ns0:FEAuthRequest')
    ...
    def retrieve_cae(self, document_type_number, inv_number, pos_number):
        ...
        """
        FeCompConsReq = ApiClient(self.url).get_type('ns0:FECompConsultaReq')
        ...
        cae_details = ApiClient(self.url).service.FECompConsultar(
            Auth=self.auth_request,
