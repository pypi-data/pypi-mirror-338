...
class WsbfeInvoiceDetails(object):
    ...
    def _get_document_request(self):
        return ApiClient(self.wsbfe.url).type_factory('ns0').ClsBFERequest()

    def _get_item_array(self):
        return ApiClient(self.wsbfe.url).get_type('ns0:ArrayOfItem')

    def _get_item(self):
        return ApiClient(self.wsbfe.url).get_type('ns0:Item')
    
    def _get_associated_document_array(self):
        return ApiClient(self.wsbfe.url).get_type('ns0:ArrayOfCbteAsoc')

    def _get_optional_array(self):
        return ApiClient(self.wsbfe.url).get_type('ns0:ArrayOfOpcional')

    def _get_associated_document(self):
        return ApiClient(self.wsbfe.url).get_type('ns0:CbteAsoc')

    def _get_optional(self):
        return ApiClient(self.wsbfe.url).get_type('ns0:Opcional')
...
class Wsbfe(object):
    ...
    def get_cae(self, invoices, pos):
        ...
        for invoice in invoices:
            ...
            response = ApiClient(self.url).service.BFEAuthorize(self.auth_request, request)
    ...
    def check_webservice_status(self):
        ...
        res = ApiClient(self.url).service.BFEDummy()
        if res.AppServer != 'OK':
    ...
    def get_last_number(self, pos_number, document_code):
        ...
        request = ApiClient(self.url).service.BFEGetLast_CMP(last_document_req)
    ...
    def get_last_id(self):
        ...
        request = ApiClient(self.url).service.BFEGetLast_ID(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_measurement_units(self):
        ...
        request = ApiClient(self.url).service.BFEGetPARAM_UMed(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_currencies(self):
        ...
        request = ApiClient(self.url).service.BFEGetPARAM_MON(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_document_codes(self):
        ...
        request = ApiClient(self.url).service.BFEGetPARAM_Tipo_Cbte(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_product_types_ncm(self):
        ...
        request = ApiClient(self.url).service.BFEGetPARAM_NCM(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_zones_codes(self):
        ...
        request = ApiClient(self.url).service.BFEGetPARAM_Zonas(self.auth_request)
        self._check_for_errors(request)
    ...
    def get_iva_types(self):
        ...
        request = ApiClient(self.url).service.BFEGetPARAM_Tipo_IVA(self.auth_request)
        self._check_for_errors(request)
    ...
    def _set_last_document(self, pos_number, document_code):
        ClsBFE_LastCMP = ApiClient(self.url).get_type('ns0:ClsBFE_LastCMP')
    ...
    def _create_auth_request(self):
        ...
        ClsBFEAuthRequest = ApiClient(self.url).get_type('ns0:ClsBFEAuthRequest')
    ...
    def retrieve_cae(self, document_type_number, inv_number, pos_number):
        ...
        _Cmp = Cmp(
            Tipo_cbte=document_type_number,
            Cbte_nro=inv_number,
            Punto_vta=pos_number
        )

        cae_details = ApiClient(self.url).service.BFEGetCMP(
