...
class EvolutionaryStructureExplorer:
    ...
    def __init__(self, params:dict=None, dataset_path:str=None, template_path:str=None, output_path:str=None, debug=False):
        ...
        self.DoE = None
        self.BO = None
        #self.foreigners_generation_funcs = None
    ...
    def generate_new_compositions(self, 
        ...
        if generation == 1:
            ...
            self.BO.fit(features, objectives) # bounds=bounds, n_candidates=3, strategy="ei"
            design_points = self.BO.recommend_candidates( n_candidates=foreigners )
            dp_name = 'BO'
        ...
        for generation in range(1, self._max_generations):
            ...
            if self.partitions['dataset'].size > self.min_size_for_filter:
                selected_indices = select_multiobjective_iterative(
                                    ...
                                    temperature=self.multiobjective_params['temperature'],
            ...
            t0 = time.time()
            mutated_structures, crossed_structures, mutation_rate_array = self.mutation_crossover_handler.apply_mutation_and_crossover(top_structures, generation, objectives)
