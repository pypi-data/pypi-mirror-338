...
def validate_evolution_parameters(params: dict = None) -> dict:
    ...
    params : dict, optional
        Dictionary containing parameter overrides. Expected keys and their default values are:
            ...
            - 'mutation_rate_params' (dict): Dictionary with keys:
                * 'period' (int): Default is 40.
                * 'decay_rate' (float): Default is 0.1.
                * 'temperature' (float): Default is 1.0.
            ...
            - 'objective_funcs', 'features_funcs', 'mutation_funcs', 'crossover_funcs',
              'DoE', 'physical_model_func': Workflow functions; default is None.
    ...
    for key in ['max_generations', 'min_size_for_filter', 'collision_factor', 
                'md_params', 'foreigners', 'dataset_path', 'template_path', 'output_path',
                'objective_funcs', 'features_funcs', 'mutation_funcs', 'crossover_funcs',
                'DoE', 'BO','physical_model_func', 'supercell_steps']:
        if key in params:
