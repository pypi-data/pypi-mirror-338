...
class Features:
    ...
    def schema_metadata(self):
        """Metadata on schema items is available from 2025.04.002.

        TODO: When that version goes live, we should scrap this feature flag.
        """
        return self._unicat.api_version >= "2025.04.002"
...
def serialize_metadata(metadata):
    ...
    for name, metadata_field in metadata.items():
        print(
            name, type(metadata_field), isinstance(metadata_field, UnicatMetadataField)
        )
