...
import random
from Techv_ai.client import techvai_client
...
def initialize_router(api_key: str):
    ...
    print(f"[DEBUG] Loaded Model Config: {models.keys()}")  
    if not models:
        raise ValueError("No models loaded! Check FILE_PATH in .env")
    return query_router(api_key=api_key, models=models)

# def test_query_router():
#     api_key = os.getenv("API_KEY")
#     router = initialize_router(api_key)

#     # Test query complexity scoring
#     test_question = "What is the capital of France?"
#     # complexity_scores = router.complexity_scorer.get_scores(test_question)
#     # print("Complexity Scores:", complexity_scores)

#     # # Test model selection
#     # allowed_categories = ["simple", "moderate", "complex"]
#     # selected_model = router.select_best_model(complexity_scores, allowed_categories)
#     # print("Selected Model:", selected_model)

#     # Test query routing
#     response = router.route_query(test_question)
