...
def main(argv):
    if len(argv) >= 2 and argv[1] in ('gen', 'clean'):
        ...
        setup(
            ...
            url='https://github.com/orShadxw/Fastgram',
            download_url='https://github.com/orShadxw/Fastgram/releases',
            ...
            install_requires=['orjson', 'aiohttp', 'pyaes', 'rsa'],
            extras_require={
                'cryptg': ['cryptg'],
                'uvloop': ['uvloop'],
                'orjson': ['orjson'],
                'auofiles': ['aiofiles'],
                'fastest': ['uvloop', 'orjson', 'aiofiles', 'cryptg']
            }
        )
