"""Textual TUI application for DocBuddy."""
...
from docbuddy.config import get_config, get_default_model
from docbuddy.main import ask_question, preview_matches, get_kb_info
from docbuddy.core import build_knowledge_base
...
class PreviewScreen(Screen):
    ...
    def on_mount(self) -> None:
        """Called when the screen is mounted."""
        self.title = "DocBuddy - Preview Matches"
...
class KBInfoScreen(Screen):
    ...
    def on_mount(self) -> None:
        """Called when the screen is mounted."""
        self.title = "DocBuddy - Knowledge Base Info"
        self.update_kb_info()
...
class DocBuddyApp(App):
    """DocBuddy TUI application."""
    ...
    def on_mount(self) -> None:
        ...
        self.title = "DocBuddy - Document Assistant"
