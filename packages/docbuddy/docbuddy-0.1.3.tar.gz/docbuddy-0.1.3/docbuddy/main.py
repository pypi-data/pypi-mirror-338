"""Main module for DocBuddy API."""

from docbuddy.core import process_query, get_matching_documents, kb_info
from docbuddy.config import get_default_model, get_prompt_template

def ask_question(question: str, model: str = None, template_name: str = None) -> str:
    """Ask a question using DocBuddy.
