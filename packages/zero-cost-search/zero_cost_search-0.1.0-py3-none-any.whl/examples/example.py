...
from zero_cost_search import ZeroCostNAS, setup_logger, plot_search_results
...
def main():
    ...
    print(f"Predicted architecture using meta-learning (took {prediction_time:.2f} seconds):")
