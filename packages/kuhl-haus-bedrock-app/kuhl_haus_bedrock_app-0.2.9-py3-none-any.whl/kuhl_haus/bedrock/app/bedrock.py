...
from kuhl_haus.bedrock.app.factories.aws_client_factory import get_client_for_service
...
bedrock_runtime = get_client_for_service(service_name="bedrock-runtime", config=config)
bedrock_client = get_client_for_service(service_name='bedrock', config=config)
