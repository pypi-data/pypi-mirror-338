...
class TestSimpleDao(unittest.TestCase):
    ...
    def test_list(self):
        result = TestDao().query_batch_beans(Test, Where("`id` = 99669"))
        for row in result:
            print(row)

    def test_list_maps(self):
        result = TestDao().query_batch_maps(Where("`id` = 99669"))
        for row in result:
            print(row)

    def test_list_all(self):
        result = TestDao().query_batch_all_beans(Test)
        for row in result:
            print(row)

    def test_list_all_maps(self):
        result = TestDao().query_batch_all_maps()
        for row in result:
            print(row)
