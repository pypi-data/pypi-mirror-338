...
class BatchMaintenanceWindow(NextGenWindow):
    ...
    def update_batch_desc(self, text: str) -> None:
        ...
        with contextlib.suppress(_ctypes.COMError):
            self.window.child_window(auto_id="txtDesc").set_text(text)
    ...
    def update_default_date(self, date_to_update: str) -> None:
        ...
        """
        with contextlib.suppress(_ctypes.COMError):
            self.window.child_window(auto_id="txtDefDate").child_window(auto_id="mtxtDate").set_text(date_to_update)
    ...
    def update_process_date(self, date_to_update: str) -> None:
        ...
        """
        with contextlib.suppress(_ctypes.COMError):
            self.window.child_window(auto_id="txtProcessDate").child_window(auto_id="mtxtDate").set_text(date_to_update)
    ...
    def update_total_adjustment(self, total_adjustment: str) -> None:
        ...
        with contextlib.suppress(_ctypes.COMError):
            self.window.child_window(auto_id="txtTotAdjusted").set_text(total_adjustment)
