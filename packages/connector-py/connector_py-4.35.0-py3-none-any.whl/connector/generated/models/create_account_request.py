...
from connector.generated.models.create_account import CreateAccount
...
class CreateAccountRequest(BaseModel):
    ...
    request: CreateAccount = Field(description="The main request payload.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": CreateAccount.from_dict(obj["request"]) if obj.get("request") is not None else None,
