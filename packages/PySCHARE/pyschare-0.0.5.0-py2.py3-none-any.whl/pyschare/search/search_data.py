...
from pyschare.helpers.constants import search_helper_text, MAIN_TITLE, FPATH, DICTPATH
...
from pyschare.helpers.data_functions import get_data_dir, get_search_table_info
...
class Search:
    def __init__(self):
        ...
        self.search_button = create_button(text='Search', box_name='search', style={**button_style, 'button_color': 'blue'})
        self.save_button = create_button(text='Save Table', box_name='save', style={**button_style, 'button_color': 'green'})
        self.clear_button = create_button(text='Clear Table', box_name='clear', style={**button_style, 'button_color': 'red'})
