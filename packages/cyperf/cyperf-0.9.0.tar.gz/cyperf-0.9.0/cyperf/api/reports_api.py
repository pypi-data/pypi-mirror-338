...
class ReportsApi:
    ...
    def download_pdf(
        ...
        :type result_id: str
        :param pdf_id: The ID of the download PDF operation. (required)
        :type pdf_id: int
    ...
    def _download_pdf_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/results/{resultId}/download-pdf/{pdfId}',
    ...
    def _poll_results_generate_csv_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/results/{resultId}/operations/generate-csv/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def start_results_generate_csv(
        ...
        :param result_id: The ID of the result. (required)
        :type result_id: str
        :param generate_csv_reports_operation:
        :type generate_csv_reports_operation: GenerateCSVReportsOperation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _start_results_generate_csv_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if generate_csv_reports_operation is not None:
            _body_params = generate_csv_reports_operation
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/results/{resultId}/operations/generate-csv',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def start_results_generate_pdf(
        ...
        :param result_id: The ID of the result. (required)
        :type result_id: str
        :param generate_pdf_report_operation:
        :type generate_pdf_report_operation: GeneratePDFReportOperation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _start_results_generate_pdf_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if generate_pdf_report_operation is not None:
            _body_params = generate_pdf_report_operation
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/results/{resultId}/operations/generate-pdf',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
