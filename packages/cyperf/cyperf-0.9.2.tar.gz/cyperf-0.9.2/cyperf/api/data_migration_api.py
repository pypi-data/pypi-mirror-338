...
class DataMigrationApi:
    ...
    def _poll_export_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/controller-migration/operations/export/{id}',
    ...
    def start_export(
        ...
        :param export_package_operation:
        :type export_package_operation: ExportPackageOperation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _start_export_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if export_package_operation is not None:
            _body_params = export_package_operation
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/controller-migration/operations/export',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _start_import_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/controller-migration/operations/import',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
