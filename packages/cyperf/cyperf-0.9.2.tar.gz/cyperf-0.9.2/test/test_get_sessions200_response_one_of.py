...
class TestGetSessions200ResponseOneOf(unittest.TestCase):
    """GetSessions200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSessions200ResponseOneOf:
        """Test GetSessions200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSessions200ResponseOneOf`
        """
        model = GetSessions200ResponseOneOf()
        if include_optional:
            return GetSessions200ResponseOneOf(
                data = [
