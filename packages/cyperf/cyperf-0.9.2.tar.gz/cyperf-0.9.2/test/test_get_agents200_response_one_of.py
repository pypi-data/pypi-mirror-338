...
class TestGetAgents200ResponseOneOf(unittest.TestCase):
    """GetAgents200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAgents200ResponseOneOf:
        """Test GetAgents200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAgents200ResponseOneOf`
        """
        model = GetAgents200ResponseOneOf()
        if include_optional:
            return GetAgents200ResponseOneOf(
                data = [
    ...
    def testGetAgents200ResponseOneOf(self):
        """Test GetAgents200ResponseOneOf"""
