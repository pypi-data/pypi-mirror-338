...
async def _add_collection_run_time_actions(request: web.Request, sub: str) -> PermissionContext:
    ...
    if collection_map.get(CredentialsView.get_type_name()):
        add_run_time_action(request, name='heaserver-people-person-get-credential-collection', rel='hea-system-menu-item application/x.collection', path='collections/heaobject.keychain.CredentialsView')
