...
client_with_default_decorators_from_yaml = FitClass.from_yaml(yaml_path)()
client_with_default_decorators_from_json = FitClass.from_json(json_path)()

yaml_path = Path(__file__).parent / 'config_complex.yaml'
json_path = Path(__file__).parent / 'config_complex.json'
client_complex_from_yaml = FitClass.from_yaml(yaml_path)()
client_complex_from_json = FitClass.from_json(json_path)()
