...
from .utils import dict_to_html_table, merge_logs, reorder_dict
...
def setup_parser():
    ...
    parser.add_argument("-rc", "--remove-obs-comp", action="store_true", help="Remove the observation compatibility checks.")
