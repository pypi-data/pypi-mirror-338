...
class PyBridge(object):
    ...
    def LoadMearecOnPybridge(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/allego.PyBridge/LoadMearecOnPybridge',
            pybridge__pb2.PyBridgeFileOpenRequest.SerializeToString,
    ...
    def SpikesSendMearecHDF5(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/allego.PyBridge/SpikesSendMearecHDF5',
    ...
    def SpikesCloseMearecHDF5(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/allego.PyBridge/SpikesCloseMearecHDF5',
            common__pb2.StandardRequest.SerializeToString,
            common__pb2.StandardReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetMearecTemplate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/allego.PyBridge/GetMearecTemplate',
    ...
    def GetMearecWaveforms(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/allego.PyBridge/GetMearecWaveforms',
    ...
    def GetMearecSignals(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/allego.PyBridge/GetMearecSignals',
