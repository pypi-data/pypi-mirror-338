/*! For license information please see 9375.27c97f3baf902aa8.js.LICENSE.txt */
export const __webpack_ids__=["9375"];export const __webpack_modules__={43685:function(t,e,i){var s=i(44249),n=i(72621),o=i(57243),a=i(9065),r=i(50778),h=i(92444),d=i(76688);let l=class extends h.A{};l.styles=[d.W],l=(0,a.__decorate)([(0,r.Mo)("mwc-checkbox")],l);var c=i(35359),m=i(65703);class p extends m.K{constructor(){super(...arguments),this.left=!1,this.graphic="control"}render(){const t={"mdc-deprecated-list-item__graphic":this.left,"mdc-deprecated-list-item__meta":!this.left},e=this.renderText(),i=this.graphic&&"control"!==this.graphic&&!this.left?this.renderGraphic():o.dy``,s=this.hasMeta&&this.left?this.renderMeta():o.dy``,n=this.renderRipple();return o.dy`
      ${n}
      ${i}
      ${this.left?"":e}
      <span class=${(0,c.$)(t)}>
      ...
      ${this.left?e:""}
      ${s}`}async onChange(t){const e=t.target;this.selected===e.checked||(this._skipPropRequest=!0,this.selected=e.checked,await this.updateComplete,this._skipPropRequest=!1)}}(0,a.__decorate)([(0,r.IO)("slot")],p.prototype,"slotElement",void 0),(0,a.__decorate)([(0,r.IO)("mwc-checkbox")],p.prototype,"checkboxElement",void 0),(0,a.__decorate)([(0,r.Cb)({type:Boolean})],p.prototype,"left",void 0),(0,a.__decorate)([(0,r.Cb)({type:String,reflect:!0})],p.prototype,"graphic",void 0);const u=o.iv`:host(:not([twoline])){height:56px}:host(:not([left])) .mdc-deprecated-list-item__meta{height:40px;width:40px}`;var g=i(46289),f=i(11297);(0,s.Z)([(0,r.Mo)("ha-check-list-item")],(function(t,e){class i extends e{constructor(...e){super(...e),t(this)}}return{F:i,d:[{kind:"method",key:"onChange",value:async function(t){(0,n.Z)(i,"onChange",this,3)([t]),(0,f.B)(this,t.type)}},{kind:"field",static:!0,key:"styles",value(){return[g.W,u,o.iv`
      :host {
    ...
    `]}}]}}),p)},77182:function(t,e,i){var s=i(44249),n=i(57243),o=i(50778);i(10508);(0,s.Z)([(0,o.Mo)("ha-tip")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"method",key:"render",value:function(){return this.hass?n.dy`
  ...
  `}}]}}),n.oi)},12206:function(t,e,i){i.a(t,(async function(t,s){try{i.r(e);var n=i(44249),o=i(15108),a=(i(2060),i(87319),i(57243)),r=i(50778),h=i(91583),d=i(11297),l=i(45294),c=i(98773),m=i(42883),p=i(18727),u=i(4557),g=i(66193),f=(i(20095),i(43685),i(19537)),_=(i(44118),i(28906),i(10508),i(77182),i(80359)),v=i(18875),y=i(49672),b=t([f,_,v]);[f,_,v]=b.then?(await b)():b;const k="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",w="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";(0,n.Z)([(0,r.Mo)("dialog-media-manage")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[(0,r.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,r.SB)()],key:"_currentItem",value:void 0},{kind:"field",decorators:[(0,r.SB)()],key:"_params",value:void 0},{kind:"field",decorators:[(0,r.SB)()],key:"_uploading",value(){return!1}},{kind:"field",decorators:[(0,r.SB)()],key:"_deleting",value(){return!1}},{kind:"field",decorators:[(0,r.SB)()],key:"_selected",value(){return new Set}},{kind:"field",key:"_filesChanged",value(){return!1}},{kind:"method",key:"showDialog",value:function(t){this._params=t,this._refreshMedia()}},{kind:"method",key:"closeDialog",value:function(){this._filesChanged&&this._params.onClose&&this._params.onClose(),this._params=void 0,this._currentItem=void 0,this._uploading=!1,this._deleting=!1,this._filesChanged=!1,(0,d.B)(this,"dialog-closed",{dialog:this.localName})}},{kind:"method",key:"render",value:function(){if(!this._params)return a.Ld;const t=this._currentItem?.children?.filter((t=>!t.can_expand))||[];let e=0;return a.dy`
      <ha-dialog
        open
        scrimClickAction
        escapeKeyAction
      ...
      >
          ...
          ${0===this._selected.size?a.dy`
              ...
              `:a.dy`
                ...
                ${this._deleting?"":a.dy`
                      <ha-button
                        slot="actionItems"
                        .label=${this.hass.localize("ui.components.media-browser.file_management.deselect_all")}
        ...
        ${this._currentItem?t.length?a.dy`
                <mwc-list multi @selected=${this._handleSelected}>
                  ${(0,h.r)(t,(t=>t.media_content_id),(t=>{const i=a.dy`
                        <ha-svg-icon
                          slot="graphic"
                          .path=${c.Fn["directory"===t.media_class&&t.children_media_class||t.media_class].icon}
                        ></ha-svg-icon>
                      `;return a.dy`
                        <ha-check-list-item
              ...
              `:a.dy`<div class="no-items">
                <p>
                  ${this.hass.localize("ui.components.media-browser.file_management.no_items")}
                </p>
                ${this._currentItem?.children?.length?a.dy`<span class="folders"
            ...
            `}
        ${(0,y.p)(this.hass,"hassio")?a.dy`<ha-tip .hass=${this.hass}>
              ${this.hass.localize("ui.components.media-browser.file_management.tip_media_storage",{storage:a.dy`<a
                    href="/config/storage"
    ...
    `}},{kind:"method",key:"_handleSelected",value:function(t){this._selected=t.detail.index}},{kind:"method",key:"_startUploading",value:function(){this._uploading=!0,this._filesChanged=!0}},{kind:"method",key:"_doneUploading",value:function(){this._uploading=!1,this._refreshMedia()}},{kind:"method",key:"_handleDeselectAll",value:function(){this._selected.size&&(this._selected=new Set)}},{kind:"method",key:"_handleDelete",value:async function(){if(!(await(0,u.g7)(this,{text:this.hass.localize("ui.components.media-browser.file_management.confirm_delete",{count:this._selected.size}),warning:!0})))return;this._filesChanged=!0,this._deleting=!0;const t=[];let e=0;this._currentItem.children.forEach((i=>{i.can_expand||this._selected.has(e++)&&t.push(i)}));try{await Promise.all(t.map((async t=>{if((0,m.aV)(t.media_content_id))await(0,m.Qr)(this.hass,t.media_content_id);else if((0,m.IB)(t.media_content_id)){const e=(0,p.TT)(t.media_content_id);e&&await(0,p.ao)(this.hass,e)}this._currentItem={...this._currentItem,children:this._currentItem.children.filter((e=>e!==t))}})))}finally{this._deleting=!1,this._selected=new Set}}},{kind:"method",key:"_refreshMedia",value:async function(){this._selected=new Set,this._currentItem=void 0,this._currentItem=await(0,m.b)(this.hass,this._params.currentItem.media_content_id)}},{kind:"get",static:!0,key:"styles",value:function(){return[g.yu,a.iv`
      ...
      `]}}]}}),a.oi);s()}catch(k){s(k)}}))},18875:function(t,e,i){i.a(t,(async function(t,e){try{var s=i(44249),n=(i(31622),i(57243)),o=i(50778),a=i(11297),r=i(42883),h=i(4557),d=i(19537),l=(i(10508),t([d]));d=(l.then?(await l)():l)[0];const c="M9,16V10H5L12,3L19,10H15V16H9M5,20V18H19V20H5Z";(0,s.Z)([(0,o.Mo)("ha-media-upload-button")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"currentItem",value:void 0},{kind:"field",decorators:[(0,o.SB)()],key:"_uploading",value(){return 0}},{kind:"method",key:"render",value:function(){return this.currentItem&&(0,r.aV)(this.currentItem.media_content_id||"")?n.dy`
      <mwc-button
      ...
      >
        ${this._uploading>0?n.dy`
              <ha-spinner
                ...
                slot="icon"
              ></ha-spinner>
            `:n.dy` <ha-svg-icon .path=${c} slot="icon"></ha-svg-icon> `}
      </mwc-button>
    `:n.Ld}},{kind:"method",key:"_startUpload",value:async function(){if(this._uploading>0)return;const t=document.createElement("input");t.type="file",t.accept="audio/*,video/*,image/*",t.multiple=!0,t.addEventListener("change",(async()=>{(0,a.B)(this,"uploading");const e=t.files;document.body.removeChild(t);const i=this.currentItem.media_content_id;for(let t=0;t<e.length;t++){this._uploading=e.length-t;try{await(0,r.oE)(this.hass,i,e[t])}catch(s){(0,h.Ys)(this,{text:this.hass.localize("ui.components.media-browser.file_management.upload_failed",{reason:s.message||s})});break}}this._uploading=0,(0,a.B)(this,"media-refresh")}),{once:!0}),t.style.display="none",document.body.append(t),t.click()}},{kind:"field",static:!0,key:"styles",value(){return n.iv`
    mwc-button {
