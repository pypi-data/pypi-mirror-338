export const __webpack_ids__=["2142"];export const __webpack_modules__={61527:function(t,e,i){i.r(e),i.d(e,{HaMediaSelector:()=>_});var a=i(44249),s=i(57243),o=i(50778),d=i(35359),n=i(11297),l=i(4468),r=i(41946),c=i(98773),m=i(85019),u=(i(17949),i(42877),i(92903));const h=[{name:"media_content_id",required:!1,selector:{text:{}}},{name:"media_content_type",required:!1,selector:{text:{}}}];let _=(0,a.Z)([(0,o.Mo)("ha-selector-media")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"selector",value:void 0},{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"value",value:void 0},{kind:"field",decorators:[(0,o.Cb)()],key:"label",value:void 0},{kind:"field",decorators:[(0,o.Cb)()],key:"helper",value:void 0},{kind:"field",decorators:[(0,o.Cb)({type:Boolean,reflect:!0})],key:"disabled",value(){return!1}},{kind:"field",decorators:[(0,o.Cb)({type:Boolean,reflect:!0})],key:"required",value(){return!0}},{kind:"field",decorators:[(0,o.SB)()],key:"_thumbnailUrl",value:void 0},{kind:"method",key:"willUpdate",value:function(t){if(t.has("value")){const e=this.value?.metadata?.thumbnail,i=t.get("value")?.metadata?.thumbnail;if(e===i)return;e&&e.startsWith("/")?(this._thumbnailUrl=void 0,(0,r.iI)(this.hass,e).then((t=>{this._thumbnailUrl=t.path}))):e&&e.startsWith("https://brands.home-assistant.io")?this._thumbnailUrl=(0,m.X1)({domain:(0,m.u4)(e),type:"icon",useFallback:!0,darkOptimized:this.hass.themes?.darkMode}):this._thumbnailUrl=e}}},{kind:"method",key:"render",value:function(){const t=this.value?.entity_id?this.hass.states[this.value.entity_id]:void 0,e=!this.value?.entity_id||t&&(0,l.e)(t,c.yZ.BROWSE_MEDIA);return s.dy`<ha-entity-picker
        .hass=${this.hass}
      ...
      ${e?s.dy`<ha-card
          ...
          >
            <div
              class="thumbnail ${(0,d.$)({portrait:!!this.value?.metadata?.media_class&&"portrait"===c.Fn[this.value.metadata.children_media_class||this.value.metadata.media_class].thumbnail_ratio})}"
            >
              ${this.value?.metadata?.thumbnail?s.dy`
                    <div
                      class="${(0,d.$)({"centered-image":!!this.value.metadata.media_class&&["app","directory"].includes(this.value.metadata.media_class)})}
                        image"
                  ...
                  `:s.dy`
                    <div class="icon-holder image">
                      <ha-svg-icon
                        class="folder"
                        .path=${this.value?.media_content_id?this.value?.metadata?.media_class?c.Fn["directory"===this.value.metadata.media_class&&this.value.metadata.children_media_class||this.value.metadata.media_class].icon:"M19 3H5C3.89 3 3 3.89 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.89 20.1 3 19 3M10 16V8L15 12":"M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z"}
                      ></ha-svg-icon>
                    </div>
                  `}
            </div>
            ...
            ></ha-form>`}`}},{kind:"field",key:"_computeLabelCallback",value(){return t=>this.hass.localize(`ui.components.selectors.media.${t.name}`)}},{kind:"method",key:"_entityChanged",value:function(t){t.stopPropagation(),(0,n.B)(this,"value-changed",{value:{entity_id:t.detail.value,media_content_id:"",media_content_type:""}})}},{kind:"method",key:"_pickMedia",value:function(){(0,u.B)(this,{action:"pick",entityId:this.value.entity_id,navigateIds:this.value.metadata?.navigateIds,mediaPickedCallback:t=>{(0,n.B)(this,"value-changed",{value:{...this.value,media_content_id:t.item.media_content_id,media_content_type:t.item.media_content_type,metadata:{title:t.item.title,thumbnail:t.item.thumbnail,media_class:t.item.media_class,children_media_class:t.item.children_media_class,navigateIds:t.navigateIds?.map((t=>({media_content_type:t.media_content_type,media_content_id:t.media_content_id})))}}})}})}},{kind:"field",static:!0,key:"styles",value(){return s.iv`
    ha-entity-picker {
      display: block;
      margin-bottom: 16px;
    }
