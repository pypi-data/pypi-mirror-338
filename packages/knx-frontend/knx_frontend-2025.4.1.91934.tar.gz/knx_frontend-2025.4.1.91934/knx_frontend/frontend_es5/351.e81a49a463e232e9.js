/*! For license information please see 351.e81a49a463e232e9.js.LICENSE.txt */
"use strict";(self.webpackChunkknx_frontend=self.webpackChunkknx_frontend||[]).push([["351"],{72933:function(e,t,a){a.d(t,{K:()=>l,N:()=>s});var n=a(57243);let i,r,o=e=>e;const s=(0,n.dy)(i||(i=o`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></svg>`)),l=(0,n.dy)(r||(r=o`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path></svg>`))},10916:function(e,t,a){a.a(e,(async function(e,t){try{var n=a(44686),i=a(90248),r=a(83194),o=e([n,i]);[n,i]=o.then?(await o)():o,(0,r.P)(n.u1,i.a),t()}catch(s){t(s)}}))},60553:function(e,t,a){a.d(t,{Ph:()=>c,s_:()=>u});var n=a(57243);let i,r,o,s,l,d=e=>e;const c=(0,n.iv)(i||(i=d`
button {
...
`)),(0,n.iv)(s||(s=d`[hidden] { display: none !important; }`)),(0,n.iv)(l||(l=d`
:host {
  display: block;
...
`)))},44686:function(e,t,a){a.a(e,(async function(e,n){try{a.d(t,{HZ:()=>d,Hb:()=>p,It:()=>h,TG:()=>o,gW:()=>c,nL:()=>u,u1:()=>y});a(71695),a(92519),a(42179),a(89256),a(24931),a(88463),a(57449),a(19814),a(47021);var i=a(69440),r=e([i]);i=(r.then?(await r)():r)[0];const o=Intl&&Intl.DateTimeFormat,s=[38,33,36],l=[40,34,35],d=new Set([37,...s]),c=new Set([39,...l]),u=new Set([39,...s]),h=new Set([37,...l]),p=new Set([37,39,...s,...l]),y="app-datepicker";n()}catch(o){n(o)}}))},90248:function(e,t,a){a.a(e,(async function(e,n){try{a.d(t,{a:()=>J});a(71695),a(9359),a(70104),a(40251),a(92519),a(42179),a(89256),a(24931),a(88463),a(57449),a(19814),a(47021);var i=a(9065),r=a(57243),o=a(50778),s=a(67064),l=a(35359),d=a(91583),c=a(47766),u=a(72933),h=a(60553),p=a(44686),y=a(41476),f=a(88641),_=a(89503),m=a(17850),b=a(89560),v=a(68385),w=a(48346),g=a(54060),k=a(53186),D=a(38788),x=a(87593),T=a(95772),C=a(33594),S=a(62681),F=a(15574),$=a(59958),U=a(2217),N=a(71312),L=a(4773),M=e([k,v,p,f]);[k,v,p,f]=M.then?(await M)():M;let E,W,Y,O,P,V,I,A,j,z,K,q,Z,G,H,R,B=e=>e;class J extends r.oi{constructor(){super(),this.firstDayOfWeek=0,this.showWeekNumber=!1,this.weekNumberType="first-4-day-week",this.landscape=!1,this.locale=(0,k.L)(),this.disabledDays="",this.disabledDates="",this.weekLabel="Wk",this.inline=!1,this.dragRatio=.15,this._hasMin=!1,this._hasMax=!1,this._disabledDaysSet=new Set,this._disabledDatesSet=new Set,this._dx=-1/0,this._hasNativeWebAnimation="animate"in HTMLElement.prototype,this._updatingDateWithKey=!1;const e=(0,g.F)(),t=(0,v._)(this.locale),a=(0,$.y)(e),n=(0,g.F)("2100-12-31");this.value=a,this.startView="calendar",this._min=new Date(e),this._max=new Date(n),this._todayDate=e,this._maxDate=n,this._yearList=(0,U.S)(e,n),this._selectedDate=new Date(e),this._focusedDate=new Date(e),this._formatters=t}get startView(){return this._startView}set startView(e){const t=e||"calendar";if("calendar"!==t&&"yearList"!==t)return;const a=this._startView;this._startView=t,this.requestUpdate("startView",a)}get min(){return this._hasMin?(0,$.y)(this._min):""}set min(e){const t=(0,g.F)(e),a=(0,x.q)(e,t);this._min=a?t:this._todayDate,this._hasMin=a,this.requestUpdate("min")}get max(){return this._hasMax?(0,$.y)(this._max):""}set max(e){const t=(0,g.F)(e),a=(0,x.q)(e,t);this._max=a?t:this._maxDate,this._hasMax=a,this.requestUpdate("max")}get value(){return(0,$.y)(this._focusedDate)}set value(e){const t=(0,g.F)(e),a=(0,x.q)(e,t)?t:this._todayDate;this._focusedDate=new Date(a),this._selectedDate=this._lastSelectedDate=new Date(a)}disconnectedCallback(){super.disconnectedCallback(),this._tracker&&(this._tracker.disconnect(),this._tracker=void 0)}render(){this._formatters.locale!==this.locale&&(this._formatters=(0,v._)(this.locale));const e="yearList"===this._startView?this._renderDatepickerYearList():this._renderDatepickerCalendar(),t=this.inline?null:(0,r.dy)(E||(E=B`<div class="datepicker-header" part="header">${0}</div>`),this._renderHeaderSelectorButton());return(0,r.dy)(W||(W=B`
    ...
    `),(0,l.$)({"btn__year-selector":!0,selected:!a}),"yearList",this._updateView("yearList"),o,(0,l.$)({"btn__calendar-selector":!0,selected:a}),"calendar",this._updateView("calendar"),i)}_renderDatepickerYearList(){const{yearFormat:e}=this._formatters,t=this._focusedDate.getUTCFullYear();return(0,r.dy)(O||(O=B`
    <div class="datepicker-body__year-list-view" part="year-list-view">
      <div class="year-list-view__full-list" part="year-list" @click="${0}">
      ${0}</div>
    </div>
    `),this._updateYear,this._yearList.map((a=>(0,r.dy)(P||(P=B`<button
        class="${0}"
        type="button"
        part="year"
        .year="${0}">${0}</button>`),(0,l.$)({"year-list-view__list-item":!0,"year--selected":t===a}),a,e((0,c.u)(a,0,1))))))}_renderDatepickerCalendar(){const{longMonthYearFormat:e,dayFormat:t,fullDateFormat:a,longWeekdayFormat:n,narrowWeekdayFormat:i}=this._formatters,o=(0,S._)(this.disabledDays,Number),s=(0,S._)(this.disabledDates,g.F),c=this.showWeekNumber,h=this._focusedDate,p=this.firstDayOfWeek,y=(0,g.F)(),_=this._selectedDate,m=this._max,b=this._min,{calendars:v,disabledDaysSet:k,disabledDatesSet:D,weekdays:x}=(0,w.$)({dayFormat:t,fullDateFormat:a,longWeekdayFormat:n,narrowWeekdayFormat:i,firstDayOfWeek:p,disabledDays:o,disabledDates:s,locale:this.locale,selectedDate:_,showWeekNumber:this.showWeekNumber,weekNumberType:this.weekNumberType,max:m,min:b,weekLabel:this.weekLabel}),T=!v[0].calendar.length,C=!v[2].calendar.length,F=x.map((e=>(0,r.dy)(V||(V=B`<th
      ...
      `),n,n,i?e(i):"",F,t.map((e=>(0,r.dy)(j||(j=B`<tr role="row">${0}</tr>`),e.map(((e,t)=>{const{disabled:a,fullDate:n,label:i,value:d}=e;if(!n&&d&&c&&t<1)return(0,r.dy)(z||(z=B`<th
                      ...
                      abbr="${0}"
                      aria-label="${0}"
                    >${0}</th>`),i,i,d);if(!d||!n)return(0,r.dy)(K||(K=B`<td class="full-calendar__day day--empty" part="calendar-day"></td>`));const u=+new Date(n),p=+h===u,f=o&&s.getUTCDate()===Number(d);return(0,r.dy)(q||(q=B`
                  <td
                    tabindex="${0}"
                    class="${0}"
                    part="calendar-day${0}"
                  ...
                  `),f?"0":"-1",(0,l.$)({"full-calendar__day":!0,"day--disabled":a,"day--today":+y===u,"day--focused":!a&&p}),+y===u?" calendar-today":"",a?"true":"false",i,p?"true":"false",n,d,+y===u?" today":"",d)}))))))}));return this._disabledDatesSet=D,this._disabledDaysSet=k,(0,r.dy)(Z||(Z=B`
    ...
    `),T?null:(0,r.dy)(G||(G=B`
          <button
            ...
            @click="${0}"
          >${0}</button>
        `),this._updateMonth("previous"),u.N),C?null:(0,r.dy)(H||(H=B`
          <button
            class="btn__month-selector"
            type="button"
            part="month-selector"
