...
/* harmony import */ var _components_variableInspectorPanel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/variableInspectorPanel */ "./lib/components/variableInspectorPanel.js");
...
const VariableItem = ({ vrb, commands, labShell, showType, showShape, showSize }) => {
    ...
    const loadPreview = async (type) => {
        if (notebookPanel) {
            try {
                ...
                const result = await (0,_utils_executeGetMatrix__WEBPACK_IMPORTED_MODULE_2__.executeMatrixContent)(vrb.name, 0, 10, 0, 10, notebookPanel);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (_utils_allowedTypes__WEBPACK_IMPORTED_MODULE_3__.allowedTypes.includes(vrb.type) &&
            vrb.dimension === 1 &&
            vrb.type === 'list') {
            loadPreview('list');
        }
        ...
        if (notebookPanel) {
            try {
                ...
                if (variableData && !isOpen) {
                    setLoading(true);
                    (0,_components_variableInspectorPanel__WEBPACK_IMPORTED_MODULE_4__.createEmptyVariableInspectorPanel)(labShell, variableName, variableType, variableShape, notebookPanel);
                }
            }
            catch (err) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: `mljar-variable-inspector-item ${_utils_allowedTypes__WEBPACK_IMPORTED_MODULE_3__.allowedTypes.includes(vrb.type) && vrb.dimension <= 2 && vrb.type !== 'list' && vrb.dimension !== 1 ? '' : 'small-value'}` },
        ...
        _utils_allowedTypes__WEBPACK_IMPORTED_MODULE_3__.allowedTypes.includes(vrb.type) && vrb.dimension <= 2 ? (vrb.dimension === 1 && vrb.type === 'list' ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: "mljar-variable-inspector-variable-preview", title: preview, onClick: () => handleButtonClick(vrb.name, vrb.type, vrb.shape) }, preview)) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: "mljar-variable-inspector-show-variable-button", onClick: () => handleButtonClick(vrb.name, vrb.type, vrb.shape), "aria-label": `Show details for ${vrb.name}`, title: "Show value" }, loading ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "mljar-variable-spinner-big" })) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_icons_detailIcon__WEBPACK_IMPORTED_MODULE_5__.detailIcon.react, { className: "mljar-variable-detail-button-icon" }))))) : vrb.type === 'dict' ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "mljar-variable-inspector-variable-value", title: preview }, preview)) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "mljar-variable-inspector-variable-value", title: vrb.value }, vrb.value))));
};
...
//# sourceMappingURL=lib_index_js.bb7cc39fd155d1b9295a.js.map