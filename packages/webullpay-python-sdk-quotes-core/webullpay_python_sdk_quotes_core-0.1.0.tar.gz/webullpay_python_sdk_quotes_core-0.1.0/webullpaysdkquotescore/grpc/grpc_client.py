...
from webullpaysdkquotescore.grpc.grpc_retry_policy import DefaultSubscribeRetryPolicy
from webullpaysdkquotescore.grpc import error
from webullpaysdkquotescore.grpc.connect import Connect
...
class GrpcApiClient(object):
    ...
    def set_stream_logger(self, log_level=logging.DEBUG, logger_name='webullpaysdkquotescore', stream=None,
                          format_string=None):
    ...
    def set_file_logger(self, path, log_level=logging.DEBUG, logger_name='webullpaysdkquotescore', format_string=None):
        log = logging.getLogger(logger_name)
        log.setLevel(log_level)
