...
def get_reframed_query_with_config_prompt(
    ...
    logger.info(f"Reframed query with config prompt: {prompt}")
    return prompt
...
def get_reframed_query_with_metadata_prompt(
    ...
    prompt = "\n\n".join(query_reframer_prompt)
    logger.info(f"Reframed query with config and metadata prompt: {prompt}")
    return prompt
...
def get_config_mapping_prompt(
    ...
    config_mapping_prompt_list.append(f"Given the query: `{query}`")
    config_mapping_prompt_list.append(
    ...
    logger.info(f"Config mapping prompt: {prompt}")
    return prompt
