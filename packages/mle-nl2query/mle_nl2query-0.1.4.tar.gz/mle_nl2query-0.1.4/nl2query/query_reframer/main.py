...
class QueryReframer(BaseModule):
    ...
    def run(self, state):
        ...
        if state["query_reframer_metadata_yn"]:
            self.query_reframer_with_metadata_prompt = self.query_reframer_with_metadata_prompt
            self.query_reframer_with_metadata_examples = self.query_reframer_with_metadata_examples
        elif state["query_reframer_config_yn"]:
            self.query_reframer_with_config_prompt = self.query_reframer_with_config_prompt
            self.query_reframer_with_config_examples = self.query_reframer_with_config_examples
        else:
